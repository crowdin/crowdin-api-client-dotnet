...
namespace Crowdin.Api.Api
{
    ...
    public interface IVendorsApiSync : IApiAccessor
    {
        ...
        /// <returns>VendorCollectionResource</returns>
        VendorCollectionResource ApiVendorsGetMany(int? limit = default(int?), int? offset = default(int?));
        ...
        /// <param name="limit">A maximum number of items to retrieve (optional, default to 25)</param>
        /// <param name="offset">A starting offset in the collection (optional, default to 0)</param>
        /// <returns>ApiResponse of VendorCollectionResource</returns>
        ApiResponse<VendorCollectionResource> ApiVendorsGetManyWithHttpInfo(int? limit = default(int?), int? offset = default(int?));
    ...
    public interface IVendorsApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of VendorCollectionResource</returns>
        System.Threading.Tasks.Task<VendorCollectionResource> ApiVendorsGetManyAsync(int? limit = default(int?), int? offset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="offset">A starting offset in the collection (optional, default to 0)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VendorCollectionResource)</returns>
        System.Threading.Tasks.Task<ApiResponse<VendorCollectionResource>> ApiVendorsGetManyWithHttpInfoAsync(int? limit = default(int?), int? offset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class VendorsApi : IVendorsApi
    {
        ...
        /// <returns></returns>
        public VendorsApi(Crowdin.Api.Client.Configuration configuration)
        {
        ...
        public VendorsApi(Crowdin.Api.Client.ISynchronousClient client, Crowdin.Api.Client.IAsynchronousClient asyncClient, Crowdin.Api.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="offset">A starting offset in the collection (optional, default to 0)</param>
        /// <returns>VendorCollectionResource</returns>
        public VendorCollectionResource ApiVendorsGetMany(int? limit = default(int?), int? offset = default(int?))
        {
            Crowdin.Api.Client.ApiResponse<VendorCollectionResource> localVarResponse = ApiVendorsGetManyWithHttpInfo(limit, offset);
        ...
        /// <param name="offset">A starting offset in the collection (optional, default to 0)</param>
        /// <returns>ApiResponse of VendorCollectionResource</returns>
        public Crowdin.Api.Client.ApiResponse<VendorCollectionResource> ApiVendorsGetManyWithHttpInfo(int? limit = default(int?), int? offset = default(int?))
        {
            ...
            var localVarResponse = this.Client.Get<VendorCollectionResource>("/vendors", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("ApiVendorsGetMany", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of VendorCollectionResource</returns>
        public async System.Threading.Tasks.Task<VendorCollectionResource> ApiVendorsGetManyAsync(int? limit = default(int?), int? offset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Crowdin.Api.Client.ApiResponse<VendorCollectionResource> localVarResponse = await ApiVendorsGetManyWithHttpInfoAsync(limit, offset, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VendorCollectionResource)</returns>
        public async System.Threading.Tasks.Task<Crowdin.Api.Client.ApiResponse<VendorCollectionResource>> ApiVendorsGetManyWithHttpInfoAsync(int? limit = default(int?), int? offset = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<VendorCollectionResource>("/vendors", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
