...
namespace Crowdin.Api.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.crowdin.com/api/v2";
        ...
        public Configuration(
            ...
            string basePath = "https://api.crowdin.com/api/v2") : this()
        {
        ...
        {
            string report = "C# SDK (Crowdin.Api) Debug Report:\n";
