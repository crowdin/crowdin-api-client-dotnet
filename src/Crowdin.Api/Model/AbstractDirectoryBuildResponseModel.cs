...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AbstractDirectoryBuildResponseModel")]
    public partial class AbstractDirectoryBuildResponseModel : IEquatable<AbstractDirectoryBuildResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractDirectoryBuildResponseModel" /> class.
        /// </summary>
        ...
        public AbstractDirectoryBuildResponseModel(int id = default(int), int projectId = default(int), StatusEnum? status = default(StatusEnum?), int progress = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime finishedAt = default(DateTime))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AbstractDirectoryBuildResponseModel {\n");
        ...
        {
            return this.Equals(input as AbstractDirectoryBuildResponseModel);
        }

        /// <summary>
        /// Returns true if AbstractDirectoryBuildResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of AbstractDirectoryBuildResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractDirectoryBuildResponseModel input)
        {
            if (input == null)
                return false;
