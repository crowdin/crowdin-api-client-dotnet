...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupOperationTest")]
    ...
    public partial class GroupOperationTest : GroupOperation, IEquatable<GroupOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;GroupOperationTest&quot;).</param>
        ...
        public GroupOperationTest(OneOfstringarray value = default(OneOfstringarray), OpEnum op = "GroupOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for GroupOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupOperationTest {\n");
        ...
        {
            return this.Equals(input as GroupOperationTest);
        }

        /// <summary>
        /// Returns true if GroupOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupOperationTest input)
        {
            if (input == null)
                return false;
