...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectPlaceholderOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(ProjectPlaceholderOperationReplace), "ProjectPlaceholderOperationReplace")]
    ...
    public partial class ProjectPlaceholderOperation : IEquatable<ProjectPlaceholderOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum PathEnum
        {
            ...
            /// <summary>
            /// Enum IsBlocking for value: /isBlocking
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectPlaceholderOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectPlaceholderOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectPlaceholderOperation" /> class.
        /// </summary>
        ...
        public ProjectPlaceholderOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectPlaceholderOperation {\n");
        ...
        {
            return this.Equals(input as ProjectPlaceholderOperation);
        }

        /// <summary>
        /// Returns true if ProjectPlaceholderOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectPlaceholderOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectPlaceholderOperation input)
        {
            if (input == null)
                return false;
