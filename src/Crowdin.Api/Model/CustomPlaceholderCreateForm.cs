...
{
    /// <summary>
    /// CustomPlaceholderCreateForm
    /// </summary>
    [DataContract(Name = "CustomPlaceholderCreateForm")]
    public partial class CustomPlaceholderCreateForm : IEquatable<CustomPlaceholderCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholderCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomPlaceholderCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholderCreateForm" /> class.
        /// </summary>
        /// <param name="description">description.</param>
        /// <param name="definition">definition (required).</param>
        /// <param name="argumentDelimiter">argumentDelimiter (default to &quot;&quot;&quot;).</param>
        public CustomPlaceholderCreateForm(string description = default(string), string definition = default(string), string argumentDelimiter = """)
        {
            // to ensure "definition" is required (not null)
            if (definition == null) {
                throw new ArgumentNullException("definition is a required property for CustomPlaceholderCreateForm and cannot be null");
            }
            this.Definition = definition;
            this.Description = description;
            // use default value if no "argumentDelimiter" provided
        ...
        /// <summary>
        /// Gets or Sets ArgumentDelimiter
        /// </summary>
        [DataMember(Name = "argumentDelimiter", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomPlaceholderCreateForm {\n");
            sb.Append("  Description: ").Append(Description).Append("\n");
            sb.Append("  Definition: ").Append(Definition).Append("\n");
            sb.Append("  ArgumentDelimiter: ").Append(ArgumentDelimiter).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CustomPlaceholderCreateForm);
        }

        /// <summary>
        /// Returns true if CustomPlaceholderCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomPlaceholderCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomPlaceholderCreateForm input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ArgumentDelimiter == input.ArgumentDelimiter ||
                    (this.ArgumentDelimiter != null &&
                    this.ArgumentDelimiter.Equals(input.ArgumentDelimiter))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ArgumentDelimiter != null)
                    hashCode = hashCode * 59 + this.ArgumentDelimiter.GetHashCode();
                return hashCode;
            }
        }
