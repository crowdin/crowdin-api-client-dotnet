...
namespace Crowdin.Api.Model
{
    ...
    /// Exception Resource
    /// </summary>
    [DataContract(Name = "ExceptionResource")]
    public partial class ExceptionResource : IEquatable<ExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public ExceptionResource(Exception error = default(Exception))
        {
            this.Error = error;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExceptionResource {\n");
        ...
        {
            return this.Equals(input as ExceptionResource);
        }

        /// <summary>
        /// Returns true if ExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExceptionResource input)
        {
            if (input == null)
                return false;
