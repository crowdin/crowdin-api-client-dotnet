...
namespace Crowdin.Api.Model
{
    ...
    /// ProgressWords
    /// </summary>
    [DataContract(Name = "Progress_words")]
    public partial class ProgressWords : IEquatable<ProgressWords>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgressWords" /> class.
        /// </summary>
        /// <param name="total">total.</param>
        /// <param name="translated">translated.</param>
        /// <param name="approved">approved.</param>
        public ProgressWords(int total = default(int), int translated = default(int), int approved = default(int))
        {
            this.Total = total;
        ...
        {
            return this.Equals(input as ProgressWords);
        }

        /// <summary>
        /// Returns true if ProgressWords instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgressWords to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgressWords input)
        {
            if (input == null)
                return false;
