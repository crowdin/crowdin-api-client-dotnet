...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FileOperationReplace")]
    ...
    public partial class FileOperationReplace : FileOperation, IEquatable<FileOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FileOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FileOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;FileOperationReplace&quot;).</param>
        ...
        public FileOperationReplace(OneOfstringintegerarray value = default(OneOfstringintegerarray), OpEnum op = "FileOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for FileOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public OneOfstringintegerarray Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileOperationReplace {\n");
        ...
        {
            return this.Equals(input as FileOperationReplace);
        }

        /// <summary>
        /// Returns true if FileOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of FileOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileOperationReplace input)
        {
            if (input == null)
                return false;
