...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(WebhookOperationReplace), "WebhookOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(WebhookOperationTest), "WebhookOperationTest")]
    ...
    public partial class WebhookOperation : IEquatable<WebhookOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum PathEnum
        {
            ...
            /// <summary>
            /// Enum IsActive for value: /isActive
            /// </summary>
            [EnumMember(Value = "/isActive")]
            IsActive = 3,

            /// <summary>
            /// Enum BatchingEnabled for value: /batchingEnabled
            /// </summary>
            [EnumMember(Value = "/batchingEnabled")]
            BatchingEnabled = 4,
            ...
            /// <summary>
            /// Enum RequestType for value: /requestType
            /// </summary>
        ...
        public WebhookOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as WebhookOperation);
        }

        /// <summary>
        /// Returns true if WebhookOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookOperation input)
        {
            if (input == null)
                return false;
