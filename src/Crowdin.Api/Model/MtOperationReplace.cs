...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MtOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(MtOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(MtOperationTest), "test")]
    public partial class MtOperationReplace : MtOperation, IEquatable<MtOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MtOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MtOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;MtOperationReplace&quot;).</param>
        ...
        public MtOperationReplace(OneOfstringobject value = default(OneOfstringobject), OpEnum op = "MtOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for MtOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public OneOfstringobject Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtOperationReplace {\n");
        ...
        {
            return this.Equals(input as MtOperationReplace);
        }

        /// <summary>
        /// Returns true if MtOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of MtOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtOperationReplace input)
        {
            if (input == null)
                return false;
