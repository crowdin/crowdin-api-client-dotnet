...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddProjectTeamForm_permissions")]
    public partial class AddProjectTeamFormPermissions : IEquatable<AddProjectTeamFormPermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectTeamFormPermissions" /> class.
        /// </summary>
        /// <param name="it">it.</param>
        /// <param name="de">de.</param>
        public AddProjectTeamFormPermissions(AddProjectTeamFormPermissionsIt it = default(AddProjectTeamFormPermissionsIt), AddProjectTeamFormPermissionsDe de = default(AddProjectTeamFormPermissionsDe))
        {
            this.It = it;
            this.De = de;
        }
        ...
        public AddProjectTeamFormPermissionsIt It { get; set; }

        /// <summary>
        /// Gets or Sets De
        /// </summary>
        [DataMember(Name = "de", EmitDefaultValue = false)]
        public AddProjectTeamFormPermissionsDe De { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProjectTeamFormPermissions {\n");
        ...
        {
            return this.Equals(input as AddProjectTeamFormPermissions);
        }

        /// <summary>
        /// Returns true if AddProjectTeamFormPermissions instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProjectTeamFormPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProjectTeamFormPermissions input)
        {
            if (input == null)
                return false;
