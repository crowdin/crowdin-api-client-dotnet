...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SpreadsheetLanguageCodeColumnNumber")]
    public partial class SpreadsheetLanguageCodeColumnNumber : IEquatable<SpreadsheetLanguageCodeColumnNumber>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpreadsheetLanguageCodeColumnNumber" /> class.
        /// </summary>
        /// <param name="columnNumber">Defines column number for the specified language.</param>
        public SpreadsheetLanguageCodeColumnNumber(int columnNumber = default(int))
        {
            this.ColumnNumber = columnNumber;
        }

        /// <summary>
        /// Defines column number for the specified language
        /// </summary>
        /// <value>Defines column number for the specified language</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SpreadsheetLanguageCodeColumnNumber {\n");
        ...
        {
            return this.Equals(input as SpreadsheetLanguageCodeColumnNumber);
        }

        /// <summary>
        /// Returns true if SpreadsheetLanguageCodeColumnNumber instances are equal
        /// </summary>
        /// <param name="input">Instance of SpreadsheetLanguageCodeColumnNumber to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpreadsheetLanguageCodeColumnNumber input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ColumnNumber == input.ColumnNumber ||
                    this.ColumnNumber.Equals(input.ColumnNumber)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.ColumnNumber.GetHashCode();
                return hashCode;
            }
        }
