...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TermOperationTest")]
    ...
    public partial class TermOperationTest : TermOperation, IEquatable<TermOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;TermOperationTest&quot;).</param>
        ...
        public TermOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "TermOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TermOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TermOperationTest {\n");
        ...
        {
            return this.Equals(input as TermOperationTest);
        }

        /// <summary>
        /// Returns true if TermOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of TermOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermOperationTest input)
        {
            if (input == null)
                return false;
