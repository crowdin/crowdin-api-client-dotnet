...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Language_Translation_Progress_2")]
    public partial class LanguageTranslationProgress2 : IEquatable<LanguageTranslationProgress2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageTranslationProgress2" /> class.
        /// </summary>
        /// <param name="languageId">languageId.</param>
        public LanguageTranslationProgress2(string languageId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LanguageTranslationProgress2 {\n");
        ...
        {
            return this.Equals(input as LanguageTranslationProgress2);
        }

        /// <summary>
        /// Returns true if LanguageTranslationProgress2 instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageTranslationProgress2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageTranslationProgress2 input)
        {
            if (input == null)
                return false;
