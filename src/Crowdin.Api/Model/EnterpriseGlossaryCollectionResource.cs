...
{
    /// <summary>
    /// Glossary Collection Resource
    /// </summary>
    [DataContract(Name = "EnterpriseGlossaryCollectionResource")]
    public partial class EnterpriseGlossaryCollectionResource : IEquatable<EnterpriseGlossaryCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseGlossaryCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public EnterpriseGlossaryCollectionResource(List<EnterpriseGlossaryResource> data = default(List<EnterpriseGlossaryResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<EnterpriseGlossaryResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseGlossaryCollectionResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseGlossaryCollectionResource);
        }

        /// <summary>
        /// Returns true if EnterpriseGlossaryCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseGlossaryCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseGlossaryCollectionResource input)
        {
            if (input == null)
                return false;
