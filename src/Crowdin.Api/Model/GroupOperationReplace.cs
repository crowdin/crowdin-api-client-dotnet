...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(GroupOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(GroupOperationTest), "test")]
    public partial class GroupOperationReplace : GroupOperation, IEquatable<GroupOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;GroupOperationReplace&quot;).</param>
        ...
        public GroupOperationReplace(OneOfstringinteger value = default(OneOfstringinteger), OpEnum op = "GroupOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for GroupOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupOperationReplace {\n");
        ...
        {
            return this.Equals(input as GroupOperationReplace);
        }

        /// <summary>
        /// Returns true if GroupOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupOperationReplace input)
        {
            if (input == null)
                return false;
