...
namespace Crowdin.Api.Model
{
    ...
    public partial class TaskProgress : IEquatable<TaskProgress>, IValidatableObject
    {
        /// <summary>
        ...
        public TaskProgress(int total = default(int), int done = default(int), int percent = default(int))
        {
            this.Total = total;
            this.Done = done;
