...
{
    /// <summary>
    /// ProofreadStepResponseData
    /// </summary>
    [DataContract(Name = "ProofreadStepResponse_data")]
    public partial class ProofreadStepResponseData : IEquatable<ProofreadStepResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProofreadStepResponseData" /> class.
        /// </summary>
        ...
        public ProofreadStepResponseData(int id = default(int), string title = default(string), string type = default(string), List<string> languages = default(List<string>), TranslateStepResponseDataConfig config = default(TranslateStepResponseDataConfig))
        {
            this.Id = id;
            this.Title = title;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProofreadStepResponseData {\n");
        ...
        {
            return this.Equals(input as ProofreadStepResponseData);
        }

        /// <summary>
        /// Returns true if ProofreadStepResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of ProofreadStepResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProofreadStepResponseData input)
        {
            if (input == null)
                return false;
