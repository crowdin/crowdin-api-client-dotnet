...
{
    /// <summary>
    /// MethodNotAllowedExceptionResourceError
    /// </summary>
    [DataContract(Name = "MethodNotAllowedExceptionResource_error")]
    public partial class MethodNotAllowedExceptionResourceError : IEquatable<MethodNotAllowedExceptionResourceError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MethodNotAllowedExceptionResourceError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public MethodNotAllowedExceptionResourceError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MethodNotAllowedExceptionResourceError {\n");
        ...
        {
            return this.Equals(input as MethodNotAllowedExceptionResourceError);
        }

        /// <summary>
        /// Returns true if MethodNotAllowedExceptionResourceError instances are equal
        /// </summary>
        /// <param name="input">Instance of MethodNotAllowedExceptionResourceError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MethodNotAllowedExceptionResourceError input)
        {
            if (input == null)
                return false;
