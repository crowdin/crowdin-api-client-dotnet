...
namespace Crowdin.Api.Model
{
    ...
    /// TeamMemberForm
    /// </summary>
    [DataContract(Name = "TeamMemberForm")]
    public partial class TeamMemberForm : IEquatable<TeamMemberForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamMemberForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamMemberForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamMemberForm" /> class.
        /// </summary>
        /// <param name="userIds">Team Users Identifiers. Get via [List Users](#operation/api.users.getMany)  __Note:__ You can invite up to 50 team members at a time. (required).</param>
        public TeamMemberForm(List<int> userIds = default(List<int>))
        {
            // to ensure "userIds" is required (not null)
            if (userIds == null) {
                throw new ArgumentNullException("userIds is a required property for TeamMemberForm and cannot be null");
            }
            this.UserIds = userIds;
        }

        /// <summary>
        /// Team Users Identifiers. Get via [List Users](#operation/api.users.getMany)  __Note:__ You can invite up to 50 team members at a time.
        /// </summary>
        /// <value>Team Users Identifiers. Get via [List Users](#operation/api.users.getMany)  __Note:__ You can invite up to 50 team members at a time.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamMemberForm {\n");
        ...
        {
            return this.Equals(input as TeamMemberForm);
        }

        /// <summary>
        /// Returns true if TeamMemberForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamMemberForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamMemberForm input)
        {
            if (input == null)
                return false;
