...
namespace Crowdin.Api.Model
{
    ...
    /// GlossaryExport
    /// </summary>
    [DataContract(Name = "GlossaryExport")]
    public partial class GlossaryExport : IEquatable<GlossaryExport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryExport" /> class.
        /// </summary>
        ...
        public GlossaryExport(string identifier = default(string), string status = default(string), int progress = default(int), GlossaryExportAttributes attributes = default(GlossaryExportAttributes), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime finishedAt = default(DateTime), string eta = default(string))
        {
        ...
        public GlossaryExportAttributes Attributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryExport {\n");
        ...
        {
            return this.Equals(input as GlossaryExport);
        }

        /// <summary>
        /// Returns true if GlossaryExport instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryExport input)
        {
            if (input == null)
                return false;
