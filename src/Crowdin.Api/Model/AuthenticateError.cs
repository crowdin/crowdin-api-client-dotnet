...
namespace Crowdin.Api.Model
{
    ...
    /// Authenticate Error
    /// </summary>
    [DataContract(Name = "AuthenticateError")]
    public partial class AuthenticateError : IEquatable<AuthenticateError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticateError" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public AuthenticateError(AuthenticateErrorError error = default(AuthenticateErrorError))
        {
            this.Error = error;
        }
        ...
        public AuthenticateErrorError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticateError {\n");
        ...
        {
            return this.Equals(input as AuthenticateError);
        }

        /// <summary>
        /// Returns true if AuthenticateError instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticateError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticateError input)
        {
            if (input == null)
                return false;
