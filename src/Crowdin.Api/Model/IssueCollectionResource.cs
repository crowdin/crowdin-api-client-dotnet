...
{
    /// <summary>
    /// Issue Collection Resource
    /// </summary>
    [DataContract(Name = "IssueCollectionResource")]
    public partial class IssueCollectionResource : IEquatable<IssueCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public IssueCollectionResource(List<IssueResource> data = default(List<IssueResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<IssueResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IssueCollectionResource {\n");
        ...
        {
            return this.Equals(input as IssueCollectionResource);
        }

        /// <summary>
        /// Returns true if IssueCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueCollectionResource input)
        {
            if (input == null)
                return false;
