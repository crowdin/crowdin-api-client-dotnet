...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnterpriseTmCreateForm")]
    public partial class EnterpriseTmCreateForm : IEquatable<EnterpriseTmCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTmCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnterpriseTmCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTmCreateForm" /> class.
        /// </summary>
        /// <param name="name">Translation Memory name (required).</param>
        /// <param name="groupId">Group Identifier – defines group to which TM is added. Get via [List Groups](#operation/api.groups.getMany)  If &#39;0&#39; – TM will be available for all projects and groups in your workspace (default to 0).</param>
        public EnterpriseTmCreateForm(string name = default(string), int groupId = 0)
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for EnterpriseTmCreateForm and cannot be null");
            }
            this.Name = name;
        ...
        /// </summary>
        /// <value>Translation Memory name</value>
        [DataMember(Name = "name", IsRequired = true, EmitDefaultValue = false)]
        public string Name { get; set; }

        /// <summary>
        /// Group Identifier – defines group to which TM is added. Get via [List Groups](#operation/api.groups.getMany)  If &#39;0&#39; – TM will be available for all projects and groups in your workspace
        /// </summary>
        /// <value>Group Identifier – defines group to which TM is added. Get via [List Groups](#operation/api.groups.getMany)  If &#39;0&#39; – TM will be available for all projects and groups in your workspace</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTmCreateForm {\n");
        ...
        {
            return this.Equals(input as EnterpriseTmCreateForm);
        }

        /// <summary>
        /// Returns true if EnterpriseTmCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTmCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTmCreateForm input)
        {
            if (input == null)
                return false;
