...
{
    /// <summary>
    /// PropertyFileExportOptionsResponseModel
    /// </summary>
    [DataContract(Name = "PropertyFileExportOptionsResponseModel")]
    public partial class PropertyFileExportOptionsResponseModel : IEquatable<PropertyFileExportOptionsResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyFileExportOptionsResponseModel" /> class.
        /// </summary>
        /// <param name="escapeQuotes">escapeQuotes.</param>
        /// <param name="escapeSpecialCharacters">escapeSpecialCharacters.</param>
        /// <param name="exportPattern">exportPattern.</param>
        public PropertyFileExportOptionsResponseModel(int? escapeQuotes = default(int?), int? escapeSpecialCharacters = default(int?), string exportPattern = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets EscapeQuotes
        /// </summary>
        [DataMember(Name = "escapeQuotes", EmitDefaultValue = true)]
        public int? EscapeQuotes { get; set; }

        /// <summary>
        /// Gets or Sets EscapeSpecialCharacters
        /// </summary>
        [DataMember(Name = "escapeSpecialCharacters", EmitDefaultValue = true)]
        public int? EscapeSpecialCharacters { get; set; }

        /// <summary>
        /// Gets or Sets ExportPattern
        /// </summary>
        [DataMember(Name = "exportPattern", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertyFileExportOptionsResponseModel {\n");
        ...
        {
            return this.Equals(input as PropertyFileExportOptionsResponseModel);
        }

        /// <summary>
        /// Returns true if PropertyFileExportOptionsResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyFileExportOptionsResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyFileExportOptionsResponseModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.EscapeSpecialCharacters != null &&
