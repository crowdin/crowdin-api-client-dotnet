...
{
    /// <summary>
    /// Files Translation Language Progress Resource
    /// </summary>
    [DataContract(Name = "LanguageProgressResource")]
    public partial class LanguageProgressResource : IEquatable<LanguageProgressResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageProgressResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public LanguageProgressResource(LanguageProgress data = default(LanguageProgress))
        {
            this.Data = data;
        }
        ...
        public LanguageProgress Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LanguageProgressResource {\n");
        ...
        {
            return this.Equals(input as LanguageProgressResource);
        }

        /// <summary>
        /// Returns true if LanguageProgressResource instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageProgressResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageProgressResource input)
        {
            if (input == null)
                return false;
