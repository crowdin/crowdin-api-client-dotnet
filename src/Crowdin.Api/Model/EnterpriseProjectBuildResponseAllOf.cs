...
{
    /// <summary>
    /// EnterpriseProjectBuildResponseAllOf
    /// </summary>
    [DataContract(Name = "EnterpriseProjectBuildResponse_allOf")]
    public partial class EnterpriseProjectBuildResponseAllOf : IEquatable<EnterpriseProjectBuildResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseProjectBuildResponseAllOf" /> class.
        /// </summary>
        /// <param name="attributes">attributes.</param>
        public EnterpriseProjectBuildResponseAllOf(List<OneOfEnterpriseBuildAttributesResponseModelEnterprisePseudoBuildAttributesResponseModel> attributes = default(List<OneOfEnterpriseBuildAttributesResponseModelEnterprisePseudoBuildAttributesResponseModel>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseProjectBuildResponseAllOf {\n");
        ...
        {
            return this.Equals(input as EnterpriseProjectBuildResponseAllOf);
        }

        /// <summary>
        /// Returns true if EnterpriseProjectBuildResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseProjectBuildResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseProjectBuildResponseAllOf input)
        {
            if (input == null)
                return false;
