...
namespace Crowdin.Api.Model
{
    ...
    /// TmExport
    /// </summary>
    [DataContract(Name = "TmExport")]
    public partial class TmExport : IEquatable<TmExport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmExport" /> class.
        /// </summary>
        ...
        public TmExport(string identifier = default(string), string status = default(string), int progress = default(int), TmExportAttributes attributes = default(TmExportAttributes), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime finishedAt = default(DateTime), string eta = default(string))
        {
        ...
        public TmExportAttributes Attributes { get; set; }
        ...
        {
            return this.Equals(input as TmExport);
        }

        /// <summary>
        /// Returns true if TmExport instances are equal
        /// </summary>
        /// <param name="input">Instance of TmExport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmExport input)
        {
            if (input == null)
                return false;
