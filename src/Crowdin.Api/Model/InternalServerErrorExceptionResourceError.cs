...
{
    /// <summary>
    /// InternalServerErrorExceptionResourceError
    /// </summary>
    [DataContract(Name = "InternalServerErrorExceptionResource_error")]
    public partial class InternalServerErrorExceptionResourceError : IEquatable<InternalServerErrorExceptionResourceError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalServerErrorExceptionResourceError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public InternalServerErrorExceptionResourceError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InternalServerErrorExceptionResourceError {\n");
        ...
        {
            return this.Equals(input as InternalServerErrorExceptionResourceError);
        }

        /// <summary>
        /// Returns true if InternalServerErrorExceptionResourceError instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalServerErrorExceptionResourceError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalServerErrorExceptionResourceError input)
        {
            if (input == null)
                return false;
