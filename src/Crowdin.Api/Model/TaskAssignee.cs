...
namespace Crowdin.Api.Model
{
    ...
    /// TaskAssignee
    /// </summary>
    [DataContract(Name = "TaskAssignee")]
    public partial class TaskAssignee : IEquatable<TaskAssignee>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskAssignee" /> class.
        /// </summary>
        ...
        /// <param name="wordsLeft">wordsLeft.</param>
        public TaskAssignee(int id = default(int), string username = default(string), string fullName = default(string), string avatarUrl = default(string), int wordsCount = default(int), int wordsLeft = default(int))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets WordsLeft
        /// </summary>
        [DataMember(Name = "wordsLeft", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as TaskAssignee);
        }

        /// <summary>
        /// Returns true if TaskAssignee instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskAssignee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskAssignee input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WordsLeft == input.WordsLeft ||
                    this.WordsLeft.Equals(input.WordsLeft)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.WordsLeft.GetHashCode();
                return hashCode;
            }
        }
