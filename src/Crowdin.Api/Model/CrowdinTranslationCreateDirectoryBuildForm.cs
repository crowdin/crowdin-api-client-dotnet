...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinTranslationCreateDirectoryBuildForm")]
    public partial class CrowdinTranslationCreateDirectoryBuildForm : IEquatable<CrowdinTranslationCreateDirectoryBuildForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTranslationCreateDirectoryBuildForm" /> class.
        /// </summary>
        ...
        public CrowdinTranslationCreateDirectoryBuildForm(List<string> targetLanguageIds = default(List<string>), bool skipUntranslatedStrings = false, bool skipUntranslatedFiles = false, bool exportApprovedOnly = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTranslationCreateDirectoryBuildForm {\n");
        ...
        {
            return this.Equals(input as CrowdinTranslationCreateDirectoryBuildForm);
        }

        /// <summary>
        /// Returns true if CrowdinTranslationCreateDirectoryBuildForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTranslationCreateDirectoryBuildForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTranslationCreateDirectoryBuildForm input)
        {
            if (input == null)
                return false;
