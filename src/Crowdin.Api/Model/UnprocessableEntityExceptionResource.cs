...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnprocessableEntityExceptionResource")]
    public partial class UnprocessableEntityExceptionResource : IEquatable<UnprocessableEntityExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnprocessableEntityExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public UnprocessableEntityExceptionResource(UnprocessableEntityExceptionResourceError error = default(UnprocessableEntityExceptionResourceError))
        {
            this.Error = error;
        }
        ...
        public UnprocessableEntityExceptionResourceError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnprocessableEntityExceptionResource {\n");
        ...
        {
            return this.Equals(input as UnprocessableEntityExceptionResource);
        }

        /// <summary>
        /// Returns true if UnprocessableEntityExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of UnprocessableEntityExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnprocessableEntityExceptionResource input)
        {
            if (input == null)
                return false;
