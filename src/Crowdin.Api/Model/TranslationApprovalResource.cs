...
{
    /// <summary>
    /// Translation Approval Resource
    /// </summary>
    [DataContract(Name = "TranslationApprovalResource")]
    public partial class TranslationApprovalResource : IEquatable<TranslationApprovalResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationApprovalResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TranslationApprovalResource(Approval data = default(Approval))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationApprovalResource {\n");
        ...
        {
            return this.Equals(input as TranslationApprovalResource);
        }

        /// <summary>
        /// Returns true if TranslationApprovalResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationApprovalResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationApprovalResource input)
        {
            if (input == null)
                return false;
