...
{
    /// <summary>
    /// MtPreTranslateStepResponseDataConfig
    /// </summary>
    [DataContract(Name = "MtPreTranslateStepResponse_data_config")]
    public partial class MtPreTranslateStepResponseDataConfig : IEquatable<MtPreTranslateStepResponseDataConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtPreTranslateStepResponseDataConfig" /> class.
        /// </summary>
        /// <param name="mtId">mtId.</param>
        public MtPreTranslateStepResponseDataConfig(int mtId = default(int))
        {
            this.MtId = mtId;
        }
        ...
        /// Gets or Sets MtId
        /// </summary>
        [DataMember(Name = "mtId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtPreTranslateStepResponseDataConfig {\n");
        ...
        {
            return this.Equals(input as MtPreTranslateStepResponseDataConfig);
        }

        /// <summary>
        /// Returns true if MtPreTranslateStepResponseDataConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of MtPreTranslateStepResponseDataConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtPreTranslateStepResponseDataConfig input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.MtId == input.MtId ||
                    this.MtId.Equals(input.MtId)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.MtId.GetHashCode();
                return hashCode;
            }
        }
