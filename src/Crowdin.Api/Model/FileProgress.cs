...
namespace Crowdin.Api.Model
{
    ...
    /// FileProgress
    /// </summary>
    [DataContract(Name = "FileProgress")]
    public partial class FileProgress : IEquatable<FileProgress>, IValidatableObject
    {
        /// <summary>
        ...
        public FileProgress(ProgressWords words = default(ProgressWords), ProgressPhrases phrases = default(ProgressPhrases), int translationProgress = default(int), int approvalProgress = default(int), string languageId = default(string), string eTag = default(string))
        {
            this.Words = words;
        ...
        {
            return this.Equals(input as FileProgress);
        }

        /// <summary>
        /// Returns true if FileProgress instances are equal
        /// </summary>
        /// <param name="input">Instance of FileProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileProgress input)
        {
            if (input == null)
                return false;
