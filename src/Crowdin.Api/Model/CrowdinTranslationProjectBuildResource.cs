...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinTranslationProjectBuildResource")]
    public partial class CrowdinTranslationProjectBuildResource : IEquatable<CrowdinTranslationProjectBuildResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTranslationProjectBuildResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CrowdinTranslationProjectBuildResource(CrowdinProjectBuildResponse data = default(CrowdinProjectBuildResponse))
        {
            this.Data = data;
        }
        ...
        public CrowdinProjectBuildResponse Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTranslationProjectBuildResource {\n");
        ...
        {
            return this.Equals(input as CrowdinTranslationProjectBuildResource);
        }

        /// <summary>
        /// Returns true if CrowdinTranslationProjectBuildResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTranslationProjectBuildResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTranslationProjectBuildResource input)
        {
            if (input == null)
                return false;
