...
namespace Crowdin.Api.Model
{
    ...
    /// Approval
    /// </summary>
    [DataContract(Name = "Approval")]
    public partial class Approval : IEquatable<Approval>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Approval" /> class.
        /// </summary>
        /// <param name="id">Approval Identifier. Get via [List Translation Approvals](#operation/api.projects.approvals.getMany).</param>
        /// <param name="user">user.</param>
        /// <param name="translationId">Translation Identifier.</param>
        ...
        /// <param name="createdAt">Approval create date.</param>
        public Approval(int id = default(int), IcuLanguageTranslationUser user = default(IcuLanguageTranslationUser), int translationId = default(int), int stringId = default(int), string languageId = default(string), int workflowStepId = default(int), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.User = user;
        ...
        /// <summary>
        /// Approval Identifier. Get via [List Translation Approvals](#operation/api.projects.approvals.getMany)
        /// </summary>
        /// <value>Approval Identifier. Get via [List Translation Approvals](#operation/api.projects.approvals.getMany)</value>
        ...
        /// </summary>
        /// <value>Translation Identifier</value>
        ...
        /// </summary>
        /// <value>Workflow Step Identifier</value>
        ...
        /// </summary>
        /// <value>Approval create date</value>
