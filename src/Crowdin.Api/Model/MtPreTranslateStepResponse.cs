...
{
    /// <summary>
    /// MtPreTranslateStepResponse
    /// </summary>
    [DataContract(Name = "MtPreTranslateStepResponse")]
    public partial class MtPreTranslateStepResponse : IEquatable<MtPreTranslateStepResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtPreTranslateStepResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MtPreTranslateStepResponse(MtPreTranslateStepResponseData data = default(MtPreTranslateStepResponseData))
        {
            this.Data = data;
        }
        ...
        public MtPreTranslateStepResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtPreTranslateStepResponse {\n");
        ...
        {
            return this.Equals(input as MtPreTranslateStepResponse);
        }

        /// <summary>
        /// Returns true if MtPreTranslateStepResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MtPreTranslateStepResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtPreTranslateStepResponse input)
        {
            if (input == null)
                return false;
