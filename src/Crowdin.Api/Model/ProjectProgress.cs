...
namespace Crowdin.Api.Model
{
    ...
    /// ProjectProgress
    /// </summary>
    [DataContract(Name = "ProjectProgress")]
    public partial class ProjectProgress : IEquatable<ProjectProgress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectProgress" /> class.
        /// </summary>
        ...
        public ProjectProgress(ProgressWords words = default(ProgressWords), ProgressPhrases phrases = default(ProgressPhrases), int translationProgress = default(int), int approvalProgress = default(int), string languageId = default(string))
        {
            this.Words = words;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectProgress {\n");
        ...
        {
            return this.Equals(input as ProjectProgress);
        }

        /// <summary>
        /// Returns true if ProjectProgress instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectProgress input)
        {
            if (input == null)
                return false;
