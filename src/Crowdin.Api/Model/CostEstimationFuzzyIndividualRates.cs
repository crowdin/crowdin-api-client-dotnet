...
{
    /// <summary>
    /// CostEstimationFuzzyIndividualRates
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.individual-rates")]
    public partial class CostEstimationFuzzyIndividualRates : IEquatable<CostEstimationFuzzyIndividualRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyIndividualRates" /> class.
        /// </summary>
        /// <param name="languageIds">Class ReportCreateForm.</param>
        /// <param name="rates">Class ReportCreateForm.</param>
        public CostEstimationFuzzyIndividualRates(List<string> languageIds = default(List<string>), List<CostEstimationFuzzyIndividualRateModes> rates = default(List<CostEstimationFuzzyIndividualRateModes>))
        {
        ...
        public List<CostEstimationFuzzyIndividualRateModes> Rates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyIndividualRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyIndividualRates);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyIndividualRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyIndividualRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyIndividualRates input)
        {
            if (input == null)
                return false;
