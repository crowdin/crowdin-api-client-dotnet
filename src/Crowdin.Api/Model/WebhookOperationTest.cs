...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookOperationTest")]
    ...
    public partial class WebhookOperationTest : WebhookOperation, IEquatable<WebhookOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;WebhookOperationTest&quot;).</param>
        ...
        public WebhookOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "WebhookOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for WebhookOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookOperationTest {\n");
        ...
        {
            return this.Equals(input as WebhookOperationTest);
        }

        /// <summary>
        /// Returns true if WebhookOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookOperationTest input)
        {
            if (input == null)
                return false;
