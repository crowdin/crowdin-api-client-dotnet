...
{
    /// <summary>
    /// A JSON Patch &#x60;Test&#x60; operation as defined by [RFC 6902](https://tools.ietf.org/html/rfc6902#section-4.3)
    /// </summary>
    [DataContract(Name = "ProjectSettingOperationTest")]
    ...
    public partial class ProjectSettingOperationTest : ProjectSettingOperation, IEquatable<ProjectSettingOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectSettingOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectSettingOperationTest&quot;).</param>
        ...
        public ProjectSettingOperationTest(OneOfstringintegerbooleanobject value = default(OneOfstringintegerbooleanobject), OpEnum op = "ProjectSettingOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectSettingOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectSettingOperationTest {\n");
        ...
        {
            return this.Equals(input as ProjectSettingOperationTest);
        }

        /// <summary>
        /// Returns true if ProjectSettingOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectSettingOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectSettingOperationTest input)
        {
            if (input == null)
                return false;
