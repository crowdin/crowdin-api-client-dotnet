...
{
    /// <summary>
    /// Distribution Release Resource
    /// </summary>
    [DataContract(Name = "DistributionReleaseResource")]
    public partial class DistributionReleaseResource : IEquatable<DistributionReleaseResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionReleaseResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public DistributionReleaseResource(DistributionRelease data = default(DistributionRelease))
        {
            this.Data = data;
        }
        ...
        public DistributionRelease Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionReleaseResource {\n");
        ...
        {
            return this.Equals(input as DistributionReleaseResource);
        }

        /// <summary>
        /// Returns true if DistributionReleaseResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionReleaseResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionReleaseResource input)
        {
            if (input == null)
                return false;
