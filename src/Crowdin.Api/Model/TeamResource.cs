...
namespace Crowdin.Api.Model
{
    ...
    /// Team Resource
    /// </summary>
    [DataContract(Name = "TeamResource")]
    public partial class TeamResource : IEquatable<TeamResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TeamResource(Team data = default(Team))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as TeamResource);
        }

        /// <summary>
        /// Returns true if TeamResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamResource input)
        {
            if (input == null)
                return false;
