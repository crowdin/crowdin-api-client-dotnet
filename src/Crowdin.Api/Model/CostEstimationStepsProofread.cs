...
{
    /// <summary>
    /// CostEstimationStepsProofread
    /// </summary>
    [DataContract(Name = "cost-estimation.steps.proofread")]
    public partial class CostEstimationStepsProofread : IEquatable<CostEstimationStepsProofread>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationStepsProofread" /> class.
        /// </summary>
        ...
        public CostEstimationStepsProofread(string type = default(string), string mode = default(string), List<CostEstimationStepsProofreadRegularRates> regularRates = default(List<CostEstimationStepsProofreadRegularRates>), List<CostEstimationStepsProofreadIndividualRates> individualRates = default(List<CostEstimationStepsProofreadIndividualRates>))
        {
            this.Type = type;
            this.Mode = mode;
        ...
        public List<CostEstimationStepsProofreadRegularRates> RegularRates { get; set; }
        ...
        public List<CostEstimationStepsProofreadIndividualRates> IndividualRates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationStepsProofread {\n");
        ...
        {
            return this.Equals(input as CostEstimationStepsProofread);
        }

        /// <summary>
        /// Returns true if CostEstimationStepsProofread instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationStepsProofread to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationStepsProofread input)
        {
            if (input == null)
                return false;
