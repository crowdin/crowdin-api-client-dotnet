...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TmOperationTest")]
    ...
    public partial class TmOperationTest : TmOperation, IEquatable<TmOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TmOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TmOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;TmOperationTest&quot;).</param>
        ...
        public TmOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "TmOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TmOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmOperationTest {\n");
        ...
        {
            return this.Equals(input as TmOperationTest);
        }

        /// <summary>
        /// Returns true if TmOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of TmOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmOperationTest input)
        {
            if (input == null)
                return false;
