...
{
    /// <summary>
    /// Language Translation File Progress Collection Resource
    /// </summary>
    [DataContract(Name = "FileProgressCollectionResource")]
    public partial class FileProgressCollectionResource : IEquatable<FileProgressCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileProgressCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public FileProgressCollectionResource(List<FileProgressResource> data = default(List<FileProgressResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<FileProgressResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileProgressCollectionResource {\n");
        ...
        {
            return this.Equals(input as FileProgressCollectionResource);
        }

        /// <summary>
        /// Returns true if FileProgressCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of FileProgressCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileProgressCollectionResource input)
        {
            if (input == null)
                return false;
