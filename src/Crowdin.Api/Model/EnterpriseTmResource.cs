...
namespace Crowdin.Api.Model
{
    ...
    /// Tm Resource
    /// </summary>
    [DataContract(Name = "EnterpriseTmResource")]
    public partial class EnterpriseTmResource : IEquatable<EnterpriseTmResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTmResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EnterpriseTmResource(Tm data = default(Tm))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTmResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseTmResource);
        }

        /// <summary>
        /// Returns true if EnterpriseTmResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTmResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTmResource input)
        {
            if (input == null)
                return false;
