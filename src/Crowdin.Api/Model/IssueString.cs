...
namespace Crowdin.Api.Model
{
    ...
    /// IssueString
    /// </summary>
    [DataContract(Name = "Issue_string")]
    public partial class IssueString : IEquatable<IssueString>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueString" /> class.
        /// </summary>
        ...
        public IssueString(int id = default(int), string text = default(string), string type = default(string), bool hasPlurals = default(bool), bool isIcu = default(bool), string context = default(string), int fileId = default(int))
        {
            this.Id = id;
            this.Text = text;
            this.Type = type;
        ...
        {
            return this.Equals(input as IssueString);
        }

        /// <summary>
        /// Returns true if IssueString instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueString to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueString input)
        {
            if (input == null)
                return false;
