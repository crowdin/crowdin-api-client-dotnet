...
{
    /// <summary>
    /// TranslationCostsStepsProofread
    /// </summary>
    [DataContract(Name = "translation-costs.steps.proofread")]
    public partial class TranslationCostsStepsProofread : IEquatable<TranslationCostsStepsProofread>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCostsStepsProofread" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCostsStepsProofread {\n");
        ...
        {
            return this.Equals(input as TranslationCostsStepsProofread);
        }

        /// <summary>
        /// Returns true if TranslationCostsStepsProofread instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCostsStepsProofread to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCostsStepsProofread input)
        {
            if (input == null)
                return false;
