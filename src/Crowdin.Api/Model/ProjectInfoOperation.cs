...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectInfoOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(ProjectInfoOperationReplace), "ProjectInfoOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(ProjectInfoOperationTest), "ProjectInfoOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(ProjectInfoOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(ProjectInfoOperationTest), "test")]
    public partial class ProjectInfoOperation : IEquatable<ProjectInfoOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// A JSON Pointer as defined by &lt;a href&#x3D;\&quot;https://tools.ietf.org/html/rfc6901\&quot; target&#x3D;\&quot;_blank\&quot;&gt;RFC 6901&lt;/a&gt;
        /// </summary>
        /// <value>A JSON Pointer as defined by &lt;a href&#x3D;\&quot;https://tools.ietf.org/html/rfc6901\&quot; target&#x3D;\&quot;_blank\&quot;&gt;RFC 6901&lt;/a&gt;</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum PathEnum
        {
            ...
            /// <summary>
            /// Enum TargetLanguageIds for value: /targetLanguageIds
            /// </summary>
            [EnumMember(Value = "/targetLanguageIds")]
            TargetLanguageIds = 2,
            ...
            /// <summary>
            /// Enum LanguageAccessPolicy for value: /languageAccessPolicy
            /// </summary>
            [EnumMember(Value = "/languageAccessPolicy")]
            LanguageAccessPolicy = 5,

            /// <summary>
            /// Enum GlossaryAccess for value: /glossaryAccess
            /// </summary>
            [EnumMember(Value = "/glossaryAccess")]
            GlossaryAccess = 6,
            ...
            SkipUntranslatedStrings = 11,

            /// <summary>
            /// Enum SkipUntranslatedFiles for value: /skipUntranslatedFiles
            /// </summary>
            [EnumMember(Value = "/skipUntranslatedFiles")]
            SkipUntranslatedFiles = 12,

            /// <summary>
            /// Enum ExportApprovedOnly for value: /exportApprovedOnly
            /// </summary>
            [EnumMember(Value = "/exportApprovedOnly")]
            ExportApprovedOnly = 13,

            /// <summary>
            /// Enum AutoTranslateDialects for value: /autoTranslateDialects
            /// </summary>
            [EnumMember(Value = "/autoTranslateDialects")]
            AutoTranslateDialects = 14,
            ...
            /// <summary>
            /// Enum HiddenStringsProofreadersAccess for value: /hiddenStringsProofreadersAccess
            /// </summary>
            [EnumMember(Value = "/hiddenStringsProofreadersAccess")]
            HiddenStringsProofreadersAccess = 16,
            ...
            /// <summary>
            /// Enum InContextProcessHiddenStrings for value: /inContextProcessHiddenStrings
            /// </summary>
            [EnumMember(Value = "/inContextProcessHiddenStrings")]
            InContextProcessHiddenStrings = 21,

            /// <summary>
            /// Enum InContextPseudoLanguageId for value: /inContextPseudoLanguageId
            /// </summary>
            [EnumMember(Value = "/inContextPseudoLanguageId")]
            InContextPseudoLanguageId = 22,
            ...
            LanguageMappinglanguageIdmappingKey = 28,

            /// <summary>
            /// Enum NotificationSettingsTranslatorNewStrings for value: /notificationSettings/translatorNewStrings
            /// </summary>
            [EnumMember(Value = "/notificationSettings/translatorNewStrings")]
            NotificationSettingsTranslatorNewStrings = 29,

            /// <summary>
            /// Enum NotificationSettingsManagerNewStrings for value: /notificationSettings/managerNewStrings
            /// </summary>
            [EnumMember(Value = "/notificationSettings/managerNewStrings")]
            NotificationSettingsManagerNewStrings = 30,

            /// <summary>
            /// Enum NotificationSettingsManagerLanguageCompleted for value: /notificationSettings/managerLanguageCompleted
            /// </summary>
            [EnumMember(Value = "/notificationSettings/managerLanguageCompleted")]
            NotificationSettingsManagerLanguageCompleted = 31
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectInfoOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectInfoOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectInfoOperation" /> class.
        /// </summary>
        /// <param name="op">Patch operation to perform (required).</param>
        /// <param name="path">A JSON Pointer as defined by &lt;a href&#x3D;\&quot;https://tools.ietf.org/html/rfc6901\&quot; target&#x3D;\&quot;_blank\&quot;&gt;RFC 6901&lt;/a&gt; (required).</param>
        public ProjectInfoOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectInfoOperation {\n");
        ...
        {
            return this.Equals(input as ProjectInfoOperation);
        }

        /// <summary>
        /// Returns true if ProjectInfoOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectInfoOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectInfoOperation input)
        {
            if (input == null)
                return false;
