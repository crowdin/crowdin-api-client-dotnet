...
namespace Crowdin.Api.Model
{
    ...
    /// Project Resource
    /// </summary>
    [DataContract(Name = "CrowdinProjectInfoResource")]
    public partial class CrowdinProjectInfoResource : IEquatable<CrowdinProjectInfoResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinProjectInfoResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CrowdinProjectInfoResource(ProjectResponse data = default(ProjectResponse))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinProjectInfoResource {\n");
        ...
        {
            return this.Equals(input as CrowdinProjectInfoResource);
        }

        /// <summary>
        /// Returns true if CrowdinProjectInfoResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinProjectInfoResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinProjectInfoResource input)
        {
            if (input == null)
                return false;
