...
{
    /// <summary>
    /// CrowdinFileBuildForm
    /// </summary>
    [DataContract(Name = "CrowdinFileBuildForm")]
    public partial class CrowdinFileBuildForm : IEquatable<CrowdinFileBuildForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinFileBuildForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrowdinFileBuildForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinFileBuildForm" /> class.
        /// </summary>
        /// <param name="targetLanguageId">Target Language Identifier. Get via [Project Target Languages](#operation/api.projects.get) (required).</param>
        /// <param name="exportAsXliff">Use [Export Project Translation](#operation/api.projects.translations.exports.post) instead.   Defines whether to export file in XLIFF format (default to false).</param>
        /// <param name="skipUntranslatedStrings">Defines whether to export only translated strings  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedFiles&#x3D;true&#x60; in same request (default to false).</param>
        /// <param name="skipUntranslatedFiles">Defines whether to export only translated file  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedStrings&#x3D;true&#x60; in same request (default to false).</param>
        /// <param name="exportApprovedOnly">Defines whether to export only approved strings (default to false).</param>
        public CrowdinFileBuildForm(string targetLanguageId = default(string), bool exportAsXliff = false, bool skipUntranslatedStrings = false, bool skipUntranslatedFiles = false, bool exportApprovedOnly = false)
        {
            // to ensure "targetLanguageId" is required (not null)
            if (targetLanguageId == null) {
                throw new ArgumentNullException("targetLanguageId is a required property for CrowdinFileBuildForm and cannot be null");
            }
            this.TargetLanguageId = targetLanguageId;
            this.ExportAsXliff = exportAsXliff;
        ...
        /// <summary>
        /// Target Language Identifier. Get via [Project Target Languages](#operation/api.projects.get)
        /// </summary>
        /// <value>Target Language Identifier. Get via [Project Target Languages](#operation/api.projects.get)</value>
        [DataMember(Name = "targetLanguageId", IsRequired = true, EmitDefaultValue = false)]
        public string TargetLanguageId { get; set; }

        /// <summary>
        /// Use [Export Project Translation](#operation/api.projects.translations.exports.post) instead.   Defines whether to export file in XLIFF format
        /// </summary>
        /// <value>Use [Export Project Translation](#operation/api.projects.translations.exports.post) instead.   Defines whether to export file in XLIFF format</value>
        [DataMember(Name = "exportAsXliff", EmitDefaultValue = true)]
        [Obsolete]
        public bool ExportAsXliff { get; set; }

        /// <summary>
        /// Defines whether to export only translated strings  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedFiles&#x3D;true&#x60; in same request
        /// </summary>
        /// <value>Defines whether to export only translated strings  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedFiles&#x3D;true&#x60; in same request</value>
        [DataMember(Name = "skipUntranslatedStrings", EmitDefaultValue = true)]
        public bool SkipUntranslatedStrings { get; set; }

        /// <summary>
        /// Defines whether to export only translated file  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedStrings&#x3D;true&#x60; in same request
        /// </summary>
        /// <value>Defines whether to export only translated file  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedStrings&#x3D;true&#x60; in same request</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinFileBuildForm {\n");
            sb.Append("  TargetLanguageId: ").Append(TargetLanguageId).Append("\n");
            sb.Append("  ExportAsXliff: ").Append(ExportAsXliff).Append("\n");
        ...
        {
            return this.Equals(input as CrowdinFileBuildForm);
        }

        /// <summary>
        /// Returns true if CrowdinFileBuildForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinFileBuildForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinFileBuildForm input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExportAsXliff == input.ExportAsXliff ||
                    this.ExportAsXliff.Equals(input.ExportAsXliff)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.ExportAsXliff.GetHashCode();
