...
{
    /// <summary>
    /// TranslateStepResponseData
    /// </summary>
    [DataContract(Name = "TranslateStepResponse_data")]
    public partial class TranslateStepResponseData : IEquatable<TranslateStepResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateStepResponseData" /> class.
        /// </summary>
        ...
        public TranslateStepResponseData(int id = default(int), string title = default(string), string type = default(string), List<string> languages = default(List<string>), TranslateStepResponseDataConfig config = default(TranslateStepResponseDataConfig))
        {
            this.Id = id;
            this.Title = title;
            this.Type = type;
        ...
        public TranslateStepResponseDataConfig Config { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslateStepResponseData {\n");
        ...
        {
            return this.Equals(input as TranslateStepResponseData);
        }

        /// <summary>
        /// Returns true if TranslateStepResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslateStepResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslateStepResponseData input)
        {
            if (input == null)
                return false;
