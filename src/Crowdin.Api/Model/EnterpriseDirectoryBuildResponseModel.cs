...
{
    /// <summary>
    /// EnterpriseDirectoryBuildResponseModel
    /// </summary>
    [DataContract(Name = "EnterpriseDirectoryBuildResponseModel")]
    public partial class EnterpriseDirectoryBuildResponseModel : IEquatable<EnterpriseDirectoryBuildResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseDirectoryBuildResponseModel" /> class.
        /// </summary>
        ...
        public EnterpriseDirectoryBuildResponseModel(int? directoryId = default(int?), List<string> targetLanguagesId = default(List<string>), bool skipUntranslatedStrings = default(bool), bool skipUntranslatedFiles = default(bool), int exportWithMinApprovalsCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseDirectoryBuildResponseModel {\n");
        ...
        {
            return this.Equals(input as EnterpriseDirectoryBuildResponseModel);
        }

        /// <summary>
        /// Returns true if EnterpriseDirectoryBuildResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseDirectoryBuildResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseDirectoryBuildResponseModel input)
        {
            if (input == null)
                return false;
