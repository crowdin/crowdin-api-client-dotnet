...
namespace Crowdin.Api.Model
{
    ...
    /// Language Mapping
    /// </summary>
    [DataContract(Name = "CrowdinStringsBasedProjectCreateForm_languageMapping")]
    public partial class CrowdinStringsBasedProjectCreateFormLanguageMapping : IEquatable<CrowdinStringsBasedProjectCreateFormLanguageMapping>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinStringsBasedProjectCreateFormLanguageMapping" /> class.
        /// </summary>
        /// <param name="uk">uk.</param>
        public CrowdinStringsBasedProjectCreateFormLanguageMapping(LanguageMappingUk uk = default(LanguageMappingUk))
        {
            this.Uk = uk;
        }
        ...
        public LanguageMappingUk Uk { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinStringsBasedProjectCreateFormLanguageMapping {\n");
        ...
        {
            return this.Equals(input as CrowdinStringsBasedProjectCreateFormLanguageMapping);
        }

        /// <summary>
        /// Returns true if CrowdinStringsBasedProjectCreateFormLanguageMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinStringsBasedProjectCreateFormLanguageMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinStringsBasedProjectCreateFormLanguageMapping input)
        {
            if (input == null)
                return false;
