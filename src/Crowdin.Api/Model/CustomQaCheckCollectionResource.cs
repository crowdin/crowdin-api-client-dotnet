...
{
    /// <summary>
    /// Custom QA Check Collection Resource
    /// </summary>
    [DataContract(Name = "CustomQaCheckCollectionResource")]
    public partial class CustomQaCheckCollectionResource : IEquatable<CustomQaCheckCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public CustomQaCheckCollectionResource(List<CustomQaCheckResource> data = default(List<CustomQaCheckResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<CustomQaCheckResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomQaCheckCollectionResource {\n");
        ...
        {
            return this.Equals(input as CustomQaCheckCollectionResource);
        }

        /// <summary>
        /// Returns true if CustomQaCheckCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomQaCheckCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomQaCheckCollectionResource input)
        {
            if (input == null)
                return false;
