...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "XmlFileImportOptions")]
    public partial class XmlFileImportOptions : IEquatable<XmlFileImportOptions>, IValidatableObject
    {
        /// <summary>
        /// Defines TranslatableElements
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum TranslatableElementsEnum
        {
            /// <summary>
            /// Enum PathToNode for value: /path/to/node
            /// </summary>
            [EnumMember(Value = "/path/to/node")]
            PathToNode = 1,

            /// <summary>
            /// Enum PathToAttributeattr for value: /path/to/attribute[@attr]
            /// </summary>
            [EnumMember(Value = "/path/to/attribute[@attr]")]
            PathToAttributeattr = 2,
            ...
            /// <summary>
            /// Enum Attr for value: //[@attr]
            /// </summary>
            [EnumMember(Value = "//[@attr]")]
            Attr = 4,

            /// <summary>
            /// Enum NodeoneNodetwo for value: nodeone/nodetwo
            /// </summary>
            [EnumMember(Value = "nodeone/nodetwo")]
            NodeoneNodetwo = 5,
            ...
            /// <summary>
            /// Enum Nodeattr for value: //node[@attr]
            /// </summary>
            [EnumMember(Value = "//node[@attr]")]
            Nodeattr = 7
        ...
        /// </summary>
        /// <value>This is an array of strings, where each item is the XPaths to DOM element that should be imported</value>
        [DataMember(Name = "translatableElements", EmitDefaultValue = false)]
        public List<TranslatableElementsEnum> TranslatableElements { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlFileImportOptions" /> class.
        /// </summary>
        /// <param name="translateContent">Defines whether to translate texts placed inside the tags (default to true).</param>
        /// <param name="translateAttributes">Defines whether to translate tags attributes (default to true).</param>
        /// <param name="contentSegmentation">Defines whether to split long texts into smaller text segments.   __Important!__ This option disables the possibility to upload existing translations for XML files when enabled. (default to true).</param>
        /// <param name="translatableElements">This is an array of strings, where each item is the XPaths to DOM element that should be imported.</param>
        /// <param name="srxStorageId">Storage Identifier. Get via [List Storages](#operation/api.storages.getMany).  Storage identifier of the SRX segmentation rules file. Read more about [Custom Segmentation](https://support.crowdin.com/custom-segmentation/#segmentation-examples)..</param>
        public XmlFileImportOptions(bool translateContent = true, bool translateAttributes = true, bool contentSegmentation = true, List<TranslatableElementsEnum> translatableElements = default(List<TranslatableElementsEnum>), int srxStorageId = default(int))
        {
        ...
        /// </summary>
        /// <value>Defines whether to translate texts placed inside the tags</value>
        [DataMember(Name = "translateContent", EmitDefaultValue = true)]
        public bool TranslateContent { get; set; }

        /// <summary>
        /// Defines whether to translate tags attributes
        /// </summary>
        /// <value>Defines whether to translate tags attributes</value>
        [DataMember(Name = "translateAttributes", EmitDefaultValue = true)]
        public bool TranslateAttributes { get; set; }

        /// <summary>
        /// Defines whether to split long texts into smaller text segments.   __Important!__ This option disables the possibility to upload existing translations for XML files when enabled.
        /// </summary>
        /// <value>Defines whether to split long texts into smaller text segments.   __Important!__ This option disables the possibility to upload existing translations for XML files when enabled.</value>
        [DataMember(Name = "contentSegmentation", EmitDefaultValue = true)]
        public bool ContentSegmentation { get; set; }

        /// <summary>
        /// Storage Identifier. Get via [List Storages](#operation/api.storages.getMany).  Storage identifier of the SRX segmentation rules file. Read more about [Custom Segmentation](https://support.crowdin.com/custom-segmentation/#segmentation-examples).
        /// </summary>
        /// <value>Storage Identifier. Get via [List Storages](#operation/api.storages.getMany).  Storage identifier of the SRX segmentation rules file. Read more about [Custom Segmentation](https://support.crowdin.com/custom-segmentation/#segmentation-examples).</value>
        [DataMember(Name = "srxStorageId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XmlFileImportOptions {\n");
            sb.Append("  TranslateContent: ").Append(TranslateContent).Append("\n");
            sb.Append("  TranslateAttributes: ").Append(TranslateAttributes).Append("\n");
            sb.Append("  ContentSegmentation: ").Append(ContentSegmentation).Append("\n");
            sb.Append("  TranslatableElements: ").Append(TranslatableElements).Append("\n");
            sb.Append("  SrxStorageId: ").Append(SrxStorageId).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as XmlFileImportOptions);
        }

        /// <summary>
        /// Returns true if XmlFileImportOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of XmlFileImportOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XmlFileImportOptions input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TranslateContent == input.TranslateContent ||
                    this.TranslateContent.Equals(input.TranslateContent)
                ) && 
                (
                    this.TranslateAttributes == input.TranslateAttributes ||
                    this.TranslateAttributes.Equals(input.TranslateAttributes)
                ) && 
                (
                    this.ContentSegmentation == input.ContentSegmentation ||
                    this.ContentSegmentation.Equals(input.ContentSegmentation)
                ) && 
                (
                    this.TranslatableElements == input.TranslatableElements ||
                    this.TranslatableElements.SequenceEqual(input.TranslatableElements)
                ) && 
                (
                    this.SrxStorageId == input.SrxStorageId ||
                    this.SrxStorageId.Equals(input.SrxStorageId)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.TranslateContent.GetHashCode();
                hashCode = hashCode * 59 + this.TranslateAttributes.GetHashCode();
                hashCode = hashCode * 59 + this.ContentSegmentation.GetHashCode();
                hashCode = hashCode * 59 + this.TranslatableElements.GetHashCode();
                hashCode = hashCode * 59 + this.SrxStorageId.GetHashCode();
                return hashCode;
            }
        }
