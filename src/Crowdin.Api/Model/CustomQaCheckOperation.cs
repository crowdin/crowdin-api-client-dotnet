...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomQaCheckOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(CustomQaCheckOperationReplace), "CustomQaCheckOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(CustomQaCheckOperationTest), "CustomQaCheckOperationTest")]
    ...
    public partial class CustomQaCheckOperation : IEquatable<CustomQaCheckOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomQaCheckOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckOperation" /> class.
        /// </summary>
        ...
        public CustomQaCheckOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomQaCheckOperation {\n");
        ...
        {
            return this.Equals(input as CustomQaCheckOperation);
        }

        /// <summary>
        /// Returns true if CustomQaCheckOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomQaCheckOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomQaCheckOperation input)
        {
            if (input == null)
                return false;
