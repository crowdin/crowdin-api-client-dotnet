...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomLanguageOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(CustomLanguageOperationReplace), "CustomLanguageOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(CustomLanguageOperationTest), "CustomLanguageOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(CustomLanguageOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(CustomLanguageOperationTest), "test")]
    public partial class CustomLanguageOperation : IEquatable<CustomLanguageOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum PathEnum
        {
            ...
            /// <summary>
            /// Enum TextDirection for value: /textDirection
            /// </summary>
            [EnumMember(Value = "/textDirection")]
            TextDirection = 2,

            /// <summary>
            /// Enum PluralCategoryNames for value: /pluralCategoryNames
            /// </summary>
            [EnumMember(Value = "/pluralCategoryNames")]
            PluralCategoryNames = 3,

            /// <summary>
            /// Enum ThreeLettersCode for value: /threeLettersCode
            /// </summary>
            [EnumMember(Value = "/threeLettersCode")]
            ThreeLettersCode = 4,

            /// <summary>
            /// Enum LocaleCode for value: /localeCode
            /// </summary>
            [EnumMember(Value = "/localeCode")]
            LocaleCode = 5,

            /// <summary>
            /// Enum DialectOf for value: /dialectOf
            /// </summary>
            [EnumMember(Value = "/dialectOf")]
            DialectOf = 6
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomLanguageOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomLanguageOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomLanguageOperation" /> class.
        /// </summary>
        ...
        public CustomLanguageOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomLanguageOperation {\n");
        ...
        {
            return this.Equals(input as CustomLanguageOperation);
        }

        /// <summary>
        /// Returns true if CustomLanguageOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomLanguageOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomLanguageOperation input)
        {
            if (input == null)
                return false;
