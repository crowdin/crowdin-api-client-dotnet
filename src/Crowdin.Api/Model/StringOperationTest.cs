...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringOperationTest")]
    ...
    public partial class StringOperationTest : StringOperation, IEquatable<StringOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StringOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StringOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;StringOperationTest&quot;).</param>
        ...
        public StringOperationTest(OneOfstringintegerboolean value = default(OneOfstringintegerboolean), OpEnum op = "StringOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for StringOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringOperationTest {\n");
        ...
        {
            return this.Equals(input as StringOperationTest);
        }

        /// <summary>
        /// Returns true if StringOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of StringOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringOperationTest input)
        {
            if (input == null)
                return false;
