...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectInfoOperationReplace")]
    ...
    public partial class ProjectInfoOperationReplace : ProjectInfoOperation, IEquatable<ProjectInfoOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectInfoOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectInfoOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectInfoOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectInfoOperationReplace&quot;).</param>
        ...
        public ProjectInfoOperationReplace(OneOfstringarray value = default(OneOfstringarray), OpEnum op = "ProjectInfoOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectInfoOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectInfoOperationReplace {\n");
        ...
        {
            return this.Equals(input as ProjectInfoOperationReplace);
        }

        /// <summary>
        /// Returns true if ProjectInfoOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectInfoOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectInfoOperationReplace input)
        {
            if (input == null)
                return false;
