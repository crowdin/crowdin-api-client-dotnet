...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReportGenerate")]
    public partial class ReportGenerate : IEquatable<ReportGenerate>, IValidatableObject
    {
        /// <summary>
        ...
        public ReportGenerate(string identifier = default(string), string status = default(string), int progress = default(int), ReportGenerateAttributes attributes = default(ReportGenerateAttributes), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime finishedAt = default(DateTime), string eta = default(string))
        {
        ...
        public ReportGenerateAttributes Attributes { get; set; }
