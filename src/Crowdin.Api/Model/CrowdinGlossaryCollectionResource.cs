...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinGlossaryCollectionResource")]
    public partial class CrowdinGlossaryCollectionResource : IEquatable<CrowdinGlossaryCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinGlossaryCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public CrowdinGlossaryCollectionResource(List<CrowdinGlossaryResource> data = default(List<CrowdinGlossaryResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<CrowdinGlossaryResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinGlossaryCollectionResource {\n");
        ...
        {
            return this.Equals(input as CrowdinGlossaryCollectionResource);
        }

        /// <summary>
        /// Returns true if CrowdinGlossaryCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinGlossaryCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinGlossaryCollectionResource input)
        {
            if (input == null)
                return false;
