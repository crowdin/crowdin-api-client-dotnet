...
namespace Crowdin.Api.Model
{
    ...
    /// PreTranslation
    /// </summary>
    [DataContract(Name = "PreTranslation")]
    public partial class PreTranslation : IEquatable<PreTranslation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreTranslation" /> class.
        /// </summary>
        ...
        public PreTranslation(string identifier = default(string), string status = default(string), int progress = default(int), PreTranslateAttributes attributes = default(PreTranslateAttributes), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime finishedAt = default(DateTime), string eta = default(string))
        {
        ...
        {
            return this.Equals(input as PreTranslation);
        }

        /// <summary>
        /// Returns true if PreTranslation instances are equal
        /// </summary>
        /// <param name="input">Instance of PreTranslation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreTranslation input)
        {
            if (input == null)
                return false;
