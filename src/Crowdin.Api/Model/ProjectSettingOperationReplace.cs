...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectSettingOperationReplace")]
    ...
    public partial class ProjectSettingOperationReplace : ProjectSettingOperation, IEquatable<ProjectSettingOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectSettingOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectSettingOperationReplace&quot;).</param>
        ...
        public ProjectSettingOperationReplace(OneOfstringintegerbooleanobject value = default(OneOfstringintegerbooleanobject), OpEnum op = "ProjectSettingOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectSettingOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public OneOfstringintegerbooleanobject Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectSettingOperationReplace {\n");
        ...
        {
            return this.Equals(input as ProjectSettingOperationReplace);
        }

        /// <summary>
        /// Returns true if ProjectSettingOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectSettingOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectSettingOperationReplace input)
        {
            if (input == null)
                return false;
