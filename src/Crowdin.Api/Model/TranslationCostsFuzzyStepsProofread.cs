...
{
    /// <summary>
    /// TranslationCostsFuzzyStepsProofread
    /// </summary>
    [DataContract(Name = "translation-costs-fuzzy.steps.proofread")]
    public partial class TranslationCostsFuzzyStepsProofread : IEquatable<TranslationCostsFuzzyStepsProofread>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCostsFuzzyStepsProofread" /> class.
        /// </summary>
        /// <param name="type">Proofread.</param>
        /// <param name="mode">simple.</param>
        /// <param name="regularRates">regularRates.</param>
        /// <param name="individualRates">individualRates.</param>
        public TranslationCostsFuzzyStepsProofread(string type = default(string), string mode = default(string), List<CostEstimationFuzzyStepsProofreadRegularRates> regularRates = default(List<CostEstimationFuzzyStepsProofreadRegularRates>), List<CostEstimationFuzzyStepsProofreadIndividualRates> individualRates = default(List<CostEstimationFuzzyStepsProofreadIndividualRates>))
        {
            this.Type = type;
            this.Mode = mode;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCostsFuzzyStepsProofread {\n");
        ...
        {
            return this.Equals(input as TranslationCostsFuzzyStepsProofread);
        }

        /// <summary>
        /// Returns true if TranslationCostsFuzzyStepsProofread instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCostsFuzzyStepsProofread to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCostsFuzzyStepsProofread input)
        {
            if (input == null)
                return false;
