...
namespace Crowdin.Api.Model
{
    ...
    /// Report Resource
    /// </summary>
    [DataContract(Name = "GroupReportResource")]
    public partial class GroupReportResource : IEquatable<GroupReportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupReportResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public GroupReportResource(GroupReportGenerate data = default(GroupReportGenerate))
        {
            this.Data = data;
        }
        ...
        public GroupReportGenerate Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupReportResource {\n");
        ...
        {
            return this.Equals(input as GroupReportResource);
        }

        /// <summary>
        /// Returns true if GroupReportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupReportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupReportResource input)
        {
            if (input == null)
                return false;
