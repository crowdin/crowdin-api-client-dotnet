...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskOperationReplace")]
    ...
    public partial class TaskOperationReplace : TaskOperation, IEquatable<TaskOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TaskOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;TaskOperationReplace&quot;).</param>
        ...
        public TaskOperationReplace(OneOfstringbooleanarrayarray value = default(OneOfstringbooleanarrayarray), OpEnum op = "TaskOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TaskOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskOperationReplace {\n");
        ...
        {
            return this.Equals(input as TaskOperationReplace);
        }

        /// <summary>
        /// Returns true if TaskOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskOperationReplace input)
        {
            if (input == null)
                return false;
