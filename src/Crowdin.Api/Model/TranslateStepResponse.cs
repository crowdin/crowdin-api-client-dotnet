...
{
    /// <summary>
    /// TranslateStepResponse
    /// </summary>
    [DataContract(Name = "TranslateStepResponse")]
    public partial class TranslateStepResponse : IEquatable<TranslateStepResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateStepResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TranslateStepResponse(TranslateStepResponseData data = default(TranslateStepResponseData))
        {
            this.Data = data;
        }
        ...
        public TranslateStepResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslateStepResponse {\n");
        ...
        {
            return this.Equals(input as TranslateStepResponse);
        }

        /// <summary>
        /// Returns true if TranslateStepResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslateStepResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslateStepResponse input)
        {
            if (input == null)
                return false;
