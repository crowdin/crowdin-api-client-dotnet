...
{
    /// <summary>
    /// LabelStringAssignForm
    /// </summary>
    [DataContract(Name = "LabelStringAssignForm")]
    public partial class LabelStringAssignForm : IEquatable<LabelStringAssignForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelStringAssignForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LabelStringAssignForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelStringAssignForm" /> class.
        /// </summary>
        /// <param name="stringIds">String Identifiers. Get via [List Strings](#operation/api.projects.strings.getMany)  __Note:__ You can assign up to 500 strings at a time. (required).</param>
        public LabelStringAssignForm(List<int> stringIds = default(List<int>))
        {
            // to ensure "stringIds" is required (not null)
            if (stringIds == null) {
                throw new ArgumentNullException("stringIds is a required property for LabelStringAssignForm and cannot be null");
            }
            this.StringIds = stringIds;
        }

        /// <summary>
        /// String Identifiers. Get via [List Strings](#operation/api.projects.strings.getMany)  __Note:__ You can assign up to 500 strings at a time.
        /// </summary>
        /// <value>String Identifiers. Get via [List Strings](#operation/api.projects.strings.getMany)  __Note:__ You can assign up to 500 strings at a time.</value>
        [DataMember(Name = "stringIds", IsRequired = true, EmitDefaultValue = false)]
        public List<int> StringIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LabelStringAssignForm {\n");
            sb.Append("  StringIds: ").Append(StringIds).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as LabelStringAssignForm);
        }

        /// <summary>
        /// Returns true if LabelStringAssignForm instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelStringAssignForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelStringAssignForm input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.StringIds != null &&
                    input.StringIds != null &&
                    this.StringIds.SequenceEqual(input.StringIds)
                );
        }
