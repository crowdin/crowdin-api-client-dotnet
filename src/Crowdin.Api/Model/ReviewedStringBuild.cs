...
namespace Crowdin.Api.Model
{
    ...
    /// ReviewedStringBuild
    /// </summary>
    [DataContract(Name = "ReviewedStringBuild")]
    public partial class ReviewedStringBuild : IEquatable<ReviewedStringBuild>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewedStringBuild" /> class.
        /// </summary>
        ...
        public ReviewedStringBuild(int id = default(int), int projectId = default(int), StatusEnum? status = default(StatusEnum?), int progress = default(int), ReviewedStringBuildAttributes attributes = default(ReviewedStringBuildAttributes))
        {
            this.Id = id;
        ...
        public ReviewedStringBuildAttributes Attributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReviewedStringBuild {\n");
        ...
        {
            return this.Equals(input as ReviewedStringBuild);
        }

        /// <summary>
        /// Returns true if ReviewedStringBuild instances are equal
        /// </summary>
        /// <param name="input">Instance of ReviewedStringBuild to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReviewedStringBuild input)
        {
            if (input == null)
                return false;
