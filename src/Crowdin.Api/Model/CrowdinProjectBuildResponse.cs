...
{
    /// <summary>
    /// CrowdinProjectBuildResponse
    /// </summary>
    [DataContract(Name = "CrowdinProjectBuildResponse")]
    public partial class CrowdinProjectBuildResponse : IEquatable<CrowdinProjectBuildResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinProjectBuildResponse" /> class.
        /// </summary>
        ...
        public CrowdinProjectBuildResponse(int id = default(int), int projectId = default(int), StatusEnum? status = default(StatusEnum?), int progress = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime finishedAt = default(DateTime), List<OneOfCrowdinBuildAttributesResponseModelCrowdinPseudoBuildAttributesResponseModel> attributes = default(List<OneOfCrowdinBuildAttributesResponseModelCrowdinPseudoBuildAttributesResponseModel>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinProjectBuildResponse {\n");
        ...
        {
            return this.Equals(input as CrowdinProjectBuildResponse);
        }

        /// <summary>
        /// Returns true if CrowdinProjectBuildResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinProjectBuildResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinProjectBuildResponse input)
        {
            if (input == null)
                return false;
