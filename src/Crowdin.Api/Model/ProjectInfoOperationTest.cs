...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectInfoOperationTest")]
    ...
    public partial class ProjectInfoOperationTest : ProjectInfoOperation, IEquatable<ProjectInfoOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectInfoOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectInfoOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectInfoOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectInfoOperationTest&quot;).</param>
        ...
        public ProjectInfoOperationTest(OneOfstringarray value = default(OneOfstringarray), OpEnum op = "ProjectInfoOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectInfoOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectInfoOperationTest {\n");
        ...
        {
            return this.Equals(input as ProjectInfoOperationTest);
        }

        /// <summary>
        /// Returns true if ProjectInfoOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectInfoOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectInfoOperationTest input)
        {
            if (input == null)
                return false;
