...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringCommentOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(StringCommentOperationReplace), "StringCommentOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(StringCommentOperationTest), "StringCommentOperationTest")]
    ...
    public partial class StringCommentOperation : IEquatable<StringCommentOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum PathEnum
        {
            ...
            /// <summary>
            /// Enum IssueStatus for value: /issueStatus
            /// </summary>
            [EnumMember(Value = "/issueStatus")]
            IssueStatus = 2
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCommentOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StringCommentOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCommentOperation" /> class.
        /// </summary>
        ...
        public StringCommentOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringCommentOperation {\n");
        ...
        {
            return this.Equals(input as StringCommentOperation);
        }

        /// <summary>
        /// Returns true if StringCommentOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of StringCommentOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringCommentOperation input)
        {
            if (input == null)
                return false;
