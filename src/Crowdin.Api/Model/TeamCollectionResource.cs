...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamCollectionResource")]
    public partial class TeamCollectionResource : IEquatable<TeamCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public TeamCollectionResource(List<TeamResource> data = default(List<TeamResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<TeamResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamCollectionResource {\n");
        ...
        {
            return this.Equals(input as TeamCollectionResource);
        }

        /// <summary>
        /// Returns true if TeamCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamCollectionResource input)
        {
            if (input == null)
                return false;
