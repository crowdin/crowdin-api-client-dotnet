...
namespace Crowdin.Api.Model
{
    ...
    /// QaCheck Resource
    /// </summary>
    [DataContract(Name = "QaCheckStatisticResource")]
    public partial class QaCheckStatisticResource : IEquatable<QaCheckStatisticResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QaCheckStatisticResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public QaCheckStatisticResource(QaCheck data = default(QaCheck))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QaCheckStatisticResource {\n");
        ...
        {
            return this.Equals(input as QaCheckStatisticResource);
        }

        /// <summary>
        /// Returns true if QaCheckStatisticResource instances are equal
        /// </summary>
        /// <param name="input">Instance of QaCheckStatisticResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QaCheckStatisticResource input)
        {
            if (input == null)
                return false;
