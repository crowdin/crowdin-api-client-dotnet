...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslationResource")]
    public partial class TranslationResource : IEquatable<TranslationResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TranslationResource(StringTranslation data = default(StringTranslation))
        {
            this.Data = data;
        }
        ...
        public StringTranslation Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationResource {\n");
        ...
        {
            return this.Equals(input as TranslationResource);
        }

        /// <summary>
        /// Returns true if TranslationResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationResource input)
        {
            if (input == null)
                return false;
