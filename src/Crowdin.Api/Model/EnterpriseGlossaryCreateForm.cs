...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnterpriseGlossaryCreateForm")]
    public partial class EnterpriseGlossaryCreateForm : IEquatable<EnterpriseGlossaryCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseGlossaryCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnterpriseGlossaryCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseGlossaryCreateForm" /> class.
        /// </summary>
        /// <param name="name">Glossary name (required).</param>
        /// <param name="groupId">Group Identifier – defines group to which Glossary is added. Get via [List Groups](#operation/api.groups.getMany)  If &#39;0&#39; – Glossary will be available for all projects and groups in your workspace (default to 0).</param>
        public EnterpriseGlossaryCreateForm(string name = default(string), int groupId = 0)
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for EnterpriseGlossaryCreateForm and cannot be null");
            }
            this.Name = name;
        ...
        /// Glossary name
        /// </summary>
        /// <value>Glossary name</value>
        [DataMember(Name = "name", IsRequired = true, EmitDefaultValue = false)]
        public string Name { get; set; }

        /// <summary>
        /// Group Identifier – defines group to which Glossary is added. Get via [List Groups](#operation/api.groups.getMany)  If &#39;0&#39; – Glossary will be available for all projects and groups in your workspace
        /// </summary>
        /// <value>Group Identifier – defines group to which Glossary is added. Get via [List Groups](#operation/api.groups.getMany)  If &#39;0&#39; – Glossary will be available for all projects and groups in your workspace</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseGlossaryCreateForm {\n");
        ...
        {
            return this.Equals(input as EnterpriseGlossaryCreateForm);
        }

        /// <summary>
        /// Returns true if EnterpriseGlossaryCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseGlossaryCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseGlossaryCreateForm input)
        {
            if (input == null)
                return false;
