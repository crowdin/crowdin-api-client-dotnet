...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringCommentOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(StringCommentOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(StringCommentOperationTest), "test")]
    public partial class StringCommentOperationReplace : StringCommentOperation, IEquatable<StringCommentOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCommentOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StringCommentOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCommentOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;StringCommentOperationReplace&quot;).</param>
        ...
        public StringCommentOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "StringCommentOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for StringCommentOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringCommentOperationReplace {\n");
        ...
        {
            return this.Equals(input as StringCommentOperationReplace);
        }

        /// <summary>
        /// Returns true if StringCommentOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of StringCommentOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringCommentOperationReplace input)
        {
            if (input == null)
                return false;
