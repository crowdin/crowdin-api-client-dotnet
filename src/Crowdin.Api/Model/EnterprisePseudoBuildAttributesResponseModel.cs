...
{
    /// <summary>
    /// EnterprisePseudoBuildAttributesResponseModel
    /// </summary>
    [DataContract(Name = "EnterprisePseudoBuildAttributesResponseModel")]
    public partial class EnterprisePseudoBuildAttributesResponseModel : IEquatable<EnterprisePseudoBuildAttributesResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterprisePseudoBuildAttributesResponseModel" /> class.
        /// </summary>
        /// <param name="pseudo">pseudo.</param>
        /// <param name="prefix">prefix.</param>
        /// <param name="suffix">suffix.</param>
        /// <param name="lengthTransformation">lengthTransformation.</param>
        /// <param name="charTransformation">charTransformation.</param>
        public EnterprisePseudoBuildAttributesResponseModel(bool pseudo = default(bool), string prefix = default(string), string suffix = default(string), int lengthTransformation = default(int), string charTransformation = default(string))
        {
            this.Pseudo = pseudo;
            this.Prefix = prefix;
            this.Suffix = suffix;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterprisePseudoBuildAttributesResponseModel {\n");
        ...
        {
            return this.Equals(input as EnterprisePseudoBuildAttributesResponseModel);
        }

        /// <summary>
        /// Returns true if EnterprisePseudoBuildAttributesResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterprisePseudoBuildAttributesResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterprisePseudoBuildAttributesResponseModel input)
        {
            if (input == null)
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CharTransformation != null)
