...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OtherFilesImportOptions")]
    public partial class OtherFilesImportOptions : IEquatable<OtherFilesImportOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OtherFilesImportOptions" /> class.
        /// </summary>
        /// <param name="contentSegmentation">Defines whether to split long texts into smaller text segments. Only for __xml__, __html__, __md__, __fm_md__, __fm_html__, __flsnp__, __docx__, __mif__, __idml__, __dita__ files.  __Important!__ This option disables the possibility to upload existing translations for files when enabled. (default to true).</param>
        ...
        public OtherFilesImportOptions(bool contentSegmentation = true, int srxStorageId = default(int))
        {
        ...
        /// <summary>
        /// Defines whether to split long texts into smaller text segments. Only for __xml__, __html__, __md__, __fm_md__, __fm_html__, __flsnp__, __docx__, __mif__, __idml__, __dita__ files.  __Important!__ This option disables the possibility to upload existing translations for files when enabled.
        /// </summary>
        /// <value>Defines whether to split long texts into smaller text segments. Only for __xml__, __html__, __md__, __fm_md__, __fm_html__, __flsnp__, __docx__, __mif__, __idml__, __dita__ files.  __Important!__ This option disables the possibility to upload existing translations for files when enabled.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OtherFilesImportOptions {\n");
        ...
        {
            return this.Equals(input as OtherFilesImportOptions);
        }

        /// <summary>
        /// Returns true if OtherFilesImportOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of OtherFilesImportOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OtherFilesImportOptions input)
        {
            if (input == null)
                return false;
