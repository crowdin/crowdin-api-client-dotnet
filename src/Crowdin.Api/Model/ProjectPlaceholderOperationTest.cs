...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectPlaceholderOperationTest")]
    ...
    public partial class ProjectPlaceholderOperationTest : CustomPlaceholderOperation, IEquatable<ProjectPlaceholderOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectPlaceholderOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectPlaceholderOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectPlaceholderOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectPlaceholderOperationTest&quot;).</param>
        ...
        public ProjectPlaceholderOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "ProjectPlaceholderOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectPlaceholderOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectPlaceholderOperationTest {\n");
        ...
        {
            return this.Equals(input as ProjectPlaceholderOperationTest);
        }

        /// <summary>
        /// Returns true if ProjectPlaceholderOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectPlaceholderOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectPlaceholderOperationTest input)
        {
            if (input == null)
                return false;
