...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FallbackLanguagesScheme")]
    public partial class FallbackLanguagesScheme : IEquatable<FallbackLanguagesScheme>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FallbackLanguagesScheme" /> class.
        /// </summary>
        /// <param name="languageId">languageId.</param>
        public FallbackLanguagesScheme(List<string> languageId = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FallbackLanguagesScheme {\n");
        ...
        {
            return this.Equals(input as FallbackLanguagesScheme);
        }

        /// <summary>
        /// Returns true if FallbackLanguagesScheme instances are equal
        /// </summary>
        /// <param name="input">Instance of FallbackLanguagesScheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FallbackLanguagesScheme input)
        {
            if (input == null)
                return false;
