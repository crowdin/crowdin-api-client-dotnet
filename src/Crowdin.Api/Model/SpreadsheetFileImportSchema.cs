...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SpreadsheetFileImportSchema")]
    public partial class SpreadsheetFileImportSchema : Dictionary<String, SpreadsheetLanguageCodeColumnNumber>, IEquatable<SpreadsheetFileImportSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpreadsheetFileImportSchema" /> class.
        /// </summary>
        /// <param name="none">Defines empty column.</param>
        /// <param name="identifier">Defines identifier column number.</param>
        /// <param name="sourcePhrase">Defines source phrase column number.</param>
        /// <param name="sourceOrTranslation">Defines source or translation column number.</param>
        /// <param name="translation">Defines translation column number.</param>
        /// <param name="context">Defines context column number.</param>
        /// <param name="maxLength">Defines max length column number.</param>
        /// <param name="labels">Defines labels column number.</param>
        public SpreadsheetFileImportSchema(int none = default(int), int identifier = default(int), int sourcePhrase = default(int), int sourceOrTranslation = default(int), int translation = default(int), int context = default(int), int maxLength = default(int), int labels = default(int)) : base()
        {
            this.None = none;
            this.Identifier = identifier;
            this.SourcePhrase = sourcePhrase;
            this.SourceOrTranslation = sourceOrTranslation;
        ...
        /// <summary>
        /// Defines empty column
        /// </summary>
        /// <value>Defines empty column</value>
        [DataMember(Name = "none", EmitDefaultValue = false)]
        public int None { get; set; }

        /// <summary>
        /// Defines identifier column number
        /// </summary>
        /// <value>Defines identifier column number</value>
        [DataMember(Name = "identifier", EmitDefaultValue = false)]
        public int Identifier { get; set; }

        /// <summary>
        /// Defines source phrase column number
        /// </summary>
        /// <value>Defines source phrase column number</value>
        [DataMember(Name = "sourcePhrase", EmitDefaultValue = false)]
        public int SourcePhrase { get; set; }

        /// <summary>
        /// Defines source or translation column number
        /// </summary>
        /// <value>Defines source or translation column number</value>
        [DataMember(Name = "sourceOrTranslation", EmitDefaultValue = false)]
        public int SourceOrTranslation { get; set; }

        /// <summary>
        /// Defines translation column number
        /// </summary>
        /// <value>Defines translation column number</value>
        [DataMember(Name = "translation", EmitDefaultValue = false)]
        public int Translation { get; set; }

        /// <summary>
        /// Defines context column number
        /// </summary>
        /// <value>Defines context column number</value>
        [DataMember(Name = "context", EmitDefaultValue = false)]
        public int Context { get; set; }

        /// <summary>
        /// Defines max length column number
        /// </summary>
        /// <value>Defines max length column number</value>
        [DataMember(Name = "maxLength", EmitDefaultValue = false)]
        public int MaxLength { get; set; }

        /// <summary>
        /// Defines labels column number
        /// </summary>
        /// <value>Defines labels column number</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SpreadsheetFileImportSchema {\n");
            sb.Append("  ").Append(base.ToString().Replace("\n", "\n  ")).Append("\n");
            sb.Append("  None: ").Append(None).Append("\n");
            sb.Append("  Identifier: ").Append(Identifier).Append("\n");
            sb.Append("  SourcePhrase: ").Append(SourcePhrase).Append("\n");
            sb.Append("  SourceOrTranslation: ").Append(SourceOrTranslation).Append("\n");
        ...
        {
            return this.Equals(input as SpreadsheetFileImportSchema);
        }

        /// <summary>
        /// Returns true if SpreadsheetFileImportSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of SpreadsheetFileImportSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpreadsheetFileImportSchema input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.SourcePhrase == input.SourcePhrase ||
                    this.SourcePhrase.Equals(input.SourcePhrase)
                ) && base.Equals(input) && 
                (
                    this.SourceOrTranslation == input.SourceOrTranslation ||
                    this.SourceOrTranslation.Equals(input.SourceOrTranslation)
                ) && base.Equals(input) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.SourcePhrase.GetHashCode();
                hashCode = hashCode * 59 + this.SourceOrTranslation.GetHashCode();
