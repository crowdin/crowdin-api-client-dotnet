...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FileImportResource")]
    public partial class FileImportResource : IEquatable<FileImportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileImportResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FileImportResource(FileImport data = default(FileImport))
        {
            this.Data = data;
        }
        ...
        public FileImport Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileImportResource {\n");
        ...
        {
            return this.Equals(input as FileImportResource);
        }

        /// <summary>
        /// Returns true if FileImportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of FileImportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileImportResource input)
        {
            if (input == null)
                return false;
