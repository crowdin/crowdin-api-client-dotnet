...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnterpriseTranslationDirectoryBuildResource")]
    public partial class EnterpriseTranslationDirectoryBuildResource : IEquatable<EnterpriseTranslationDirectoryBuildResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTranslationDirectoryBuildResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EnterpriseTranslationDirectoryBuildResource(EnterpriseDirectoryBuildResponse data = default(EnterpriseDirectoryBuildResponse))
        {
            this.Data = data;
        }
        ...
        public EnterpriseDirectoryBuildResponse Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTranslationDirectoryBuildResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseTranslationDirectoryBuildResource);
        }

        /// <summary>
        /// Returns true if EnterpriseTranslationDirectoryBuildResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTranslationDirectoryBuildResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTranslationDirectoryBuildResource input)
        {
            if (input == null)
                return false;
