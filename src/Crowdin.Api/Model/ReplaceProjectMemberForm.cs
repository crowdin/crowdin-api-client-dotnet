...
{
    /// <summary>
    /// ReplaceProjectMemberForm
    /// </summary>
    [DataContract(Name = "ReplaceProjectMemberForm")]
    public partial class ReplaceProjectMemberForm : IEquatable<ReplaceProjectMemberForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplaceProjectMemberForm" /> class.
        /// </summary>
        ...
        public ReplaceProjectMemberForm(bool accessToAllWorkflowSteps = true, bool managerAccess = false, AddProjectMemberFormPermissions permissions = default(AddProjectMemberFormPermissions))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReplaceProjectMemberForm {\n");
        ...
        {
            return this.Equals(input as ReplaceProjectMemberForm);
        }

        /// <summary>
        /// Returns true if ReplaceProjectMemberForm instances are equal
        /// </summary>
        /// <param name="input">Instance of ReplaceProjectMemberForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReplaceProjectMemberForm input)
        {
            if (input == null)
                return false;
