...
namespace Crowdin.Api.Model
{
    ...
    /// TagPositionScheme
    /// </summary>
    [DataContract(Name = "TagPositionScheme")]
    public partial class TagPositionScheme : IEquatable<TagPositionScheme>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagPositionScheme" /> class.
        /// </summary>
        /// <param name="x">x.</param>
        /// <param name="y">y.</param>
        /// <param name="width">width.</param>
        /// <param name="height">height.</param>
        public TagPositionScheme(int x = default(int), int y = default(int), int width = default(int), int height = default(int))
        {
            this.X = x;
            this.Y = y;
            this.Width = width;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagPositionScheme {\n");
        ...
        {
            return this.Equals(input as TagPositionScheme);
        }

        /// <summary>
        /// Returns true if TagPositionScheme instances are equal
        /// </summary>
        /// <param name="input">Instance of TagPositionScheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagPositionScheme input)
        {
            if (input == null)
                return false;
