...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskOperationTest")]
    ...
    public partial class TaskOperationTest : TaskOperation, IEquatable<TaskOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TaskOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;TaskOperationTest&quot;).</param>
        ...
        public TaskOperationTest(OneOfstringbooleanarrayarray value = default(OneOfstringbooleanarrayarray), OpEnum op = "TaskOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TaskOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskOperationTest {\n");
        ...
        {
            return this.Equals(input as TaskOperationTest);
        }

        /// <summary>
        /// Returns true if TaskOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskOperationTest input)
        {
            if (input == null)
                return false;
