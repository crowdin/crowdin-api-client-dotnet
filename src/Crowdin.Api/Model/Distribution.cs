...
namespace Crowdin.Api.Model
{
    ...
    public partial class Distribution : IEquatable<Distribution>, IValidatableObject
    {
        ...
        public Distribution(string hash = default(string), string name = default(string), List<int> fileIds = default(List<int>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Hash = hash;
            this.Name = name;
