...
{
    /// <summary>
    /// TranslationVoteCreateForm
    /// </summary>
    [DataContract(Name = "TranslationVoteCreateForm")]
    public partial class TranslationVoteCreateForm : IEquatable<TranslationVoteCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Vote type:  * &#39;up&#39; — upvote translation  * &#39;down&#39; — downvote translation
        /// </summary>
        /// <value>Vote type:  * &#39;up&#39; — upvote translation  * &#39;down&#39; — downvote translation</value>
        ...
        /// </summary>
        /// <value>Vote type:  * &#39;up&#39; — upvote translation  * &#39;down&#39; — downvote translation</value>
        [DataMember(Name = "mark", IsRequired = true, EmitDefaultValue = false)]
        public MarkEnum Mark { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationVoteCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranslationVoteCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationVoteCreateForm" /> class.
        /// </summary>
        /// <param name="mark">Vote type:  * &#39;up&#39; — upvote translation  * &#39;down&#39; — downvote translation (required).</param>
        /// <param name="translationId">Translation Identifier. Get via [List String Translations](#operation/api.projects.translations.getMany) (required).</param>
        public TranslationVoteCreateForm(MarkEnum mark = default(MarkEnum), int translationId = default(int))
        {
            this.Mark = mark;
        ...
        /// <summary>
        /// Translation Identifier. Get via [List String Translations](#operation/api.projects.translations.getMany)
        /// </summary>
        /// <value>Translation Identifier. Get via [List String Translations](#operation/api.projects.translations.getMany)</value>
        [DataMember(Name = "translationId", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationVoteCreateForm {\n");
        ...
        {
            return this.Equals(input as TranslationVoteCreateForm);
        }

        /// <summary>
        /// Returns true if TranslationVoteCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationVoteCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationVoteCreateForm input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TranslationId == input.TranslationId ||
                    this.TranslationId.Equals(input.TranslationId)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.TranslationId.GetHashCode();
                return hashCode;
            }
        }
