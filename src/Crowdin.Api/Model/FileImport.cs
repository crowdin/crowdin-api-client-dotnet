...
namespace Crowdin.Api.Model
{
    ...
    /// FileImport
    /// </summary>
    [DataContract(Name = "FileImport")]
    public partial class FileImport : IEquatable<FileImport>, IValidatableObject
    {
        /// <summary>
        ...
        public FileImport(int projectId = default(int), int storageId = default(int), string languageId = default(string), int fileId = default(int))
        {
        ...
        {
            return this.Equals(input as FileImport);
        }

        /// <summary>
        /// Returns true if FileImport instances are equal
        /// </summary>
        /// <param name="input">Instance of FileImport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileImport input)
        {
            if (input == null)
                return false;
