...
namespace Crowdin.Api.Model
{
    ...
    public partial class Vendor : IEquatable<Vendor>, IValidatableObject
    {
        ...
        public Vendor(int id = default(int), string name = default(string), string description = default(string), StatusEnum? status = default(StatusEnum?))
        {
            this.Id = id;
            this.Name = name;
