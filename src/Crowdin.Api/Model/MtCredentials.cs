...
namespace Crowdin.Api.Model
{
    ...
    /// MtCredentials
    /// </summary>
    [DataContract(Name = "Mt_credentials")]
    public partial class MtCredentials : IEquatable<MtCredentials>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentials" /> class.
        /// </summary>
        /// <param name="crowdinNmt">crowdinNmt.</param>
        /// <param name="crowdinNmtMultiTranslations">crowdinNmtMultiTranslations.</param>
        public MtCredentials(int crowdinNmt = default(int), int crowdinNmtMultiTranslations = default(int))
        {
            this.CrowdinNmt = crowdinNmt;
            this.CrowdinNmtMultiTranslations = crowdinNmtMultiTranslations;
        }

        /// <summary>
        /// Gets or Sets CrowdinNmt
        /// </summary>
        [DataMember(Name = "crowdin_nmt", EmitDefaultValue = false)]
        public int CrowdinNmt { get; set; }

        /// <summary>
        /// Gets or Sets CrowdinNmtMultiTranslations
        /// </summary>
        [DataMember(Name = "crowdin_nmt_multi_translations", EmitDefaultValue = false)]
        public int CrowdinNmtMultiTranslations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentials {\n");
            sb.Append("  CrowdinNmt: ").Append(CrowdinNmt).Append("\n");
            sb.Append("  CrowdinNmtMultiTranslations: ").Append(CrowdinNmtMultiTranslations).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as MtCredentials);
        }

        /// <summary>
        /// Returns true if MtCredentials instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentials to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentials input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CrowdinNmt == input.CrowdinNmt ||
                    this.CrowdinNmt.Equals(input.CrowdinNmt)
                ) && 
                (
                    this.CrowdinNmtMultiTranslations == input.CrowdinNmtMultiTranslations ||
                    this.CrowdinNmtMultiTranslations.Equals(input.CrowdinNmtMultiTranslations)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.CrowdinNmt.GetHashCode();
                hashCode = hashCode * 59 + this.CrowdinNmtMultiTranslations.GetHashCode();
                return hashCode;
            }
        }
