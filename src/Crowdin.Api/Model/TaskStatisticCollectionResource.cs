...
{
    /// <summary>
    /// Task Statistic Collection Resource
    /// </summary>
    [DataContract(Name = "TaskStatisticCollectionResource")]
    public partial class TaskStatisticCollectionResource : IEquatable<TaskStatisticCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskStatisticCollectionResource" /> class.
        /// </summary>
        /// <param name="data">Class TaskStatisticCollectionResource.</param>
        /// <param name="pagination">pagination.</param>
        public TaskStatisticCollectionResource(List<TaskStatisticResource> data = default(List<TaskStatisticResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        /// <summary>
        /// Class TaskStatisticCollectionResource
        /// </summary>
        /// <value>Class TaskStatisticCollectionResource</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<TaskStatisticResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskStatisticCollectionResource {\n");
        ...
        {
            return this.Equals(input as TaskStatisticCollectionResource);
        }

        /// <summary>
        /// Returns true if TaskStatisticCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskStatisticCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskStatisticCollectionResource input)
        {
            if (input == null)
                return false;
