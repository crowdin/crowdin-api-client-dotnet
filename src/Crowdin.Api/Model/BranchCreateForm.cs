...
namespace Crowdin.Api.Model
{
    ...
    /// BranchCreateForm
    /// </summary>
    [DataContract(Name = "BranchCreateForm")]
    public partial class BranchCreateForm : IEquatable<BranchCreateForm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BranchCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchCreateForm" /> class.
        /// </summary>
        /// <param name="name">Branch name  __Note:__ Can&#39;t contain &#x60;\\ / : * ? \&quot; &lt; &gt; |&#x60; symbols  (required).</param>
        /// <param name="title">Use to provide more details for translators. Title is available in UI only.</param>
        /// <param name="exportPattern">Branch export pattern. Defines branch name and path in resulting translations bundle  __Note:__ Can&#39;t contain &#x60;: * ? \&quot; &lt; &gt; |&#x60; symbols.</param>
        /// <param name="priority">Defines priority level for each branch (default to PriorityEnum.Normal).</param>
        public BranchCreateForm(string name = default(string), string title = default(string), string exportPattern = default(string), PriorityEnum? priority = PriorityEnum.Normal)
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for BranchCreateForm and cannot be null");
            }
            this.Name = name;
            this.Title = title;
        ...
        /// <summary>
        /// Branch name  __Note:__ Can&#39;t contain &#x60;\\ / : * ? \&quot; &lt; &gt; |&#x60; symbols 
        /// </summary>
        /// <value>Branch name  __Note:__ Can&#39;t contain &#x60;\\ / : * ? \&quot; &lt; &gt; |&#x60; symbols </value>
        ...
        /// <summary>
        /// Branch export pattern. Defines branch name and path in resulting translations bundle  __Note:__ Can&#39;t contain &#x60;: * ? \&quot; &lt; &gt; |&#x60; symbols
        /// </summary>
        /// <value>Branch export pattern. Defines branch name and path in resulting translations bundle  __Note:__ Can&#39;t contain &#x60;: * ? \&quot; &lt; &gt; |&#x60; symbols</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BranchCreateForm {\n");
        ...
        {
            return this.Equals(input as BranchCreateForm);
        }

        /// <summary>
        /// Returns true if BranchCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchCreateForm input)
        {
            if (input == null)
                return false;
