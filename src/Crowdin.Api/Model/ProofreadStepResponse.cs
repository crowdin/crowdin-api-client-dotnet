...
{
    /// <summary>
    /// ProofreadStepResponse
    /// </summary>
    [DataContract(Name = "ProofreadStepResponse")]
    public partial class ProofreadStepResponse : IEquatable<ProofreadStepResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProofreadStepResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ProofreadStepResponse(ProofreadStepResponseData data = default(ProofreadStepResponseData))
        {
            this.Data = data;
        }
        ...
        public ProofreadStepResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProofreadStepResponse {\n");
        ...
        {
            return this.Equals(input as ProofreadStepResponse);
        }

        /// <summary>
        /// Returns true if ProofreadStepResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ProofreadStepResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProofreadStepResponse input)
        {
            if (input == null)
                return false;
