...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnterpriseProjectCollectionResource")]
    public partial class EnterpriseProjectCollectionResource : IEquatable<EnterpriseProjectCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseProjectCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public EnterpriseProjectCollectionResource(List<EnterpriseProjectResource> data = default(List<EnterpriseProjectResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<EnterpriseProjectResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseProjectCollectionResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseProjectCollectionResource);
        }

        /// <summary>
        /// Returns true if EnterpriseProjectCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseProjectCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseProjectCollectionResource input)
        {
            if (input == null)
                return false;
