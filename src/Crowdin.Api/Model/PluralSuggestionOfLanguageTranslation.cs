...
{
    /// <summary>
    /// PluralSuggestionOfLanguageTranslation
    /// </summary>
    [DataContract(Name = "PluralSuggestionOfLanguageTranslation")]
    public partial class PluralSuggestionOfLanguageTranslation : IEquatable<PluralSuggestionOfLanguageTranslation>, IValidatableObject
    {
        /// <summary>
        /// Defines PluralForm
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum PluralFormEnum
        {
            /// <summary>
        ...
        /// <summary>
        /// Gets or Sets PluralForm
        /// </summary>
        [DataMember(Name = "pluralForm", EmitDefaultValue = false)]
        public PluralFormEnum? PluralForm { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PluralSuggestionOfLanguageTranslation" /> class.
        /// </summary>
        /// <param name="translationId">translationId.</param>
        /// <param name="text">text.</param>
        /// <param name="pluralForm">pluralForm.</param>
        /// <param name="user">user.</param>
        /// <param name="createdAt">createdAt.</param>
        public PluralSuggestionOfLanguageTranslation(int translationId = default(int), string text = default(string), PluralFormEnum? pluralForm = default(PluralFormEnum?), IcuLanguageTranslationUser user = default(IcuLanguageTranslationUser), DateTime createdAt = default(DateTime))
        {
        ...
        public IcuLanguageTranslationUser User { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PluralSuggestionOfLanguageTranslation {\n");
            sb.Append("  TranslationId: ").Append(TranslationId).Append("\n");
            sb.Append("  Text: ").Append(Text).Append("\n");
            sb.Append("  PluralForm: ").Append(PluralForm).Append("\n");
        ...
        {
            return this.Equals(input as PluralSuggestionOfLanguageTranslation);
        }

        /// <summary>
        /// Returns true if PluralSuggestionOfLanguageTranslation instances are equal
        /// </summary>
        /// <param name="input">Instance of PluralSuggestionOfLanguageTranslation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PluralSuggestionOfLanguageTranslation input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PluralForm == input.PluralForm ||
                    this.PluralForm.Equals(input.PluralForm)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.PluralForm.GetHashCode();
                if (this.User != null)
