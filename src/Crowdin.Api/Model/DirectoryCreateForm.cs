...
namespace Crowdin.Api.Model
{
    ...
    /// DirectoryCreateForm
    /// </summary>
    [DataContract(Name = "DirectoryCreateForm")]
    public partial class DirectoryCreateForm : IEquatable<DirectoryCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Defines priority level for each branch
        /// </summary>
        /// <value>Defines priority level for each branch</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DirectoryCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryCreateForm" /> class.
        /// </summary>
        /// <param name="name">Directory name  __Note:__ Can&#39;t contain &#x60;\\ / : * ? \&quot; &lt; &gt; |&#x60; symbols (required).</param>
        /// <param name="branchId">Branch identifier. Get via [List Branches](#operation/api.projects.branches.getMany)  __Note:__ Can&#39;t be used with &#x60;directoryId&#x60; in same request.</param>
        /// <param name="directoryId">Parent Directory Identifier. Get via [List Directories](#operation/api.projects.directories.getMany)  __Note:__ Can&#39;t be used with &#x60;branchId&#x60; in same request.</param>
        /// <param name="title">Use to provide more details for translators. Title is available in UI only.</param>
        /// <param name="exportPattern">Directory export pattern. Defines directory name and path in resulting translations bundle  __Note:__ Can&#39;t contain &#x60;: * ? \&quot; &lt; &gt; |&#x60; symbols.</param>
        /// <param name="priority">Defines priority level for each branch (default to PriorityEnum.Normal).</param>
        public DirectoryCreateForm(string name = default(string), int branchId = default(int), int directoryId = default(int), string title = default(string), string exportPattern = default(string), PriorityEnum? priority = PriorityEnum.Normal)
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for DirectoryCreateForm and cannot be null");
            }
            this.Name = name;
        ...
        /// <summary>
        /// Directory name  __Note:__ Can&#39;t contain &#x60;\\ / : * ? \&quot; &lt; &gt; |&#x60; symbols
        /// </summary>
        /// <value>Directory name  __Note:__ Can&#39;t contain &#x60;\\ / : * ? \&quot; &lt; &gt; |&#x60; symbols</value>
        [DataMember(Name = "name", IsRequired = true, EmitDefaultValue = false)]
        public string Name { get; set; }

        /// <summary>
        /// Branch identifier. Get via [List Branches](#operation/api.projects.branches.getMany)  __Note:__ Can&#39;t be used with &#x60;directoryId&#x60; in same request
        /// </summary>
        /// <value>Branch identifier. Get via [List Branches](#operation/api.projects.branches.getMany)  __Note:__ Can&#39;t be used with &#x60;directoryId&#x60; in same request</value>
        [DataMember(Name = "branchId", EmitDefaultValue = false)]
        public int BranchId { get; set; }

        /// <summary>
        /// Parent Directory Identifier. Get via [List Directories](#operation/api.projects.directories.getMany)  __Note:__ Can&#39;t be used with &#x60;branchId&#x60; in same request
        /// </summary>
        /// <value>Parent Directory Identifier. Get via [List Directories](#operation/api.projects.directories.getMany)  __Note:__ Can&#39;t be used with &#x60;branchId&#x60; in same request</value>
        ...
        /// <summary>
        /// Directory export pattern. Defines directory name and path in resulting translations bundle  __Note:__ Can&#39;t contain &#x60;: * ? \&quot; &lt; &gt; |&#x60; symbols
        /// </summary>
        /// <value>Directory export pattern. Defines directory name and path in resulting translations bundle  __Note:__ Can&#39;t contain &#x60;: * ? \&quot; &lt; &gt; |&#x60; symbols</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DirectoryCreateForm {\n");
        ...
        {
            return this.Equals(input as DirectoryCreateForm);
        }

        /// <summary>
        /// Returns true if DirectoryCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of DirectoryCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DirectoryCreateForm input)
        {
            if (input == null)
                return false;
