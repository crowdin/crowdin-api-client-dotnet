...
namespace Crowdin.Api.Model
{
    ...
    /// List Users
    /// </summary>
    [DataContract(Name = "UserCollectionResource")]
    public partial class UserCollectionResource : IEquatable<UserCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public UserCollectionResource(List<CrowdinUserResource> data = default(List<CrowdinUserResource>), List<Pagination> pagination = default(List<Pagination>))
        {
            this.Data = data;
        ...
        public List<CrowdinUserResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserCollectionResource {\n");
        ...
        {
            return this.Equals(input as UserCollectionResource);
        }

        /// <summary>
        /// Returns true if UserCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of UserCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserCollectionResource input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Pagination.SequenceEqual(input.Pagination)
                );
        }
