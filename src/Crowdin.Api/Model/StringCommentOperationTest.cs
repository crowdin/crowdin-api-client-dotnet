...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringCommentOperationTest")]
    ...
    public partial class StringCommentOperationTest : StringCommentOperation, IEquatable<StringCommentOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCommentOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StringCommentOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCommentOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;StringCommentOperationTest&quot;).</param>
        ...
        public StringCommentOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "StringCommentOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for StringCommentOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringCommentOperationTest {\n");
        ...
        {
            return this.Equals(input as StringCommentOperationTest);
        }

        /// <summary>
        /// Returns true if StringCommentOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of StringCommentOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringCommentOperationTest input)
        {
            if (input == null)
                return false;
