...
namespace Crowdin.Api.Model
{
    ...
    /// Screenshot Resource
    /// </summary>
    [DataContract(Name = "ScreenshotResource")]
    public partial class ScreenshotResource : IEquatable<ScreenshotResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ScreenshotResource(Screenshot data = default(Screenshot))
        {
            this.Data = data;
        }
        ...
        public Screenshot Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScreenshotResource {\n");
        ...
        {
            return this.Equals(input as ScreenshotResource);
        }

        /// <summary>
        /// Returns true if ScreenshotResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotResource input)
        {
            if (input == null)
                return false;
