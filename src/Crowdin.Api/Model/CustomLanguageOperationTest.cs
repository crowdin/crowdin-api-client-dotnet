...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomLanguageOperationTest")]
    ...
    public partial class CustomLanguageOperationTest : CustomLanguageOperation, IEquatable<CustomLanguageOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomLanguageOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomLanguageOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomLanguageOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;CustomLanguageOperationTest&quot;).</param>
        ...
        public CustomLanguageOperationTest(OneOfstringarray value = default(OneOfstringarray), OpEnum op = "CustomLanguageOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for CustomLanguageOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomLanguageOperationTest {\n");
        ...
        {
            return this.Equals(input as CustomLanguageOperationTest);
        }

        /// <summary>
        /// Returns true if CustomLanguageOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomLanguageOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomLanguageOperationTest input)
        {
            if (input == null)
                return false;
