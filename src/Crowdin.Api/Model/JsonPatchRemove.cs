...
{
    /// <summary>
    /// A JSON Patch &#x60;Remove&#x60; operation as defined by [RFC 6902](https://tools.ietf.org/html/rfc6902#section-4.2)
    /// </summary>
    [DataContract(Name = "JsonPatchRemove")]
    ...
    public partial class JsonPatchRemove : JsonPatchOperation, IEquatable<JsonPatchRemove>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchRemove" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JsonPatchRemove() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchRemove" /> class.
        /// </summary>
        /// <param name="op">Patch operation to perform (required) (default to &quot;JsonPatchRemove&quot;).</param>
        ...
        public JsonPatchRemove(OpEnum op = "JsonPatchRemove", string path = default(string)) : base(op, path)
        {
        }
        ...
        {
            return this.Equals(input as JsonPatchRemove);
        }

        /// <summary>
        /// Returns true if JsonPatchRemove instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonPatchRemove to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonPatchRemove input)
        {
            if (input == null)
                return false;
