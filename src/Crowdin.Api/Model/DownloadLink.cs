...
namespace Crowdin.Api.Model
{
    ...
    /// DownloadLink
    /// </summary>
    [DataContract(Name = "DownloadLink")]
    public partial class DownloadLink : IEquatable<DownloadLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DownloadLink" /> class.
        /// </summary>
        /// <param name="url">url.</param>
        /// <param name="expireIn">expireIn.</param>
        public DownloadLink(string url = default(string), string expireIn = default(string))
        {
            this.Url = url;
        ...
        {
            return this.Equals(input as DownloadLink);
        }

        /// <summary>
        /// Returns true if DownloadLink instances are equal
        /// </summary>
        /// <param name="input">Instance of DownloadLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DownloadLink input)
        {
            if (input == null)
                return false;
