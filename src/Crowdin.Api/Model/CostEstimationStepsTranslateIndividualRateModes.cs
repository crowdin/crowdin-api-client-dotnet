...
{
    /// <summary>
    /// CostEstimationStepsTranslateIndividualRateModes
    /// </summary>
    [DataContract(Name = "cost-estimation.steps.translate.individual-rate-modes")]
    public partial class CostEstimationStepsTranslateIndividualRateModes : IEquatable<CostEstimationStepsTranslateIndividualRateModes>, IValidatableObject
    {
        /// <summary>
        /// tm_match
        /// </summary>
        /// <value>tm_match</value>
        ...
        public enum ModeEnum
        {
            ...
            /// <summary>
            /// Enum TmMatch for value: tm_match
            /// </summary>
            [EnumMember(Value = "tm_match")]
            TmMatch = 2
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationStepsTranslateIndividualRateModes" /> class.
        /// </summary>
        /// <param name="mode">tm_match.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationStepsTranslateIndividualRateModes(ModeEnum? mode = default(ModeEnum?), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationStepsTranslateIndividualRateModes {\n");
        ...
        {
            return this.Equals(input as CostEstimationStepsTranslateIndividualRateModes);
        }

        /// <summary>
        /// Returns true if CostEstimationStepsTranslateIndividualRateModes instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationStepsTranslateIndividualRateModes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationStepsTranslateIndividualRateModes input)
        {
            if (input == null)
                return false;
