...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(TeamOperationReplace), "TeamOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(TeamOperationReplace), "replace")]
    public partial class TeamOperation : IEquatable<TeamOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamOperation" /> class.
        /// </summary>
        ...
        public TeamOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as TeamOperation);
        }

        /// <summary>
        /// Returns true if TeamOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamOperation input)
        {
            if (input == null)
                return false;
