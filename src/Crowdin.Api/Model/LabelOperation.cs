...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LabelOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(LabelOperationReplace), "LabelOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(LabelOperationTest), "LabelOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(LabelOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(LabelOperationTest), "test")]
    public partial class LabelOperation : IEquatable<LabelOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LabelOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelOperation" /> class.
        /// </summary>
        ...
        public LabelOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LabelOperation {\n");
        ...
        {
            return this.Equals(input as LabelOperation);
        }

        /// <summary>
        /// Returns true if LabelOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelOperation input)
        {
            if (input == null)
                return false;
