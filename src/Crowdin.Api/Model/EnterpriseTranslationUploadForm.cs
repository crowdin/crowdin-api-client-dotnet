...
{
    /// <summary>
    /// EnterpriseTranslationUploadForm
    /// </summary>
    [DataContract(Name = "EnterpriseTranslationUploadForm")]
    public partial class EnterpriseTranslationUploadForm : IEquatable<EnterpriseTranslationUploadForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTranslationUploadForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnterpriseTranslationUploadForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTranslationUploadForm" /> class.
        /// </summary>
        /// <param name="storageId">Storage Identifier. Get via [List Storages](#operation/api.storages.getMany) (required).</param>
        /// <param name="fileId">File Identifier for import. Get via [List Files](#operation/api.projects.files.getMany) (required).</param>
        /// <param name="importEqSuggestions">Defines whether to add translation if it&#39;s the same as the source string (default to false).</param>
        /// <param name="autoApproveImported">Mark uploaded translations as approved (default to false).</param>
        /// <param name="translateHidden">Allow translations upload to hidden source strings (default to false).</param>
        ...
        public EnterpriseTranslationUploadForm(int storageId = default(int), int fileId = default(int), bool importEqSuggestions = false, bool autoApproveImported = false, bool translateHidden = false, bool markAddedTranslationsAsDone = true)
        {
        ...
        /// <summary>
        /// File Identifier for import. Get via [List Files](#operation/api.projects.files.getMany)
        /// </summary>
        /// <value>File Identifier for import. Get via [List Files](#operation/api.projects.files.getMany)</value>
        ...
        /// </summary>
        /// <value>Defines whether to add translation if it&#39;s the same as the source string</value>
        [DataMember(Name = "importEqSuggestions", EmitDefaultValue = true)]
        public bool ImportEqSuggestions { get; set; }

        /// <summary>
        /// Mark uploaded translations as approved
        /// </summary>
        /// <value>Mark uploaded translations as approved</value>
        [DataMember(Name = "autoApproveImported", EmitDefaultValue = true)]
        public bool AutoApproveImported { get; set; }

        /// <summary>
        /// Allow translations upload to hidden source strings
        /// </summary>
        /// <value>Allow translations upload to hidden source strings</value>
        [DataMember(Name = "translateHidden", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTranslationUploadForm {\n");
            sb.Append("  StorageId: ").Append(StorageId).Append("\n");
            sb.Append("  FileId: ").Append(FileId).Append("\n");
            sb.Append("  ImportEqSuggestions: ").Append(ImportEqSuggestions).Append("\n");
            sb.Append("  AutoApproveImported: ").Append(AutoApproveImported).Append("\n");
            sb.Append("  TranslateHidden: ").Append(TranslateHidden).Append("\n");
        ...
        {
            return this.Equals(input as EnterpriseTranslationUploadForm);
        }

        /// <summary>
        /// Returns true if EnterpriseTranslationUploadForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTranslationUploadForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTranslationUploadForm input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ImportEqSuggestions == input.ImportEqSuggestions ||
                    this.ImportEqSuggestions.Equals(input.ImportEqSuggestions)
                ) && 
                (
                    this.AutoApproveImported == input.AutoApproveImported ||
                    this.AutoApproveImported.Equals(input.AutoApproveImported)
                ) && 
                (
                    this.TranslateHidden == input.TranslateHidden ||
                    this.TranslateHidden.Equals(input.TranslateHidden)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.ImportEqSuggestions.GetHashCode();
                hashCode = hashCode * 59 + this.AutoApproveImported.GetHashCode();
                hashCode = hashCode * 59 + this.TranslateHidden.GetHashCode();
