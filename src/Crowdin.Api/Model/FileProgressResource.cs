...
{
    /// <summary>
    /// Language Translation File Progress Resource
    /// </summary>
    [DataContract(Name = "FileProgressResource")]
    public partial class FileProgressResource : IEquatable<FileProgressResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileProgressResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FileProgressResource(FileProgress data = default(FileProgress))
        {
            this.Data = data;
        }
        ...
        public FileProgress Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileProgressResource {\n");
        ...
        {
            return this.Equals(input as FileProgressResource);
        }

        /// <summary>
        /// Returns true if FileProgressResource instances are equal
        /// </summary>
        /// <param name="input">Instance of FileProgressResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileProgressResource input)
        {
            if (input == null)
                return false;
