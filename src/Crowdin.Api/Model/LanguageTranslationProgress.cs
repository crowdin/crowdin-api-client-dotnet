...
{
    /// <summary>
    /// Language Translation File Progress Response Model
    /// </summary>
    [DataContract(Name = "Language_Translation_Progress")]
    public partial class LanguageTranslationProgress : IEquatable<LanguageTranslationProgress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageTranslationProgress" /> class.
        /// </summary>
        /// <param name="languageId">languageId.</param>
        /// <param name="eTag">eTag.</param>
        public LanguageTranslationProgress(string languageId = default(string), string eTag = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LanguageTranslationProgress {\n");
        ...
        {
            return this.Equals(input as LanguageTranslationProgress);
        }

        /// <summary>
        /// Returns true if LanguageTranslationProgress instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageTranslationProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageTranslationProgress input)
        {
            if (input == null)
                return false;
