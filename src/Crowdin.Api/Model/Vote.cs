...
namespace Crowdin.Api.Model
{
    ...
    public partial class Vote : IEquatable<Vote>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="votedAt">Vote created date.</param>
        /// <param name="mark">Vote action.</param>
        public Vote(int id = default(int), IcuLanguageTranslationUser user = default(IcuLanguageTranslationUser), int translationId = default(int), DateTime votedAt = default(DateTime), string mark = default(string))
        {
            this.Id = id;
            this.User = user;
        ...
        /// Vote created date
        /// </summary>
        /// <value>Vote created date</value>
        [DataMember(Name = "votedAt", EmitDefaultValue = false)]
        public DateTime VotedAt { get; set; }

        /// <summary>
        /// Vote action
        /// </summary>
        /// <value>Vote action</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  VotedAt: ").Append(VotedAt).Append("\n");
        ...
        {
            return this.Equals(input as Vote);
        }

        /// <summary>
        /// Returns true if Vote instances are equal
        /// </summary>
        /// <param name="input">Instance of Vote to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Vote input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.VotedAt == input.VotedAt ||
                    (this.VotedAt != null &&
                    this.VotedAt.Equals(input.VotedAt))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.VotedAt != null)
                    hashCode = hashCode * 59 + this.VotedAt.GetHashCode();
                if (this.Mark != null)
