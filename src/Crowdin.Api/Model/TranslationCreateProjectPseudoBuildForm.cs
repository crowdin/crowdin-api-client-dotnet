...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslationCreateProjectPseudoBuildForm")]
    public partial class TranslationCreateProjectPseudoBuildForm : IEquatable<TranslationCreateProjectPseudoBuildForm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCreateProjectPseudoBuildForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranslationCreateProjectPseudoBuildForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCreateProjectPseudoBuildForm" /> class.
        /// </summary>
        ...
        public TranslationCreateProjectPseudoBuildForm(bool pseudo = default(bool), string prefix = default(string), string suffix = default(string), int lengthTransformation = default(int), CharTransformationEnum? charTransformation = default(CharTransformationEnum?))
        {
            this.Pseudo = pseudo;
            this.Prefix = prefix;
            this.Suffix = suffix;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCreateProjectPseudoBuildForm {\n");
        ...
        {
            return this.Equals(input as TranslationCreateProjectPseudoBuildForm);
        }

        /// <summary>
        /// Returns true if TranslationCreateProjectPseudoBuildForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCreateProjectPseudoBuildForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCreateProjectPseudoBuildForm input)
        {
            if (input == null)
                return false;
