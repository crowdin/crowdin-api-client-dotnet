...
namespace Crowdin.Api.Model
{
    ...
    /// MtCredentialsAmazon
    /// </summary>
    [DataContract(Name = "mt.credentials.amazon")]
    public partial class MtCredentialsAmazon : IEquatable<MtCredentialsAmazon>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentialsAmazon" /> class.
        /// </summary>
        /// <param name="accessKey">Api key.</param>
        /// <param name="secretKey">Secret key.</param>
        public MtCredentialsAmazon(string accessKey = default(string), string secretKey = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentialsAmazon {\n");
        ...
        {
            return this.Equals(input as MtCredentialsAmazon);
        }

        /// <summary>
        /// Returns true if MtCredentialsAmazon instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentialsAmazon to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentialsAmazon input)
        {
            if (input == null)
                return false;
