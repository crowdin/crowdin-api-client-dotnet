...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectOperationAdd")]
    ...
    public partial class ProjectOperationAdd : ProjectSettingOperation, IEquatable<ProjectOperationAdd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectOperationAdd" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectOperationAdd() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectOperationAdd" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectOperationAdd&quot;).</param>
        ...
        public ProjectOperationAdd(OneOfstringintegerbooleanobject value = default(OneOfstringintegerbooleanobject), OpEnum op = "ProjectOperationAdd", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectOperationAdd and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectOperationAdd {\n");
        ...
        {
            return this.Equals(input as ProjectOperationAdd);
        }

        /// <summary>
        /// Returns true if ProjectOperationAdd instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectOperationAdd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectOperationAdd input)
        {
            if (input == null)
                return false;
