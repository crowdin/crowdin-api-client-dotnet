...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VendorTaskOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(VendorTaskOperationReplace), "VendorTaskOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(VendorTaskOperationTest), "VendorTaskOperationTest")]
    ...
    public partial class VendorTaskOperation : IEquatable<VendorTaskOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VendorTaskOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VendorTaskOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VendorTaskOperation" /> class.
        /// </summary>
        ...
        public VendorTaskOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VendorTaskOperation {\n");
        ...
        {
            return this.Equals(input as VendorTaskOperation);
        }

        /// <summary>
        /// Returns true if VendorTaskOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of VendorTaskOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VendorTaskOperation input)
        {
            if (input == null)
                return false;
