...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslationCostsFuzzyMode")]
    public partial class TranslationCostsFuzzyMode : IEquatable<TranslationCostsFuzzyMode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCostsFuzzyMode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranslationCostsFuzzyMode() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCostsFuzzyMode" /> class.
        /// </summary>
        /// <param name="name">translation-costs (required).</param>
        /// <param name="schema">schema (required).</param>
        public TranslationCostsFuzzyMode(string name = default(string), TranslationCostsFuzzyModeSchema schema = default(TranslationCostsFuzzyModeSchema))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for TranslationCostsFuzzyMode and cannot be null");
            }
            this.Name = name;
            // to ensure "schema" is required (not null)
            if (schema == null) {
                throw new ArgumentNullException("schema is a required property for TranslationCostsFuzzyMode and cannot be null");
            }
            this.Schema = schema;
        }
        ...
        public TranslationCostsFuzzyModeSchema Schema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCostsFuzzyMode {\n");
        ...
        {
            return this.Equals(input as TranslationCostsFuzzyMode);
        }

        /// <summary>
        /// Returns true if TranslationCostsFuzzyMode instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCostsFuzzyMode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCostsFuzzyMode input)
        {
            if (input == null)
                return false;
