...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupWorkflowTranslationCosts_schema")]
    public partial class GroupWorkflowTranslationCostsSchema : IEquatable<GroupWorkflowTranslationCostsSchema>, IValidatableObject
    {
        /// <summary>
        /// Defines report unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupWorkflowTranslationCostsSchema" /> class.
        /// </summary>
        /// <param name="projectIds">Project Identifier for which the report should be generated. Get via [List Projects](#operation/api.projects.getMany).</param>
        ...
        public GroupWorkflowTranslationCostsSchema(List<int> projectIds = default(List<int>), UnitEnum? unit = UnitEnum.Words, CurrencyEnum? currency = CurrencyEnum.USD, FormatEnum? format = FormatEnum.Xlsx, GroupByEnum? groupBy = GroupByEnum.User, DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime))
        {
        ...
        /// <summary>
        /// Project Identifier for which the report should be generated. Get via [List Projects](#operation/api.projects.getMany)
        /// </summary>
        /// <value>Project Identifier for which the report should be generated. Get via [List Projects](#operation/api.projects.getMany)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupWorkflowTranslationCostsSchema {\n");
        ...
        {
            return this.Equals(input as GroupWorkflowTranslationCostsSchema);
        }

        /// <summary>
        /// Returns true if GroupWorkflowTranslationCostsSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupWorkflowTranslationCostsSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupWorkflowTranslationCostsSchema input)
        {
            if (input == null)
                return false;
