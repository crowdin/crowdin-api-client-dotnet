...
{
    /// <summary>
    /// TranslationCreateDirectoryPseudoBuildForm
    /// </summary>
    [DataContract(Name = "TranslationCreateDirectoryPseudoBuildForm")]
    public partial class TranslationCreateDirectoryPseudoBuildForm : IEquatable<TranslationCreateDirectoryPseudoBuildForm>, IValidatableObject
    {
        /// <summary>
        /// Transforms characters to other languages. Acceptable values are: asian, cyrillic, european, arabic.
        /// </summary>
        /// <value>Transforms characters to other languages. Acceptable values are: asian, cyrillic, european, arabic.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum CharTransformationEnum
        {
            /// <summary>
        ...
        /// </summary>
        /// <value>Transforms characters to other languages. Acceptable values are: asian, cyrillic, european, arabic.</value>
        [DataMember(Name = "charTransformation", EmitDefaultValue = false)]
        public CharTransformationEnum? CharTransformation { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCreateDirectoryPseudoBuildForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranslationCreateDirectoryPseudoBuildForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCreateDirectoryPseudoBuildForm" /> class.
        /// </summary>
        /// <param name="pseudo">Flag for detecting pseudo translation (required).</param>
        /// <param name="prefix">Add special characters at the beginning of each string to show where messages have been concatenated together..</param>
        /// <param name="suffix">Add special characters at the end of each string to show where messages have been concatenated together..</param>
        /// <param name="lengthTransformation">Make string larger or shorter. Acceptable values must be from -50 to 100. Default is 0..</param>
        /// <param name="charTransformation">Transforms characters to other languages. Acceptable values are: asian, cyrillic, european, arabic..</param>
        public TranslationCreateDirectoryPseudoBuildForm(bool pseudo = default(bool), string prefix = default(string), string suffix = default(string), int lengthTransformation = default(int), CharTransformationEnum? charTransformation = default(CharTransformationEnum?))
        {
            this.Pseudo = pseudo;
            this.Prefix = prefix;
            this.Suffix = suffix;
        ...
        /// <summary>
        /// Flag for detecting pseudo translation
        /// </summary>
        /// <value>Flag for detecting pseudo translation</value>
        [DataMember(Name = "pseudo", IsRequired = true, EmitDefaultValue = true)]
        public bool Pseudo { get; set; }

        /// <summary>
        /// Add special characters at the beginning of each string to show where messages have been concatenated together.
        /// </summary>
        /// <value>Add special characters at the beginning of each string to show where messages have been concatenated together.</value>
        [DataMember(Name = "prefix", EmitDefaultValue = false)]
        public string Prefix { get; set; }

        /// <summary>
        /// Add special characters at the end of each string to show where messages have been concatenated together.
        /// </summary>
        /// <value>Add special characters at the end of each string to show where messages have been concatenated together.</value>
        [DataMember(Name = "suffix", EmitDefaultValue = false)]
        public string Suffix { get; set; }

        /// <summary>
        /// Make string larger or shorter. Acceptable values must be from -50 to 100. Default is 0.
        /// </summary>
        /// <value>Make string larger or shorter. Acceptable values must be from -50 to 100. Default is 0.</value>
        [DataMember(Name = "lengthTransformation", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCreateDirectoryPseudoBuildForm {\n");
            sb.Append("  Pseudo: ").Append(Pseudo).Append("\n");
            sb.Append("  Prefix: ").Append(Prefix).Append("\n");
            sb.Append("  Suffix: ").Append(Suffix).Append("\n");
            sb.Append("  LengthTransformation: ").Append(LengthTransformation).Append("\n");
            sb.Append("  CharTransformation: ").Append(CharTransformation).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TranslationCreateDirectoryPseudoBuildForm);
        }

        /// <summary>
        /// Returns true if TranslationCreateDirectoryPseudoBuildForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCreateDirectoryPseudoBuildForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCreateDirectoryPseudoBuildForm input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.LengthTransformation == input.LengthTransformation ||
                    this.LengthTransformation.Equals(input.LengthTransformation)
                ) && 
                (
                    this.CharTransformation == input.CharTransformation ||
                    this.CharTransformation.Equals(input.CharTransformation)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.LengthTransformation.GetHashCode();
                hashCode = hashCode * 59 + this.CharTransformation.GetHashCode();
                return hashCode;
            }
        }
