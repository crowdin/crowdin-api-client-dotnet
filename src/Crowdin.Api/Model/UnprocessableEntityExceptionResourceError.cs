...
{
    /// <summary>
    /// UnprocessableEntityExceptionResourceError
    /// </summary>
    [DataContract(Name = "UnprocessableEntityExceptionResource_error")]
    public partial class UnprocessableEntityExceptionResourceError : IEquatable<UnprocessableEntityExceptionResourceError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnprocessableEntityExceptionResourceError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public UnprocessableEntityExceptionResourceError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnprocessableEntityExceptionResourceError {\n");
        ...
        {
            return this.Equals(input as UnprocessableEntityExceptionResourceError);
        }

        /// <summary>
        /// Returns true if UnprocessableEntityExceptionResourceError instances are equal
        /// </summary>
        /// <param name="input">Instance of UnprocessableEntityExceptionResourceError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnprocessableEntityExceptionResourceError input)
        {
            if (input == null)
                return false;
