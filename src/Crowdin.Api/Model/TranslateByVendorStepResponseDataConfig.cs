...
{
    /// <summary>
    /// TranslateByVendorStepResponseDataConfig
    /// </summary>
    [DataContract(Name = "TranslateByVendorStepResponse_data_config")]
    public partial class TranslateByVendorStepResponseDataConfig : IEquatable<TranslateByVendorStepResponseDataConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateByVendorStepResponseDataConfig" /> class.
        /// </summary>
        /// <param name="vendorId">vendorId.</param>
        public TranslateByVendorStepResponseDataConfig(int vendorId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslateByVendorStepResponseDataConfig {\n");
        ...
        {
            return this.Equals(input as TranslateByVendorStepResponseDataConfig);
        }

        /// <summary>
        /// Returns true if TranslateByVendorStepResponseDataConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslateByVendorStepResponseDataConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslateByVendorStepResponseDataConfig input)
        {
            if (input == null)
                return false;
