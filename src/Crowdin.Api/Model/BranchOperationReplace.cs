...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BranchOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(BranchOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(BranchOperationTest), "test")]
    public partial class BranchOperationReplace : BranchOperation, IEquatable<BranchOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BranchOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;BranchOperationReplace&quot;).</param>
        ...
        public BranchOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "BranchOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for BranchOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BranchOperationReplace {\n");
        ...
        {
            return this.Equals(input as BranchOperationReplace);
        }

        /// <summary>
        /// Returns true if BranchOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchOperationReplace input)
        {
            if (input == null)
                return false;
