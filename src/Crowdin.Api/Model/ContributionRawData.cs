...
{
    /// <summary>
    /// Generate a raw contribution data
    /// </summary>
    [DataContract(Name = "ContributionRawData")]
    public partial class ContributionRawData : IEquatable<ContributionRawData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContributionRawData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContributionRawData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContributionRawData" /> class.
        /// </summary>
        /// <param name="name">contribution-raw-data (required).</param>
        /// <param name="schema">schema (required).</param>
        public ContributionRawData(string name = default(string), ContributionRawDataSchema schema = default(ContributionRawDataSchema))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for ContributionRawData and cannot be null");
            }
            this.Name = name;
            // to ensure "schema" is required (not null)
            if (schema == null) {
                throw new ArgumentNullException("schema is a required property for ContributionRawData and cannot be null");
            }
            this.Schema = schema;
        }
        ...
        /// </summary>
        /// <value>contribution-raw-data</value>
        ...
        public ContributionRawDataSchema Schema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContributionRawData {\n");
        ...
        {
            return this.Equals(input as ContributionRawData);
        }

        /// <summary>
        /// Returns true if ContributionRawData instances are equal
        /// </summary>
        /// <param name="input">Instance of ContributionRawData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContributionRawData input)
        {
            if (input == null)
                return false;
