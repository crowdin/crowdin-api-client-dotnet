...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectOperationTest")]
    ...
    public partial class ProjectOperationTest : ProjectInfoOperation, IEquatable<ProjectOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectOperationTest&quot;).</param>
        ...
        public ProjectOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "ProjectOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectOperationTest {\n");
        ...
        {
            return this.Equals(input as ProjectOperationTest);
        }

        /// <summary>
        /// Returns true if ProjectOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectOperationTest input)
        {
            if (input == null)
                return false;
