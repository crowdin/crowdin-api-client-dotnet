...
{
    /// <summary>
    /// QaCheck Statistic Collection Resource
    /// </summary>
    [DataContract(Name = "QaCheckStatisticCollectionResource")]
    public partial class QaCheckStatisticCollectionResource : IEquatable<QaCheckStatisticCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QaCheckStatisticCollectionResource" /> class.
        /// </summary>
        /// <param name="data">Class QaCheckStatisticCollectionResource.</param>
        /// <param name="pagination">pagination.</param>
        public QaCheckStatisticCollectionResource(List<QaCheckStatisticResource> data = default(List<QaCheckStatisticResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        /// <summary>
        /// Class QaCheckStatisticCollectionResource
        /// </summary>
        /// <value>Class QaCheckStatisticCollectionResource</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<QaCheckStatisticResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QaCheckStatisticCollectionResource {\n");
        ...
        {
            return this.Equals(input as QaCheckStatisticCollectionResource);
        }

        /// <summary>
        /// Returns true if QaCheckStatisticCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of QaCheckStatisticCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QaCheckStatisticCollectionResource input)
        {
            if (input == null)
                return false;
