...
namespace Crowdin.Api.Model
{
    ...
    public partial class Tm : IEquatable<Tm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="segmentsCount">segmentsCount.</param>
        /// <param name="defaultProjectId">defaultProjectId.</param>
        /// <param name="projectIds">projectIds.</param>
        /// <param name="createdAt">createdAt.</param>
        public Tm(int id = default(int), int userId = default(int), string name = default(string), List<string> languageIds = default(List<string>), int segmentsCount = default(int), int defaultProjectId = default(int), List<int> projectIds = default(List<int>), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.UserId = userId;
            this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets SegmentsCount
        /// </summary>
        [DataMember(Name = "segmentsCount", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as Tm);
        }

        /// <summary>
        /// Returns true if Tm instances are equal
        /// </summary>
        /// <param name="input">Instance of Tm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Tm input)
        {
            if (input == null)
                return false;
