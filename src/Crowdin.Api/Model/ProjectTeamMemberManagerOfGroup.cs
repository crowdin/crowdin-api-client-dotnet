...
{
    /// <summary>
    /// ProjectTeamMemberManagerOfGroup
    /// </summary>
    [DataContract(Name = "ProjectTeamMember_managerOfGroup")]
    public partial class ProjectTeamMemberManagerOfGroup : IEquatable<ProjectTeamMemberManagerOfGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTeamMemberManagerOfGroup" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public ProjectTeamMemberManagerOfGroup(int id = default(int), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectTeamMemberManagerOfGroup {\n");
        ...
        {
            return this.Equals(input as ProjectTeamMemberManagerOfGroup);
        }

        /// <summary>
        /// Returns true if ProjectTeamMemberManagerOfGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTeamMemberManagerOfGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTeamMemberManagerOfGroup input)
        {
            if (input == null)
                return false;
