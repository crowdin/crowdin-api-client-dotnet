...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GlossaryOperationTest")]
    ...
    public partial class GlossaryOperationTest : GlossaryOperation, IEquatable<GlossaryOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GlossaryOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;GlossaryOperationTest&quot;).</param>
        ...
        public GlossaryOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "GlossaryOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for GlossaryOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryOperationTest {\n");
        ...
        {
            return this.Equals(input as GlossaryOperationTest);
        }

        /// <summary>
        /// Returns true if GlossaryOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryOperationTest input)
        {
            if (input == null)
                return false;
