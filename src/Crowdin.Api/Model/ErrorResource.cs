...
namespace Crowdin.Api.Model
{
    ...
    /// ErrorResource
    /// </summary>
    [DataContract(Name = "ErrorResource")]
    public partial class ErrorResource : IEquatable<ErrorResource>, IValidatableObject
    {
        ...
        public ErrorResource(string key = default(string), List<AttributeError> errors = default(List<AttributeError>))
        {
            this.Key = key;
            this.Errors = errors;
        }
        ...
        public List<AttributeError> Errors { get; set; }
