...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinStringsBasedProjectCreateForm_notificationSettings")]
    public partial class CrowdinStringsBasedProjectCreateFormNotificationSettings : IEquatable<CrowdinStringsBasedProjectCreateFormNotificationSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinStringsBasedProjectCreateFormNotificationSettings" /> class.
        /// </summary>
        /// <param name="translatorNewStrings">Notify translators about new strings (default to false).</param>
        /// <param name="managerNewStrings">Notify project managers about new strings (default to false).</param>
        /// <param name="managerLanguageCompleted">Notify project managers about language translation/validation completion (default to false).</param>
        public CrowdinStringsBasedProjectCreateFormNotificationSettings(bool translatorNewStrings = false, bool managerNewStrings = false, bool managerLanguageCompleted = false)
        {
            this.TranslatorNewStrings = translatorNewStrings;
            this.ManagerNewStrings = managerNewStrings;
            this.ManagerLanguageCompleted = managerLanguageCompleted;
        }

        /// <summary>
        /// Notify translators about new strings
        /// </summary>
        /// <value>Notify translators about new strings</value>
        [DataMember(Name = "translatorNewStrings", EmitDefaultValue = true)]
        public bool TranslatorNewStrings { get; set; }

        /// <summary>
        /// Notify project managers about new strings
        /// </summary>
        /// <value>Notify project managers about new strings</value>
        [DataMember(Name = "managerNewStrings", EmitDefaultValue = true)]
        public bool ManagerNewStrings { get; set; }

        /// <summary>
        /// Notify project managers about language translation/validation completion
        /// </summary>
        /// <value>Notify project managers about language translation/validation completion</value>
        [DataMember(Name = "managerLanguageCompleted", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinStringsBasedProjectCreateFormNotificationSettings {\n");
            sb.Append("  TranslatorNewStrings: ").Append(TranslatorNewStrings).Append("\n");
            sb.Append("  ManagerNewStrings: ").Append(ManagerNewStrings).Append("\n");
            sb.Append("  ManagerLanguageCompleted: ").Append(ManagerLanguageCompleted).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as CrowdinStringsBasedProjectCreateFormNotificationSettings);
        }

        /// <summary>
        /// Returns true if CrowdinStringsBasedProjectCreateFormNotificationSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinStringsBasedProjectCreateFormNotificationSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinStringsBasedProjectCreateFormNotificationSettings input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TranslatorNewStrings == input.TranslatorNewStrings ||
                    this.TranslatorNewStrings.Equals(input.TranslatorNewStrings)
                ) && 
                (
                    this.ManagerNewStrings == input.ManagerNewStrings ||
                    this.ManagerNewStrings.Equals(input.ManagerNewStrings)
                ) && 
                (
                    this.ManagerLanguageCompleted == input.ManagerLanguageCompleted ||
                    this.ManagerLanguageCompleted.Equals(input.ManagerLanguageCompleted)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.TranslatorNewStrings.GetHashCode();
                hashCode = hashCode * 59 + this.ManagerNewStrings.GetHashCode();
                hashCode = hashCode * 59 + this.ManagerLanguageCompleted.GetHashCode();
                return hashCode;
            }
        }
