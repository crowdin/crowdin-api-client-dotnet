...
{
    /// <summary>
    /// ForbiddenExceptionResourceError
    /// </summary>
    [DataContract(Name = "ForbiddenExceptionResource_error")]
    public partial class ForbiddenExceptionResourceError : IEquatable<ForbiddenExceptionResourceError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForbiddenExceptionResourceError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public ForbiddenExceptionResourceError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForbiddenExceptionResourceError {\n");
        ...
        {
            return this.Equals(input as ForbiddenExceptionResourceError);
        }

        /// <summary>
        /// Returns true if ForbiddenExceptionResourceError instances are equal
        /// </summary>
        /// <param name="input">Instance of ForbiddenExceptionResourceError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForbiddenExceptionResourceError input)
        {
            if (input == null)
                return false;
