...
{
    /// <summary>
    /// CostEstimationFuzzyStepsTranslateRegularRates
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.steps.translate.regular-rates")]
    public partial class CostEstimationFuzzyStepsTranslateRegularRates : IEquatable<CostEstimationFuzzyStepsTranslateRegularRates>, IValidatableObject
    {
        /// <summary>
        /// perfect
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyStepsTranslateRegularRates" /> class.
        /// </summary>
        /// <param name="mode">perfect.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationFuzzyStepsTranslateRegularRates(ModeEnum? mode = default(ModeEnum?), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyStepsTranslateRegularRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyStepsTranslateRegularRates);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyStepsTranslateRegularRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyStepsTranslateRegularRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyStepsTranslateRegularRates input)
        {
            if (input == null)
                return false;
