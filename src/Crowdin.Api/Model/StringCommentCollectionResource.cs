...
{
    /// <summary>
    /// String Comment Collection Resource
    /// </summary>
    [DataContract(Name = "StringCommentCollectionResource")]
    public partial class StringCommentCollectionResource : IEquatable<StringCommentCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCommentCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public StringCommentCollectionResource(List<StringCommentResource> data = default(List<StringCommentResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<StringCommentResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringCommentCollectionResource {\n");
        ...
        {
            return this.Equals(input as StringCommentCollectionResource);
        }

        /// <summary>
        /// Returns true if StringCommentCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of StringCommentCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringCommentCollectionResource input)
        {
            if (input == null)
                return false;
