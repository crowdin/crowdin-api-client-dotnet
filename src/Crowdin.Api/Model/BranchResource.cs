...
namespace Crowdin.Api.Model
{
    ...
    /// Branch Resource
    /// </summary>
    [DataContract(Name = "BranchResource")]
    public partial class BranchResource : IEquatable<BranchResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public BranchResource(Branch data = default(Branch))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as BranchResource);
        }

        /// <summary>
        /// Returns true if BranchResource instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchResource input)
        {
            if (input == null)
                return false;
