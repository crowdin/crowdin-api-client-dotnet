...
{
    /// <summary>
    /// MtCredentialsCustomMt
    /// </summary>
    [DataContract(Name = "mt.credentials.custom_mt")]
    public partial class MtCredentialsCustomMt : IEquatable<MtCredentialsCustomMt>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentialsCustomMt" /> class.
        /// </summary>
        /// <param name="url">Base URL.</param>
        public MtCredentialsCustomMt(string url = default(string))
        {
            this.Url = url;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentialsCustomMt {\n");
        ...
        {
            return this.Equals(input as MtCredentialsCustomMt);
        }

        /// <summary>
        /// Returns true if MtCredentialsCustomMt instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentialsCustomMt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentialsCustomMt input)
        {
            if (input == null)
                return false;
