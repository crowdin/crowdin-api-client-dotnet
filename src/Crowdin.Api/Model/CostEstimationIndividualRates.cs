...
{
    /// <summary>
    /// CostEstimationIndividualRates
    /// </summary>
    [DataContract(Name = "cost-estimation.individual-rates")]
    public partial class CostEstimationIndividualRates : IEquatable<CostEstimationIndividualRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationIndividualRates" /> class.
        /// </summary>
        /// <param name="languageIds">Array of language ids.</param>
        /// <param name="rates">Class ReportCreateForm.</param>
        public CostEstimationIndividualRates(List<string> languageIds = default(List<string>), List<CostEstimationIndividualRateModes> rates = default(List<CostEstimationIndividualRateModes>))
        {
        ...
        public List<CostEstimationIndividualRateModes> Rates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationIndividualRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationIndividualRates);
        }

        /// <summary>
        /// Returns true if CostEstimationIndividualRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationIndividualRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationIndividualRates input)
        {
            if (input == null)
                return false;
