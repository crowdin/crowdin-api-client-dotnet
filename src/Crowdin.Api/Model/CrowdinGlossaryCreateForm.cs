...
{
    /// <summary>
    /// CrowdinGlossaryCreateForm
    /// </summary>
    [DataContract(Name = "CrowdinGlossaryCreateForm")]
    public partial class CrowdinGlossaryCreateForm : IEquatable<CrowdinGlossaryCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinGlossaryCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrowdinGlossaryCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinGlossaryCreateForm" /> class.
        /// </summary>
        /// <param name="name">Glossary name (required).</param>
        public CrowdinGlossaryCreateForm(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CrowdinGlossaryCreateForm and cannot be null");
            }
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinGlossaryCreateForm {\n");
        ...
        {
            return this.Equals(input as CrowdinGlossaryCreateForm);
        }

        /// <summary>
        /// Returns true if CrowdinGlossaryCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinGlossaryCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinGlossaryCreateForm input)
        {
            if (input == null)
                return false;
