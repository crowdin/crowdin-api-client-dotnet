...
namespace Crowdin.Api.Model
{
    ...
    /// User Resource
    /// </summary>
    [DataContract(Name = "CrowdinUserResource")]
    public partial class CrowdinUserResource : IEquatable<CrowdinUserResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinUserResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CrowdinUserResource(CrowdinUser data = default(CrowdinUser))
        {
            this.Data = data;
        }
        ...
        public CrowdinUser Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinUserResource {\n");
        ...
        {
            return this.Equals(input as CrowdinUserResource);
        }

        /// <summary>
        /// Returns true if CrowdinUserResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinUserResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinUserResource input)
        {
            if (input == null)
                return false;
