...
{
    /// <summary>
    /// CostEstimationStepsProofreadIndividualRates
    /// </summary>
    [DataContract(Name = "cost-estimation.steps.proofread.individual-rates")]
    public partial class CostEstimationStepsProofreadIndividualRates : IEquatable<CostEstimationStepsProofreadIndividualRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationStepsProofreadIndividualRates" /> class.
        /// </summary>
        /// <param name="languageIdsTo">Array of language ids.</param>
        /// <param name="rates">rates.</param>
        public CostEstimationStepsProofreadIndividualRates(List<string> languageIdsTo = default(List<string>), List<CostEstimationStepsProofreadIndividualRateModes> rates = default(List<CostEstimationStepsProofreadIndividualRateModes>))
        {
        ...
        public List<CostEstimationStepsProofreadIndividualRateModes> Rates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationStepsProofreadIndividualRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationStepsProofreadIndividualRates);
        }

        /// <summary>
        /// Returns true if CostEstimationStepsProofreadIndividualRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationStepsProofreadIndividualRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationStepsProofreadIndividualRates input)
        {
            if (input == null)
                return false;
