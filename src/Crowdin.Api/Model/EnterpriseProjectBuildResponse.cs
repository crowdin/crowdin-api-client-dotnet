...
{
    /// <summary>
    /// EnterpriseProjectBuildResponse
    /// </summary>
    [DataContract(Name = "EnterpriseProjectBuildResponse")]
    public partial class EnterpriseProjectBuildResponse : IEquatable<EnterpriseProjectBuildResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseProjectBuildResponse" /> class.
        /// </summary>
        ...
        public EnterpriseProjectBuildResponse(int id = default(int), int projectId = default(int), StatusEnum? status = default(StatusEnum?), int progress = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime finishedAt = default(DateTime), List<OneOfEnterpriseBuildAttributesResponseModelEnterprisePseudoBuildAttributesResponseModel> attributes = default(List<OneOfEnterpriseBuildAttributesResponseModelEnterprisePseudoBuildAttributesResponseModel>))
        {
            this.Id = id;
        ...
        public List<OneOfEnterpriseBuildAttributesResponseModelEnterprisePseudoBuildAttributesResponseModel> Attributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseProjectBuildResponse {\n");
        ...
        {
            return this.Equals(input as EnterpriseProjectBuildResponse);
        }

        /// <summary>
        /// Returns true if EnterpriseProjectBuildResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseProjectBuildResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseProjectBuildResponse input)
        {
            if (input == null)
                return false;
