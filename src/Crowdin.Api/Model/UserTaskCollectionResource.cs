...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserTaskCollectionResource")]
    public partial class UserTaskCollectionResource : IEquatable<UserTaskCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTaskCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public UserTaskCollectionResource(List<UserTaskResource> data = default(List<UserTaskResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<UserTaskResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserTaskCollectionResource {\n");
        ...
        {
            return this.Equals(input as UserTaskCollectionResource);
        }

        /// <summary>
        /// Returns true if UserTaskCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of UserTaskCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserTaskCollectionResource input)
        {
            if (input == null)
                return false;
