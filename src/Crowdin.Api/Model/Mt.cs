...
namespace Crowdin.Api.Model
{
    ...
    public partial class Mt : IEquatable<Mt>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Mt" /> class.
        /// </summary>
        ...
        public Mt(int id = default(int), int groupId = default(int), string name = default(string), string type = default(string), MtCredentials credentials = default(MtCredentials), List<int> projectIds = default(List<int>))
        {
            this.Id = id;
        ...
        public MtCredentials Credentials { get; set; }
        ...
        {
            return this.Equals(input as Mt);
        }

        /// <summary>
        /// Returns true if Mt instances are equal
        /// </summary>
        /// <param name="input">Instance of Mt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Mt input)
        {
            if (input == null)
                return false;
