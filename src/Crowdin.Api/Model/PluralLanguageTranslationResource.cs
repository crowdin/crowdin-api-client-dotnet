...
{
    /// <summary>
    /// Plural Language Translation Resource
    /// </summary>
    [DataContract(Name = "PluralLanguageTranslationResource")]
    public partial class PluralLanguageTranslationResource : IEquatable<PluralLanguageTranslationResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PluralLanguageTranslationResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PluralLanguageTranslationResource(PluralLanguageTranslation data = default(PluralLanguageTranslation))
        {
            this.Data = data;
        }
        ...
        public PluralLanguageTranslation Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PluralLanguageTranslationResource {\n");
        ...
        {
            return this.Equals(input as PluralLanguageTranslationResource);
        }

        /// <summary>
        /// Returns true if PluralLanguageTranslationResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PluralLanguageTranslationResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PluralLanguageTranslationResource input)
        {
            if (input == null)
                return false;
