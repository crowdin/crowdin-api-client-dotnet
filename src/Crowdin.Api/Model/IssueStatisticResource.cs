...
{
    /// <summary>
    /// Issue Statistic Resource
    /// </summary>
    [DataContract(Name = "IssueStatisticResource")]
    public partial class IssueStatisticResource : IEquatable<IssueStatisticResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueStatisticResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public IssueStatisticResource(IssueStatistic data = default(IssueStatistic))
        {
            this.Data = data;
        }
        ...
        public IssueStatistic Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IssueStatisticResource {\n");
        ...
        {
            return this.Equals(input as IssueStatisticResource);
        }

        /// <summary>
        /// Returns true if IssueStatisticResource instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueStatisticResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueStatisticResource input)
        {
            if (input == null)
                return false;
