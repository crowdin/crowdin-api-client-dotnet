...
{
    /// <summary>
    /// Project Placeholder Collection Resource
    /// </summary>
    [DataContract(Name = "ProjectPlaceholderCollectionResource")]
    public partial class ProjectPlaceholderCollectionResource : IEquatable<ProjectPlaceholderCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectPlaceholderCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public ProjectPlaceholderCollectionResource(List<ProjectPlaceholderResource> data = default(List<ProjectPlaceholderResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<ProjectPlaceholderResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectPlaceholderCollectionResource {\n");
        ...
        {
            return this.Equals(input as ProjectPlaceholderCollectionResource);
        }

        /// <summary>
        /// Returns true if ProjectPlaceholderCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectPlaceholderCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectPlaceholderCollectionResource input)
        {
            if (input == null)
                return false;
