...
namespace Crowdin.Api.Model
{
    ...
    /// WorkflowTemplate
    /// </summary>
    [DataContract(Name = "WorkflowTemplate")]
    public partial class WorkflowTemplate : IEquatable<WorkflowTemplate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTemplate" /> class.
        /// </summary>
        ...
        public WorkflowTemplate(int id = default(int), string title = default(string), string description = default(string), int groupId = default(int), bool isDefault = default(bool))
        {
            this.Id = id;
            this.Title = title;
        ...
        {
            return this.Equals(input as WorkflowTemplate);
        }

        /// <summary>
        /// Returns true if WorkflowTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowTemplate input)
        {
            if (input == null)
                return false;
