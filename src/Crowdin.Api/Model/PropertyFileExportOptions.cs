...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PropertyFileExportOptions")]
    public partial class PropertyFileExportOptions : IEquatable<PropertyFileExportOptions>, IValidatableObject
    {
        /// <summary>
        /// Values available:  *              0 - Do not escape single quote  *              1 - Escape single quote by another single quote  *              2 - Escape single quote by a backslash  *              3 - Escape single quote by another single quote only in strings containing variables (&#x60;{0}&#x60;)
        /// </summary>
        /// <value>Values available:  *              0 - Do not escape single quote  *              1 - Escape single quote by another single quote  *              2 - Escape single quote by a backslash  *              3 - Escape single quote by another single quote only in strings containing variables (&#x60;{0}&#x60;)</value>
        public enum EscapeQuotesEnum
        {
            /// <summary>
        ...
        /// </summary>
        /// <value>Values available:  *              0 - Do not escape single quote  *              1 - Escape single quote by another single quote  *              2 - Escape single quote by a backslash  *              3 - Escape single quote by another single quote only in strings containing variables (&#x60;{0}&#x60;)</value>
        [DataMember(Name = "escapeQuotes", EmitDefaultValue = false)]
        public EscapeQuotesEnum? EscapeQuotes { get; set; }
        /// <summary>
        /// Defines whether any special characters (&#x3D;, :, ! and #) should be escaped by backslash in exported translations. You can add escape_special_characters per-file option.  * * Acceptable values are: 0, 1. Default is 0.  *              0 - Do not escape special characters  *              1 - Escape special characters by a backslash
        /// </summary>
        /// <value>Defines whether any special characters (&#x3D;, :, ! and #) should be escaped by backslash in exported translations. You can add escape_special_characters per-file option.  * * Acceptable values are: 0, 1. Default is 0.  *              0 - Do not escape special characters  *              1 - Escape special characters by a backslash</value>
        public enum EscapeSpecialCharactersEnum
        {
            /// <summary>
            /// Enum NUMBER_0 for value: 0
            /// </summary>
        ...
        /// </summary>
        /// <value>Defines whether any special characters (&#x3D;, :, ! and #) should be escaped by backslash in exported translations. You can add escape_special_characters per-file option.  * * Acceptable values are: 0, 1. Default is 0.  *              0 - Do not escape special characters  *              1 - Escape special characters by a backslash</value>
        [DataMember(Name = "escapeSpecialCharacters", EmitDefaultValue = false)]
        public EscapeSpecialCharactersEnum? EscapeSpecialCharacters { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyFileExportOptions" /> class.
        /// </summary>
        /// <param name="escapeQuotes">Values available:  *              0 - Do not escape single quote  *              1 - Escape single quote by another single quote  *              2 - Escape single quote by a backslash  *              3 - Escape single quote by another single quote only in strings containing variables (&#x60;{0}&#x60;).</param>
        /// <param name="escapeSpecialCharacters">Defines whether any special characters (&#x3D;, :, ! and #) should be escaped by backslash in exported translations. You can add escape_special_characters per-file option.  * * Acceptable values are: 0, 1. Default is 0.  *              0 - Do not escape special characters  *              1 - Escape special characters by a backslash.</param>
        /// <param name="exportPattern">File export pattern. Defines file name and path in resulting translations bundle  __Note:__ Can&#39;t contain &#x60;: * ? \&quot; &lt; &gt; |&#x60; symbols.</param>
        public PropertyFileExportOptions(EscapeQuotesEnum? escapeQuotes = default(EscapeQuotesEnum?), EscapeSpecialCharactersEnum? escapeSpecialCharacters = default(EscapeSpecialCharactersEnum?), string exportPattern = default(string))
        {
        ...
        /// <summary>
        /// File export pattern. Defines file name and path in resulting translations bundle  __Note:__ Can&#39;t contain &#x60;: * ? \&quot; &lt; &gt; |&#x60; symbols
        /// </summary>
        /// <value>File export pattern. Defines file name and path in resulting translations bundle  __Note:__ Can&#39;t contain &#x60;: * ? \&quot; &lt; &gt; |&#x60; symbols</value>
        [DataMember(Name = "exportPattern", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PropertyFileExportOptions {\n");
        ...
        {
            return this.Equals(input as PropertyFileExportOptions);
        }

        /// <summary>
        /// Returns true if PropertyFileExportOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyFileExportOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyFileExportOptions input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.EscapeQuotes == input.EscapeQuotes ||
                    this.EscapeQuotes.Equals(input.EscapeQuotes)
                ) && 
                (
                    this.EscapeSpecialCharacters == input.EscapeSpecialCharacters ||
                    this.EscapeSpecialCharacters.Equals(input.EscapeSpecialCharacters)
                ) && 
                (
                    this.ExportPattern == input.ExportPattern ||
                    (this.ExportPattern != null &&
                    this.ExportPattern.Equals(input.ExportPattern))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.EscapeQuotes.GetHashCode();
                hashCode = hashCode * 59 + this.EscapeSpecialCharacters.GetHashCode();
                if (this.ExportPattern != null)
                    hashCode = hashCode * 59 + this.ExportPattern.GetHashCode();
                return hashCode;
            }
        }
