...
{
    /// <summary>
    /// EnterpriseMtCreateForm
    /// </summary>
    [DataContract(Name = "EnterpriseMtCreateForm")]
    public partial class EnterpriseMtCreateForm : IEquatable<EnterpriseMtCreateForm>, IValidatableObject
    {
        /// <summary>
        /// MT engine type
        /// </summary>
        /// <value>MT engine type</value>
        ...
        public enum TypeEnum
        {
            ...
            /// <summary>
            /// Enum GoogleAutoml for value: google_automl
            /// </summary>
            [EnumMember(Value = "google_automl")]
            GoogleAutoml = 2,
            ...
            /// <summary>
            /// Enum Watson for value: watson
            /// </summary>
            [EnumMember(Value = "watson")]
            Watson = 7,

            /// <summary>
            /// Enum Modernmt for value: modernmt
            /// </summary>
            [EnumMember(Value = "modernmt")]
            Modernmt = 8,

            /// <summary>
            /// Enum CustomMt for value: custom_mt
            /// </summary>
            [EnumMember(Value = "custom_mt")]
            CustomMt = 9
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseMtCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnterpriseMtCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseMtCreateForm" /> class.
        /// </summary>
        /// <param name="name">Machine Translation engine name (required).</param>
        /// <param name="type">MT engine type (required).</param>
        /// <param name="credentials">MT engine credentials (required).</param>
        /// <param name="groupId">Group Identifier – defines group to which MT is added. Get via [List Groups](#operation/api.groups.getMany)  If &#39;0&#39; – MT will be available for all projects and groups in your workspace (default to 0).</param>
        public EnterpriseMtCreateForm(string name = default(string), TypeEnum type = default(TypeEnum), OneOfmtCredentialsGooglemtCredentialsGoogleAutomlmtCredentialsMicrosoftmtCredentialsYandexmtCredentialsDeeplmtCredentialsWatsonmtCredentialsAmazonmtCredentialsModernmtmtCredentialsCustomMt credentials = default(OneOfmtCredentialsGooglemtCredentialsGoogleAutomlmtCredentialsMicrosoftmtCredentialsYandexmtCredentialsDeeplmtCredentialsWatsonmtCredentialsAmazonmtCredentialsModernmtmtCredentialsCustomMt), int groupId = 0)
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for EnterpriseMtCreateForm and cannot be null");
            }
            this.Name = name;
            this.Type = type;
            // to ensure "credentials" is required (not null)
            if (credentials == null) {
                throw new ArgumentNullException("credentials is a required property for EnterpriseMtCreateForm and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Machine Translation engine name</value>
        ...
        /// </summary>
        /// <value>MT engine credentials</value>
        [DataMember(Name = "credentials", IsRequired = true, EmitDefaultValue = true)]
        public OneOfmtCredentialsGooglemtCredentialsGoogleAutomlmtCredentialsMicrosoftmtCredentialsYandexmtCredentialsDeeplmtCredentialsWatsonmtCredentialsAmazonmtCredentialsModernmtmtCredentialsCustomMt Credentials { get; set; }

        /// <summary>
        /// Group Identifier – defines group to which MT is added. Get via [List Groups](#operation/api.groups.getMany)  If &#39;0&#39; – MT will be available for all projects and groups in your workspace
        /// </summary>
        /// <value>Group Identifier – defines group to which MT is added. Get via [List Groups](#operation/api.groups.getMany)  If &#39;0&#39; – MT will be available for all projects and groups in your workspace</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseMtCreateForm {\n");
        ...
        {
            return this.Equals(input as EnterpriseMtCreateForm);
        }

        /// <summary>
        /// Returns true if EnterpriseMtCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseMtCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseMtCreateForm input)
        {
            if (input == null)
                return false;
