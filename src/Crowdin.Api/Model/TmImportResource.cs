...
namespace Crowdin.Api.Model
{
    ...
    /// Tm Import Resource
    /// </summary>
    [DataContract(Name = "TmImportResource")]
    public partial class TmImportResource : IEquatable<TmImportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmImportResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TmImportResource(TmImport data = default(TmImport))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmImportResource {\n");
        ...
        {
            return this.Equals(input as TmImportResource);
        }

        /// <summary>
        /// Returns true if TmImportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TmImportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmImportResource input)
        {
            if (input == null)
                return false;
