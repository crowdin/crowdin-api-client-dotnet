...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnterpriseTranslationCreateProjectBuildForm")]
    public partial class EnterpriseTranslationCreateProjectBuildForm : IEquatable<EnterpriseTranslationCreateProjectBuildForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTranslationCreateProjectBuildForm" /> class.
        /// </summary>
        /// <param name="branchId">Branch Identifier. Get via [List Branches](#operation/api.projects.branches.getMany).</param>
        /// <param name="targetLanguageIds">Specify target languages for build. Get via [List Supported Languages](#operation/api.languages.getMany)  Leave this field empty to build all target languages.</param>
        /// <param name="skipUntranslatedStrings">Defines whether to export only translated strings  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedFiles&#x3D;true&#x60; in same request.</param>
        ...
        public EnterpriseTranslationCreateProjectBuildForm(int branchId = default(int), List<string> targetLanguageIds = default(List<string>), bool skipUntranslatedStrings = default(bool), bool skipUntranslatedFiles = default(bool), int exportWithMinApprovalsCount = default(int))
        {
        ...
        /// <summary>
        /// Branch Identifier. Get via [List Branches](#operation/api.projects.branches.getMany)
        /// </summary>
        /// <value>Branch Identifier. Get via [List Branches](#operation/api.projects.branches.getMany)</value>
        [DataMember(Name = "branchId", EmitDefaultValue = false)]
        public int BranchId { get; set; }

        /// <summary>
        /// Specify target languages for build. Get via [List Supported Languages](#operation/api.languages.getMany)  Leave this field empty to build all target languages
        /// </summary>
        /// <value>Specify target languages for build. Get via [List Supported Languages](#operation/api.languages.getMany)  Leave this field empty to build all target languages</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTranslationCreateProjectBuildForm {\n");
        ...
        {
            return this.Equals(input as EnterpriseTranslationCreateProjectBuildForm);
        }

        /// <summary>
        /// Returns true if EnterpriseTranslationCreateProjectBuildForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTranslationCreateProjectBuildForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTranslationCreateProjectBuildForm input)
        {
            if (input == null)
                return false;
