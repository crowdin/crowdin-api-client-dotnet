...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkflowStepCollectionResource")]
    public partial class WorkflowStepCollectionResource : IEquatable<WorkflowStepCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowStepCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public WorkflowStepCollectionResource(List<WorkflowStepResource> data = default(List<WorkflowStepResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<WorkflowStepResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkflowStepCollectionResource {\n");
        ...
        {
            return this.Equals(input as WorkflowStepCollectionResource);
        }

        /// <summary>
        /// Returns true if WorkflowStepCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowStepCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowStepCollectionResource input)
        {
            if (input == null)
                return false;
