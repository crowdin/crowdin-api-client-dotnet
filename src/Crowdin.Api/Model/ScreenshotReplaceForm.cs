...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScreenshotReplaceForm")]
    public partial class ScreenshotReplaceForm : IEquatable<ScreenshotReplaceForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotReplaceForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScreenshotReplaceForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotReplaceForm" /> class.
        /// </summary>
        ...
        public ScreenshotReplaceForm(int storageId = default(int), string name = default(string))
        {
            this.StorageId = storageId;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for ScreenshotReplaceForm and cannot be null");
            }
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScreenshotReplaceForm {\n");
        ...
        {
            return this.Equals(input as ScreenshotReplaceForm);
        }

        /// <summary>
        /// Returns true if ScreenshotReplaceForm instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotReplaceForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotReplaceForm input)
        {
            if (input == null)
                return false;
