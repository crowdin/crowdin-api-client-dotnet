...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslationUploadForm")]
    public partial class TranslationUploadForm : IEquatable<TranslationUploadForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationUploadForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranslationUploadForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationUploadForm" /> class.
        /// </summary>
        ...
        public TranslationUploadForm(int storageId = default(int), int fileId = default(int), bool importEqSuggestions = false, bool autoApproveImported = false, bool translateHidden = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationUploadForm {\n");
        ...
        {
            return this.Equals(input as TranslationUploadForm);
        }

        /// <summary>
        /// Returns true if TranslationUploadForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationUploadForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationUploadForm input)
        {
            if (input == null)
                return false;
