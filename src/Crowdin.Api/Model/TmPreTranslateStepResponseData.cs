...
{
    /// <summary>
    /// TmPreTranslateStepResponseData
    /// </summary>
    [DataContract(Name = "TmPreTranslateStepResponse_data")]
    public partial class TmPreTranslateStepResponseData : IEquatable<TmPreTranslateStepResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmPreTranslateStepResponseData" /> class.
        /// </summary>
        ...
        public TmPreTranslateStepResponseData(int id = default(int), string title = default(string), string type = default(string), List<string> languages = default(List<string>), TmPreTranslateStepResponseDataConfig config = default(TmPreTranslateStepResponseDataConfig))
        {
            this.Id = id;
            this.Title = title;
            this.Type = type;
        ...
        public TmPreTranslateStepResponseDataConfig Config { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmPreTranslateStepResponseData {\n");
        ...
        {
            return this.Equals(input as TmPreTranslateStepResponseData);
        }

        /// <summary>
        /// Returns true if TmPreTranslateStepResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of TmPreTranslateStepResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmPreTranslateStepResponseData input)
        {
            if (input == null)
                return false;
