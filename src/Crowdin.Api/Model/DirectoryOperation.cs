...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DirectoryOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(DirectoryOperationReplace), "DirectoryOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(DirectoryOperationTest), "DirectoryOperationTest")]
    ...
    public partial class DirectoryOperation : IEquatable<DirectoryOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum PathEnum
        {
            ...
            /// <summary>
            /// Enum ExportPattern for value: /exportPattern
            /// </summary>
            [EnumMember(Value = "/exportPattern")]
            ExportPattern = 5,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryOperation" /> class.
        /// </summary>
        ...
        public DirectoryOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DirectoryOperation {\n");
        ...
        {
            return this.Equals(input as DirectoryOperation);
        }

        /// <summary>
        /// Returns true if DirectoryOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of DirectoryOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DirectoryOperation input)
        {
            if (input == null)
                return false;
