...
{
    /// <summary>
    /// CrowdinPseudoBuildAttributesResponseModel
    /// </summary>
    [DataContract(Name = "CrowdinPseudoBuildAttributesResponseModel")]
    public partial class CrowdinPseudoBuildAttributesResponseModel : IEquatable<CrowdinPseudoBuildAttributesResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinPseudoBuildAttributesResponseModel" /> class.
        /// </summary>
        ...
        public CrowdinPseudoBuildAttributesResponseModel(bool pseudo = default(bool), string prefix = default(string), string suffix = default(string), int lengthTransformation = default(int), string charTransformation = default(string))
        {
            this.Pseudo = pseudo;
            this.Prefix = prefix;
            this.Suffix = suffix;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinPseudoBuildAttributesResponseModel {\n");
        ...
        {
            return this.Equals(input as CrowdinPseudoBuildAttributesResponseModel);
        }

        /// <summary>
        /// Returns true if CrowdinPseudoBuildAttributesResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinPseudoBuildAttributesResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinPseudoBuildAttributesResponseModel input)
        {
            if (input == null)
                return false;
