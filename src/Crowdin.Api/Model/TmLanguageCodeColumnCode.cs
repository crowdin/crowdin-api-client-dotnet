...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TmLanguageCodeColumnCode")]
    public partial class TmLanguageCodeColumnCode : IEquatable<TmLanguageCodeColumnCode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmLanguageCodeColumnCode" /> class.
        /// </summary>
        /// <param name="columnNumber">columnNumber.</param>
        public TmLanguageCodeColumnCode(int columnNumber = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmLanguageCodeColumnCode {\n");
        ...
        {
            return this.Equals(input as TmLanguageCodeColumnCode);
        }

        /// <summary>
        /// Returns true if TmLanguageCodeColumnCode instances are equal
        /// </summary>
        /// <param name="input">Instance of TmLanguageCodeColumnCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmLanguageCodeColumnCode input)
        {
            if (input == null)
                return false;
