...
{
    /// <summary>
    /// A list of Translations for a String.
    /// </summary>
    [DataContract(Name = "TranslationCollectionResource")]
    public partial class TranslationCollectionResource : IEquatable<TranslationCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public TranslationCollectionResource(List<TranslationResource> data = default(List<TranslationResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<TranslationResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCollectionResource {\n");
        ...
        {
            return this.Equals(input as TranslationCollectionResource);
        }

        /// <summary>
        /// Returns true if TranslationCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCollectionResource input)
        {
            if (input == null)
                return false;
