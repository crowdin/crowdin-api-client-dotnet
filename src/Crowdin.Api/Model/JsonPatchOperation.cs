...
namespace Crowdin.Api.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(JsonPatchAdd), "JsonPatchAdd")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchCopy), "JsonPatchCopy")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchMove), "JsonPatchMove")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchRemove), "JsonPatchRemove")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchReplace), "JsonPatchReplace")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchTest), "JsonPatchTest")]
    ...
    public partial class JsonPatchOperation : IEquatable<JsonPatchOperation>, IValidatableObject
    {
        ...
        public JsonPatchOperation(OpEnum op = default(OpEnum), string path = default(string))
        {
            this.Op = op;
            // to ensure "path" is required (not null)
            if (path == null) {
                throw new ArgumentNullException("path is a required property for JsonPatchOperation and cannot be null");
            }
            this.Path = path;
        }
