...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChannelSubscriptionCollectionResource")]
    public partial class ChannelSubscriptionCollectionResource : IEquatable<ChannelSubscriptionCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelSubscriptionCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ChannelSubscriptionCollectionResource(List<ChannelSubscriptionResource> data = default(List<ChannelSubscriptionResource>))
        {
            this.Data = data;
        }
        ...
        public List<ChannelSubscriptionResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChannelSubscriptionCollectionResource {\n");
        ...
        {
            return this.Equals(input as ChannelSubscriptionCollectionResource);
        }

        /// <summary>
        /// Returns true if ChannelSubscriptionCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ChannelSubscriptionCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChannelSubscriptionCollectionResource input)
        {
            if (input == null)
                return false;
