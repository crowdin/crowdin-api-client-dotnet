...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomPlaceholderResource")]
    public partial class CustomPlaceholderResource : IEquatable<CustomPlaceholderResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholderResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CustomPlaceholderResource(CustomPlaceholder data = default(CustomPlaceholder))
        {
            this.Data = data;
        }
        ...
        public CustomPlaceholder Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomPlaceholderResource {\n");
        ...
        {
            return this.Equals(input as CustomPlaceholderResource);
        }

        /// <summary>
        /// Returns true if CustomPlaceholderResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomPlaceholderResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomPlaceholderResource input)
        {
            if (input == null)
                return false;
