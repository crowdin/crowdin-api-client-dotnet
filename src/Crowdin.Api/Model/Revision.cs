...
namespace Crowdin.Api.Model
{
    ...
    public partial class Revision : IEquatable<Revision>, IValidatableObject
    {
        ...
        /// <param name="restoreToRevision">restoreToRevision.</param>
        /// <param name="info">info.</param>
        /// <param name="date">date.</param>
        public Revision(int id = default(int), int projectId = default(int), int fileId = default(int), int? restoreToRevision = default(int?), RevisionInfo info = default(RevisionInfo), DateTime date = default(DateTime))
        {
            this.Id = id;
            this.ProjectId = projectId;
            this.FileId = fileId;
            this.RestoreToRevision = restoreToRevision;
            this.Info = info;
            this.Date = date;
        }
        ...
        /// <summary>
        /// Gets or Sets RestoreToRevision
        /// </summary>
        [DataMember(Name = "restoreToRevision", EmitDefaultValue = true)]
        ...
        public RevisionInfo Info { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RestoreToRevision: ").Append(RestoreToRevision).Append("\n");
        ...
        public bool Equals(Revision input)
        {
            ...
            return 
                ...
                (
                    this.RestoreToRevision == input.RestoreToRevision ||
                    (this.RestoreToRevision != null &&
                    this.RestoreToRevision.Equals(input.RestoreToRevision))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RestoreToRevision != null)
                    hashCode = hashCode * 59 + this.RestoreToRevision.GetHashCode();
                if (this.Info != null)
