...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserTaskOperation")]
    public partial class UserTaskOperation : IEquatable<UserTaskOperation>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum IsArchived for value: /isArchived
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTaskOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UserTaskOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTaskOperation" /> class.
        /// </summary>
        ...
        /// <param name="value">Acceptable values: &#x60;true&#x60; – archive task, or &#x60;false&#x60; – move a task from archived to a list of all tasks. (required) (default to true).</param>
        public UserTaskOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum), bool value = true)
        {
            this.Op = op;
            this.Path = path;
            this.Value = value;
        ...
        /// <summary>
        /// Acceptable values: &#x60;true&#x60; – archive task, or &#x60;false&#x60; – move a task from archived to a list of all tasks.
        /// </summary>
        /// <value>Acceptable values: &#x60;true&#x60; – archive task, or &#x60;false&#x60; – move a task from archived to a list of all tasks.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserTaskOperation {\n");
        ...
        {
            return this.Equals(input as UserTaskOperation);
        }

        /// <summary>
        /// Returns true if UserTaskOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of UserTaskOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserTaskOperation input)
        {
            if (input == null)
                return false;
