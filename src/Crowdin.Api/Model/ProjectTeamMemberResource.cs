...
{
    /// <summary>
    /// Project Team Member Resource
    /// </summary>
    [DataContract(Name = "ProjectTeamMemberResource")]
    public partial class ProjectTeamMemberResource : IEquatable<ProjectTeamMemberResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTeamMemberResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ProjectTeamMemberResource(ProjectTeamMember data = default(ProjectTeamMember))
        {
            this.Data = data;
        }
        ...
        public ProjectTeamMember Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectTeamMemberResource {\n");
        ...
        {
            return this.Equals(input as ProjectTeamMemberResource);
        }

        /// <summary>
        /// Returns true if ProjectTeamMemberResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTeamMemberResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTeamMemberResource input)
        {
            if (input == null)
                return false;
