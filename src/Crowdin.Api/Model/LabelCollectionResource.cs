...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LabelCollectionResource")]
    public partial class LabelCollectionResource : IEquatable<LabelCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public LabelCollectionResource(List<LabelResource> data = default(List<LabelResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<LabelResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LabelCollectionResource {\n");
        ...
        {
            return this.Equals(input as LabelCollectionResource);
        }

        /// <summary>
        /// Returns true if LabelCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelCollectionResource input)
        {
            if (input == null)
                return false;
