...
{
    /// <summary>
    /// CrowdinStringsBasedProjectCreateForm
    /// </summary>
    [DataContract(Name = "CrowdinStringsBasedProjectCreateForm")]
    public partial class CrowdinStringsBasedProjectCreateForm : IEquatable<CrowdinStringsBasedProjectCreateForm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinStringsBasedProjectCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrowdinStringsBasedProjectCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinStringsBasedProjectCreateForm" /> class.
        /// </summary>
        ...
        public CrowdinStringsBasedProjectCreateFormNotificationSettings NotificationSettings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinStringsBasedProjectCreateForm {\n");
        ...
        {
            return this.Equals(input as CrowdinStringsBasedProjectCreateForm);
        }

        /// <summary>
        /// Returns true if CrowdinStringsBasedProjectCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinStringsBasedProjectCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinStringsBasedProjectCreateForm input)
        {
            if (input == null)
                return false;
