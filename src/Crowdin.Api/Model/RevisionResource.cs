...
{
    /// <summary>
    /// File Revision Resource
    /// </summary>
    [DataContract(Name = "RevisionResource")]
    public partial class RevisionResource : IEquatable<RevisionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RevisionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public RevisionResource(Revision data = default(Revision))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RevisionResource {\n");
        ...
        {
            return this.Equals(input as RevisionResource);
        }

        /// <summary>
        /// Returns true if RevisionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of RevisionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RevisionResource input)
        {
            if (input == null)
                return false;
