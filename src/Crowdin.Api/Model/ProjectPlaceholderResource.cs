...
{
    /// <summary>
    /// Project Placeholder Resource
    /// </summary>
    [DataContract(Name = "ProjectPlaceholderResource")]
    public partial class ProjectPlaceholderResource : IEquatable<ProjectPlaceholderResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectPlaceholderResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ProjectPlaceholderResource(ProjectPlaceholderResponse data = default(ProjectPlaceholderResponse))
        {
            this.Data = data;
        }
        ...
        public ProjectPlaceholderResponse Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectPlaceholderResource {\n");
        ...
        {
            return this.Equals(input as ProjectPlaceholderResource);
        }

        /// <summary>
        /// Returns true if ProjectPlaceholderResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectPlaceholderResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectPlaceholderResource input)
        {
            if (input == null)
                return false;
