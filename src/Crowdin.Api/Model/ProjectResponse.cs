...
namespace Crowdin.Api.Model
{
    ...
    public partial class ProjectResponse : IEquatable<ProjectResponse>, IValidatableObject
    {
        ...
        public ProjectResponse(int id = default(int), int userId = default(int), string sourceLanguageId = default(string), List<string> targetLanguageIds = default(List<string>), string languageAccessPolicy = default(string), string name = default(string), string cname = default(string), string identifier = default(string), string description = default(string), string visibility = default(string), string logo = default(string), bool publicDownloads = default(bool), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime lastActivity = default(DateTime), List<Language> targetLanguages = default(List<Language>))
        {
            this.Id = id;
            this.UserId = userId;
