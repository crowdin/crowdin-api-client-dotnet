...
{
    /// <summary>
    /// EnterpriseDirectoryBuildResponse
    /// </summary>
    [DataContract(Name = "EnterpriseDirectoryBuildResponse")]
    public partial class EnterpriseDirectoryBuildResponse : IEquatable<EnterpriseDirectoryBuildResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseDirectoryBuildResponse" /> class.
        /// </summary>
        ...
        public EnterpriseDirectoryBuildResponse(int id = default(int), int projectId = default(int), StatusEnum? status = default(StatusEnum?), int progress = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime finishedAt = default(DateTime))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseDirectoryBuildResponse {\n");
        ...
        {
            return this.Equals(input as EnterpriseDirectoryBuildResponse);
        }

        /// <summary>
        /// Returns true if EnterpriseDirectoryBuildResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseDirectoryBuildResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseDirectoryBuildResponse input)
        {
            if (input == null)
                return false;
