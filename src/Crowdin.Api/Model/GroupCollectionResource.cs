...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupCollectionResource")]
    public partial class GroupCollectionResource : IEquatable<GroupCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public GroupCollectionResource(List<GroupResource> data = default(List<GroupResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<GroupResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupCollectionResource {\n");
        ...
        {
            return this.Equals(input as GroupCollectionResource);
        }

        /// <summary>
        /// Returns true if GroupCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupCollectionResource input)
        {
            if (input == null)
                return false;
