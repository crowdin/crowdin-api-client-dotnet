...
namespace Crowdin.Api.Model
{
    ...
    /// LogoUploadForm
    /// </summary>
    [DataContract(Name = "LogoUploadForm")]
    public partial class LogoUploadForm : IEquatable<LogoUploadForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LogoUploadForm" /> class.
        /// </summary>
        ...
        public LogoUploadForm(int storageId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LogoUploadForm {\n");
        ...
        {
            return this.Equals(input as LogoUploadForm);
        }

        /// <summary>
        /// Returns true if LogoUploadForm instances are equal
        /// </summary>
        /// <param name="input">Instance of LogoUploadForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogoUploadForm input)
        {
            if (input == null)
                return false;
