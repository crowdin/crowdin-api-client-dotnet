...
{
    /// <summary>
    /// Translation Vote Resource
    /// </summary>
    [DataContract(Name = "TranslationVoteResource")]
    public partial class TranslationVoteResource : IEquatable<TranslationVoteResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationVoteResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TranslationVoteResource(Vote data = default(Vote))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationVoteResource {\n");
        ...
        {
            return this.Equals(input as TranslationVoteResource);
        }

        /// <summary>
        /// Returns true if TranslationVoteResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationVoteResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationVoteResource input)
        {
            if (input == null)
                return false;
