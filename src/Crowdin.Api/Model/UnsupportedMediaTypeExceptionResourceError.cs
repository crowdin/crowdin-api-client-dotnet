...
{
    /// <summary>
    /// UnsupportedMediaTypeExceptionResourceError
    /// </summary>
    [DataContract(Name = "UnsupportedMediaTypeExceptionResource_error")]
    public partial class UnsupportedMediaTypeExceptionResourceError : IEquatable<UnsupportedMediaTypeExceptionResourceError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnsupportedMediaTypeExceptionResourceError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public UnsupportedMediaTypeExceptionResourceError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnsupportedMediaTypeExceptionResourceError {\n");
        ...
        {
            return this.Equals(input as UnsupportedMediaTypeExceptionResourceError);
        }

        /// <summary>
        /// Returns true if UnsupportedMediaTypeExceptionResourceError instances are equal
        /// </summary>
        /// <param name="input">Instance of UnsupportedMediaTypeExceptionResourceError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnsupportedMediaTypeExceptionResourceError input)
        {
            if (input == null)
                return false;
