...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScreenshotOperationTest")]
    ...
    public partial class ScreenshotOperationTest : ScreenshotOperation, IEquatable<ScreenshotOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScreenshotOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ScreenshotOperationTest&quot;).</param>
        ...
        public ScreenshotOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "ScreenshotOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ScreenshotOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScreenshotOperationTest {\n");
        ...
        {
            return this.Equals(input as ScreenshotOperationTest);
        }

        /// <summary>
        /// Returns true if ScreenshotOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotOperationTest input)
        {
            if (input == null)
                return false;
