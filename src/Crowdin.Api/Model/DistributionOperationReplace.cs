...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DistributionOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(DistributionOperationReplace), "replace")]
    public partial class DistributionOperationReplace : DistributionOperation, IEquatable<DistributionOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DistributionOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;DistributionOperationReplace&quot;).</param>
        ...
        public DistributionOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "DistributionOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for DistributionOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionOperationReplace {\n");
        ...
        {
            return this.Equals(input as DistributionOperationReplace);
        }

        /// <summary>
        /// Returns true if DistributionOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionOperationReplace input)
        {
            if (input == null)
                return false;
