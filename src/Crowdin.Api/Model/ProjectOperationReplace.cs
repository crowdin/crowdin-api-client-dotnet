...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(ProjectOperationAdd), "add")]
    [JsonSubtypes.KnownSubType(typeof(ProjectOperationRemove), "remove")]
    [JsonSubtypes.KnownSubType(typeof(ProjectOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(ProjectOperationTest), "test")]
    public partial class ProjectOperationReplace : ProjectInfoOperation, IEquatable<ProjectOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectOperationReplace&quot;).</param>
        ...
        public ProjectOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "ProjectOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectOperationReplace {\n");
        ...
        {
            return this.Equals(input as ProjectOperationReplace);
        }

        /// <summary>
        /// Returns true if ProjectOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectOperationReplace input)
        {
            if (input == null)
                return false;
