...
namespace Crowdin.Api.Model
{
    ...
    /// Label Resource
    /// </summary>
    [DataContract(Name = "LabelResource")]
    public partial class LabelResource : IEquatable<LabelResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public LabelResource(Label data = default(Label))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as LabelResource);
        }

        /// <summary>
        /// Returns true if LabelResource instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelResource input)
        {
            if (input == null)
                return false;
