...
{
    /// <summary>
    /// CostEstimationStepsTranslateRegularRates
    /// </summary>
    [DataContract(Name = "cost-estimation.steps.translate.regular-rates")]
    public partial class CostEstimationStepsTranslateRegularRates : IEquatable<CostEstimationStepsTranslateRegularRates>, IValidatableObject
    {
        /// <summary>
        /// tm_match
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationStepsTranslateRegularRates" /> class.
        /// </summary>
        /// <param name="mode">tm_match.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationStepsTranslateRegularRates(ModeEnum? mode = default(ModeEnum?), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationStepsTranslateRegularRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationStepsTranslateRegularRates);
        }

        /// <summary>
        /// Returns true if CostEstimationStepsTranslateRegularRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationStepsTranslateRegularRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationStepsTranslateRegularRates input)
        {
            if (input == null)
                return false;
