...
{
    /// <summary>
    /// TranslationCostsStepsTranslate
    /// </summary>
    [DataContract(Name = "translation-costs.steps.translate")]
    public partial class TranslationCostsStepsTranslate : IEquatable<TranslationCostsStepsTranslate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCostsStepsTranslate" /> class.
        /// </summary>
        ...
        public TranslationCostsStepsTranslate(string type = default(string), string mode = default(string), List<CostEstimationStepsTranslateRegularRates> regularRates = default(List<CostEstimationStepsTranslateRegularRates>), List<CostEstimationStepsTranslateIndividualRates> individualRates = default(List<CostEstimationStepsTranslateIndividualRates>))
        {
            this.Type = type;
            this.Mode = mode;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCostsStepsTranslate {\n");
        ...
        {
            return this.Equals(input as TranslationCostsStepsTranslate);
        }

        /// <summary>
        /// Returns true if TranslationCostsStepsTranslate instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCostsStepsTranslate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCostsStepsTranslate input)
        {
            if (input == null)
                return false;
