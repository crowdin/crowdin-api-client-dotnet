...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DistributionOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(DistributionOperationReplace), "DistributionOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(DistributionOperationReplace), "replace")]
    public partial class DistributionOperation : IEquatable<DistributionOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DistributionOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionOperation" /> class.
        /// </summary>
        ...
        public DistributionOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionOperation {\n");
        ...
        {
            return this.Equals(input as DistributionOperation);
        }

        /// <summary>
        /// Returns true if DistributionOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionOperation input)
        {
            if (input == null)
                return false;
