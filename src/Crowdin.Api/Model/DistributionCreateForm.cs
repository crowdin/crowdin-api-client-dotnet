...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DistributionCreateForm")]
    public partial class DistributionCreateForm : IEquatable<DistributionCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DistributionCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionCreateForm" /> class.
        /// </summary>
        /// <param name="name">Distribution name (required).</param>
        /// <param name="fileIds">Files ids (required).</param>
        public DistributionCreateForm(string name = default(string), List<int> fileIds = default(List<int>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for DistributionCreateForm and cannot be null");
            }
            this.Name = name;
            // to ensure "fileIds" is required (not null)
            if (fileIds == null) {
                throw new ArgumentNullException("fileIds is a required property for DistributionCreateForm and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionCreateForm {\n");
        ...
        {
            return this.Equals(input as DistributionCreateForm);
        }

        /// <summary>
        /// Returns true if DistributionCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionCreateForm input)
        {
            if (input == null)
                return false;
