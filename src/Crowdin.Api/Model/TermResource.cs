...
namespace Crowdin.Api.Model
{
    ...
    /// Term Resource
    /// </summary>
    [DataContract(Name = "TermResource")]
    public partial class TermResource : IEquatable<TermResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TermResource(Term data = default(Term))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as TermResource);
        }

        /// <summary>
        /// Returns true if TermResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TermResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermResource input)
        {
            if (input == null)
                return false;
