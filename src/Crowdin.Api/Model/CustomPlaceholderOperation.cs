...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomPlaceholderOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(CustomPlaceholderOperationReplace), "CustomPlaceholderOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(CustomPlaceholderOperationTest), "CustomPlaceholderOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(ProjectPlaceholderOperationTest), "ProjectPlaceholderOperationTest")]
    ...
    public partial class CustomPlaceholderOperation : IEquatable<CustomPlaceholderOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholderOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomPlaceholderOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholderOperation" /> class.
        /// </summary>
        ...
        public CustomPlaceholderOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomPlaceholderOperation {\n");
        ...
        {
            return this.Equals(input as CustomPlaceholderOperation);
        }

        /// <summary>
        /// Returns true if CustomPlaceholderOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomPlaceholderOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomPlaceholderOperation input)
        {
            if (input == null)
                return false;
