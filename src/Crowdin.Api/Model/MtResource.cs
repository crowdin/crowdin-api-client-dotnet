...
namespace Crowdin.Api.Model
{
    ...
    /// Mt Resource
    /// </summary>
    [DataContract(Name = "MtResource")]
    public partial class MtResource : IEquatable<MtResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MtResource(Mt data = default(Mt))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as MtResource);
        }

        /// <summary>
        /// Returns true if MtResource instances are equal
        /// </summary>
        /// <param name="input">Instance of MtResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtResource input)
        {
            if (input == null)
                return false;
