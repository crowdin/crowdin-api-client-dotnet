...
{
    /// <summary>
    /// CrowdinDirectoryBuildResponse
    /// </summary>
    [DataContract(Name = "CrowdinDirectoryBuildResponse")]
    public partial class CrowdinDirectoryBuildResponse : IEquatable<CrowdinDirectoryBuildResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinDirectoryBuildResponse" /> class.
        /// </summary>
        ...
        public CrowdinDirectoryBuildResponse(int id = default(int), int projectId = default(int), StatusEnum? status = default(StatusEnum?), int progress = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime finishedAt = default(DateTime))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinDirectoryBuildResponse {\n");
        ...
        {
            return this.Equals(input as CrowdinDirectoryBuildResponse);
        }

        /// <summary>
        /// Returns true if CrowdinDirectoryBuildResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinDirectoryBuildResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinDirectoryBuildResponse input)
        {
            if (input == null)
                return false;
