...
namespace Crowdin.Api.Model
{
    ...
    public partial class Language : IEquatable<Language>, IValidatableObject
    {
        ...
        /// <param name="editorCode">- alias of internal code.</param>
        /// <param name="twoLettersCode">alias of iso6391 code.</param>
        /// <param name="threeLettersCode">alias of iso6393 code.</param>
        /// <param name="locale">locale.</param>
        /// <param name="androidCode">androidCode.</param>
        /// <param name="osxCode">osxCode.</param>
        /// <param name="osxLocale">osxLocale.</param>
        /// <param name="pluralCategoryNames">plural category names.</param>
        /// <param name="pluralRules">string with plural rules.</param>
        /// <param name="pluralExamples">plural examples array.</param>
        /// <param name="textDirection">textDirection.</param>
        /// <param name="dialectOf">dialectOf.</param>
        public Language(string id = default(string), string name = default(string), string editorCode = default(string), string twoLettersCode = default(string), string threeLettersCode = default(string), string locale = default(string), string androidCode = default(string), string osxCode = default(string), string osxLocale = default(string), List<string> pluralCategoryNames = default(List<string>), string pluralRules = default(string), List<string> pluralExamples = default(List<string>), TextDirectionEnum? textDirection = default(TextDirectionEnum?), string dialectOf = default(string))
        {
            this.Id = id;
            this.Name = name;
