...
{
    /// <summary>
    /// ICU Language Translation Collection Resource
    /// </summary>
    [DataContract(Name = "IcuLanguageTranslationCollectionResource")]
    public partial class IcuLanguageTranslationCollectionResource : IEquatable<IcuLanguageTranslationCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IcuLanguageTranslationCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public IcuLanguageTranslationCollectionResource(List<IcuLanguageTranslationResource> data = default(List<IcuLanguageTranslationResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<IcuLanguageTranslationResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IcuLanguageTranslationCollectionResource {\n");
        ...
        {
            return this.Equals(input as IcuLanguageTranslationCollectionResource);
        }

        /// <summary>
        /// Returns true if IcuLanguageTranslationCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of IcuLanguageTranslationCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IcuLanguageTranslationCollectionResource input)
        {
            if (input == null)
                return false;
