...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinTmCollectionResource")]
    public partial class CrowdinTmCollectionResource : IEquatable<CrowdinTmCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTmCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public CrowdinTmCollectionResource(List<CrowdinTmResource> data = default(List<CrowdinTmResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<CrowdinTmResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTmCollectionResource {\n");
        ...
        {
            return this.Equals(input as CrowdinTmCollectionResource);
        }

        /// <summary>
        /// Returns true if CrowdinTmCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTmCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTmCollectionResource input)
        {
            if (input == null)
                return false;
