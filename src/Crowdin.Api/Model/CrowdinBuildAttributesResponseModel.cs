...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinBuildAttributesResponseModel")]
    public partial class CrowdinBuildAttributesResponseModel : IEquatable<CrowdinBuildAttributesResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinBuildAttributesResponseModel" /> class.
        /// </summary>
        ...
        public CrowdinBuildAttributesResponseModel(int? branchId = default(int?), int? directoryId = default(int?), List<string> targetLanguagesId = default(List<string>), bool skipUntranslatedStrings = default(bool), bool skipUntranslatedFiles = default(bool), bool exportApprovedOnly = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinBuildAttributesResponseModel {\n");
        ...
        {
            return this.Equals(input as CrowdinBuildAttributesResponseModel);
        }

        /// <summary>
        /// Returns true if CrowdinBuildAttributesResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinBuildAttributesResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinBuildAttributesResponseModel input)
        {
            if (input == null)
                return false;
