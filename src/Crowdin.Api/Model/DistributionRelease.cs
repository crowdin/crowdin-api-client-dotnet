...
namespace Crowdin.Api.Model
{
    ...
    /// DistributionRelease
    /// </summary>
    [DataContract(Name = "DistributionRelease")]
    public partial class DistributionRelease : IEquatable<DistributionRelease>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionRelease" /> class.
        /// </summary>
        /// <param name="status">status.</param>
        /// <param name="progress">progress.</param>
        /// <param name="currentLanguageId">currentLanguageId.</param>
        /// <param name="currentFileId">currentFileId.</param>
        /// <param name="date">in UTC.</param>
        public DistributionRelease(StatusEnum? status = default(StatusEnum?), int? progress = default(int?), string currentLanguageId = default(string), int? currentFileId = default(int?), DateTime? date = default(DateTime?))
        {
            this.Status = status;
        ...
        /// <summary>
        /// Gets or Sets CurrentLanguageId
        /// </summary>
        [DataMember(Name = "currentLanguageId", EmitDefaultValue = true)]
        public string CurrentLanguageId { get; set; }

        /// <summary>
        /// Gets or Sets CurrentFileId
        /// </summary>
        [DataMember(Name = "currentFileId", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionRelease {\n");
            sb.Append("  Status: ").Append(Status).Append("\n");
            sb.Append("  Progress: ").Append(Progress).Append("\n");
            sb.Append("  CurrentLanguageId: ").Append(CurrentLanguageId).Append("\n");
            sb.Append("  CurrentFileId: ").Append(CurrentFileId).Append("\n");
        ...
        {
            return this.Equals(input as DistributionRelease);
        }

        /// <summary>
        /// Returns true if DistributionRelease instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionRelease to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionRelease input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CurrentLanguageId == input.CurrentLanguageId ||
                    (this.CurrentLanguageId != null &&
                    this.CurrentLanguageId.Equals(input.CurrentLanguageId))
                ) && 
                (
                    this.CurrentFileId == input.CurrentFileId ||
                    (this.CurrentFileId != null &&
                    this.CurrentFileId.Equals(input.CurrentFileId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CurrentLanguageId != null)
                    hashCode = hashCode * 59 + this.CurrentLanguageId.GetHashCode();
                if (this.CurrentFileId != null)
                    hashCode = hashCode * 59 + this.CurrentFileId.GetHashCode();
                if (this.Date != null)
