...
{
    /// <summary>
    /// CostEstimationFuzzyStepsProofreadIndividualRates
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.steps.proofread.individual-rates")]
    public partial class CostEstimationFuzzyStepsProofreadIndividualRates : IEquatable<CostEstimationFuzzyStepsProofreadIndividualRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyStepsProofreadIndividualRates" /> class.
        /// </summary>
        /// <param name="languageIdsTo">Array of language ids.</param>
        /// <param name="rates">rates.</param>
        public CostEstimationFuzzyStepsProofreadIndividualRates(List<string> languageIdsTo = default(List<string>), List<CostEstimationFuzzyStepsProofreadIndividualRateModes> rates = default(List<CostEstimationFuzzyStepsProofreadIndividualRateModes>))
        {
            this.LanguageIdsTo = languageIdsTo;
            this.Rates = rates;
        }
        ...
        /// </summary>
        /// <value>Array of language ids</value>
        [DataMember(Name = "languageIdsTo", EmitDefaultValue = false)]
        public List<string> LanguageIdsTo { get; set; }

        /// <summary>
        /// Gets or Sets Rates
        /// </summary>
        [DataMember(Name = "rates", EmitDefaultValue = false)]
        public List<CostEstimationFuzzyStepsProofreadIndividualRateModes> Rates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyStepsProofreadIndividualRates {\n");
            sb.Append("  LanguageIdsTo: ").Append(LanguageIdsTo).Append("\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyStepsProofreadIndividualRates);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyStepsProofreadIndividualRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyStepsProofreadIndividualRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyStepsProofreadIndividualRates input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.LanguageIdsTo == input.LanguageIdsTo ||
                    this.LanguageIdsTo != null &&
                    input.LanguageIdsTo != null &&
                    this.LanguageIdsTo.SequenceEqual(input.LanguageIdsTo)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.LanguageIdsTo != null)
                    hashCode = hashCode * 59 + this.LanguageIdsTo.GetHashCode();
                if (this.Rates != null)
