...
{
    /// <summary>
    /// Contribution Raw Data Report schema
    /// </summary>
    [DataContract(Name = "ContributionRawData_schema")]
    public partial class ContributionRawDataSchema : IEquatable<ContributionRawDataSchema>, IValidatableObject
    {
        /// <summary>
        /// Defines report mode
        /// </summary>
        /// <value>Defines report mode</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum ModeEnum
        {
            /// <summary>
            /// Enum Translations for value: translations
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContributionRawDataSchema" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ContributionRawDataSchema() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ContributionRawDataSchema" /> class.
        /// </summary>
        /// <param name="mode">Defines report mode (required).</param>
        ...
        /// <param name="userId">User Identifier for which the report should be generated. Get via [List Project Members](#operation/api.projects.members.getMany).</param>
        /// <param name="dateFrom">Report date from in UTC, ISO 8601.</param>
        /// <param name="dateTo">Report date to in UTC, ISO 8601.</param>
        public ContributionRawDataSchema(ModeEnum mode = default(ModeEnum), UnitEnum? unit = UnitEnum.Words, string languageId = default(string), string userId = default(string), DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime))
        {
            this.Mode = mode;
            this.Unit = unit;
        ...
        /// <summary>
        /// User Identifier for which the report should be generated. Get via [List Project Members](#operation/api.projects.members.getMany)
        /// </summary>
        /// <value>User Identifier for which the report should be generated. Get via [List Project Members](#operation/api.projects.members.getMany)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ContributionRawDataSchema {\n");
        ...
        {
            return this.Equals(input as ContributionRawDataSchema);
        }

        /// <summary>
        /// Returns true if ContributionRawDataSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of ContributionRawDataSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ContributionRawDataSchema input)
        {
            if (input == null)
                return false;
