...
{
    /// <summary>
    /// Subscription for notification channels
    /// </summary>
    [DataContract(Name = "ChannelSubscriptionResource")]
    public partial class ChannelSubscriptionResource : IEquatable<ChannelSubscriptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelSubscriptionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ChannelSubscriptionResource(Subscription data = default(Subscription))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChannelSubscriptionResource {\n");
        ...
        {
            return this.Equals(input as ChannelSubscriptionResource);
        }

        /// <summary>
        /// Returns true if ChannelSubscriptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ChannelSubscriptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChannelSubscriptionResource input)
        {
            if (input == null)
                return false;
