...
{
    /// <summary>
    /// TranslateStepResponseDataConfig
    /// </summary>
    [DataContract(Name = "TranslateStepResponse_data_config")]
    public partial class TranslateStepResponseDataConfig : IEquatable<TranslateStepResponseDataConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateStepResponseDataConfig" /> class.
        /// </summary>
        /// <param name="assignees">assignees.</param>
        public TranslateStepResponseDataConfig(TranslateStepResponseDataConfigAssignees assignees = default(TranslateStepResponseDataConfigAssignees))
        {
        ...
        public TranslateStepResponseDataConfigAssignees Assignees { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslateStepResponseDataConfig {\n");
        ...
        {
            return this.Equals(input as TranslateStepResponseDataConfig);
        }

        /// <summary>
        /// Returns true if TranslateStepResponseDataConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslateStepResponseDataConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslateStepResponseDataConfig input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    (this.Assignees != null &&
                    this.Assignees.Equals(input.Assignees))
                );
        }
