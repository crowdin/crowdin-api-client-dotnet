...
{
    /// <summary>
    /// Issue Statistic Response Model
    /// </summary>
    [DataContract(Name = "IssueStatistic")]
    public partial class IssueStatistic : IEquatable<IssueStatistic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueStatistic" /> class.
        /// </summary>
        /// <param name="total">total.</param>
        /// <param name="languageId">languageId.</param>
        public IssueStatistic(int total = default(int), int languageId = default(int))
        {
            this.Total = total;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IssueStatistic {\n");
        ...
        {
            return this.Equals(input as IssueStatistic);
        }

        /// <summary>
        /// Returns true if IssueStatistic instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueStatistic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueStatistic input)
        {
            if (input == null)
                return false;
