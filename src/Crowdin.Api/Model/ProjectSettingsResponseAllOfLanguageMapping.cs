...
{
    /// <summary>
    /// ProjectSettingsResponseAllOfLanguageMapping
    /// </summary>
    [DataContract(Name = "ProjectSettingsResponse_allOf_languageMapping")]
    public partial class ProjectSettingsResponseAllOfLanguageMapping : IEquatable<ProjectSettingsResponseAllOfLanguageMapping>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingsResponseAllOfLanguageMapping" /> class.
        /// </summary>
        /// <param name="uk">uk.</param>
        public ProjectSettingsResponseAllOfLanguageMapping(LanguageMappingUk uk = default(LanguageMappingUk))
        {
            this.Uk = uk;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectSettingsResponseAllOfLanguageMapping {\n");
        ...
        {
            return this.Equals(input as ProjectSettingsResponseAllOfLanguageMapping);
        }

        /// <summary>
        /// Returns true if ProjectSettingsResponseAllOfLanguageMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectSettingsResponseAllOfLanguageMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectSettingsResponseAllOfLanguageMapping input)
        {
            if (input == null)
                return false;
