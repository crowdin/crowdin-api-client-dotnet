...
namespace Crowdin.Api.Model
{
    ...
    /// ScreenshotSize
    /// </summary>
    [DataContract(Name = "Screenshot_size")]
    public partial class ScreenshotSize : IEquatable<ScreenshotSize>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotSize" /> class.
        /// </summary>
        /// <param name="width">width.</param>
        /// <param name="height">height.</param>
        public ScreenshotSize(int width = default(int), int height = default(int))
        {
            this.Width = width;
            this.Height = height;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScreenshotSize {\n");
        ...
        {
            return this.Equals(input as ScreenshotSize);
        }

        /// <summary>
        /// Returns true if ScreenshotSize instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotSize to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotSize input)
        {
            if (input == null)
                return false;
