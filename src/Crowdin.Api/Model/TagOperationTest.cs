...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TagOperationTest")]
    ...
    public partial class TagOperationTest : TagOperation, IEquatable<TagOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TagOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TagOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;TagOperationTest&quot;).</param>
        ...
        public TagOperationTest(OneOfstringinteger value = default(OneOfstringinteger), OpEnum op = "TagOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TagOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagOperationTest {\n");
        ...
        {
            return this.Equals(input as TagOperationTest);
        }

        /// <summary>
        /// Returns true if TagOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of TagOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagOperationTest input)
        {
            if (input == null)
                return false;
