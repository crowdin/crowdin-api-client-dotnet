...
namespace Crowdin.Api.Model
{
    ...
    /// TagCreateForm
    /// </summary>
    [DataContract(Name = "TagCreateForm")]
    public partial class TagCreateForm : IEquatable<TagCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagCreateForm" /> class.
        /// </summary>
        ...
        public TagCreateForm(int stringId = default(int), TagPositionScheme position = default(TagPositionScheme))
        {
        ...
        public TagPositionScheme Position { get; set; }
        ...
        {
            return this.Equals(input as TagCreateForm);
        }

        /// <summary>
        /// Returns true if TagCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TagCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagCreateForm input)
        {
            if (input == null)
                return false;
