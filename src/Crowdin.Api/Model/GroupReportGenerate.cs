...
{
    /// <summary>
    /// Generate Group Report Response Model
    /// </summary>
    [DataContract(Name = "GroupReportGenerate")]
    public partial class GroupReportGenerate : IEquatable<GroupReportGenerate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupReportGenerate" /> class.
        /// </summary>
        ...
        public GroupReportGenerate(string identifier = default(string), string status = default(string), int progress = default(int), GroupReportGenerateAttributes attributes = default(GroupReportGenerateAttributes), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime finishedAt = default(DateTime), string eta = default(string))
        {
        ...
        public GroupReportGenerateAttributes Attributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupReportGenerate {\n");
        ...
        {
            return this.Equals(input as GroupReportGenerate);
        }

        /// <summary>
        /// Returns true if GroupReportGenerate instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupReportGenerate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupReportGenerate input)
        {
            if (input == null)
                return false;
