...
namespace Crowdin.Api.Model
{
    ...
    public partial class Any : AbstractOpenAPISchema, IEquatable<Any>, IValidatableObject
    {
        /// <summary>
        ...
        public Any(List<int> actualInstance)
        {
        ...
        public Any(List<string> actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public Any(bool actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public Any(string actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: List<int>, List<string>, bool, int, string");
                }
            }
        }
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, Any.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of Any
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of Any</returns>
        public static Any FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                {
                    newAny = new Any(JsonConvert.DeserializeObject<List<int>>(jsonString, Any.SerializerSettings));
                }
                else
                {
                    newAny = new Any(JsonConvert.DeserializeObject<List<int>>(jsonString, Any.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newAny = new Any(JsonConvert.DeserializeObject<List<string>>(jsonString, Any.SerializerSettings));
                }
                else
                {
                    newAny = new Any(JsonConvert.DeserializeObject<List<string>>(jsonString, Any.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newAny = new Any(JsonConvert.DeserializeObject<bool>(jsonString, Any.SerializerSettings));
                }
                else
                {
                    newAny = new Any(JsonConvert.DeserializeObject<bool>(jsonString, Any.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newAny = new Any(JsonConvert.DeserializeObject<int>(jsonString, Any.SerializerSettings));
                }
                else
                {
                    newAny = new Any(JsonConvert.DeserializeObject<int>(jsonString, Any.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newAny = new Any(JsonConvert.DeserializeObject<string>(jsonString, Any.SerializerSettings));
                }
                else
                {
                    newAny = new Any(JsonConvert.DeserializeObject<string>(jsonString, Any.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for Any
    /// </summary>
    public class AnyJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(Any).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return Any.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
