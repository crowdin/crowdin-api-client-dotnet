...
{
    /// <summary>
    /// CostEstimationFuzzyIndividualRateModes
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.individual-rate-modes")]
    public partial class CostEstimationFuzzyIndividualRateModes : IEquatable<CostEstimationFuzzyIndividualRateModes>, IValidatableObject
    {
        /// <summary>
        /// perfect
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyIndividualRateModes" /> class.
        /// </summary>
        /// <param name="mode">perfect.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationFuzzyIndividualRateModes(ModeEnum? mode = default(ModeEnum?), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyIndividualRateModes {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyIndividualRateModes);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyIndividualRateModes instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyIndividualRateModes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyIndividualRateModes input)
        {
            if (input == null)
                return false;
