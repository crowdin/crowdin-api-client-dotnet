...
{
    /// <summary>
    /// EnterpriseBuildReviewedStringCreateForm
    /// </summary>
    [DataContract(Name = "EnterpriseBuildReviewedStringCreateForm")]
    public partial class EnterpriseBuildReviewedStringCreateForm : IEquatable<EnterpriseBuildReviewedStringCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseBuildReviewedStringCreateForm" /> class.
        /// </summary>
        /// <param name="branchId">Branch Identifier. Get via [List Branches](#operation/api.projects.branches.getMany).</param>
        public EnterpriseBuildReviewedStringCreateForm(int branchId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseBuildReviewedStringCreateForm {\n");
        ...
        {
            return this.Equals(input as EnterpriseBuildReviewedStringCreateForm);
        }

        /// <summary>
        /// Returns true if EnterpriseBuildReviewedStringCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseBuildReviewedStringCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseBuildReviewedStringCreateForm input)
        {
            if (input == null)
                return false;
