...
namespace Crowdin.Api.Model
{
    ...
    /// Storage Resource
    /// </summary>
    [DataContract(Name = "StorageResource")]
    public partial class StorageResource : IEquatable<StorageResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public StorageResource(Storage data = default(Storage))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as StorageResource);
        }

        /// <summary>
        /// Returns true if StorageResource instances are equal
        /// </summary>
        /// <param name="input">Instance of StorageResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorageResource input)
        {
            if (input == null)
                return false;
