...
namespace Crowdin.Api.Model
{
    ...
    /// TeamCreateForm
    /// </summary>
    [DataContract(Name = "TeamCreateForm")]
    public partial class TeamCreateForm : IEquatable<TeamCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamCreateForm" /> class.
        /// </summary>
        /// <param name="name">Team name (required).</param>
        public TeamCreateForm(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for TeamCreateForm and cannot be null");
            }
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamCreateForm {\n");
        ...
        {
            return this.Equals(input as TeamCreateForm);
        }

        /// <summary>
        /// Returns true if TeamCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamCreateForm input)
        {
            if (input == null)
                return false;
