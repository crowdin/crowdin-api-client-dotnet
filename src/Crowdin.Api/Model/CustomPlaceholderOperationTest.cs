...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomPlaceholderOperationTest")]
    ...
    public partial class CustomPlaceholderOperationTest : CustomPlaceholderOperation, IEquatable<CustomPlaceholderOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholderOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomPlaceholderOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholderOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;CustomPlaceholderOperationTest&quot;).</param>
        ...
        public CustomPlaceholderOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "CustomPlaceholderOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for CustomPlaceholderOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomPlaceholderOperationTest {\n");
        ...
        {
            return this.Equals(input as CustomPlaceholderOperationTest);
        }

        /// <summary>
        /// Returns true if CustomPlaceholderOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomPlaceholderOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomPlaceholderOperationTest input)
        {
            if (input == null)
                return false;
