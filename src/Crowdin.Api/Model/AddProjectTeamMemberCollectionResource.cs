...
{
    /// <summary>
    /// Add Project Team Members List
    /// </summary>
    [DataContract(Name = "AddProjectTeamMemberCollectionResource")]
    public partial class AddProjectTeamMemberCollectionResource : IEquatable<AddProjectTeamMemberCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectTeamMemberCollectionResource" /> class.
        /// </summary>
        /// <param name="skipped">skipped.</param>
        /// <param name="added">added.</param>
        /// <param name="pagination">pagination.</param>
        public AddProjectTeamMemberCollectionResource(List<ProjectTeamMemberResource> skipped = default(List<ProjectTeamMemberResource>), List<ProjectTeamMemberResource> added = default(List<ProjectTeamMemberResource>), Pagination pagination = default(Pagination))
        {
        ...
        public List<ProjectTeamMemberResource> Skipped { get; set; }

        /// <summary>
        /// Gets or Sets Added
        /// </summary>
        [DataMember(Name = "added", EmitDefaultValue = false)]
        public List<ProjectTeamMemberResource> Added { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProjectTeamMemberCollectionResource {\n");
        ...
        {
            return this.Equals(input as AddProjectTeamMemberCollectionResource);
        }

        /// <summary>
        /// Returns true if AddProjectTeamMemberCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProjectTeamMemberCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProjectTeamMemberCollectionResource input)
        {
            if (input == null)
                return false;
