...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectOperationRemove")]
    ...
    public partial class ProjectOperationRemove : ProjectSettingOperation, IEquatable<ProjectOperationRemove>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectOperationRemove" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectOperationRemove() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectOperationRemove" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectOperationRemove&quot;).</param>
        ...
        public ProjectOperationRemove(OneOfstringintegerbooleanobject value = default(OneOfstringintegerbooleanobject), OpEnum op = "ProjectOperationRemove", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectOperationRemove and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectOperationRemove {\n");
        ...
        {
            return this.Equals(input as ProjectOperationRemove);
        }

        /// <summary>
        /// Returns true if ProjectOperationRemove instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectOperationRemove to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectOperationRemove input)
        {
            if (input == null)
                return false;
