...
{
    /// <summary>
    /// CostEstimationFuzzyStepsTranslateIndividualRates
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.steps.translate.individual-rates")]
    public partial class CostEstimationFuzzyStepsTranslateIndividualRates : IEquatable<CostEstimationFuzzyStepsTranslateIndividualRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyStepsTranslateIndividualRates" /> class.
        /// </summary>
        /// <param name="languageIdsTo">Array of language ids.</param>
        /// <param name="rates">rates.</param>
        public CostEstimationFuzzyStepsTranslateIndividualRates(List<string> languageIdsTo = default(List<string>), List<CostEstimationFuzzyStepsTranslateIndividualRateModes> rates = default(List<CostEstimationFuzzyStepsTranslateIndividualRateModes>))
        {
        ...
        public List<CostEstimationFuzzyStepsTranslateIndividualRateModes> Rates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyStepsTranslateIndividualRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyStepsTranslateIndividualRates);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyStepsTranslateIndividualRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyStepsTranslateIndividualRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyStepsTranslateIndividualRates input)
        {
            if (input == null)
                return false;
