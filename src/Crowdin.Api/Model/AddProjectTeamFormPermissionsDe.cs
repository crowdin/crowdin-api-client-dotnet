...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddProjectTeamForm_permissions_de")]
    public partial class AddProjectTeamFormPermissionsDe : IEquatable<AddProjectTeamFormPermissionsDe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectTeamFormPermissionsDe" /> class.
        /// </summary>
        /// <param name="workflowStepIds">You cat set &#x60;all&#x60; value to grant permissions for all workflow steps for current language.</param>
        public AddProjectTeamFormPermissionsDe(string workflowStepIds = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProjectTeamFormPermissionsDe {\n");
        ...
        {
            return this.Equals(input as AddProjectTeamFormPermissionsDe);
        }

        /// <summary>
        /// Returns true if AddProjectTeamFormPermissionsDe instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProjectTeamFormPermissionsDe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProjectTeamFormPermissionsDe input)
        {
            if (input == null)
                return false;
