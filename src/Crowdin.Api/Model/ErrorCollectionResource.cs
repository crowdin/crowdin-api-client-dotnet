...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ErrorCollectionResource")]
    public partial class ErrorCollectionResource : IEquatable<ErrorCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorCollectionResource" /> class.
        /// </summary>
        /// <param name="errors">errors.</param>
        public ErrorCollectionResource(List<ErrorResource> errors = default(List<ErrorResource>))
        {
            this.Errors = errors;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrorCollectionResource {\n");
        ...
        {
            return this.Equals(input as ErrorCollectionResource);
        }

        /// <summary>
        /// Returns true if ErrorCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorCollectionResource input)
        {
            if (input == null)
                return false;
