...
{
    /// <summary>
    /// Issue Statistic Collection Resource
    /// </summary>
    [DataContract(Name = "IssueStatisticCollectionResource")]
    public partial class IssueStatisticCollectionResource : IEquatable<IssueStatisticCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueStatisticCollectionResource" /> class.
        /// </summary>
        /// <param name="data">Class IssueStatisticCollectionResource.</param>
        /// <param name="pagination">pagination.</param>
        public IssueStatisticCollectionResource(List<IssueStatisticResource> data = default(List<IssueStatisticResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        /// <summary>
        /// Class IssueStatisticCollectionResource
        /// </summary>
        /// <value>Class IssueStatisticCollectionResource</value>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<IssueStatisticResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IssueStatisticCollectionResource {\n");
        ...
        {
            return this.Equals(input as IssueStatisticCollectionResource);
        }

        /// <summary>
        /// Returns true if IssueStatisticCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueStatisticCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueStatisticCollectionResource input)
        {
            if (input == null)
                return false;
