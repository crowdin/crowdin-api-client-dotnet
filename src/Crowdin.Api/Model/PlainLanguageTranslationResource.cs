...
{
    /// <summary>
    /// Plain Language Translation Resource
    /// </summary>
    [DataContract(Name = "PlainLanguageTranslationResource")]
    public partial class PlainLanguageTranslationResource : IEquatable<PlainLanguageTranslationResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlainLanguageTranslationResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PlainLanguageTranslationResource(PlainLanguageTranslation data = default(PlainLanguageTranslation))
        {
            this.Data = data;
        }
        ...
        public PlainLanguageTranslation Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlainLanguageTranslationResource {\n");
        ...
        {
            return this.Equals(input as PlainLanguageTranslationResource);
        }

        /// <summary>
        /// Returns true if PlainLanguageTranslationResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PlainLanguageTranslationResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlainLanguageTranslationResource input)
        {
            if (input == null)
                return false;
