...
{
    /// <summary>
    /// CrowdinTaskCreateForm
    /// </summary>
    [DataContract(Name = "CrowdinTaskCreateForm")]
    public partial class CrowdinTaskCreateForm : IEquatable<CrowdinTaskCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Task type:  *     0 - translate  *     1 - proofread
        /// </summary>
        /// <value>Task type:  *     0 - translate  *     1 - proofread</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTaskCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrowdinTaskCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTaskCreateForm" /> class.
        /// </summary>
        ...
        /// <param name="type">Task type:  *     0 - translate  *     1 - proofread (required).</param>
        ...
        /// <param name="skipUntranslatedStrings">Defines whether to export only translated strings  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;type&#x3D;0&#x60; or &#x60;type&#x3D;2&#x60; in same request (default to false).</param>
        ...
        /// <param name="deadline">Defines task deadline date  Format: UTC, ISO 8601.</param>
        ...
        public CrowdinTaskCreateForm(string title = default(string), string languageId = default(string), List<int> fileIds = default(List<int>), TypeEnum type = default(TypeEnum), StatusEnum? status = StatusEnum.Todo, string description = default(string), bool splitFiles = false, bool skipAssignedStrings = false, bool skipUntranslatedStrings = false, List<int> labelIds = default(List<int>), List<CrowdinTaskAssignee> assignees = default(List<CrowdinTaskAssignee>), DateTime deadline = default(DateTime), DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime))
        {
            // to ensure "title" is required (not null)
            if (title == null) {
                throw new ArgumentNullException("title is a required property for CrowdinTaskCreateForm and cannot be null");
            }
            this.Title = title;
            // to ensure "languageId" is required (not null)
            if (languageId == null) {
                throw new ArgumentNullException("languageId is a required property for CrowdinTaskCreateForm and cannot be null");
            }
            this.LanguageId = languageId;
            // to ensure "fileIds" is required (not null)
            if (fileIds == null) {
                throw new ArgumentNullException("fileIds is a required property for CrowdinTaskCreateForm and cannot be null");
            }
        ...
        /// <summary>
        /// Defines whether to export only translated strings  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;type&#x3D;0&#x60; or &#x60;type&#x3D;2&#x60; in same request
        /// </summary>
        /// <value>Defines whether to export only translated strings  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;type&#x3D;0&#x60; or &#x60;type&#x3D;2&#x60; in same request</value>
        ...
        public List<CrowdinTaskAssignee> Assignees { get; set; }

        /// <summary>
        /// Defines task deadline date  Format: UTC, ISO 8601
        /// </summary>
        /// <value>Defines task deadline date  Format: UTC, ISO 8601</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTaskCreateForm {\n");
        ...
        {
            return this.Equals(input as CrowdinTaskCreateForm);
        }

        /// <summary>
        /// Returns true if CrowdinTaskCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTaskCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTaskCreateForm input)
        {
            if (input == null)
                return false;
