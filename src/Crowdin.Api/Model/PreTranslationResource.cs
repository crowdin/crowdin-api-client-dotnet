...
{
    /// <summary>
    /// Pre Translation Resource
    /// </summary>
    [DataContract(Name = "PreTranslationResource")]
    public partial class PreTranslationResource : IEquatable<PreTranslationResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreTranslationResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public PreTranslationResource(PreTranslation data = default(PreTranslation))
        {
            this.Data = data;
        }
        ...
        public PreTranslation Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreTranslationResource {\n");
        ...
        {
            return this.Equals(input as PreTranslationResource);
        }

        /// <summary>
        /// Returns true if PreTranslationResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PreTranslationResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreTranslationResource input)
        {
            if (input == null)
                return false;
