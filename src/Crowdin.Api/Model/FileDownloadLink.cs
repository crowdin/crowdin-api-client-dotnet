...
namespace Crowdin.Api.Model
{
    ...
    /// FileDownloadLink
    /// </summary>
    [DataContract(Name = "File_Download_Link")]
    public partial class FileDownloadLink : IEquatable<FileDownloadLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileDownloadLink" /> class.
        /// </summary>
        /// <param name="etag">etag.</param>
        public FileDownloadLink(string etag = default(string))
        {
            this.Etag = etag;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileDownloadLink {\n");
        ...
        {
            return this.Equals(input as FileDownloadLink);
        }

        /// <summary>
        /// Returns true if FileDownloadLink instances are equal
        /// </summary>
        /// <param name="input">Instance of FileDownloadLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileDownloadLink input)
        {
            if (input == null)
                return false;
