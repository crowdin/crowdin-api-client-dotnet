...
{
    /// <summary>
    /// Tm Collection Resource
    /// </summary>
    [DataContract(Name = "EnterpriseTmCollectionResource")]
    public partial class EnterpriseTmCollectionResource : IEquatable<EnterpriseTmCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTmCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public EnterpriseTmCollectionResource(List<EnterpriseTmResource> data = default(List<EnterpriseTmResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<EnterpriseTmResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTmCollectionResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseTmCollectionResource);
        }

        /// <summary>
        /// Returns true if EnterpriseTmCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTmCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTmCollectionResource input)
        {
            if (input == null)
                return false;
