...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(WebhookOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(WebhookOperationTest), "test")]
    public partial class WebhookOperationReplace : WebhookOperation, IEquatable<WebhookOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;WebhookOperationReplace&quot;).</param>
        ...
        public WebhookOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "WebhookOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for WebhookOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookOperationReplace {\n");
        ...
        {
            return this.Equals(input as WebhookOperationReplace);
        }

        /// <summary>
        /// Returns true if WebhookOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookOperationReplace input)
        {
            if (input == null)
                return false;
