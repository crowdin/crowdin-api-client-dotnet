...
namespace Crowdin.Api.Model
{
    ...
    /// CrowdinTmCreateForm
    /// </summary>
    [DataContract(Name = "CrowdinTmCreateForm")]
    public partial class CrowdinTmCreateForm : IEquatable<CrowdinTmCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTmCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrowdinTmCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTmCreateForm" /> class.
        /// </summary>
        /// <param name="name">Translation Memory name (required).</param>
        public CrowdinTmCreateForm(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CrowdinTmCreateForm and cannot be null");
            }
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTmCreateForm {\n");
        ...
        {
            return this.Equals(input as CrowdinTmCreateForm);
        }

        /// <summary>
        /// Returns true if CrowdinTmCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTmCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTmCreateForm input)
        {
            if (input == null)
                return false;
