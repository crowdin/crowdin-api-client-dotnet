...
namespace Crowdin.Api.Model
{
    ...
    /// MtCredentialsGoogle
    /// </summary>
    [DataContract(Name = "mt.credentials.google")]
    public partial class MtCredentialsGoogle : IEquatable<MtCredentialsGoogle>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentialsGoogle" /> class.
        /// </summary>
        /// <param name="apiKey">Api key.</param>
        public MtCredentialsGoogle(string apiKey = default(string))
        {
            this.ApiKey = apiKey;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentialsGoogle {\n");
        ...
        {
            return this.Equals(input as MtCredentialsGoogle);
        }

        /// <summary>
        /// Returns true if MtCredentialsGoogle instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentialsGoogle to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentialsGoogle input)
        {
            if (input == null)
                return false;
