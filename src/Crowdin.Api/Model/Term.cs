...
namespace Crowdin.Api.Model
{
    ...
    public partial class Term : IEquatable<Term>, IValidatableObject
    {
        ...
        /// <param name="glossaryId">glossaryId.</param>
        /// <param name="languageId">languageId.</param>
        /// <param name="text">text.</param>
        /// <param name="description">description.</param>
        /// <param name="partOfSpeech">partOfSpeech.</param>
        /// <param name="lemma">lemma.</param>
        /// <param name="createdAt">UTC timezone.</param>
        /// <param name="updatedAt">UTC timezone.</param>
        public Term(int id = default(int), int userId = default(int), int glossaryId = default(int), string languageId = default(string), string text = default(string), string description = default(string), string partOfSpeech = default(string), string lemma = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.UserId = userId;
        ...
        public bool Equals(Term input)
        {
            ...
            return 
                ...
                (
                    this.GlossaryId == input.GlossaryId ||
                    this.GlossaryId.Equals(input.GlossaryId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.GlossaryId.GetHashCode();
