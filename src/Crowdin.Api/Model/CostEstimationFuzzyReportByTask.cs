...
{
    /// <summary>
    /// CostEstimationFuzzyReportByTask
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.report.byTask")]
    public partial class CostEstimationFuzzyReportByTask : IEquatable<CostEstimationFuzzyReportByTask>, IValidatableObject
    {
        /// <summary>
        /// Defines report unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyReportByTask" /> class.
        /// </summary>
        ...
        public CostEstimationFuzzyReportByTask(UnitEnum? unit = UnitEnum.Words, CurrencyEnum? currency = CurrencyEnum.USD, FormatEnum? format = FormatEnum.Xlsx, int taskId = default(int), List<AnyOfcostEstimationFuzzyStepsTranslatecostEstimationFuzzyStepsProofread> stepTypes = default(List<AnyOfcostEstimationFuzzyStepsTranslatecostEstimationFuzzyStepsProofread>))
        {
            this.Unit = unit;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyReportByTask {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyReportByTask);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyReportByTask instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyReportByTask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyReportByTask input)
        {
            if (input == null)
                return false;
