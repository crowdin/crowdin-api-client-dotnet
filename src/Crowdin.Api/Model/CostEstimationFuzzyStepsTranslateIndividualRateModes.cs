...
{
    /// <summary>
    /// CostEstimationFuzzyStepsTranslateIndividualRateModes
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.steps.translate.individual-rate-modes")]
    public partial class CostEstimationFuzzyStepsTranslateIndividualRateModes : IEquatable<CostEstimationFuzzyStepsTranslateIndividualRateModes>, IValidatableObject
    {
        /// <summary>
        /// perfect
        /// </summary>
        ...
        public enum ModeEnum
        {
            ...
            /// <summary>
            /// Enum _9995 for value: 99-95
            /// </summary>
            [EnumMember(Value = "99-95")]
            _9995 = 4,

            /// <summary>
            /// Enum _9490 for value: 94-90
            /// </summary>
            [EnumMember(Value = "94-90")]
            _9490 = 5,

            /// <summary>
            /// Enum _8980 for value: 89-80
            /// </summary>
            [EnumMember(Value = "89-80")]
            _8980 = 6
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyStepsTranslateIndividualRateModes" /> class.
        /// </summary>
        /// <param name="mode">perfect.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationFuzzyStepsTranslateIndividualRateModes(ModeEnum? mode = default(ModeEnum?), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyStepsTranslateIndividualRateModes {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyStepsTranslateIndividualRateModes);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyStepsTranslateIndividualRateModes instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyStepsTranslateIndividualRateModes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyStepsTranslateIndividualRateModes input)
        {
            if (input == null)
                return false;
