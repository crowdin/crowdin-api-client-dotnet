...
namespace Crowdin.Api.Model
{
    ...
    /// UserTaskAllOf
    /// </summary>
    [DataContract(Name = "UserTask_allOf")]
    public partial class UserTaskAllOf : IEquatable<UserTaskAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTaskAllOf" /> class.
        /// </summary>
        /// <param name="isArchived">isArchived.</param>
        public UserTaskAllOf(bool isArchived = default(bool))
        {
        ...
        {
            return this.Equals(input as UserTaskAllOf);
        }

        /// <summary>
        /// Returns true if UserTaskAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of UserTaskAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserTaskAllOf input)
        {
            if (input == null)
                return false;
