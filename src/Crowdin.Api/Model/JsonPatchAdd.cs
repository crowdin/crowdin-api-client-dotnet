...
{
    /// <summary>
    /// A JSON Patch &#x60;Add&#x60; operation as defined by [RFC 6902](https://tools.ietf.org/html/rfc6902#section-4.1)
    /// </summary>
    [DataContract(Name = "JsonPatchAdd")]
    ...
    public partial class JsonPatchAdd : JsonPatchOperation, IEquatable<JsonPatchAdd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchAdd" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JsonPatchAdd() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchAdd" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;JsonPatchAdd&quot;).</param>
        ...
        public JsonPatchAdd(Any value = default(Any), OpEnum op = "JsonPatchAdd", string path = default(string)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for JsonPatchAdd and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as JsonPatchAdd);
        }

        /// <summary>
        /// Returns true if JsonPatchAdd instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonPatchAdd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonPatchAdd input)
        {
            if (input == null)
                return false;
