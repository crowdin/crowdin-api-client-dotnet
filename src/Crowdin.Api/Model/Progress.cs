...
{
    /// <summary>
    /// Language Translation Progress Response Model
    /// </summary>
    ...
    public partial class Progress : IEquatable<Progress>, IValidatableObject
    {
        ...
        public Progress(ProgressWords words = default(ProgressWords), ProgressPhrases phrases = default(ProgressPhrases), int translationProgress = default(int), int approvalProgress = default(int))
        {
            this.Words = words;
