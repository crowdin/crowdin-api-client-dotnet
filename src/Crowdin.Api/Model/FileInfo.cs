...
namespace Crowdin.Api.Model
{
    ...
    public partial class FileInfo : IEquatable<FileInfo>, IValidatableObject
    {
        ...
        public FileInfo(int id = default(int), int projectId = default(int), int? branchId = default(int?), int? directoryId = default(int?), string name = default(string), string title = default(string), string type = default(string), string path = default(string), string status = default(string))
        {
            this.Id = id;
