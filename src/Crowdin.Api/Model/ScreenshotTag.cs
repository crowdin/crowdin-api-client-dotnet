...
namespace Crowdin.Api.Model
{
    ...
    /// ScreenshotTag
    /// </summary>
    [DataContract(Name = "ScreenshotTag")]
    public partial class ScreenshotTag : IEquatable<ScreenshotTag>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotTag" /> class.
        /// </summary>
        ...
        public ScreenshotTag(int id = default(int), int screenshotId = default(int), int stringId = default(int), ScreenshotTagPosition position = default(ScreenshotTagPosition), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
        ...
        public ScreenshotTagPosition Position { get; set; }
        ...
        {
            return this.Equals(input as ScreenshotTag);
        }

        /// <summary>
        /// Returns true if ScreenshotTag instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotTag input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ScreenshotId == input.ScreenshotId ||
                    this.ScreenshotId.Equals(input.ScreenshotId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.ScreenshotId.GetHashCode();
