...
{
    /// <summary>
    /// QaCheck Response Model
    /// </summary>
    [DataContract(Name = "QaCheck")]
    public partial class QaCheck : IEquatable<QaCheck>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QaCheck" /> class.
        /// </summary>
        ...
        /// <param name="validationDescription">validationDescription.</param>
        /// <param name="pluralId">pluralId.</param>
        /// <param name="text">text.</param>
        public QaCheck(int stringId = default(int), string languageId = default(string), string category = default(string), string categoryDescription = default(string), string validation = default(string), string validationDescription = default(string), int pluralId = default(int), string text = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets ValidationDescription
        /// </summary>
        [DataMember(Name = "validationDescription", EmitDefaultValue = false)]
        public string ValidationDescription { get; set; }

        /// <summary>
        /// Gets or Sets PluralId
        /// </summary>
        [DataMember(Name = "pluralId", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ValidationDescription: ").Append(ValidationDescription).Append("\n");
            sb.Append("  PluralId: ").Append(PluralId).Append("\n");
        ...
        {
            return this.Equals(input as QaCheck);
        }

        /// <summary>
        /// Returns true if QaCheck instances are equal
        /// </summary>
        /// <param name="input">Instance of QaCheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QaCheck input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ValidationDescription == input.ValidationDescription ||
                    (this.ValidationDescription != null &&
                    this.ValidationDescription.Equals(input.ValidationDescription))
                ) && 
                (
                    this.PluralId == input.PluralId ||
                    this.PluralId.Equals(input.PluralId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ValidationDescription != null)
                    hashCode = hashCode * 59 + this.ValidationDescription.GetHashCode();
                hashCode = hashCode * 59 + this.PluralId.GetHashCode();
                if (this.Text != null)
