...
{
    /// <summary>
    /// TranslationCostsFuzzyStepsTranslate
    /// </summary>
    [DataContract(Name = "translation-costs-fuzzy.steps.translate")]
    public partial class TranslationCostsFuzzyStepsTranslate : IEquatable<TranslationCostsFuzzyStepsTranslate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCostsFuzzyStepsTranslate" /> class.
        /// </summary>
        ...
        public TranslationCostsFuzzyStepsTranslate(string type = default(string), string mode = default(string), List<CostEstimationFuzzyStepsTranslateRegularRates> regularRates = default(List<CostEstimationFuzzyStepsTranslateRegularRates>), List<CostEstimationFuzzyStepsTranslateIndividualRates> individualRates = default(List<CostEstimationFuzzyStepsTranslateIndividualRates>))
        {
            this.Type = type;
            this.Mode = mode;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCostsFuzzyStepsTranslate {\n");
        ...
        {
            return this.Equals(input as TranslationCostsFuzzyStepsTranslate);
        }

        /// <summary>
        /// Returns true if TranslationCostsFuzzyStepsTranslate instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCostsFuzzyStepsTranslate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCostsFuzzyStepsTranslate input)
        {
            if (input == null)
                return false;
