...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FileOperationTest")]
    ...
    public partial class FileOperationTest : FileOperation, IEquatable<FileOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FileOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FileOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;FileOperationTest&quot;).</param>
        ...
        public FileOperationTest(OneOfstringinteger value = default(OneOfstringinteger), OpEnum op = "FileOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for FileOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileOperationTest {\n");
        ...
        {
            return this.Equals(input as FileOperationTest);
        }

        /// <summary>
        /// Returns true if FileOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of FileOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileOperationTest input)
        {
            if (input == null)
                return false;
