...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomQaCheckOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(CustomQaCheckOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(CustomQaCheckOperationTest), "test")]
    public partial class CustomQaCheckOperationReplace : CustomQaCheckOperation, IEquatable<CustomQaCheckOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomQaCheckOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;CustomQaCheckOperationReplace&quot;).</param>
        ...
        public CustomQaCheckOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "CustomQaCheckOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for CustomQaCheckOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomQaCheckOperationReplace {\n");
        ...
        {
            return this.Equals(input as CustomQaCheckOperationReplace);
        }

        /// <summary>
        /// Returns true if CustomQaCheckOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomQaCheckOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomQaCheckOperationReplace input)
        {
            if (input == null)
                return false;
