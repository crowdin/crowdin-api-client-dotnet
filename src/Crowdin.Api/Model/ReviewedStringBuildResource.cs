...
{
    /// <summary>
    /// Reviewed String Build Resource
    /// </summary>
    [DataContract(Name = "ReviewedStringBuildResource")]
    public partial class ReviewedStringBuildResource : IEquatable<ReviewedStringBuildResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewedStringBuildResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ReviewedStringBuildResource(ReviewedStringBuild data = default(ReviewedStringBuild))
        {
            this.Data = data;
        }
        ...
        public ReviewedStringBuild Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReviewedStringBuildResource {\n");
        ...
        {
            return this.Equals(input as ReviewedStringBuildResource);
        }

        /// <summary>
        /// Returns true if ReviewedStringBuildResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ReviewedStringBuildResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReviewedStringBuildResource input)
        {
            if (input == null)
                return false;
