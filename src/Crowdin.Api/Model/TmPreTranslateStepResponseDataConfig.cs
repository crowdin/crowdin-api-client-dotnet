...
{
    /// <summary>
    /// TmPreTranslateStepResponseDataConfig
    /// </summary>
    [DataContract(Name = "TmPreTranslateStepResponse_data_config")]
    public partial class TmPreTranslateStepResponseDataConfig : IEquatable<TmPreTranslateStepResponseDataConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmPreTranslateStepResponseDataConfig" /> class.
        /// </summary>
        /// <param name="minRelevant">minRelevant.</param>
        /// <param name="autoSubstitution">autoSubstitution.</param>
        public TmPreTranslateStepResponseDataConfig(string minRelevant = default(string), int autoSubstitution = default(int))
        {
            this.MinRelevant = minRelevant;
            this.AutoSubstitution = autoSubstitution;
        }

        /// <summary>
        /// Gets or Sets MinRelevant
        /// </summary>
        [DataMember(Name = "minRelevant", EmitDefaultValue = false)]
        public string MinRelevant { get; set; }

        /// <summary>
        /// Gets or Sets AutoSubstitution
        /// </summary>
        [DataMember(Name = "autoSubstitution", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmPreTranslateStepResponseDataConfig {\n");
            sb.Append("  MinRelevant: ").Append(MinRelevant).Append("\n");
        ...
        {
            return this.Equals(input as TmPreTranslateStepResponseDataConfig);
        }

        /// <summary>
        /// Returns true if TmPreTranslateStepResponseDataConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of TmPreTranslateStepResponseDataConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmPreTranslateStepResponseDataConfig input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.MinRelevant == input.MinRelevant ||
                    (this.MinRelevant != null &&
                    this.MinRelevant.Equals(input.MinRelevant))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.MinRelevant != null)
                    hashCode = hashCode * 59 + this.MinRelevant.GetHashCode();
