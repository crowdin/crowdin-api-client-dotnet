...
namespace Crowdin.Api.Model
{
    ...
    /// Payment required
    /// </summary>
    [DataContract(Name = "PaymentRequiredExceptionResource")]
    public partial class PaymentRequiredExceptionResource : IEquatable<PaymentRequiredExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRequiredExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public PaymentRequiredExceptionResource(PaymentRequiredExceptionResourceError error = default(PaymentRequiredExceptionResourceError))
        {
            this.Error = error;
        }
        ...
        public PaymentRequiredExceptionResourceError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRequiredExceptionResource {\n");
        ...
        {
            return this.Equals(input as PaymentRequiredExceptionResource);
        }

        /// <summary>
        /// Returns true if PaymentRequiredExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRequiredExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRequiredExceptionResource input)
        {
            if (input == null)
                return false;
