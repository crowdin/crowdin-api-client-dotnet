...
namespace Crowdin.Api.Model
{
    ...
    public partial class Group : IEquatable<Group>, IValidatableObject
    {
        ...
        /// <param name="subgroupsCount">subgroupsCount.</param>
        /// <param name="projectsCount">projectsCount.</param>
        /// <param name="createdAt">createdAt.</param>
        /// <param name="updatedAt">updatedAt.</param>
        public Group(int id = default(int), string name = default(string), string description = default(string), int parentId = default(int), int organizationId = default(int), int userId = default(int), int subgroupsCount = default(int), int projectsCount = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets SubgroupsCount
        /// </summary>
        [DataMember(Name = "subgroupsCount", EmitDefaultValue = false)]
        public int SubgroupsCount { get; set; }

        /// <summary>
        /// Gets or Sets ProjectsCount
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubgroupsCount: ").Append(SubgroupsCount).Append("\n");
        ...
        public bool Equals(Group input)
        {
            ...
            return 
                ...
                (
                    this.SubgroupsCount == input.SubgroupsCount ||
                    this.SubgroupsCount.Equals(input.SubgroupsCount)
                ) && 
                (
                    this.ProjectsCount == input.ProjectsCount ||
                    this.ProjectsCount.Equals(input.ProjectsCount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.SubgroupsCount.GetHashCode();
                hashCode = hashCode * 59 + this.ProjectsCount.GetHashCode();
