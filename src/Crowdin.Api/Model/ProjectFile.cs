...
namespace Crowdin.Api.Model
{
    ...
    /// ProjectFile
    /// </summary>
    [DataContract(Name = "Project_File")]
    public partial class ProjectFile : IEquatable<ProjectFile>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ProjectFile);
        }

        /// <summary>
        /// Returns true if ProjectFile instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectFile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectFile input)
        {
            if (input == null)
                return false;
