...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamMemberResource")]
    public partial class TeamMemberResource : IEquatable<TeamMemberResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamMemberResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TeamMemberResource(TeamMember data = default(TeamMember))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamMemberResource {\n");
        ...
        {
            return this.Equals(input as TeamMemberResource);
        }

        /// <summary>
        /// Returns true if TeamMemberResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamMemberResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamMemberResource input)
        {
            if (input == null)
                return false;
