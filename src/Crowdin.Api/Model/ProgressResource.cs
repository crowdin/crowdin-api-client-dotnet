...
{
    /// <summary>
    /// Language Translation Progress Resource
    /// </summary>
    [DataContract(Name = "ProgressResource")]
    public partial class ProgressResource : IEquatable<ProgressResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgressResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ProgressResource(ProjectProgress data = default(ProjectProgress))
        {
            this.Data = data;
        }
        ...
        public ProjectProgress Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProgressResource {\n");
        ...
        {
            return this.Equals(input as ProgressResource);
        }

        /// <summary>
        /// Returns true if ProgressResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgressResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgressResource input)
        {
            if (input == null)
                return false;
