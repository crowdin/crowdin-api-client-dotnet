...
namespace Crowdin.Api.Model
{
    ...
    public partial class Branch : IEquatable<Branch>, IValidatableObject
    {
        ...
        public Branch(int id = default(int), int projectId = default(int), string name = default(string), string title = default(string), string exportPattern = default(string), string priority = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
