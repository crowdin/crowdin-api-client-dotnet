...
namespace Crowdin.Api.Model
{
    ...
    /// AttributeError
    /// </summary>
    [DataContract(Name = "AttributeError")]
    public partial class AttributeError : IEquatable<AttributeError>, IValidatableObject
    {
        /// <summary>
        ...
        public AttributeError(string code = default(string), string message = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as AttributeError);
        }

        /// <summary>
        /// Returns true if AttributeError instances are equal
        /// </summary>
        /// <param name="input">Instance of AttributeError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributeError input)
        {
            if (input == null)
                return false;
