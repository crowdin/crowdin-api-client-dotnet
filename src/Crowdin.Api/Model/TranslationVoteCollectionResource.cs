...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslationVoteCollectionResource")]
    public partial class TranslationVoteCollectionResource : IEquatable<TranslationVoteCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationVoteCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public TranslationVoteCollectionResource(List<TranslationVoteResource> data = default(List<TranslationVoteResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<TranslationVoteResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationVoteCollectionResource {\n");
        ...
        {
            return this.Equals(input as TranslationVoteCollectionResource);
        }

        /// <summary>
        /// Returns true if TranslationVoteCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationVoteCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationVoteCollectionResource input)
        {
            if (input == null)
                return false;
