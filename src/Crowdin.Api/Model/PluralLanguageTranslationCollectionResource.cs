...
{
    /// <summary>
    /// Plural Language Translation Collection Resource
    /// </summary>
    [DataContract(Name = "PluralLanguageTranslationCollectionResource")]
    public partial class PluralLanguageTranslationCollectionResource : IEquatable<PluralLanguageTranslationCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PluralLanguageTranslationCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public PluralLanguageTranslationCollectionResource(List<PluralLanguageTranslationResource> data = default(List<PluralLanguageTranslationResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<PluralLanguageTranslationResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PluralLanguageTranslationCollectionResource {\n");
        ...
        {
            return this.Equals(input as PluralLanguageTranslationCollectionResource);
        }

        /// <summary>
        /// Returns true if PluralLanguageTranslationCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PluralLanguageTranslationCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PluralLanguageTranslationCollectionResource input)
        {
            if (input == null)
                return false;
