...
{
    /// <summary>
    /// EnterpriseBuildAttributesResponseModel
    /// </summary>
    [DataContract(Name = "EnterpriseBuildAttributesResponseModel")]
    public partial class EnterpriseBuildAttributesResponseModel : IEquatable<EnterpriseBuildAttributesResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseBuildAttributesResponseModel" /> class.
        /// </summary>
        /// <param name="branchId">branchId.</param>
        /// <param name="targetLanguagesId">targetLanguagesId.</param>
        ...
        /// <param name="exportWithMinApprovalsCount">exportWithMinApprovalsCount.</param>
        public EnterpriseBuildAttributesResponseModel(int? branchId = default(int?), List<string> targetLanguagesId = default(List<string>), bool skipUntranslatedStrings = default(bool), bool skipUntranslatedFiles = default(bool), int exportWithMinApprovalsCount = default(int))
        {
        ...
        /// <summary>
        /// Gets or Sets TargetLanguagesId
        /// </summary>
        [DataMember(Name = "targetLanguagesId", EmitDefaultValue = false)]
        public List<string> TargetLanguagesId { get; set; }
        ...
        /// <summary>
        /// Gets or Sets ExportWithMinApprovalsCount
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseBuildAttributesResponseModel {\n");
            sb.Append("  BranchId: ").Append(BranchId).Append("\n");
            sb.Append("  TargetLanguagesId: ").Append(TargetLanguagesId).Append("\n");
        ...
        {
            return this.Equals(input as EnterpriseBuildAttributesResponseModel);
        }

        /// <summary>
        /// Returns true if EnterpriseBuildAttributesResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseBuildAttributesResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseBuildAttributesResponseModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TargetLanguagesId == input.TargetLanguagesId ||
                    this.TargetLanguagesId != null &&
                    input.TargetLanguagesId != null &&
                    this.TargetLanguagesId.SequenceEqual(input.TargetLanguagesId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TargetLanguagesId != null)
                    hashCode = hashCode * 59 + this.TargetLanguagesId.GetHashCode();
