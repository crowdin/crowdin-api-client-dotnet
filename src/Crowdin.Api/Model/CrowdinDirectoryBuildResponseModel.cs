...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinDirectoryBuildResponseModel")]
    public partial class CrowdinDirectoryBuildResponseModel : IEquatable<CrowdinDirectoryBuildResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinDirectoryBuildResponseModel" /> class.
        /// </summary>
        ...
        public CrowdinDirectoryBuildResponseModel(int? directoryId = default(int?), List<string> targetLanguagesId = default(List<string>), bool skipUntranslatedStrings = default(bool), bool skipUntranslatedFiles = default(bool), bool exportApprovedOnly = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinDirectoryBuildResponseModel {\n");
        ...
        {
            return this.Equals(input as CrowdinDirectoryBuildResponseModel);
        }

        /// <summary>
        /// Returns true if CrowdinDirectoryBuildResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinDirectoryBuildResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinDirectoryBuildResponseModel input)
        {
            if (input == null)
                return false;
