...
namespace Crowdin.Api.Model
{
    ...
    /// StringCreateForm
    /// </summary>
    [DataContract(Name = "StringCreateForm")]
    public partial class StringCreateForm : IEquatable<StringCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StringCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCreateForm" /> class.
        /// </summary>
        /// <param name="text">Text for translation (required).</param>
        /// <param name="identifier">Defines unique string identifier,  __Note:__ Required for strings-based projects or file-based projects if scheme of CSV file includes *identifier* column.</param>
        /// <param name="fileId">File Identifier. Get via [List Files](#operation/api.projects.files.getMany)  __Note:__ Required for file-based projects.</param>
        /// <param name="context">Use to provide additional information for better source text understanding.</param>
        /// <param name="isHidden">Defines whether to make string unavailable for translation (default to false).</param>
        /// <param name="maxLength">Max. length of translated text (0 – unlimited).</param>
        /// <param name="labelIds">Label Identifiers. Get via [List Labels](#operation/api.projects.labels.getMany).</param>
        public StringCreateForm(string text = default(string), string identifier = default(string), int fileId = default(int), string context = default(string), bool isHidden = false, int maxLength = default(int), List<int> labelIds = default(List<int>))
        {
            // to ensure "text" is required (not null)
            if (text == null) {
                throw new ArgumentNullException("text is a required property for StringCreateForm and cannot be null");
            }
            this.Text = text;
        ...
        /// </summary>
        /// <value>Text for translation</value>
        [DataMember(Name = "text", IsRequired = true, EmitDefaultValue = false)]
        public string Text { get; set; }

        /// <summary>
        /// Defines unique string identifier,  __Note:__ Required for strings-based projects or file-based projects if scheme of CSV file includes *identifier* column
        /// </summary>
        /// <value>Defines unique string identifier,  __Note:__ Required for strings-based projects or file-based projects if scheme of CSV file includes *identifier* column</value>
        [DataMember(Name = "identifier", EmitDefaultValue = false)]
        public string Identifier { get; set; }

        /// <summary>
        /// File Identifier. Get via [List Files](#operation/api.projects.files.getMany)  __Note:__ Required for file-based projects
        /// </summary>
        /// <value>File Identifier. Get via [List Files](#operation/api.projects.files.getMany)  __Note:__ Required for file-based projects</value>
        ...
        /// </summary>
        /// <value>Use to provide additional information for better source text understanding</value>
        [DataMember(Name = "context", EmitDefaultValue = false)]
        public string Context { get; set; }

        /// <summary>
        /// Defines whether to make string unavailable for translation
        /// </summary>
        /// <value>Defines whether to make string unavailable for translation</value>
        ...
        /// </summary>
        /// <value>Max. length of translated text (0 – unlimited)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringCreateForm {\n");
        ...
        {
            return this.Equals(input as StringCreateForm);
        }

        /// <summary>
        /// Returns true if StringCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of StringCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringCreateForm input)
        {
            if (input == null)
                return false;
