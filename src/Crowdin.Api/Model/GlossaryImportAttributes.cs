...
{
    /// <summary>
    /// GlossaryImportAttributes
    /// </summary>
    [DataContract(Name = "GlossaryImport_attributes")]
    public partial class GlossaryImportAttributes : IEquatable<GlossaryImportAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryImportAttributes" /> class.
        /// </summary>
        /// <param name="storageId">storageId.</param>
        /// <param name="scheme">scheme.</param>
        /// <param name="firstLineContainsHeader">firstLineContainsHeader.</param>
        public GlossaryImportAttributes(int storageId = default(int), GlossaryImportAttributesScheme scheme = default(GlossaryImportAttributesScheme), bool firstLineContainsHeader = default(bool))
        {
        ...
        public GlossaryImportAttributesScheme Scheme { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryImportAttributes {\n");
        ...
        {
            return this.Equals(input as GlossaryImportAttributes);
        }

        /// <summary>
        /// Returns true if GlossaryImportAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryImportAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryImportAttributes input)
        {
            if (input == null)
                return false;
