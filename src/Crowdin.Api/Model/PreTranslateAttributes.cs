...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreTranslateAttributes")]
    public partial class PreTranslateAttributes : IEquatable<PreTranslateAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreTranslateAttributes" /> class.
        /// </summary>
        /// <param name="languageIds">languageIds.</param>
        /// <param name="fileIds">fileIds.</param>
        /// <param name="method">method.</param>
        /// <param name="autoApproveOption">autoApproveOption.</param>
        /// <param name="duplicateTranslations">duplicateTranslations.</param>
        /// <param name="translateUntranslatedOnly">translateUntranslatedOnly.</param>
        /// <param name="translateWithPerfectMatchOnly">translateWithPerfectMatchOnly.</param>
        public PreTranslateAttributes(List<string> languageIds = default(List<string>), List<int> fileIds = default(List<int>), string method = default(string), string autoApproveOption = default(string), bool duplicateTranslations = default(bool), bool translateUntranslatedOnly = default(bool), bool translateWithPerfectMatchOnly = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreTranslateAttributes {\n");
        ...
        {
            return this.Equals(input as PreTranslateAttributes);
        }

        /// <summary>
        /// Returns true if PreTranslateAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of PreTranslateAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreTranslateAttributes input)
        {
            if (input == null)
                return false;
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AutoApproveOption != null)
