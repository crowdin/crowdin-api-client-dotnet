...
namespace Crowdin.Api.Model
{
    ...
    /// File Info Resource
    /// </summary>
    [DataContract(Name = "FileInfoResource")]
    public partial class FileInfoResource : IEquatable<FileInfoResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileInfoResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FileInfoResource(FileInfo data = default(FileInfo))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileInfoResource {\n");
        ...
        {
            return this.Equals(input as FileInfoResource);
        }

        /// <summary>
        /// Returns true if FileInfoResource instances are equal
        /// </summary>
        /// <param name="input">Instance of FileInfoResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileInfoResource input)
        {
            if (input == null)
                return false;
