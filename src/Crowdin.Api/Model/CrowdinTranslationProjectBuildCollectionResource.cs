...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinTranslationProjectBuildCollectionResource")]
    public partial class CrowdinTranslationProjectBuildCollectionResource : IEquatable<CrowdinTranslationProjectBuildCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTranslationProjectBuildCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public CrowdinTranslationProjectBuildCollectionResource(List<CrowdinTranslationProjectBuildResource> data = default(List<CrowdinTranslationProjectBuildResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<CrowdinTranslationProjectBuildResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTranslationProjectBuildCollectionResource {\n");
        ...
        {
            return this.Equals(input as CrowdinTranslationProjectBuildCollectionResource);
        }

        /// <summary>
        /// Returns true if CrowdinTranslationProjectBuildCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTranslationProjectBuildCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTranslationProjectBuildCollectionResource input)
        {
            if (input == null)
                return false;
