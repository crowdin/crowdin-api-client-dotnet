...
{
    /// <summary>
    /// CostEstimationReportFuzzyByTask
    /// </summary>
    [DataContract(Name = "cost-estimation.report.fuzzy.byTask")]
    public partial class CostEstimationReportFuzzyByTask : IEquatable<CostEstimationReportFuzzyByTask>, IValidatableObject
    {
        /// <summary>
        /// Defines report unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationReportFuzzyByTask" /> class.
        /// </summary>
        ...
        /// <param name="taskId">Task id. Get via [List Projects](#operation/api.projects.tasks.getMany).</param>
        /// <param name="regularRates">Class ReportCreateForm.</param>
        /// <param name="individualRates">Class ReportCreateForm.</param>
        public CostEstimationReportFuzzyByTask(UnitEnum? unit = UnitEnum.Words, CurrencyEnum? currency = CurrencyEnum.USD, FormatEnum? format = FormatEnum.Xlsx, string mode = default(string), bool calculateInternalFuzzyMatches = default(bool), int taskId = default(int), List<CostEstimationFuzzyRegularRates> regularRates = default(List<CostEstimationFuzzyRegularRates>), List<CostEstimationFuzzyIndividualRates> individualRates = default(List<CostEstimationFuzzyIndividualRates>))
        {
            this.Unit = unit;
        ...
        /// <summary>
        /// Task id. Get via [List Projects](#operation/api.projects.tasks.getMany)
        /// </summary>
        /// <value>Task id. Get via [List Projects](#operation/api.projects.tasks.getMany)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationReportFuzzyByTask {\n");
        ...
        {
            return this.Equals(input as CostEstimationReportFuzzyByTask);
        }

        /// <summary>
        /// Returns true if CostEstimationReportFuzzyByTask instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationReportFuzzyByTask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationReportFuzzyByTask input)
        {
            if (input == null)
                return false;
