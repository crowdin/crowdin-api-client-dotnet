...
{
    /// <summary>
    /// GroupReportGenerateAttributes
    /// </summary>
    [DataContract(Name = "GroupReportGenerate_attributes")]
    public partial class GroupReportGenerateAttributes : IEquatable<GroupReportGenerateAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupReportGenerateAttributes" /> class.
        /// </summary>
        /// <param name="format">format.</param>
        /// <param name="reportName">reportName.</param>
        /// <param name="projectIds">projectIds.</param>
        /// <param name="schema">schema.</param>
        public GroupReportGenerateAttributes(string format = default(string), string reportName = default(string), List<int> projectIds = default(List<int>), Object schema = default(Object))
        {
            this.Format = format;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupReportGenerateAttributes {\n");
        ...
        {
            return this.Equals(input as GroupReportGenerateAttributes);
        }

        /// <summary>
        /// Returns true if GroupReportGenerateAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupReportGenerateAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupReportGenerateAttributes input)
        {
            if (input == null)
                return false;
