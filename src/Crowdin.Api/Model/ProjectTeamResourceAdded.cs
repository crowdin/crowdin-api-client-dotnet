...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectTeamResourceAdded")]
    public partial class ProjectTeamResourceAdded : IEquatable<ProjectTeamResourceAdded>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTeamResourceAdded" /> class.
        /// </summary>
        /// <param name="skipped">skipped.</param>
        /// <param name="added">added.</param>
        public ProjectTeamResourceAdded(Object skipped = default(Object), ProjectTeam added = default(ProjectTeam))
        {
        ...
        public ProjectTeam Added { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectTeamResourceAdded {\n");
        ...
        {
            return this.Equals(input as ProjectTeamResourceAdded);
        }

        /// <summary>
        /// Returns true if ProjectTeamResourceAdded instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTeamResourceAdded to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTeamResourceAdded input)
        {
            if (input == null)
                return false;
