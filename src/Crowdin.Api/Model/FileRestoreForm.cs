...
namespace Crowdin.Api.Model
{
    ...
    /// FileRestoreForm
    /// </summary>
    [DataContract(Name = "FileRestoreForm")]
    public partial class FileRestoreForm : IEquatable<FileRestoreForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileRestoreForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FileRestoreForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FileRestoreForm" /> class.
        /// </summary>
        /// <param name="revisionId">Revision Identifier. Get via [List File Revisions](#operation/api.projects.files.revisions.getMany) (required).</param>
        public FileRestoreForm(int revisionId = default(int))
        {
            this.RevisionId = revisionId;
        }

        /// <summary>
        /// Revision Identifier. Get via [List File Revisions](#operation/api.projects.files.revisions.getMany)
        /// </summary>
        /// <value>Revision Identifier. Get via [List File Revisions](#operation/api.projects.files.revisions.getMany)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileRestoreForm {\n");
        ...
        {
            return this.Equals(input as FileRestoreForm);
        }

        /// <summary>
        /// Returns true if FileRestoreForm instances are equal
        /// </summary>
        /// <param name="input">Instance of FileRestoreForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileRestoreForm input)
        {
            if (input == null)
                return false;
