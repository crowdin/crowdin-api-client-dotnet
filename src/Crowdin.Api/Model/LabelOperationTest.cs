...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LabelOperationTest")]
    ...
    public partial class LabelOperationTest : LabelOperation, IEquatable<LabelOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LabelOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;LabelOperationTest&quot;).</param>
        ...
        public LabelOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "LabelOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for LabelOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LabelOperationTest {\n");
        ...
        {
            return this.Equals(input as LabelOperationTest);
        }

        /// <summary>
        /// Returns true if LabelOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelOperationTest input)
        {
            if (input == null)
                return false;
