...
{
    /// <summary>
    /// PluralLanguageTranslation
    /// </summary>
    [DataContract(Name = "PluralLanguageTranslation")]
    public partial class PluralLanguageTranslation : IEquatable<PluralLanguageTranslation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PluralLanguageTranslation" /> class.
        /// </summary>
        /// <param name="stringId">stringId.</param>
        /// <param name="contentType">contentType.</param>
        /// <param name="plurals">plurals.</param>
        public PluralLanguageTranslation(int stringId = default(int), string contentType = default(string), List<PluralSuggestionOfLanguageTranslation> plurals = default(List<PluralSuggestionOfLanguageTranslation>))
        {
        ...
        public List<PluralSuggestionOfLanguageTranslation> Plurals { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PluralLanguageTranslation {\n");
        ...
        {
            return this.Equals(input as PluralLanguageTranslation);
        }

        /// <summary>
        /// Returns true if PluralLanguageTranslation instances are equal
        /// </summary>
        /// <param name="input">Instance of PluralLanguageTranslation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PluralLanguageTranslation input)
        {
            if (input == null)
                return false;
