...
namespace Crowdin.Api.Model
{
    ...
    public partial class Team : IEquatable<Team>, IValidatableObject
    {
        ...
        public Team(int id = default(int), string name = default(string), int totalMembers = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.Name = name;
