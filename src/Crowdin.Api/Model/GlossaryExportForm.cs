...
namespace Crowdin.Api.Model
{
    ...
    /// GlossaryExportForm
    /// </summary>
    [DataContract(Name = "GlossaryExportForm")]
    public partial class GlossaryExportForm : IEquatable<GlossaryExportForm>, IValidatableObject
    {
        /// <summary>
        /// Supported formats:  *     &#39;tbx&#39;  *     &#39;csv&#39;  *     &#39;xlsx&#39;
        /// </summary>
        /// <value>Supported formats:  *     &#39;tbx&#39;  *     &#39;csv&#39;  *     &#39;xlsx&#39;</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryExportForm" /> class.
        /// </summary>
        /// <param name="format">Supported formats:  *     &#39;tbx&#39;  *     &#39;csv&#39;  *     &#39;xlsx&#39; (default to FormatEnum.Tbx).</param>
        public GlossaryExportForm(FormatEnum? format = FormatEnum.Tbx)
        {
            this.Format = format;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryExportForm {\n");
        ...
        {
            return this.Equals(input as GlossaryExportForm);
        }

        /// <summary>
        /// Returns true if GlossaryExportForm instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryExportForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryExportForm input)
        {
            if (input == null)
                return false;
