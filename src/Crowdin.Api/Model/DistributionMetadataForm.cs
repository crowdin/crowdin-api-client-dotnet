...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DistributionMetadataForm")]
    public partial class DistributionMetadataForm : IEquatable<DistributionMetadataForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionMetadataForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DistributionMetadataForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionMetadataForm" /> class.
        /// </summary>
        /// <param name="hash">Distribution hash (required).</param>
        public DistributionMetadataForm(string hash = default(string))
        {
            // to ensure "hash" is required (not null)
            if (hash == null) {
                throw new ArgumentNullException("hash is a required property for DistributionMetadataForm and cannot be null");
            }
            this.Hash = hash;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionMetadataForm {\n");
        ...
        {
            return this.Equals(input as DistributionMetadataForm);
        }

        /// <summary>
        /// Returns true if DistributionMetadataForm instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionMetadataForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionMetadataForm input)
        {
            if (input == null)
                return false;
