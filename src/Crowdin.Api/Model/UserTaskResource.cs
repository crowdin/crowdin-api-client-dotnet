...
namespace Crowdin.Api.Model
{
    ...
    /// User Task Resource
    /// </summary>
    [DataContract(Name = "UserTaskResource")]
    public partial class UserTaskResource : IEquatable<UserTaskResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserTaskResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public UserTaskResource(UserTask data = default(UserTask))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserTaskResource {\n");
        ...
        {
            return this.Equals(input as UserTaskResource);
        }

        /// <summary>
        /// Returns true if UserTaskResource instances are equal
        /// </summary>
        /// <param name="input">Instance of UserTaskResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserTaskResource input)
        {
            if (input == null)
                return false;
