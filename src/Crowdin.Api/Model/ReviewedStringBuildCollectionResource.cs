...
{
    /// <summary>
    /// Reviewed String Build Collection Resource
    /// </summary>
    [DataContract(Name = "ReviewedStringBuildCollectionResource")]
    public partial class ReviewedStringBuildCollectionResource : IEquatable<ReviewedStringBuildCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewedStringBuildCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public ReviewedStringBuildCollectionResource(List<ReviewedStringBuildResource> data = default(List<ReviewedStringBuildResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<ReviewedStringBuildResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReviewedStringBuildCollectionResource {\n");
        ...
        {
            return this.Equals(input as ReviewedStringBuildCollectionResource);
        }

        /// <summary>
        /// Returns true if ReviewedStringBuildCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ReviewedStringBuildCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReviewedStringBuildCollectionResource input)
        {
            if (input == null)
                return false;
