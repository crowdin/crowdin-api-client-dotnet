...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScreenshotCreateForm")]
    public partial class ScreenshotCreateForm : IEquatable<ScreenshotCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScreenshotCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotCreateForm" /> class.
        /// </summary>
        /// <param name="storageId">Storage Identifier. Get via [List Storages](#operation/api.storages.getMany).  Storage file must be image in one of the following formats:  *     &#39;jpeg&#39;  *     &#39;jpg&#39;  *     &#39;png&#39;  *     &#39;gif&#39; (required).</param>
        /// <param name="name">Screenshot name (required).</param>
        /// <param name="autoTag">Automatically tags screenshot.</param>
        public ScreenshotCreateForm(int storageId = default(int), string name = default(string), bool autoTag = default(bool))
        {
            this.StorageId = storageId;
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for ScreenshotCreateForm and cannot be null");
            }
            this.Name = name;
        ...
        /// <summary>
        /// Storage Identifier. Get via [List Storages](#operation/api.storages.getMany).  Storage file must be image in one of the following formats:  *     &#39;jpeg&#39;  *     &#39;jpg&#39;  *     &#39;png&#39;  *     &#39;gif&#39;
        /// </summary>
        /// <value>Storage Identifier. Get via [List Storages](#operation/api.storages.getMany).  Storage file must be image in one of the following formats:  *     &#39;jpeg&#39;  *     &#39;jpg&#39;  *     &#39;png&#39;  *     &#39;gif&#39;</value>
        ...
        /// </summary>
        /// <value>Automatically tags screenshot</value>
        [DataMember(Name = "autoTag", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScreenshotCreateForm {\n");
            sb.Append("  StorageId: ").Append(StorageId).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  AutoTag: ").Append(AutoTag).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ScreenshotCreateForm);
        }

        /// <summary>
        /// Returns true if ScreenshotCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotCreateForm input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AutoTag == input.AutoTag ||
                    this.AutoTag.Equals(input.AutoTag)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.AutoTag.GetHashCode();
                return hashCode;
            }
        }
