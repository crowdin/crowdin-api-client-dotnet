...
namespace Crowdin.Api.Model
{
    ...
    /// Project Resource
    /// </summary>
    [DataContract(Name = "EnterpriseProjectInfoResource")]
    public partial class EnterpriseProjectInfoResource : IEquatable<EnterpriseProjectInfoResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseProjectInfoResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EnterpriseProjectInfoResource(ProjectResponse data = default(ProjectResponse))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseProjectInfoResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseProjectInfoResource);
        }

        /// <summary>
        /// Returns true if EnterpriseProjectInfoResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseProjectInfoResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseProjectInfoResource input)
        {
            if (input == null)
                return false;
