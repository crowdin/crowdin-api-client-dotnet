...
{
    /// <summary>
    /// CostEstimationStepsProofreadRegularRates
    /// </summary>
    [DataContract(Name = "cost-estimation.steps.proofread.regular-rates")]
    public partial class CostEstimationStepsProofreadRegularRates : IEquatable<CostEstimationStepsProofreadRegularRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationStepsProofreadRegularRates" /> class.
        /// </summary>
        /// <param name="mode">proofread.</param>
        /// <param name="value">0.05.</param>
        public CostEstimationStepsProofreadRegularRates(string mode = default(string), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationStepsProofreadRegularRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationStepsProofreadRegularRates);
        }

        /// <summary>
        /// Returns true if CostEstimationStepsProofreadRegularRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationStepsProofreadRegularRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationStepsProofreadRegularRates input)
        {
            if (input == null)
                return false;
