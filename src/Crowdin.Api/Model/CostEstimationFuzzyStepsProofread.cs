...
{
    /// <summary>
    /// CostEstimationFuzzyStepsProofread
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.steps.proofread")]
    public partial class CostEstimationFuzzyStepsProofread : IEquatable<CostEstimationFuzzyStepsProofread>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyStepsProofread" /> class.
        /// </summary>
        /// <param name="type">Proofread.</param>
        ...
        public CostEstimationFuzzyStepsProofread(string type = default(string), string mode = default(string), List<CostEstimationFuzzyStepsProofreadRegularRates> regularRates = default(List<CostEstimationFuzzyStepsProofreadRegularRates>), List<CostEstimationFuzzyStepsProofreadIndividualRates> individualRates = default(List<CostEstimationFuzzyStepsProofreadIndividualRates>))
        {
            this.Type = type;
            this.Mode = mode;
        ...
        public List<CostEstimationFuzzyStepsProofreadRegularRates> RegularRates { get; set; }
        ...
        public List<CostEstimationFuzzyStepsProofreadIndividualRates> IndividualRates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyStepsProofread {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyStepsProofread);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyStepsProofread instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyStepsProofread to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyStepsProofread input)
        {
            if (input == null)
                return false;
