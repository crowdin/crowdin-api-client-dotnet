...
{
    /// <summary>
    /// EnterpriseFileBuildForm
    /// </summary>
    [DataContract(Name = "EnterpriseFileBuildForm")]
    public partial class EnterpriseFileBuildForm : IEquatable<EnterpriseFileBuildForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseFileBuildForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnterpriseFileBuildForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseFileBuildForm" /> class.
        /// </summary>
        ...
        /// <param name="skipUntranslatedFiles">Defines whether to export only translated files  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedStrings&#x3D;true&#x60; in same request.</param>
        /// <param name="exportWithMinApprovalsCount">Defines whether to export only approved strings.</param>
        public EnterpriseFileBuildForm(string targetLanguageId = default(string), bool exportAsXliff = false, bool skipUntranslatedStrings = false, bool skipUntranslatedFiles = default(bool), int exportWithMinApprovalsCount = default(int))
        {
            // to ensure "targetLanguageId" is required (not null)
            if (targetLanguageId == null) {
                throw new ArgumentNullException("targetLanguageId is a required property for EnterpriseFileBuildForm and cannot be null");
            }
        ...
        /// <summary>
        /// Defines whether to export only translated files  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedStrings&#x3D;true&#x60; in same request
        /// </summary>
        /// <value>Defines whether to export only translated files  __Note:__ &#x60;true&#x60; value can&#39;t be used with &#x60;skipUntranslatedStrings&#x3D;true&#x60; in same request</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseFileBuildForm {\n");
        ...
        {
            return this.Equals(input as EnterpriseFileBuildForm);
        }

        /// <summary>
        /// Returns true if EnterpriseFileBuildForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseFileBuildForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseFileBuildForm input)
        {
            if (input == null)
                return false;
