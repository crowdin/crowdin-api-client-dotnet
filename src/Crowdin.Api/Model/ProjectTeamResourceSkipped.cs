...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectTeamResourceSkipped")]
    public partial class ProjectTeamResourceSkipped : IEquatable<ProjectTeamResourceSkipped>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTeamResourceSkipped" /> class.
        /// </summary>
        /// <param name="skipped">skipped.</param>
        /// <param name="added">added.</param>
        public ProjectTeamResourceSkipped(ProjectTeam skipped = default(ProjectTeam), Object added = default(Object))
        {
        ...
        public ProjectTeam Skipped { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectTeamResourceSkipped {\n");
        ...
        {
            return this.Equals(input as ProjectTeamResourceSkipped);
        }

        /// <summary>
        /// Returns true if ProjectTeamResourceSkipped instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTeamResourceSkipped to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTeamResourceSkipped input)
        {
            if (input == null)
                return false;
