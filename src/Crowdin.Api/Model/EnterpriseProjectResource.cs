...
namespace Crowdin.Api.Model
{
    ...
    /// Project Resource
    /// </summary>
    [DataContract(Name = "EnterpriseProjectResource")]
    public partial class EnterpriseProjectResource : IEquatable<EnterpriseProjectResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseProjectResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EnterpriseProjectResource(ProjectResponse data = default(ProjectResponse))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseProjectResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseProjectResource);
        }

        /// <summary>
        /// Returns true if EnterpriseProjectResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseProjectResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseProjectResource input)
        {
            if (input == null)
                return false;
