...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(TaskOperationReplace), "TaskOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(TaskOperationTest), "TaskOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(TaskOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(TaskOperationTest), "test")]
    public partial class TaskOperation : IEquatable<TaskOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum PathEnum
        {
            ...
            /// <summary>
            /// Enum SplitFiles for value: /splitFiles
            /// </summary>
            [EnumMember(Value = "/splitFiles")]
            SplitFiles = 5,

            /// <summary>
            /// Enum FileIds for value: /fileIds
            /// </summary>
            [EnumMember(Value = "/fileIds")]
            FileIds = 6,

            /// <summary>
            /// Enum Assignees for value: /assignees
            /// </summary>
            [EnumMember(Value = "/assignees")]
            Assignees = 7,

            /// <summary>
            /// Enum DateFrom for value: /dateFrom
            /// </summary>
            [EnumMember(Value = "/dateFrom")]
            DateFrom = 8,

            /// <summary>
            /// Enum DateTo for value: /dateTo
            /// </summary>
            [EnumMember(Value = "/dateTo")]
            DateTo = 9,

            /// <summary>
            /// Enum LabelIds for value: /labelIds
            /// </summary>
            [EnumMember(Value = "/labelIds")]
            LabelIds = 10
        ...
        public TaskOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as TaskOperation);
        }

        /// <summary>
        /// Returns true if TaskOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskOperation input)
        {
            if (input == null)
                return false;
