...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GlossaryOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(GlossaryOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(GlossaryOperationTest), "test")]
    public partial class GlossaryOperationReplace : GlossaryOperation, IEquatable<GlossaryOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GlossaryOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;GlossaryOperationReplace&quot;).</param>
        ...
        public GlossaryOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "GlossaryOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for GlossaryOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryOperationReplace {\n");
        ...
        {
            return this.Equals(input as GlossaryOperationReplace);
        }

        /// <summary>
        /// Returns true if GlossaryOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryOperationReplace input)
        {
            if (input == null)
                return false;
