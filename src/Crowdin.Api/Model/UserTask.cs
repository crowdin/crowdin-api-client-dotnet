...
namespace Crowdin.Api.Model
{
    ...
    /// UserTask
    /// </summary>
    [DataContract(Name = "UserTask")]
    public partial class UserTask : IEquatable<UserTask>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        {
            return this.Equals(input as UserTask);
        }

        /// <summary>
        /// Returns true if UserTask instances are equal
        /// </summary>
        /// <param name="input">Instance of UserTask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserTask input)
        {
            if (input == null)
                return false;
