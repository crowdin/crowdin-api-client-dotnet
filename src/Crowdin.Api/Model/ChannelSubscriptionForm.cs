...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ChannelSubscriptionForm")]
    public partial class ChannelSubscriptionForm : IEquatable<ChannelSubscriptionForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelSubscriptionForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChannelSubscriptionForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelSubscriptionForm" /> class.
        /// </summary>
        /// <param name="subscriptionId">Notification channel Subscription Identifier (required).</param>
        public ChannelSubscriptionForm(string subscriptionId = default(string))
        {
            // to ensure "subscriptionId" is required (not null)
            if (subscriptionId == null) {
                throw new ArgumentNullException("subscriptionId is a required property for ChannelSubscriptionForm and cannot be null");
            }
            this.SubscriptionId = subscriptionId;
        }

        /// <summary>
        /// Notification channel Subscription Identifier
        /// </summary>
        /// <value>Notification channel Subscription Identifier</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChannelSubscriptionForm {\n");
        ...
        {
            return this.Equals(input as ChannelSubscriptionForm);
        }

        /// <summary>
        /// Returns true if ChannelSubscriptionForm instances are equal
        /// </summary>
        /// <param name="input">Instance of ChannelSubscriptionForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChannelSubscriptionForm input)
        {
            if (input == null)
                return false;
