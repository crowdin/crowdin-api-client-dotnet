...
{
    /// <summary>
    /// Language Translation Progress Collection Resource
    /// </summary>
    [DataContract(Name = "ProgressCollectionResource")]
    public partial class ProgressCollectionResource : IEquatable<ProgressCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgressCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public ProgressCollectionResource(List<ProgressResource> data = default(List<ProgressResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<ProgressResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProgressCollectionResource {\n");
        ...
        {
            return this.Equals(input as ProgressCollectionResource);
        }

        /// <summary>
        /// Returns true if ProgressCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgressCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgressCollectionResource input)
        {
            if (input == null)
                return false;
