...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LabelOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(LabelOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(LabelOperationTest), "test")]
    public partial class LabelOperationReplace : LabelOperation, IEquatable<LabelOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LabelOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;LabelOperationReplace&quot;).</param>
        ...
        public LabelOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "LabelOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for LabelOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LabelOperationReplace {\n");
        ...
        {
            return this.Equals(input as LabelOperationReplace);
        }

        /// <summary>
        /// Returns true if LabelOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelOperationReplace input)
        {
            if (input == null)
                return false;
