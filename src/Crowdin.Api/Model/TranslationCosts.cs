...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslationCosts")]
    public partial class TranslationCosts : IEquatable<TranslationCosts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCosts" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranslationCosts() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCosts" /> class.
        /// </summary>
        /// <param name="name">translation-costs (required).</param>
        /// <param name="schema">schema (required).</param>
        public TranslationCosts(string name = default(string), TranslationCostsSchema schema = default(TranslationCostsSchema))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for TranslationCosts and cannot be null");
            }
            this.Name = name;
            // to ensure "schema" is required (not null)
            if (schema == null) {
                throw new ArgumentNullException("schema is a required property for TranslationCosts and cannot be null");
            }
            this.Schema = schema;
        }
        ...
        public TranslationCostsSchema Schema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCosts {\n");
        ...
        {
            return this.Equals(input as TranslationCosts);
        }

        /// <summary>
        /// Returns true if TranslationCosts instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCosts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCosts input)
        {
            if (input == null)
                return false;
