...
namespace Crowdin.Api.Model
{
    ...
    /// LanguageProgress
    /// </summary>
    [DataContract(Name = "LanguageProgress")]
    public partial class LanguageProgress : IEquatable<LanguageProgress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageProgress" /> class.
        /// </summary>
        /// <param name="words">words.</param>
        /// <param name="phrases">phrases.</param>
        /// <param name="translationProgress">translationProgress.</param>
        /// <param name="approvalProgress">approvalProgress.</param>
        /// <param name="fileId">fileId.</param>
        /// <param name="eTag">eTag.</param>
        public LanguageProgress(ProgressWords words = default(ProgressWords), ProgressPhrases phrases = default(ProgressPhrases), int translationProgress = default(int), int approvalProgress = default(int), int fileId = default(int), string eTag = default(string))
        {
            this.Words = words;
        ...
        public ProgressWords Words { get; set; }

        /// <summary>
        /// Gets or Sets Phrases
        /// </summary>
        [DataMember(Name = "phrases", EmitDefaultValue = false)]
        public ProgressPhrases Phrases { get; set; }

        /// <summary>
        /// Gets or Sets TranslationProgress
        /// </summary>
        [DataMember(Name = "translationProgress", EmitDefaultValue = false)]
        public int TranslationProgress { get; set; }

        /// <summary>
        /// Gets or Sets ApprovalProgress
        /// </summary>
        [DataMember(Name = "approvalProgress", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LanguageProgress {\n");
            sb.Append("  Words: ").Append(Words).Append("\n");
            sb.Append("  Phrases: ").Append(Phrases).Append("\n");
            sb.Append("  TranslationProgress: ").Append(TranslationProgress).Append("\n");
            sb.Append("  ApprovalProgress: ").Append(ApprovalProgress).Append("\n");
        ...
        {
            return this.Equals(input as LanguageProgress);
        }

        /// <summary>
        /// Returns true if LanguageProgress instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageProgress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageProgress input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    (this.Phrases != null &&
                    this.Phrases.Equals(input.Phrases))
                ) && 
                (
                    this.TranslationProgress == input.TranslationProgress ||
                    this.TranslationProgress.Equals(input.TranslationProgress)
                ) && 
                (
                    this.ApprovalProgress == input.ApprovalProgress ||
                    this.ApprovalProgress.Equals(input.ApprovalProgress)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.TranslationProgress.GetHashCode();
                hashCode = hashCode * 59 + this.ApprovalProgress.GetHashCode();
