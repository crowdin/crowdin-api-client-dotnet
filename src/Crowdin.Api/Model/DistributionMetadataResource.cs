...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DistributionMetadataResource")]
    public partial class DistributionMetadataResource : IEquatable<DistributionMetadataResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionMetadataResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public DistributionMetadataResource(DistributionInfo data = default(DistributionInfo))
        {
            this.Data = data;
        }
        ...
        public DistributionInfo Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionMetadataResource {\n");
        ...
        {
            return this.Equals(input as DistributionMetadataResource);
        }

        /// <summary>
        /// Returns true if DistributionMetadataResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionMetadataResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionMetadataResource input)
        {
            if (input == null)
                return false;
