...
{
    /// <summary>
    /// CostEstimationReportGeneral
    /// </summary>
    [DataContract(Name = "cost-estimation.report.general")]
    public partial class CostEstimationReportGeneral : IEquatable<CostEstimationReportGeneral>, IValidatableObject
    {
        /// <summary>
        /// Defines report unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationReportGeneral" /> class.
        /// </summary>
        ...
        public CostEstimationReportGeneral(UnitEnum? unit = UnitEnum.Words, CurrencyEnum? currency = CurrencyEnum.USD, FormatEnum? format = FormatEnum.Xlsx, string mode = default(string), string languageId = default(string), List<int> fileIds = default(List<int>), List<int> directoryIds = default(List<int>), List<int> branchIds = default(List<int>), List<CostEstimationRegularRates> regularRates = default(List<CostEstimationRegularRates>), List<CostEstimationIndividualRates> individualRates = default(List<CostEstimationIndividualRates>), DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime), List<int> labelIds = default(List<int>), LabelIncludeTypeEnum? labelIncludeType = LabelIncludeTypeEnum.WithLabel)
        {
            this.Unit = unit;
        ...
        public List<CostEstimationRegularRates> RegularRates { get; set; }
        ...
        public List<CostEstimationIndividualRates> IndividualRates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationReportGeneral {\n");
        ...
        {
            return this.Equals(input as CostEstimationReportGeneral);
        }

        /// <summary>
        /// Returns true if CostEstimationReportGeneral instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationReportGeneral to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationReportGeneral input)
        {
            if (input == null)
                return false;
