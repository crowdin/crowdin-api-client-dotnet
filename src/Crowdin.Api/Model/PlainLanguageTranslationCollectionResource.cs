...
{
    /// <summary>
    /// Plain Language Translation Collection Resource
    /// </summary>
    [DataContract(Name = "PlainLanguageTranslationCollectionResource")]
    public partial class PlainLanguageTranslationCollectionResource : IEquatable<PlainLanguageTranslationCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlainLanguageTranslationCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public PlainLanguageTranslationCollectionResource(List<PlainLanguageTranslationResource> data = default(List<PlainLanguageTranslationResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<PlainLanguageTranslationResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlainLanguageTranslationCollectionResource {\n");
        ...
        {
            return this.Equals(input as PlainLanguageTranslationCollectionResource);
        }

        /// <summary>
        /// Returns true if PlainLanguageTranslationCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PlainLanguageTranslationCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlainLanguageTranslationCollectionResource input)
        {
            if (input == null)
                return false;
