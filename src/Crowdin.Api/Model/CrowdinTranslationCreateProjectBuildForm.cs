...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinTranslationCreateProjectBuildForm")]
    public partial class CrowdinTranslationCreateProjectBuildForm : IEquatable<CrowdinTranslationCreateProjectBuildForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTranslationCreateProjectBuildForm" /> class.
        /// </summary>
        ...
        public CrowdinTranslationCreateProjectBuildForm(int branchId = default(int), List<string> targetLanguageIds = default(List<string>), bool skipUntranslatedStrings = default(bool), bool skipUntranslatedFiles = default(bool), bool exportApprovedOnly = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTranslationCreateProjectBuildForm {\n");
        ...
        {
            return this.Equals(input as CrowdinTranslationCreateProjectBuildForm);
        }

        /// <summary>
        /// Returns true if CrowdinTranslationCreateProjectBuildForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTranslationCreateProjectBuildForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTranslationCreateProjectBuildForm input)
        {
            if (input == null)
                return false;
