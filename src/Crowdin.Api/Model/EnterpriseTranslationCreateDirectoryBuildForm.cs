...
{
    /// <summary>
    /// EnterpriseTranslationCreateDirectoryBuildForm
    /// </summary>
    [DataContract(Name = "EnterpriseTranslationCreateDirectoryBuildForm")]
    public partial class EnterpriseTranslationCreateDirectoryBuildForm : IEquatable<EnterpriseTranslationCreateDirectoryBuildForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTranslationCreateDirectoryBuildForm" /> class.
        /// </summary>
        ...
        public EnterpriseTranslationCreateDirectoryBuildForm(List<string> targetLanguageIds = default(List<string>), bool skipUntranslatedStrings = false, bool skipUntranslatedFiles = default(bool), int exportWithMinApprovalsCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTranslationCreateDirectoryBuildForm {\n");
        ...
        {
            return this.Equals(input as EnterpriseTranslationCreateDirectoryBuildForm);
        }

        /// <summary>
        /// Returns true if EnterpriseTranslationCreateDirectoryBuildForm instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTranslationCreateDirectoryBuildForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTranslationCreateDirectoryBuildForm input)
        {
            if (input == null)
                return false;
