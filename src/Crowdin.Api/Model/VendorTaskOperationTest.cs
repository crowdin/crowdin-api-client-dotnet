...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VendorTaskOperationTest")]
    ...
    public partial class VendorTaskOperationTest : VendorTaskOperation, IEquatable<VendorTaskOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VendorTaskOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VendorTaskOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VendorTaskOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;VendorTaskOperationTest&quot;).</param>
        ...
        public VendorTaskOperationTest(OneOfstringbooleanarrayarray value = default(OneOfstringbooleanarrayarray), OpEnum op = "VendorTaskOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for VendorTaskOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VendorTaskOperationTest {\n");
        ...
        {
            return this.Equals(input as VendorTaskOperationTest);
        }

        /// <summary>
        /// Returns true if VendorTaskOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of VendorTaskOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VendorTaskOperationTest input)
        {
            if (input == null)
                return false;
