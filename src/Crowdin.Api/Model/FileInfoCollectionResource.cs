...
{
    /// <summary>
    /// File Info Collection Resource
    /// </summary>
    [DataContract(Name = "FileInfoCollectionResource")]
    public partial class FileInfoCollectionResource : IEquatable<FileInfoCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileInfoCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public FileInfoCollectionResource(List<FileInfoResource> data = default(List<FileInfoResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<FileInfoResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileInfoCollectionResource {\n");
        ...
        {
            return this.Equals(input as FileInfoCollectionResource);
        }

        /// <summary>
        /// Returns true if FileInfoCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of FileInfoCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileInfoCollectionResource input)
        {
            if (input == null)
                return false;
