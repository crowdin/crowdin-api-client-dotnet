...
{
    /// <summary>
    /// AuthenticateErrorError
    /// </summary>
    [DataContract(Name = "AuthenticateError_error")]
    public partial class AuthenticateErrorError : IEquatable<AuthenticateErrorError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthenticateErrorError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public AuthenticateErrorError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthenticateErrorError {\n");
        ...
        {
            return this.Equals(input as AuthenticateErrorError);
        }

        /// <summary>
        /// Returns true if AuthenticateErrorError instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthenticateErrorError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthenticateErrorError input)
        {
            if (input == null)
                return false;
