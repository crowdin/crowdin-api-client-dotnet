...
{
    /// <summary>
    /// Branch Collection Resource
    /// </summary>
    [DataContract(Name = "BranchCollectionResource")]
    public partial class BranchCollectionResource : IEquatable<BranchCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public BranchCollectionResource(List<BranchResource> data = default(List<BranchResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<BranchResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BranchCollectionResource {\n");
        ...
        {
            return this.Equals(input as BranchCollectionResource);
        }

        /// <summary>
        /// Returns true if BranchCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchCollectionResource input)
        {
            if (input == null)
                return false;
