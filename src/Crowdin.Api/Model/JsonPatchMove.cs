...
{
    /// <summary>
    /// A JSON Patch &#x60;Move&#x60; operation as defined by [RFC 6902](https://tools.ietf.org/html/rfc6902#section-4.4)
    /// </summary>
    [DataContract(Name = "JsonPatchMove")]
    ...
    public partial class JsonPatchMove : JsonPatchOperation, IEquatable<JsonPatchMove>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchMove" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JsonPatchMove() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchMove" /> class.
        /// </summary>
        ...
        /// <param name="op">Patch operation to perform (required) (default to &quot;JsonPatchMove&quot;).</param>
        ...
        public JsonPatchMove(string from = default(string), OpEnum op = "JsonPatchMove", string path = default(string)) : base(op, path)
        {
            // to ensure "from" is required (not null)
            if (from == null) {
                throw new ArgumentNullException("from is a required property for JsonPatchMove and cannot be null");
            }
            this.From = from;
        }
        ...
        {
            return this.Equals(input as JsonPatchMove);
        }

        /// <summary>
        /// Returns true if JsonPatchMove instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonPatchMove to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonPatchMove input)
        {
            if (input == null)
                return false;
