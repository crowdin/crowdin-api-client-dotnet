...
{
    /// <summary>
    /// CrowdsourceStepResponse
    /// </summary>
    [DataContract(Name = "CrowdsourceStepResponse")]
    public partial class CrowdsourceStepResponse : IEquatable<CrowdsourceStepResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdsourceStepResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CrowdsourceStepResponse(CrowdsourceStepResponseData data = default(CrowdsourceStepResponseData))
        {
            this.Data = data;
        }
        ...
        public CrowdsourceStepResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdsourceStepResponse {\n");
        ...
        {
            return this.Equals(input as CrowdsourceStepResponse);
        }

        /// <summary>
        /// Returns true if CrowdsourceStepResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdsourceStepResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdsourceStepResponse input)
        {
            if (input == null)
                return false;
