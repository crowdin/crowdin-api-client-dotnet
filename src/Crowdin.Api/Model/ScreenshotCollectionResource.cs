...
{
    /// <summary>
    /// Screenshot Collection Resource
    /// </summary>
    [DataContract(Name = "ScreenshotCollectionResource")]
    public partial class ScreenshotCollectionResource : IEquatable<ScreenshotCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public ScreenshotCollectionResource(List<ScreenshotResource> data = default(List<ScreenshotResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<ScreenshotResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScreenshotCollectionResource {\n");
        ...
        {
            return this.Equals(input as ScreenshotCollectionResource);
        }

        /// <summary>
        /// Returns true if ScreenshotCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotCollectionResource input)
        {
            if (input == null)
                return false;
