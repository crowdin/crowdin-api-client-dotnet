...
{
    /// <summary>
    /// CostEstimationStepsTranslate
    /// </summary>
    [DataContract(Name = "cost-estimation.steps.translate")]
    public partial class CostEstimationStepsTranslate : IEquatable<CostEstimationStepsTranslate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationStepsTranslate" /> class.
        /// </summary>
        ...
        public CostEstimationStepsTranslate(string type = default(string), string mode = default(string), List<CostEstimationStepsTranslateRegularRates> regularRates = default(List<CostEstimationStepsTranslateRegularRates>), List<CostEstimationStepsTranslateIndividualRates> individualRates = default(List<CostEstimationStepsTranslateIndividualRates>))
        {
            this.Type = type;
            this.Mode = mode;
        ...
        public List<CostEstimationStepsTranslateRegularRates> RegularRates { get; set; }
        ...
        public List<CostEstimationStepsTranslateIndividualRates> IndividualRates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationStepsTranslate {\n");
        ...
        {
            return this.Equals(input as CostEstimationStepsTranslate);
        }

        /// <summary>
        /// Returns true if CostEstimationStepsTranslate instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationStepsTranslate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationStepsTranslate input)
        {
            if (input == null)
                return false;
