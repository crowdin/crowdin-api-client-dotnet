...
{
    /// <summary>
    /// GlossaryExportAttributes
    /// </summary>
    [DataContract(Name = "GlossaryExport_attributes")]
    public partial class GlossaryExportAttributes : IEquatable<GlossaryExportAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryExportAttributes" /> class.
        /// </summary>
        /// <param name="format">format.</param>
        public GlossaryExportAttributes(string format = default(string))
        {
            this.Format = format;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryExportAttributes {\n");
        ...
        {
            return this.Equals(input as GlossaryExportAttributes);
        }

        /// <summary>
        /// Returns true if GlossaryExportAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryExportAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryExportAttributes input)
        {
            if (input == null)
                return false;
