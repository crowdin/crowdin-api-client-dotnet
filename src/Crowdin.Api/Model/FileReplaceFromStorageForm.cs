...
{
    /// <summary>
    /// FileReplaceFromStorageForm
    /// </summary>
    [DataContract(Name = "FileReplaceFromStorageForm")]
    public partial class FileReplaceFromStorageForm : IEquatable<FileReplaceFromStorageForm>, IValidatableObject
    {
        /// <summary>
        /// Defines whether to keep existing translations and approvals for updated strings
        /// </summary>
        /// <value>Defines whether to keep existing translations and approvals for updated strings</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum UpdateOptionEnum
        {
            /// <summary>
            /// Enum ClearTranslationsAndApprovals for value: clear_translations_and_approvals
            /// </summary>
            [EnumMember(Value = "clear_translations_and_approvals")]
            ClearTranslationsAndApprovals = 1,

            /// <summary>
            /// Enum KeepTranslations for value: keep_translations
            /// </summary>
            [EnumMember(Value = "keep_translations")]
            KeepTranslations = 2,

            /// <summary>
            /// Enum KeepTranslationsAndApprovals for value: keep_translations_and_approvals
            /// </summary>
            [EnumMember(Value = "keep_translations_and_approvals")]
            KeepTranslationsAndApprovals = 3
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileReplaceFromStorageForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FileReplaceFromStorageForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FileReplaceFromStorageForm" /> class.
        /// </summary>
        /// <param name="storageId">Storage Identifier. Get via [List Storages](#operation/api.storages.getMany) (required).</param>
        /// <param name="updateOption">Defines whether to keep existing translations and approvals for updated strings (default to UpdateOptionEnum.ClearTranslationsAndApprovals).</param>
        /// <param name="importOptions">importOptions.</param>
        /// <param name="exportOptions">exportOptions.</param>
        /// <param name="attachLabelIds">Attach labels to updated strings. Get via [List Labels](#operation/api.projects.labels.getMany).</param>
        /// <param name="detachLabelIds">Detach labels from updated strings. Get via [List Labels](#operation/api.projects.labels.getMany).</param>
        public FileReplaceFromStorageForm(int storageId = default(int), UpdateOptionEnum? updateOption = UpdateOptionEnum.ClearTranslationsAndApprovals, FileImportOptions importOptions = default(FileImportOptions), FileExportOptions exportOptions = default(FileExportOptions), List<int> attachLabelIds = default(List<int>), List<int> detachLabelIds = default(List<int>))
        {
        ...
        /// <summary>
        /// Attach labels to updated strings. Get via [List Labels](#operation/api.projects.labels.getMany)
        /// </summary>
        /// <value>Attach labels to updated strings. Get via [List Labels](#operation/api.projects.labels.getMany)</value>
        [DataMember(Name = "attachLabelIds", EmitDefaultValue = false)]
        public List<int> AttachLabelIds { get; set; }

        /// <summary>
        /// Detach labels from updated strings. Get via [List Labels](#operation/api.projects.labels.getMany)
        /// </summary>
        /// <value>Detach labels from updated strings. Get via [List Labels](#operation/api.projects.labels.getMany)</value>
        [DataMember(Name = "detachLabelIds", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileReplaceFromStorageForm {\n");
            ...
            sb.Append("  DetachLabelIds: ").Append(DetachLabelIds).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as FileReplaceFromStorageForm);
        }

        /// <summary>
        /// Returns true if FileReplaceFromStorageForm instances are equal
        /// </summary>
        /// <param name="input">Instance of FileReplaceFromStorageForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileReplaceFromStorageForm input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DetachLabelIds == input.DetachLabelIds ||
                    this.DetachLabelIds != null &&
                    input.DetachLabelIds != null &&
                    this.DetachLabelIds.SequenceEqual(input.DetachLabelIds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DetachLabelIds != null)
                    hashCode = hashCode * 59 + this.DetachLabelIds.GetHashCode();
                return hashCode;
            }
        }
