...
namespace Crowdin.Api.Model
{
    ...
    /// Language Mapping
    /// </summary>
    [DataContract(Name = "EnterpriseProjectCreateForm_languageMapping")]
    public partial class EnterpriseProjectCreateFormLanguageMapping : IEquatable<EnterpriseProjectCreateFormLanguageMapping>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseProjectCreateFormLanguageMapping" /> class.
        /// </summary>
        /// <param name="uk">uk.</param>
        public EnterpriseProjectCreateFormLanguageMapping(LanguageMappingUk uk = default(LanguageMappingUk))
        {
            this.Uk = uk;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseProjectCreateFormLanguageMapping {\n");
        ...
        {
            return this.Equals(input as EnterpriseProjectCreateFormLanguageMapping);
        }

        /// <summary>
        /// Returns true if EnterpriseProjectCreateFormLanguageMapping instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseProjectCreateFormLanguageMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseProjectCreateFormLanguageMapping input)
        {
            if (input == null)
                return false;
