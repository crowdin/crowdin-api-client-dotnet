...
namespace Crowdin.Api.Model
{
    ...
    /// Glossary Resource
    /// </summary>
    [DataContract(Name = "EnterpriseGlossaryResource")]
    public partial class EnterpriseGlossaryResource : IEquatable<EnterpriseGlossaryResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseGlossaryResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EnterpriseGlossaryResource(Glossary data = default(Glossary))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseGlossaryResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseGlossaryResource);
        }

        /// <summary>
        /// Returns true if EnterpriseGlossaryResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseGlossaryResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseGlossaryResource input)
        {
            if (input == null)
                return false;
