...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskCollectionResource")]
    public partial class TaskCollectionResource : IEquatable<TaskCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public TaskCollectionResource(List<TaskResource> data = default(List<TaskResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<TaskResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskCollectionResource {\n");
        ...
        {
            return this.Equals(input as TaskCollectionResource);
        }

        /// <summary>
        /// Returns true if TaskCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskCollectionResource input)
        {
            if (input == null)
                return false;
