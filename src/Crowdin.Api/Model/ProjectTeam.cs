...
namespace Crowdin.Api.Model
{
    ...
    /// ProjectTeam
    /// </summary>
    [DataContract(Name = "ProjectTeam")]
    public partial class ProjectTeam : IEquatable<ProjectTeam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTeam" /> class.
        /// </summary>
        /// <param name="id">Team Identifier.</param>
        /// <param name="hasManagerAccess">hasManagerAccess.</param>
        /// <param name="hasAccessToAllWorkflowSteps">hasAccessToAllWorkflowSteps.</param>
        /// <param name="permissions">permissions.</param>
        public ProjectTeam(int id = default(int), bool hasManagerAccess = default(bool), bool hasAccessToAllWorkflowSteps = default(bool), ProjectTeamPermissions permissions = default(ProjectTeamPermissions))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets HasManagerAccess
        /// </summary>
        [DataMember(Name = "hasManagerAccess", EmitDefaultValue = true)]
        public bool HasManagerAccess { get; set; }

        /// <summary>
        /// Gets or Sets HasAccessToAllWorkflowSteps
        /// </summary>
        [DataMember(Name = "hasAccessToAllWorkflowSteps", EmitDefaultValue = true)]
        ...
        public ProjectTeamPermissions Permissions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  HasManagerAccess: ").Append(HasManagerAccess).Append("\n");
            sb.Append("  HasAccessToAllWorkflowSteps: ").Append(HasAccessToAllWorkflowSteps).Append("\n");
        ...
        {
            return this.Equals(input as ProjectTeam);
        }

        /// <summary>
        /// Returns true if ProjectTeam instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTeam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTeam input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HasManagerAccess == input.HasManagerAccess ||
                    this.HasManagerAccess.Equals(input.HasManagerAccess)
                ) && 
                (
                    this.HasAccessToAllWorkflowSteps == input.HasAccessToAllWorkflowSteps ||
                    this.HasAccessToAllWorkflowSteps.Equals(input.HasAccessToAllWorkflowSteps)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.HasManagerAccess.GetHashCode();
                hashCode = hashCode * 59 + this.HasAccessToAllWorkflowSteps.GetHashCode();
