...
{
    /// <summary>
    /// CostEstimationFuzzyRegularRates
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.regular-rates")]
    public partial class CostEstimationFuzzyRegularRates : IEquatable<CostEstimationFuzzyRegularRates>, IValidatableObject
    {
        /// <summary>
        /// perfect
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyRegularRates" /> class.
        /// </summary>
        /// <param name="mode">perfect.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationFuzzyRegularRates(ModeEnum? mode = default(ModeEnum?), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyRegularRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyRegularRates);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyRegularRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyRegularRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyRegularRates input)
        {
            if (input == null)
                return false;
