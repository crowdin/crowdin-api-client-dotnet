...
{
    /// <summary>
    /// Dictionary Collection Resource
    /// </summary>
    [DataContract(Name = "DictionaryCollectionResource")]
    public partial class DictionaryCollectionResource : IEquatable<DictionaryCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DictionaryCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public DictionaryCollectionResource(List<DictionaryResource> data = default(List<DictionaryResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<DictionaryResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DictionaryCollectionResource {\n");
        ...
        {
            return this.Equals(input as DictionaryCollectionResource);
        }

        /// <summary>
        /// Returns true if DictionaryCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DictionaryCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DictionaryCollectionResource input)
        {
            if (input == null)
                return false;
