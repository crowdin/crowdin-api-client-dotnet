...
namespace Crowdin.Api.Model
{
    ...
    /// MtCredentialsYandex
    /// </summary>
    [DataContract(Name = "mt.credentials.yandex")]
    public partial class MtCredentialsYandex : IEquatable<MtCredentialsYandex>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentialsYandex" /> class.
        /// </summary>
        /// <param name="apiKey">Api key.</param>
        public MtCredentialsYandex(string apiKey = default(string))
        {
            this.ApiKey = apiKey;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentialsYandex {\n");
        ...
        {
            return this.Equals(input as MtCredentialsYandex);
        }

        /// <summary>
        /// Returns true if MtCredentialsYandex instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentialsYandex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentialsYandex input)
        {
            if (input == null)
                return false;
