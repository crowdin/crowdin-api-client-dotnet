...
{
    /// <summary>
    /// Storage Collection Resource
    /// </summary>
    [DataContract(Name = "StorageCollectionResource")]
    public partial class StorageCollectionResource : IEquatable<StorageCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StorageCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public StorageCollectionResource(List<StorageResource> data = default(List<StorageResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<StorageResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StorageCollectionResource {\n");
        ...
        {
            return this.Equals(input as StorageCollectionResource);
        }

        /// <summary>
        /// Returns true if StorageCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of StorageCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorageCollectionResource input)
        {
            if (input == null)
                return false;
