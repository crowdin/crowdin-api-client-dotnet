...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectTeamMemberCollectionResource")]
    public partial class ProjectTeamMemberCollectionResource : IEquatable<ProjectTeamMemberCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTeamMemberCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public ProjectTeamMemberCollectionResource(List<ProjectTeamMemberResource> data = default(List<ProjectTeamMemberResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<ProjectTeamMemberResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectTeamMemberCollectionResource {\n");
        ...
        {
            return this.Equals(input as ProjectTeamMemberCollectionResource);
        }

        /// <summary>
        /// Returns true if ProjectTeamMemberCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTeamMemberCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTeamMemberCollectionResource input)
        {
            if (input == null)
                return false;
