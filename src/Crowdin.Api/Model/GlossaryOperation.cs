...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GlossaryOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(GlossaryOperationReplace), "GlossaryOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(GlossaryOperationTest), "GlossaryOperationTest")]
    ...
    public partial class GlossaryOperation : IEquatable<GlossaryOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GlossaryOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryOperation" /> class.
        /// </summary>
        ...
        public GlossaryOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryOperation {\n");
        ...
        {
            return this.Equals(input as GlossaryOperation);
        }

        /// <summary>
        /// Returns true if GlossaryOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryOperation input)
        {
            if (input == null)
                return false;
