...
{
    /// <summary>
    /// CrowdinTranslationExportForm
    /// </summary>
    [DataContract(Name = "CrowdinTranslationExportForm")]
    public partial class CrowdinTranslationExportForm : IEquatable<CrowdinTranslationExportForm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTranslationExportForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrowdinTranslationExportForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTranslationExportForm" /> class.
        /// </summary>
        ...
        public CrowdinTranslationExportForm(string targetLanguageId = default(string), FormatEnum? format = default(FormatEnum?), List<int> labelIds = default(List<int>), List<int> branchIds = default(List<int>), List<int> directoryIds = default(List<int>), List<int> fileIds = default(List<int>), bool skipUntranslatedStrings = false, bool skipUntranslatedFiles = false, bool exportApprovedOnly = false)
        {
            // to ensure "targetLanguageId" is required (not null)
            if (targetLanguageId == null) {
                throw new ArgumentNullException("targetLanguageId is a required property for CrowdinTranslationExportForm and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTranslationExportForm {\n");
        ...
        {
            return this.Equals(input as CrowdinTranslationExportForm);
        }

        /// <summary>
        /// Returns true if CrowdinTranslationExportForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTranslationExportForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTranslationExportForm input)
        {
            if (input == null)
                return false;
