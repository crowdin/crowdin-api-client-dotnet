...
namespace Crowdin.Api.Model
{
    ...
    /// TmExportAttributes
    /// </summary>
    [DataContract(Name = "TmExport_attributes")]
    public partial class TmExportAttributes : IEquatable<TmExportAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmExportAttributes" /> class.
        /// </summary>
        /// <param name="sourceLanguageId">sourceLanguageId.</param>
        /// <param name="targetLanguageId">targetLanguageId.</param>
        /// <param name="format">format.</param>
        public TmExportAttributes(string sourceLanguageId = default(string), string targetLanguageId = default(string), string format = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmExportAttributes {\n");
        ...
        {
            return this.Equals(input as TmExportAttributes);
        }

        /// <summary>
        /// Returns true if TmExportAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of TmExportAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmExportAttributes input)
        {
            if (input == null)
                return false;
