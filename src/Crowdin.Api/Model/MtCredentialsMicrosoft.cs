...
{
    /// <summary>
    /// MtCredentialsMicrosoft
    /// </summary>
    [DataContract(Name = "mt.credentials.microsoft")]
    public partial class MtCredentialsMicrosoft : IEquatable<MtCredentialsMicrosoft>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentialsMicrosoft" /> class.
        /// </summary>
        /// <param name="apiKey">Api key.</param>
        /// <param name="model">Custom model (optional).</param>
        public MtCredentialsMicrosoft(string apiKey = default(string), string model = default(string))
        {
            this.ApiKey = apiKey;
            this.Model = model;
        }
        ...
        /// </summary>
        /// <value>Custom model (optional)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentialsMicrosoft {\n");
        ...
        {
            return this.Equals(input as MtCredentialsMicrosoft);
        }

        /// <summary>
        /// Returns true if MtCredentialsMicrosoft instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentialsMicrosoft to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentialsMicrosoft input)
        {
            if (input == null)
                return false;
