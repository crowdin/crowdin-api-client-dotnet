...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(StringOperationReplace), "StringOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(StringOperationTest), "StringOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(StringOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(StringOperationTest), "test")]
    public partial class StringOperation : IEquatable<StringOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum PathEnum
        {
            ...
            /// <summary>
            /// Enum IsHidden for value: /isHidden
            /// </summary>
            [EnumMember(Value = "/isHidden")]
            IsHidden = 3,

            /// <summary>
            /// Enum MaxLength for value: /maxLength
            /// </summary>
        ...
        public StringOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringOperation {\n");
        ...
        {
            return this.Equals(input as StringOperation);
        }

        /// <summary>
        /// Returns true if StringOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of StringOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringOperation input)
        {
            if (input == null)
                return false;
