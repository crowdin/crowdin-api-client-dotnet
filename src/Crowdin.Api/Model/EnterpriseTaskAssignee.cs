...
namespace Crowdin.Api.Model
{
    ...
    /// Task assignee
    /// </summary>
    [DataContract(Name = "EnterpriseTaskAssignee")]
    public partial class EnterpriseTaskAssignee : IEquatable<EnterpriseTaskAssignee>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTaskAssignee" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EnterpriseTaskAssignee() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTaskAssignee" /> class.
        /// </summary>
        /// <param name="id">User Identifier. Get via [List Users](#operation/api.users.getMany) (required).</param>
        ...
        public EnterpriseTaskAssignee(int id = default(int), int wordsCount = default(int))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTaskAssignee {\n");
        ...
        {
            return this.Equals(input as EnterpriseTaskAssignee);
        }

        /// <summary>
        /// Returns true if EnterpriseTaskAssignee instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTaskAssignee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTaskAssignee input)
        {
            if (input == null)
                return false;
