...
{
    /// <summary>
    /// QaCheck Collection Resource
    /// </summary>
    [DataContract(Name = "QaCheckCollectionResource")]
    public partial class QaCheckCollectionResource : IEquatable<QaCheckCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QaCheckCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public QaCheckCollectionResource(List<QaCheckResource> data = default(List<QaCheckResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<QaCheckResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QaCheckCollectionResource {\n");
        ...
        {
            return this.Equals(input as QaCheckCollectionResource);
        }

        /// <summary>
        /// Returns true if QaCheckCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of QaCheckCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QaCheckCollectionResource input)
        {
            if (input == null)
                return false;
