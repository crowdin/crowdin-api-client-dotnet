...
{
    /// <summary>
    /// NotFoundExceptionResourceError
    /// </summary>
    [DataContract(Name = "NotFoundExceptionResource_error")]
    public partial class NotFoundExceptionResourceError : IEquatable<NotFoundExceptionResourceError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotFoundExceptionResourceError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public NotFoundExceptionResourceError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotFoundExceptionResourceError {\n");
        ...
        {
            return this.Equals(input as NotFoundExceptionResourceError);
        }

        /// <summary>
        /// Returns true if NotFoundExceptionResourceError instances are equal
        /// </summary>
        /// <param name="input">Instance of NotFoundExceptionResourceError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotFoundExceptionResourceError input)
        {
            if (input == null)
                return false;
