...
namespace Crowdin.Api.Model
{
    ...
    /// Report Resource
    /// </summary>
    [DataContract(Name = "ReportResource")]
    public partial class ReportResource : IEquatable<ReportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ReportResource(ReportGenerate data = default(ReportGenerate))
        {
            this.Data = data;
        }
        ...
        public ReportGenerate Data { get; set; }
        ...
        {
            return this.Equals(input as ReportResource);
        }

        /// <summary>
        /// Returns true if ReportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportResource input)
        {
            if (input == null)
                return false;
