...
{
    /// <summary>
    /// A JSON Patch &#x60;Test&#x60; operation as defined by [RFC 6902](https://tools.ietf.org/html/rfc6902#section-4.6)
    /// </summary>
    [DataContract(Name = "JsonPatchTest")]
    ...
    public partial class JsonPatchTest : JsonPatchOperation, IEquatable<JsonPatchTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JsonPatchTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;JsonPatchTest&quot;).</param>
        ...
        public JsonPatchTest(Any value = default(Any), OpEnum op = "JsonPatchTest", string path = default(string)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for JsonPatchTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as JsonPatchTest);
        }

        /// <summary>
        /// Returns true if JsonPatchTest instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonPatchTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonPatchTest input)
        {
            if (input == null)
                return false;
