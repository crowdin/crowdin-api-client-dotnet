...
{
    /// <summary>
    /// TmImportAttributesScheme
    /// </summary>
    [DataContract(Name = "TmImport_attributes_scheme")]
    public partial class TmImportAttributesScheme : IEquatable<TmImportAttributesScheme>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmImportAttributesScheme" /> class.
        /// </summary>
        /// <param name="en">en.</param>
        /// <param name="de">de.</param>
        public TmImportAttributesScheme(int en = default(int), int de = default(int))
        {
            this.En = en;
            this.De = de;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmImportAttributesScheme {\n");
        ...
        {
            return this.Equals(input as TmImportAttributesScheme);
        }

        /// <summary>
        /// Returns true if TmImportAttributesScheme instances are equal
        /// </summary>
        /// <param name="input">Instance of TmImportAttributesScheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmImportAttributesScheme input)
        {
            if (input == null)
                return false;
