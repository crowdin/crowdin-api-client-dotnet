...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AbstractProjectBuildResponse")]
    public partial class AbstractProjectBuildResponse : IEquatable<AbstractProjectBuildResponse>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AbstractProjectBuildResponse" /> class.
        /// </summary>
        ...
        public AbstractProjectBuildResponse(int id = default(int), int projectId = default(int), StatusEnum? status = default(StatusEnum?), int progress = default(int), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime finishedAt = default(DateTime))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AbstractProjectBuildResponse {\n");
        ...
        {
            return this.Equals(input as AbstractProjectBuildResponse);
        }

        /// <summary>
        /// Returns true if AbstractProjectBuildResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AbstractProjectBuildResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AbstractProjectBuildResponse input)
        {
            if (input == null)
                return false;
