...
{
    /// <summary>
    /// ReportGenerateAttributes
    /// </summary>
    [DataContract(Name = "ReportGenerate_attributes")]
    public partial class ReportGenerateAttributes : IEquatable<ReportGenerateAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportGenerateAttributes" /> class.
        /// </summary>
        /// <param name="format">format.</param>
        /// <param name="reportName">reportName.</param>
        /// <param name="schema">schema.</param>
        public ReportGenerateAttributes(string format = default(string), string reportName = default(string), Object schema = default(Object))
        {
            this.Format = format;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReportGenerateAttributes {\n");
        ...
        {
            return this.Equals(input as ReportGenerateAttributes);
        }

        /// <summary>
        /// Returns true if ReportGenerateAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of ReportGenerateAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReportGenerateAttributes input)
        {
            if (input == null)
                return false;
