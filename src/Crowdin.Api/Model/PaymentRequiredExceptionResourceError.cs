...
{
    /// <summary>
    /// PaymentRequiredExceptionResourceError
    /// </summary>
    [DataContract(Name = "PaymentRequiredExceptionResource_error")]
    public partial class PaymentRequiredExceptionResourceError : IEquatable<PaymentRequiredExceptionResourceError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRequiredExceptionResourceError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public PaymentRequiredExceptionResourceError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaymentRequiredExceptionResourceError {\n");
        ...
        {
            return this.Equals(input as PaymentRequiredExceptionResourceError);
        }

        /// <summary>
        /// Returns true if PaymentRequiredExceptionResourceError instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRequiredExceptionResourceError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRequiredExceptionResourceError input)
        {
            if (input == null)
                return false;
