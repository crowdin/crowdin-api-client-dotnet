...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamMemberCollectionResource")]
    public partial class TeamMemberCollectionResource : IEquatable<TeamMemberCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamMemberCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public TeamMemberCollectionResource(List<TeamMemberResource> data = default(List<TeamMemberResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<TeamMemberResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamMemberCollectionResource {\n");
        ...
        {
            return this.Equals(input as TeamMemberCollectionResource);
        }

        /// <summary>
        /// Returns true if TeamMemberCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamMemberCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamMemberCollectionResource input)
        {
            if (input == null)
                return false;
