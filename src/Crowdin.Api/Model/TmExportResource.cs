...
namespace Crowdin.Api.Model
{
    ...
    /// Tm Export Resource
    /// </summary>
    [DataContract(Name = "TmExportResource")]
    public partial class TmExportResource : IEquatable<TmExportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmExportResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TmExportResource(TmExport data = default(TmExport))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmExportResource {\n");
        ...
        {
            return this.Equals(input as TmExportResource);
        }

        /// <summary>
        /// Returns true if TmExportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TmExportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmExportResource input)
        {
            if (input == null)
                return false;
