...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GeneralFileExportOptions")]
    public partial class GeneralFileExportOptions : IEquatable<GeneralFileExportOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralFileExportOptions" /> class.
        /// </summary>
        ...
        public GeneralFileExportOptions(string exportPattern = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GeneralFileExportOptions {\n");
        ...
        {
            return this.Equals(input as GeneralFileExportOptions);
        }

        /// <summary>
        /// Returns true if GeneralFileExportOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneralFileExportOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneralFileExportOptions input)
        {
            if (input == null)
                return false;
