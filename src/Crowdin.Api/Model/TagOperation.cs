...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TagOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(TagOperationReplace), "TagOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(TagOperationTest), "TagOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(TagOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(TagOperationTest), "test")]
    public partial class TagOperation : IEquatable<TagOperation>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum StringId for value: /stringId
            /// </summary>
            [EnumMember(Value = "/stringId")]
            StringId = 1,
        ...
        public TagOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as TagOperation);
        }

        /// <summary>
        /// Returns true if TagOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of TagOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagOperation input)
        {
            if (input == null)
                return false;
