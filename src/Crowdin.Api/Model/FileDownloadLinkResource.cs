...
{
    /// <summary>
    /// File Download Link Resource
    /// </summary>
    [DataContract(Name = "FileDownloadLinkResource")]
    public partial class FileDownloadLinkResource : IEquatable<FileDownloadLinkResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileDownloadLinkResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FileDownloadLinkResource(FileDownloadLink data = default(FileDownloadLink))
        {
            this.Data = data;
        }
        ...
        public FileDownloadLink Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileDownloadLinkResource {\n");
        ...
        {
            return this.Equals(input as FileDownloadLinkResource);
        }

        /// <summary>
        /// Returns true if FileDownloadLinkResource instances are equal
        /// </summary>
        /// <param name="input">Instance of FileDownloadLinkResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileDownloadLinkResource input)
        {
            if (input == null)
                return false;
