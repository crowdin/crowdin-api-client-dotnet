...
namespace Crowdin.Api.Model
{
    ...
    /// GroupCreateForm
    /// </summary>
    [DataContract(Name = "GroupCreateForm")]
    public partial class GroupCreateForm : IEquatable<GroupCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupCreateForm" /> class.
        /// </summary>
        /// <param name="name">Group Name (required).</param>
        /// <param name="parentId">Parent Group Identifier. Get via [List Groups](#operation/api.groups.getMany).</param>
        /// <param name="description">Group description.</param>
        public GroupCreateForm(string name = default(string), int parentId = default(int), string description = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for GroupCreateForm and cannot be null");
            }
            this.Name = name;
        ...
        /// <summary>
        /// Parent Group Identifier. Get via [List Groups](#operation/api.groups.getMany)
        /// </summary>
        /// <value>Parent Group Identifier. Get via [List Groups](#operation/api.groups.getMany)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupCreateForm {\n");
        ...
        {
            return this.Equals(input as GroupCreateForm);
        }

        /// <summary>
        /// Returns true if GroupCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupCreateForm input)
        {
            if (input == null)
                return false;
