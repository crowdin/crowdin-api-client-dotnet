...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnterpriseTranslationProjectBuildCollectionResource")]
    public partial class EnterpriseTranslationProjectBuildCollectionResource : IEquatable<EnterpriseTranslationProjectBuildCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTranslationProjectBuildCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public EnterpriseTranslationProjectBuildCollectionResource(List<EnterpriseTranslationProjectBuildResource> data = default(List<EnterpriseTranslationProjectBuildResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<EnterpriseTranslationProjectBuildResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTranslationProjectBuildCollectionResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseTranslationProjectBuildCollectionResource);
        }

        /// <summary>
        /// Returns true if EnterpriseTranslationProjectBuildCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTranslationProjectBuildCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTranslationProjectBuildCollectionResource input)
        {
            if (input == null)
                return false;
