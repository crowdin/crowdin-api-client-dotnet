...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [JsonConverter(typeof(WorkflowStepResourceJsonConverter))]
    [DataContract(Name = "WorkflowStepResource")]
    public partial class WorkflowStepResource : AbstractOpenAPISchema, IEquatable<WorkflowStepResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowStepResource" /> class
        /// with the <see cref="Object" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of Object.</param>
        public WorkflowStepResource(Object actualInstance)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkflowStepResource {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, WorkflowStepResource.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of WorkflowStepResource
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of WorkflowStepResource</returns>
        public static WorkflowStepResource FromJson(string jsonString)
        {
            WorkflowStepResource newWorkflowStepResource = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newWorkflowStepResource;
            }

            try
            {
                newWorkflowStepResource = new WorkflowStepResource(JsonConvert.DeserializeObject<Object>(jsonString, WorkflowStepResource.SerializerSettings));
        ...
        {
            return this.Equals(input as WorkflowStepResource);
        }

        /// <summary>
        /// Returns true if WorkflowStepResource instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowStepResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowStepResource input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for WorkflowStepResource
    /// </summary>
    public class WorkflowStepResourceJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(WorkflowStepResource).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return WorkflowStepResource.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
