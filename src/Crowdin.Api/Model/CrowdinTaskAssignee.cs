...
namespace Crowdin.Api.Model
{
    ...
    /// Task assignees.
    /// </summary>
    [DataContract(Name = "CrowdinTaskAssignee")]
    public partial class CrowdinTaskAssignee : IEquatable<CrowdinTaskAssignee>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTaskAssignee" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrowdinTaskAssignee() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTaskAssignee" /> class.
        /// </summary>
        /// <param name="id">Project Member Identifier. Get via [List Project Members](#operation/api.projects.members.getMany) (required).</param>
        /// <param name="wordsCount">Defines how many words (starting from 1) are assigned to each task assignee  __Note:__ Can be used only when &#39;splitFiles&#39; parameter is specified.</param>
        public CrowdinTaskAssignee(int id = default(int), int wordsCount = default(int))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Project Member Identifier. Get via [List Project Members](#operation/api.projects.members.getMany)
        /// </summary>
        /// <value>Project Member Identifier. Get via [List Project Members](#operation/api.projects.members.getMany)</value>
        [DataMember(Name = "id", IsRequired = true, EmitDefaultValue = false)]
        public int Id { get; set; }

        /// <summary>
        /// Defines how many words (starting from 1) are assigned to each task assignee  __Note:__ Can be used only when &#39;splitFiles&#39; parameter is specified
        /// </summary>
        /// <value>Defines how many words (starting from 1) are assigned to each task assignee  __Note:__ Can be used only when &#39;splitFiles&#39; parameter is specified</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTaskAssignee {\n");
        ...
        {
            return this.Equals(input as CrowdinTaskAssignee);
        }

        /// <summary>
        /// Returns true if CrowdinTaskAssignee instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTaskAssignee to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTaskAssignee input)
        {
            if (input == null)
                return false;
