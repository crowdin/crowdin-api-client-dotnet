...
{
    /// <summary>
    /// CostEstimationReportByTask
    /// </summary>
    [DataContract(Name = "cost-estimation.report.byTask")]
    public partial class CostEstimationReportByTask : IEquatable<CostEstimationReportByTask>, IValidatableObject
    {
        /// <summary>
        /// Defines report unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationReportByTask" /> class.
        /// </summary>
        ...
        public CostEstimationReportByTask(UnitEnum? unit = UnitEnum.Words, CurrencyEnum? currency = CurrencyEnum.USD, FormatEnum? format = FormatEnum.Xlsx, int taskId = default(int), List<CostEstimationRegularRates> regularRates = default(List<CostEstimationRegularRates>), List<CostEstimationIndividualRates> individualRates = default(List<CostEstimationIndividualRates>))
        {
            this.Unit = unit;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationReportByTask {\n");
        ...
        {
            return this.Equals(input as CostEstimationReportByTask);
        }

        /// <summary>
        /// Returns true if CostEstimationReportByTask instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationReportByTask to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationReportByTask input)
        {
            if (input == null)
                return false;
