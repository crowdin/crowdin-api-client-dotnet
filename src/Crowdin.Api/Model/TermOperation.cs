...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TermOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(TermOperationReplace), "TermOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(TermOperationTest), "TermOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(TermOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(TermOperationTest), "test")]
    public partial class TermOperation : IEquatable<TermOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public enum PathEnum
        {
            ...
            /// <summary>
            /// Enum PartOfSpeech for value: /partOfSpeech
            /// </summary>
            [EnumMember(Value = "/partOfSpeech")]
            PartOfSpeech = 3
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TermOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermOperation" /> class.
        /// </summary>
        ...
        public TermOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as TermOperation);
        }

        /// <summary>
        /// Returns true if TermOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of TermOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermOperation input)
        {
            if (input == null)
                return false;
