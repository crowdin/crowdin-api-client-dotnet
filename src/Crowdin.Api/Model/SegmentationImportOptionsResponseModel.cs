...
{
    /// <summary>
    /// SegmentationImportOptionsResponseModel
    /// </summary>
    [DataContract(Name = "SegmentationImportOptionsResponseModel")]
    public partial class SegmentationImportOptionsResponseModel : IEquatable<SegmentationImportOptionsResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SegmentationImportOptionsResponseModel" /> class.
        /// </summary>
        /// <param name="contentSegmentation">contentSegmentation.</param>
        /// <param name="customSegmentation">customSegmentation.</param>
        public SegmentationImportOptionsResponseModel(bool contentSegmentation = default(bool), bool customSegmentation = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SegmentationImportOptionsResponseModel {\n");
        ...
        {
            return this.Equals(input as SegmentationImportOptionsResponseModel);
        }

        /// <summary>
        /// Returns true if SegmentationImportOptionsResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of SegmentationImportOptionsResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SegmentationImportOptionsResponseModel input)
        {
            if (input == null)
                return false;
