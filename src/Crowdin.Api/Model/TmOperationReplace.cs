...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TmOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(TmOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(TmOperationTest), "test")]
    public partial class TmOperationReplace : TmOperation, IEquatable<TmOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TmOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TmOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;TmOperationReplace&quot;).</param>
        ...
        public TmOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "TmOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TmOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmOperationReplace {\n");
        ...
        {
            return this.Equals(input as TmOperationReplace);
        }

        /// <summary>
        /// Returns true if TmOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of TmOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmOperationReplace input)
        {
            if (input == null)
                return false;
