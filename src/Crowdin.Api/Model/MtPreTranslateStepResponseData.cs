...
{
    /// <summary>
    /// MtPreTranslateStepResponseData
    /// </summary>
    [DataContract(Name = "MtPreTranslateStepResponse_data")]
    public partial class MtPreTranslateStepResponseData : IEquatable<MtPreTranslateStepResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtPreTranslateStepResponseData" /> class.
        /// </summary>
        ...
        public MtPreTranslateStepResponseData(int id = default(int), string title = default(string), string type = default(string), List<string> languages = default(List<string>), MtPreTranslateStepResponseDataConfig config = default(MtPreTranslateStepResponseDataConfig))
        {
            this.Id = id;
            this.Title = title;
            this.Type = type;
        ...
        public MtPreTranslateStepResponseDataConfig Config { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtPreTranslateStepResponseData {\n");
        ...
        {
            return this.Equals(input as MtPreTranslateStepResponseData);
        }

        /// <summary>
        /// Returns true if MtPreTranslateStepResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of MtPreTranslateStepResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtPreTranslateStepResponseData input)
        {
            if (input == null)
                return false;
