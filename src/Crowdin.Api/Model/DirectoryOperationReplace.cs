...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DirectoryOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(DirectoryOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(DirectoryOperationTest), "test")]
    public partial class DirectoryOperationReplace : DirectoryOperation, IEquatable<DirectoryOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DirectoryOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;DirectoryOperationReplace&quot;).</param>
        ...
        public DirectoryOperationReplace(OneOfstringinteger value = default(OneOfstringinteger), OpEnum op = "DirectoryOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for DirectoryOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public OneOfstringinteger Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DirectoryOperationReplace {\n");
        ...
        {
            return this.Equals(input as DirectoryOperationReplace);
        }

        /// <summary>
        /// Returns true if DirectoryOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of DirectoryOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DirectoryOperationReplace input)
        {
            if (input == null)
                return false;
