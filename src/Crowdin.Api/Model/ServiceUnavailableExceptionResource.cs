...
namespace Crowdin.Api.Model
{
    ...
    /// Forbidden
    /// </summary>
    [DataContract(Name = "ServiceUnavailableExceptionResource")]
    public partial class ServiceUnavailableExceptionResource : IEquatable<ServiceUnavailableExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceUnavailableExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public ServiceUnavailableExceptionResource(ServiceUnavailableExceptionResourceError error = default(ServiceUnavailableExceptionResourceError))
        {
            this.Error = error;
        }
        ...
        public ServiceUnavailableExceptionResourceError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceUnavailableExceptionResource {\n");
        ...
        {
            return this.Equals(input as ServiceUnavailableExceptionResource);
        }

        /// <summary>
        /// Returns true if ServiceUnavailableExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceUnavailableExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceUnavailableExceptionResource input)
        {
            if (input == null)
                return false;
