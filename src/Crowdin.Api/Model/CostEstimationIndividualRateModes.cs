...
{
    /// <summary>
    /// CostEstimationIndividualRateModes
    /// </summary>
    [DataContract(Name = "cost-estimation.individual-rate-modes")]
    public partial class CostEstimationIndividualRateModes : IEquatable<CostEstimationIndividualRateModes>, IValidatableObject
    {
        /// <summary>
        /// tm_match
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationIndividualRateModes" /> class.
        /// </summary>
        /// <param name="mode">tm_match.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationIndividualRateModes(ModeEnum? mode = default(ModeEnum?), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationIndividualRateModes {\n");
        ...
        {
            return this.Equals(input as CostEstimationIndividualRateModes);
        }

        /// <summary>
        /// Returns true if CostEstimationIndividualRateModes instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationIndividualRateModes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationIndividualRateModes input)
        {
            if (input == null)
                return false;
