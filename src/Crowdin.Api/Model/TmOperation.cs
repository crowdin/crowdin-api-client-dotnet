...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TmOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(TmOperationReplace), "TmOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(TmOperationTest), "TmOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(TmOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(TmOperationTest), "test")]
    public partial class TmOperation : IEquatable<TmOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TmOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TmOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TmOperation" /> class.
        /// </summary>
        ...
        public TmOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as TmOperation);
        }

        /// <summary>
        /// Returns true if TmOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of TmOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmOperation input)
        {
            if (input == null)
                return false;
