...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomQaCheckOperationTest")]
    ...
    public partial class CustomQaCheckOperationTest : CustomQaCheckOperation, IEquatable<CustomQaCheckOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomQaCheckOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;CustomQaCheckOperationTest&quot;).</param>
        ...
        public CustomQaCheckOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "CustomQaCheckOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for CustomQaCheckOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomQaCheckOperationTest {\n");
        ...
        {
            return this.Equals(input as CustomQaCheckOperationTest);
        }

        /// <summary>
        /// Returns true if CustomQaCheckOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomQaCheckOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomQaCheckOperationTest input)
        {
            if (input == null)
                return false;
