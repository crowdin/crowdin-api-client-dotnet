...
namespace Crowdin.Api.Model
{
    ...
    /// PreTranslationForm
    /// </summary>
    [DataContract(Name = "PreTranslationForm")]
    public partial class PreTranslationForm : IEquatable<PreTranslationForm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PreTranslationForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PreTranslationForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PreTranslationForm" /> class.
        /// </summary>
        ...
        /// <param name="engineId">Machine Translation engine Identifier. Read more about how to get the [MT engine identifier](https://support.crowdin.com/configuring-machine-translation-engines#mt-engine-ids)..</param>
        ...
        public PreTranslationForm(List<string> languageIds = default(List<string>), List<int> fileIds = default(List<int>), MethodEnum? method = MethodEnum.Tm, int engineId = default(int), AutoApproveOptionEnum? autoApproveOption = AutoApproveOptionEnum.None, bool duplicateTranslations = false, bool translateUntranslatedOnly = true, bool translateWithPerfectMatchOnly = false, EnterpriseFallbackLanguagesScheme fallbackLanguages = default(EnterpriseFallbackLanguagesScheme))
        {
            // to ensure "languageIds" is required (not null)
            if (languageIds == null) {
                throw new ArgumentNullException("languageIds is a required property for PreTranslationForm and cannot be null");
            }
            this.LanguageIds = languageIds;
            // to ensure "fileIds" is required (not null)
            if (fileIds == null) {
                throw new ArgumentNullException("fileIds is a required property for PreTranslationForm and cannot be null");
            }
        ...
        /// <summary>
        /// Machine Translation engine Identifier. Read more about how to get the [MT engine identifier](https://support.crowdin.com/configuring-machine-translation-engines#mt-engine-ids).
        /// </summary>
        /// <value>Machine Translation engine Identifier. Read more about how to get the [MT engine identifier](https://support.crowdin.com/configuring-machine-translation-engines#mt-engine-ids).</value>
        ...
        public EnterpriseFallbackLanguagesScheme FallbackLanguages { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreTranslationForm {\n");
        ...
        {
            return this.Equals(input as PreTranslationForm);
        }

        /// <summary>
        /// Returns true if PreTranslationForm instances are equal
        /// </summary>
        /// <param name="input">Instance of PreTranslationForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreTranslationForm input)
        {
            if (input == null)
                return false;
