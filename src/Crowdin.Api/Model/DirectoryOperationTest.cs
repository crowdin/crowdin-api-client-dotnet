...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DirectoryOperationTest")]
    ...
    public partial class DirectoryOperationTest : DirectoryOperation, IEquatable<DirectoryOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DirectoryOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;DirectoryOperationTest&quot;).</param>
        ...
        public DirectoryOperationTest(OneOfstringinteger value = default(OneOfstringinteger), OpEnum op = "DirectoryOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for DirectoryOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DirectoryOperationTest {\n");
        ...
        {
            return this.Equals(input as DirectoryOperationTest);
        }

        /// <summary>
        /// Returns true if DirectoryOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of DirectoryOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DirectoryOperationTest input)
        {
            if (input == null)
                return false;
