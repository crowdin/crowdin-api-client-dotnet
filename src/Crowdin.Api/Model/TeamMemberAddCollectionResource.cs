...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamMemberAddCollectionResource")]
    public partial class TeamMemberAddCollectionResource : IEquatable<TeamMemberAddCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamMemberAddCollectionResource" /> class.
        /// </summary>
        /// <param name="skipped">skipped.</param>
        /// <param name="added">added.</param>
        /// <param name="pagination">pagination.</param>
        public TeamMemberAddCollectionResource(List<TeamMemberResource> skipped = default(List<TeamMemberResource>), List<TeamMemberResource> added = default(List<TeamMemberResource>), Pagination pagination = default(Pagination))
        {
        ...
        public List<TeamMemberResource> Skipped { get; set; }

        /// <summary>
        /// Gets or Sets Added
        /// </summary>
        [DataMember(Name = "added", EmitDefaultValue = false)]
        public List<TeamMemberResource> Added { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamMemberAddCollectionResource {\n");
        ...
        {
            return this.Equals(input as TeamMemberAddCollectionResource);
        }

        /// <summary>
        /// Returns true if TeamMemberAddCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamMemberAddCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamMemberAddCollectionResource input)
        {
            if (input == null)
                return false;
