...
namespace Crowdin.Api.Model
{
    ...
    /// LabelCreateForm
    /// </summary>
    [DataContract(Name = "LabelCreateForm")]
    public partial class LabelCreateForm : IEquatable<LabelCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LabelCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LabelCreateForm" /> class.
        /// </summary>
        /// <param name="title">Label title (required).</param>
        public LabelCreateForm(string title = default(string))
        {
            // to ensure "title" is required (not null)
            if (title == null) {
                throw new ArgumentNullException("title is a required property for LabelCreateForm and cannot be null");
            }
            this.Title = title;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LabelCreateForm {\n");
        ...
        {
            return this.Equals(input as LabelCreateForm);
        }

        /// <summary>
        /// Returns true if LabelCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of LabelCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LabelCreateForm input)
        {
            if (input == null)
                return false;
