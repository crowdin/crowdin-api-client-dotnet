...
{
    /// <summary>
    /// CustomQaCheckCreateForm
    /// </summary>
    [DataContract(Name = "CustomQaCheckCreateForm")]
    public partial class CustomQaCheckCreateForm : IEquatable<CustomQaCheckCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomQaCheckCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckCreateForm" /> class.
        /// </summary>
        /// <param name="title">title (required).</param>
        /// <param name="description">description.</param>
        /// <param name="snippet">snippet (required).</param>
        public CustomQaCheckCreateForm(string title = default(string), string description = default(string), string snippet = default(string))
        {
            // to ensure "title" is required (not null)
            if (title == null) {
                throw new ArgumentNullException("title is a required property for CustomQaCheckCreateForm and cannot be null");
            }
            this.Title = title;
            // to ensure "snippet" is required (not null)
            if (snippet == null) {
                throw new ArgumentNullException("snippet is a required property for CustomQaCheckCreateForm and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "snippet", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomQaCheckCreateForm {\n");
        ...
        {
            return this.Equals(input as CustomQaCheckCreateForm);
        }

        /// <summary>
        /// Returns true if CustomQaCheckCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomQaCheckCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomQaCheckCreateForm input)
        {
            if (input == null)
                return false;
