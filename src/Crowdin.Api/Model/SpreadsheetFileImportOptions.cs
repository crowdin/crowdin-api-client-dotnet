...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SpreadsheetFileImportOptions")]
    public partial class SpreadsheetFileImportOptions : IEquatable<SpreadsheetFileImportOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpreadsheetFileImportOptions" /> class.
        /// </summary>
        /// <param name="firstLineContainsHeader">Defines whether the file includes a first-row header that should not be imported (default to false).</param>
        /// <param name="importTranslations">Defines whether to import translations from the file (default to true).</param>
        /// <param name="scheme">scheme.</param>
        public SpreadsheetFileImportOptions(bool firstLineContainsHeader = false, bool importTranslations = true, SpreadsheetFileImportSchema scheme = default(SpreadsheetFileImportSchema))
        {
        ...
        /// </summary>
        /// <value>Defines whether the file includes a first-row header that should not be imported</value>
        [DataMember(Name = "firstLineContainsHeader", EmitDefaultValue = true)]
        public bool FirstLineContainsHeader { get; set; }

        /// <summary>
        /// Defines whether to import translations from the file
        /// </summary>
        /// <value>Defines whether to import translations from the file</value>
        [DataMember(Name = "importTranslations", EmitDefaultValue = true)]
        ...
        public SpreadsheetFileImportSchema Scheme { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SpreadsheetFileImportOptions {\n");
            sb.Append("  FirstLineContainsHeader: ").Append(FirstLineContainsHeader).Append("\n");
            sb.Append("  ImportTranslations: ").Append(ImportTranslations).Append("\n");
        ...
        {
            return this.Equals(input as SpreadsheetFileImportOptions);
        }

        /// <summary>
        /// Returns true if SpreadsheetFileImportOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of SpreadsheetFileImportOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpreadsheetFileImportOptions input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ImportTranslations == input.ImportTranslations ||
                    this.ImportTranslations.Equals(input.ImportTranslations)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.ImportTranslations.GetHashCode();
                if (this.Scheme != null)
