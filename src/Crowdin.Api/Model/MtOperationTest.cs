...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MtOperationTest")]
    ...
    public partial class MtOperationTest : MtOperation, IEquatable<MtOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MtOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MtOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;MtOperationTest&quot;).</param>
        ...
        public MtOperationTest(OneOfstringobject value = default(OneOfstringobject), OpEnum op = "MtOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for MtOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtOperationTest {\n");
        ...
        {
            return this.Equals(input as MtOperationTest);
        }

        /// <summary>
        /// Returns true if MtOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of MtOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtOperationTest input)
        {
            if (input == null)
                return false;
