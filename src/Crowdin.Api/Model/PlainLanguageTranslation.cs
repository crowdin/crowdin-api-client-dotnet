...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PlainLanguageTranslation")]
    public partial class PlainLanguageTranslation : IEquatable<PlainLanguageTranslation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlainLanguageTranslation" /> class.
        /// </summary>
        ...
        public PlainLanguageTranslation(int stringId = default(int), string contentType = default(string), int translationId = default(int), string text = default(string), IcuLanguageTranslationUser user = default(IcuLanguageTranslationUser), DateTime createdAt = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlainLanguageTranslation {\n");
        ...
        {
            return this.Equals(input as PlainLanguageTranslation);
        }

        /// <summary>
        /// Returns true if PlainLanguageTranslation instances are equal
        /// </summary>
        /// <param name="input">Instance of PlainLanguageTranslation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlainLanguageTranslation input)
        {
            if (input == null)
                return false;
