...
namespace Crowdin.Api.Model
{
    ...
    /// User
    /// </summary>
    [DataContract(Name = "IcuLanguageTranslation_user")]
    public partial class IcuLanguageTranslationUser : IEquatable<IcuLanguageTranslationUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IcuLanguageTranslationUser" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="username">username.</param>
        /// <param name="fullName">fullName.</param>
        /// <param name="avatarUrl">avatarUrl.</param>
        public IcuLanguageTranslationUser(int id = default(int), string username = default(string), string fullName = default(string), string avatarUrl = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IcuLanguageTranslationUser {\n");
        ...
        {
            return this.Equals(input as IcuLanguageTranslationUser);
        }

        /// <summary>
        /// Returns true if IcuLanguageTranslationUser instances are equal
        /// </summary>
        /// <param name="input">Instance of IcuLanguageTranslationUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IcuLanguageTranslationUser input)
        {
            if (input == null)
                return false;
