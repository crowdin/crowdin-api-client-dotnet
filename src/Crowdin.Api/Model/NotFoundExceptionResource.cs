...
namespace Crowdin.Api.Model
{
    ...
    /// Not Found
    /// </summary>
    [DataContract(Name = "NotFoundExceptionResource")]
    public partial class NotFoundExceptionResource : IEquatable<NotFoundExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NotFoundExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public NotFoundExceptionResource(NotFoundExceptionResourceError error = default(NotFoundExceptionResourceError))
        {
            this.Error = error;
        }
        ...
        public NotFoundExceptionResourceError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NotFoundExceptionResource {\n");
        ...
        {
            return this.Equals(input as NotFoundExceptionResource);
        }

        /// <summary>
        /// Returns true if NotFoundExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of NotFoundExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NotFoundExceptionResource input)
        {
            if (input == null)
                return false;
