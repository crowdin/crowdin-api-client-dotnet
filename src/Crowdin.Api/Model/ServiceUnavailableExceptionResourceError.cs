...
{
    /// <summary>
    /// ServiceUnavailableExceptionResourceError
    /// </summary>
    [DataContract(Name = "ServiceUnavailableExceptionResource_error")]
    public partial class ServiceUnavailableExceptionResourceError : IEquatable<ServiceUnavailableExceptionResourceError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceUnavailableExceptionResourceError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public ServiceUnavailableExceptionResourceError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceUnavailableExceptionResourceError {\n");
        ...
        {
            return this.Equals(input as ServiceUnavailableExceptionResourceError);
        }

        /// <summary>
        /// Returns true if ServiceUnavailableExceptionResourceError instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceUnavailableExceptionResourceError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceUnavailableExceptionResourceError input)
        {
            if (input == null)
                return false;
