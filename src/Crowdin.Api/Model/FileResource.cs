...
namespace Crowdin.Api.Model
{
    ...
    public partial class FileResource : IEquatable<FileResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public FileResource(File data = default(File))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as FileResource);
        }

        /// <summary>
        /// Returns true if FileResource instances are equal
        /// </summary>
        /// <param name="input">Instance of FileResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileResource input)
        {
            if (input == null)
                return false;
