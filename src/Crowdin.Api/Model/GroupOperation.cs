...
namespace Crowdin.Api.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(GroupOperationReplace), "GroupOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(GroupOperationTest), "GroupOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(GroupOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(GroupOperationTest), "test")]
    public partial class GroupOperation : IEquatable<GroupOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupOperation" /> class.
        /// </summary>
        ...
        public GroupOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as GroupOperation);
        }

        /// <summary>
        /// Returns true if GroupOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupOperation input)
        {
            if (input == null)
                return false;
