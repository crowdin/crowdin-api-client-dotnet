...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QaCheckStatistic")]
    public partial class QaCheckStatistic : IEquatable<QaCheckStatistic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QaCheckStatistic" /> class.
        /// </summary>
        /// <param name="total">total.</param>
        /// <param name="languageId">languageId.</param>
        public QaCheckStatistic(int total = default(int), int languageId = default(int))
        {
            this.Total = total;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QaCheckStatistic {\n");
        ...
        {
            return this.Equals(input as QaCheckStatistic);
        }

        /// <summary>
        /// Returns true if QaCheckStatistic instances are equal
        /// </summary>
        /// <param name="input">Instance of QaCheckStatistic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QaCheckStatistic input)
        {
            if (input == null)
                return false;
