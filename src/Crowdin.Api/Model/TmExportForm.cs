...
namespace Crowdin.Api.Model
{
    ...
    /// TmExportForm
    /// </summary>
    [DataContract(Name = "TmExportForm")]
    public partial class TmExportForm : IEquatable<TmExportForm>, IValidatableObject
    {
        /// <summary>
        /// Defines TMs file format
        /// </summary>
        /// <value>Defines TMs file format</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TmExportForm" /> class.
        /// </summary>
        /// <param name="sourceLanguageId">Defines Source Language in language pair. Get via [List Supported Languages](#operation/api.languages.getMany).</param>
        /// <param name="targetLanguageId">Defines Target Language in language pair. Get via [List Supported Languages](#operation/api.languages.getMany).</param>
        /// <param name="format">Defines TMs file format (default to FormatEnum.Tmx).</param>
        public TmExportForm(string sourceLanguageId = default(string), string targetLanguageId = default(string), FormatEnum? format = FormatEnum.Tmx)
        {
        ...
        /// <summary>
        /// Defines Source Language in language pair. Get via [List Supported Languages](#operation/api.languages.getMany)
        /// </summary>
        /// <value>Defines Source Language in language pair. Get via [List Supported Languages](#operation/api.languages.getMany)</value>
        [DataMember(Name = "sourceLanguageId", EmitDefaultValue = false)]
        public string SourceLanguageId { get; set; }

        /// <summary>
        /// Defines Target Language in language pair. Get via [List Supported Languages](#operation/api.languages.getMany)
        /// </summary>
        /// <value>Defines Target Language in language pair. Get via [List Supported Languages](#operation/api.languages.getMany)</value>
        ...
        {
            return this.Equals(input as TmExportForm);
        }

        /// <summary>
        /// Returns true if TmExportForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TmExportForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmExportForm input)
        {
            if (input == null)
                return false;
