...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DistributionResource")]
    public partial class DistributionResource : IEquatable<DistributionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public DistributionResource(Distribution data = default(Distribution))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionResource {\n");
        ...
        {
            return this.Equals(input as DistributionResource);
        }

        /// <summary>
        /// Returns true if DistributionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionResource input)
        {
            if (input == null)
                return false;
