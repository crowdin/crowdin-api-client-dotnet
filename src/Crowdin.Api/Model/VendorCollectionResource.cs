...
namespace Crowdin.Api.Model
{
    ...
    /// Vendors Collection
    /// </summary>
    [DataContract(Name = "VendorCollectionResource")]
    public partial class VendorCollectionResource : IEquatable<VendorCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VendorCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public VendorCollectionResource(List<VendorResource> data = default(List<VendorResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<VendorResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VendorCollectionResource {\n");
        ...
        {
            return this.Equals(input as VendorCollectionResource);
        }

        /// <summary>
        /// Returns true if VendorCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of VendorCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VendorCollectionResource input)
        {
            if (input == null)
                return false;
