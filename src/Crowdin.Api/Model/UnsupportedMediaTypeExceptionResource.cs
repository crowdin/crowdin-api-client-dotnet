...
namespace Crowdin.Api.Model
{
    ...
    /// Not Found
    /// </summary>
    [DataContract(Name = "UnsupportedMediaTypeExceptionResource")]
    public partial class UnsupportedMediaTypeExceptionResource : IEquatable<UnsupportedMediaTypeExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnsupportedMediaTypeExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public UnsupportedMediaTypeExceptionResource(UnsupportedMediaTypeExceptionResourceError error = default(UnsupportedMediaTypeExceptionResourceError))
        {
            this.Error = error;
        }
        ...
        public UnsupportedMediaTypeExceptionResourceError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnsupportedMediaTypeExceptionResource {\n");
        ...
        {
            return this.Equals(input as UnsupportedMediaTypeExceptionResource);
        }

        /// <summary>
        /// Returns true if UnsupportedMediaTypeExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of UnsupportedMediaTypeExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnsupportedMediaTypeExceptionResource input)
        {
            if (input == null)
                return false;
