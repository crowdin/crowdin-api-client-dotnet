...
{
    /// <summary>
    /// GlossaryImportAttributesScheme
    /// </summary>
    [DataContract(Name = "GlossaryImport_attributes_scheme")]
    public partial class GlossaryImportAttributesScheme : IEquatable<GlossaryImportAttributesScheme>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryImportAttributesScheme" /> class.
        /// </summary>
        /// <param name="termEn">termEn.</param>
        /// <param name="descriptionEn">descriptionEn.</param>
        public GlossaryImportAttributesScheme(int termEn = default(int), int descriptionEn = default(int))
        {
            this.TermEn = termEn;
        ...
        /// Gets or Sets TermEn
        /// </summary>
        [DataMember(Name = "term_en", EmitDefaultValue = false)]
        ...
        public int DescriptionEn { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryImportAttributesScheme {\n");
            sb.Append("  TermEn: ").Append(TermEn).Append("\n");
        ...
        {
            return this.Equals(input as GlossaryImportAttributesScheme);
        }

        /// <summary>
        /// Returns true if GlossaryImportAttributesScheme instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryImportAttributesScheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryImportAttributesScheme input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TermEn == input.TermEn ||
                    this.TermEn.Equals(input.TermEn)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.TermEn.GetHashCode();
