...
{
    /// <summary>
    /// Calculate the real translation costs to pay your translators and proofreaders
    /// </summary>
    [DataContract(Name = "GroupWorkflowTranslationCosts")]
    public partial class GroupWorkflowTranslationCosts : IEquatable<GroupWorkflowTranslationCosts>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupWorkflowTranslationCosts" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupWorkflowTranslationCosts() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupWorkflowTranslationCosts" /> class.
        /// </summary>
        /// <param name="name">group-translation-costs (required).</param>
        /// <param name="schema">schema (required).</param>
        public GroupWorkflowTranslationCosts(string name = default(string), GroupWorkflowTranslationCostsSchema schema = default(GroupWorkflowTranslationCostsSchema))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for GroupWorkflowTranslationCosts and cannot be null");
            }
            this.Name = name;
            // to ensure "schema" is required (not null)
            if (schema == null) {
                throw new ArgumentNullException("schema is a required property for GroupWorkflowTranslationCosts and cannot be null");
            }
            this.Schema = schema;
        }

        /// <summary>
        /// group-translation-costs
        /// </summary>
        /// <value>group-translation-costs</value>
        ...
        public GroupWorkflowTranslationCostsSchema Schema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupWorkflowTranslationCosts {\n");
        ...
        {
            return this.Equals(input as GroupWorkflowTranslationCosts);
        }

        /// <summary>
        /// Returns true if GroupWorkflowTranslationCosts instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupWorkflowTranslationCosts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupWorkflowTranslationCosts input)
        {
            if (input == null)
                return false;
