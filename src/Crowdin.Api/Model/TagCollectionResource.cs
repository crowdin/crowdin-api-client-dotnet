...
{
    /// <summary>
    /// Screenshot tag Collection Resource
    /// </summary>
    [DataContract(Name = "TagCollectionResource")]
    public partial class TagCollectionResource : IEquatable<TagCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public TagCollectionResource(List<TagResource> data = default(List<TagResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<TagResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagCollectionResource {\n");
        ...
        {
            return this.Equals(input as TagCollectionResource);
        }

        /// <summary>
        /// Returns true if TagCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TagCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagCollectionResource input)
        {
            if (input == null)
                return false;
