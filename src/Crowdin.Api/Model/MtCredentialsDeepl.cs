...
namespace Crowdin.Api.Model
{
    ...
    /// MtCredentialsDeepl
    /// </summary>
    [DataContract(Name = "mt.credentials.deepl")]
    public partial class MtCredentialsDeepl : IEquatable<MtCredentialsDeepl>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentialsDeepl" /> class.
        /// </summary>
        /// <param name="apiKey">Api key.</param>
        public MtCredentialsDeepl(string apiKey = default(string))
        {
            this.ApiKey = apiKey;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentialsDeepl {\n");
        ...
        {
            return this.Equals(input as MtCredentialsDeepl);
        }

        /// <summary>
        /// Returns true if MtCredentialsDeepl instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentialsDeepl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentialsDeepl input)
        {
            if (input == null)
                return false;
