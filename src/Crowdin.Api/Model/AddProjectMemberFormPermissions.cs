...
{
    /// <summary>
    /// Specify permissions for each language and workflow steps  __Note:__ &#x60;managerAccess&#x60;, &#x60;accessToAllWorkflowSteps&#x60;, and &#x60;permissions&#x60; parameters are mutually exclusive
    /// </summary>
    [DataContract(Name = "AddProjectMemberForm_permissions")]
    public partial class AddProjectMemberFormPermissions : IEquatable<AddProjectMemberFormPermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectMemberFormPermissions" /> class.
        /// </summary>
        /// <param name="it">it.</param>
        /// <param name="de">de.</param>
        public AddProjectMemberFormPermissions(AddProjectMemberFormPermissionsIt it = default(AddProjectMemberFormPermissionsIt), AddProjectMemberFormPermissionsDe de = default(AddProjectMemberFormPermissionsDe))
        {
            this.It = it;
            this.De = de;
        }
        ...
        public AddProjectMemberFormPermissionsIt It { get; set; }

        /// <summary>
        /// Gets or Sets De
        /// </summary>
        [DataMember(Name = "de", EmitDefaultValue = false)]
        public AddProjectMemberFormPermissionsDe De { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProjectMemberFormPermissions {\n");
        ...
        {
            return this.Equals(input as AddProjectMemberFormPermissions);
        }

        /// <summary>
        /// Returns true if AddProjectMemberFormPermissions instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProjectMemberFormPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProjectMemberFormPermissions input)
        {
            if (input == null)
                return false;
