...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TagOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(TagOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(TagOperationTest), "test")]
    public partial class TagOperationReplace : TagOperation, IEquatable<TagOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TagOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TagOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;TagOperationReplace&quot;).</param>
        ...
        public TagOperationReplace(OneOfintegerstring value = default(OneOfintegerstring), OpEnum op = "TagOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TagOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public OneOfintegerstring Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagOperationReplace {\n");
        ...
        {
            return this.Equals(input as TagOperationReplace);
        }

        /// <summary>
        /// Returns true if TagOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of TagOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagOperationReplace input)
        {
            if (input == null)
                return false;
