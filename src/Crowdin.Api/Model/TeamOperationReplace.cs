...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TeamOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(TeamOperationReplace), "replace")]
    public partial class TeamOperationReplace : TeamOperation, IEquatable<TeamOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TeamOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;TeamOperationReplace&quot;).</param>
        ...
        public TeamOperationReplace(OneOfstringbooleanarrayarray value = default(OneOfstringbooleanarrayarray), OpEnum op = "TeamOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TeamOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeamOperationReplace {\n");
        ...
        {
            return this.Equals(input as TeamOperationReplace);
        }

        /// <summary>
        /// Returns true if TeamOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamOperationReplace input)
        {
            if (input == null)
                return false;
