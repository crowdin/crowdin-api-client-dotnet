...
{
    /// <summary>
    /// ProjectSettingsResponseAllOfNotificationSettings
    /// </summary>
    [DataContract(Name = "ProjectSettingsResponse_allOf_notificationSettings")]
    public partial class ProjectSettingsResponseAllOfNotificationSettings : IEquatable<ProjectSettingsResponseAllOfNotificationSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingsResponseAllOfNotificationSettings" /> class.
        /// </summary>
        ...
        public ProjectSettingsResponseAllOfNotificationSettings(bool translatorNewStrings = false, bool managerNewStrings = false, bool managerLanguageCompleted = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectSettingsResponseAllOfNotificationSettings {\n");
        ...
        {
            return this.Equals(input as ProjectSettingsResponseAllOfNotificationSettings);
        }

        /// <summary>
        /// Returns true if ProjectSettingsResponseAllOfNotificationSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectSettingsResponseAllOfNotificationSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectSettingsResponseAllOfNotificationSettings input)
        {
            if (input == null)
                return false;
