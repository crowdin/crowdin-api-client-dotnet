...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MethodNotAllowedExceptionResource")]
    public partial class MethodNotAllowedExceptionResource : IEquatable<MethodNotAllowedExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MethodNotAllowedExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public MethodNotAllowedExceptionResource(MethodNotAllowedExceptionResourceError error = default(MethodNotAllowedExceptionResourceError))
        {
            this.Error = error;
        }
        ...
        public MethodNotAllowedExceptionResourceError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MethodNotAllowedExceptionResource {\n");
        ...
        {
            return this.Equals(input as MethodNotAllowedExceptionResource);
        }

        /// <summary>
        /// Returns true if MethodNotAllowedExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of MethodNotAllowedExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MethodNotAllowedExceptionResource input)
        {
            if (input == null)
                return false;
