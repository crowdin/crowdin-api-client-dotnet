...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkflowTemplateResource")]
    public partial class WorkflowTemplateResource : IEquatable<WorkflowTemplateResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTemplateResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public WorkflowTemplateResource(WorkflowTemplate data = default(WorkflowTemplate))
        {
            this.Data = data;
        }
        ...
        public WorkflowTemplate Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkflowTemplateResource {\n");
        ...
        {
            return this.Equals(input as WorkflowTemplateResource);
        }

        /// <summary>
        /// Returns true if WorkflowTemplateResource instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowTemplateResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowTemplateResource input)
        {
            if (input == null)
                return false;
