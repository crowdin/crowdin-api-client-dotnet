...
{
    /// <summary>
    /// Files Translation Language Progress Collection Resource
    /// </summary>
    [DataContract(Name = "LanguageProgressCollectionResource")]
    public partial class LanguageProgressCollectionResource : IEquatable<LanguageProgressCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageProgressCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public LanguageProgressCollectionResource(List<LanguageProgressResource> data = default(List<LanguageProgressResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<LanguageProgressResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LanguageProgressCollectionResource {\n");
        ...
        {
            return this.Equals(input as LanguageProgressCollectionResource);
        }

        /// <summary>
        /// Returns true if LanguageProgressCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageProgressCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageProgressCollectionResource input)
        {
            if (input == null)
                return false;
