...
{
    /// <summary>
    /// Custom QA Check Resource
    /// </summary>
    [DataContract(Name = "CustomQaCheckResource")]
    public partial class CustomQaCheckResource : IEquatable<CustomQaCheckResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheckResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CustomQaCheckResource(CustomQaCheck data = default(CustomQaCheck))
        {
            this.Data = data;
        }
        ...
        public CustomQaCheck Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomQaCheckResource {\n");
        ...
        {
            return this.Equals(input as CustomQaCheckResource);
        }

        /// <summary>
        /// Returns true if CustomQaCheckResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomQaCheckResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomQaCheckResource input)
        {
            if (input == null)
                return false;
