...
{
    /// <summary>
    /// CrowdinAuthenticateUser
    /// </summary>
    [DataContract(Name = "CrowdinAuthenticateUser")]
    public partial class CrowdinAuthenticateUser : IEquatable<CrowdinAuthenticateUser>, IValidatableObject
    {
        /// <summary>
        /// Defines TwoFactor
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinAuthenticateUser" /> class.
        /// </summary>
        ...
        public CrowdinAuthenticateUser(int id = default(int), string username = default(string), string email = default(string), string fullName = default(string), string avatarUrl = default(string), DateTime createdAt = default(DateTime), DateTime? lastSeen = default(DateTime?), TwoFactorEnum? twoFactor = default(TwoFactorEnum?), bool? timezone = default(bool?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinAuthenticateUser {\n");
        ...
        {
            return this.Equals(input as CrowdinAuthenticateUser);
        }

        /// <summary>
        /// Returns true if CrowdinAuthenticateUser instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinAuthenticateUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinAuthenticateUser input)
        {
            if (input == null)
                return false;
