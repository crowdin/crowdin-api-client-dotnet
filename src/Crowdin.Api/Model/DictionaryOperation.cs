...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DictionaryOperation")]
    public partial class DictionaryOperation : IEquatable<DictionaryOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// A JSON Pointer as defined by &lt;a href&#x3D;\&quot;https://tools.ietf.org/html/rfc6901\&quot; target&#x3D;\&quot;_blank\&quot;&gt;RFC 6901&lt;/a&gt;  __Note:__ To delete multiple words with one request, please specify the word indexes in reverse order.
        /// </summary>
        /// <value>A JSON Pointer as defined by &lt;a href&#x3D;\&quot;https://tools.ietf.org/html/rfc6901\&quot; target&#x3D;\&quot;_blank\&quot;&gt;RFC 6901&lt;/a&gt;  __Note:__ To delete multiple words with one request, please specify the word indexes in reverse order.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum PathEnum
        {
            /// <summary>
            /// Enum Words0 for value: /words/0
            /// </summary>
            [EnumMember(Value = "/words/0")]
            Words0 = 1
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DictionaryOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DictionaryOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DictionaryOperation" /> class.
        /// </summary>
        /// <param name="op">Patch operation to perform (required).</param>
        /// <param name="path">A JSON Pointer as defined by &lt;a href&#x3D;\&quot;https://tools.ietf.org/html/rfc6901\&quot; target&#x3D;\&quot;_blank\&quot;&gt;RFC 6901&lt;/a&gt;  __Note:__ To delete multiple words with one request, please specify the word indexes in reverse order. (required).</param>
        public DictionaryOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DictionaryOperation {\n");
        ...
        {
            return this.Equals(input as DictionaryOperation);
        }

        /// <summary>
        /// Returns true if DictionaryOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of DictionaryOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DictionaryOperation input)
        {
            if (input == null)
                return false;
