...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TaskStatisticResource")]
    public partial class TaskStatisticResource : IEquatable<TaskStatisticResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskStatisticResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TaskStatisticResource(TaskStatistic data = default(TaskStatistic))
        {
            this.Data = data;
        }
        ...
        public TaskStatistic Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskStatisticResource {\n");
        ...
        {
            return this.Equals(input as TaskStatisticResource);
        }

        /// <summary>
        /// Returns true if TaskStatisticResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskStatisticResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskStatisticResource input)
        {
            if (input == null)
                return false;
