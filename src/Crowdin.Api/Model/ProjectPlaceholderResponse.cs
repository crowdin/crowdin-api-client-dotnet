...
{
    /// <summary>
    /// ProjectPlaceholderResponse
    /// </summary>
    [DataContract(Name = "ProjectPlaceholderResponse")]
    public partial class ProjectPlaceholderResponse : IEquatable<ProjectPlaceholderResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectPlaceholderResponse" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="customPlaceholderId">customPlaceholderId.</param>
        /// <param name="type">type.</param>
        /// <param name="index">index.</param>
        /// <param name="isBlocking">isBlocking.</param>
        public ProjectPlaceholderResponse(int id = default(int), int customPlaceholderId = default(int), string type = default(string), int index = default(int), bool isBlocking = default(bool))
        {
            this.Id = id;
            this.CustomPlaceholderId = customPlaceholderId;
            this.Type = type;
            this.Index = index;
        ...
        /// <summary>
        /// Gets or Sets CustomPlaceholderId
        /// </summary>
        [DataMember(Name = "customPlaceholderId", EmitDefaultValue = false)]
        public int CustomPlaceholderId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectPlaceholderResponse {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  CustomPlaceholderId: ").Append(CustomPlaceholderId).Append("\n");
        ...
        {
            return this.Equals(input as ProjectPlaceholderResponse);
        }

        /// <summary>
        /// Returns true if ProjectPlaceholderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectPlaceholderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectPlaceholderResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CustomPlaceholderId == input.CustomPlaceholderId ||
                    this.CustomPlaceholderId.Equals(input.CustomPlaceholderId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.CustomPlaceholderId.GetHashCode();
                if (this.Type != null)
