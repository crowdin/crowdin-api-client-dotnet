...
namespace Crowdin.Api.Model
{
    ...
    /// String Resource
    /// </summary>
    [DataContract(Name = "StringResource")]
    public partial class StringResource : IEquatable<StringResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public StringResource(String data = default(String))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringResource {\n");
        ...
        {
            return this.Equals(input as StringResource);
        }

        /// <summary>
        /// Returns true if StringResource instances are equal
        /// </summary>
        /// <param name="input">Instance of StringResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringResource input)
        {
            if (input == null)
                return false;
