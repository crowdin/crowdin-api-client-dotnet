...
{
    /// <summary>
    /// ReviewedStringBuildAttributes
    /// </summary>
    [DataContract(Name = "ReviewedStringBuild_attributes")]
    public partial class ReviewedStringBuildAttributes : IEquatable<ReviewedStringBuildAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewedStringBuildAttributes" /> class.
        /// </summary>
        /// <param name="branchId">branchId.</param>
        /// <param name="targetLanguageId">targetLanguageId.</param>
        public ReviewedStringBuildAttributes(int? branchId = default(int?), string targetLanguageId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReviewedStringBuildAttributes {\n");
        ...
        {
            return this.Equals(input as ReviewedStringBuildAttributes);
        }

        /// <summary>
        /// Returns true if ReviewedStringBuildAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of ReviewedStringBuildAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReviewedStringBuildAttributes input)
        {
            if (input == null)
                return false;
