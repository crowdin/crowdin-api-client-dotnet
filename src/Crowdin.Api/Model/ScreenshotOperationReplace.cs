...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScreenshotOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(ScreenshotOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(ScreenshotOperationTest), "test")]
    public partial class ScreenshotOperationReplace : ScreenshotOperation, IEquatable<ScreenshotOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScreenshotOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ScreenshotOperationReplace&quot;).</param>
        ...
        public ScreenshotOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "ScreenshotOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ScreenshotOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScreenshotOperationReplace {\n");
        ...
        {
            return this.Equals(input as ScreenshotOperationReplace);
        }

        /// <summary>
        /// Returns true if ScreenshotOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotOperationReplace input)
        {
            if (input == null)
                return false;
