...
{
    /// <summary>
    /// A JSON Patch &#x60;Replace&#x60; operation as defined by [RFC      *     6902](https://tools.ietf.org/html/rfc6902#section-4.3)
    /// </summary>
    [DataContract(Name = "ProjectPlaceholderOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(ProjectPlaceholderOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(ProjectPlaceholderOperationTest), "test")]
    public partial class ProjectPlaceholderOperationReplace : ProjectPlaceholderOperation, IEquatable<ProjectPlaceholderOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectPlaceholderOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectPlaceholderOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectPlaceholderOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectPlaceholderOperationReplace&quot;).</param>
        ...
        public ProjectPlaceholderOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "ProjectPlaceholderOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectPlaceholderOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public OneOfstring Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectPlaceholderOperationReplace {\n");
        ...
        {
            return this.Equals(input as ProjectPlaceholderOperationReplace);
        }

        /// <summary>
        /// Returns true if ProjectPlaceholderOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectPlaceholderOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectPlaceholderOperationReplace input)
        {
            if (input == null)
                return false;
