...
{
    /// <summary>
    /// ProofreadByVendorStepResponseData
    /// </summary>
    [DataContract(Name = "ProofreadByVendorStepResponse_data")]
    public partial class ProofreadByVendorStepResponseData : IEquatable<ProofreadByVendorStepResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProofreadByVendorStepResponseData" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="title">title.</param>
        /// <param name="type">type.</param>
        /// <param name="languages">Array of language ids.</param>
        /// <param name="config">config.</param>
        public ProofreadByVendorStepResponseData(int id = default(int), string title = default(string), string type = default(string), List<string> languages = default(List<string>), TranslateByVendorStepResponseDataConfig config = default(TranslateByVendorStepResponseDataConfig))
        {
            this.Id = id;
            this.Title = title;
            this.Type = type;
        ...
        public TranslateByVendorStepResponseDataConfig Config { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProofreadByVendorStepResponseData {\n");
        ...
        {
            return this.Equals(input as ProofreadByVendorStepResponseData);
        }

        /// <summary>
        /// Returns true if ProofreadByVendorStepResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of ProofreadByVendorStepResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProofreadByVendorStepResponseData input)
        {
            if (input == null)
                return false;
