...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "JobAttributesFieldsSchema")]
    public partial class JobAttributesFieldsSchema : IEquatable<JobAttributesFieldsSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobAttributesFieldsSchema" /> class.
        /// </summary>
        /// <param name="columnNumber">columnNumber.</param>
        public JobAttributesFieldsSchema(string columnNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JobAttributesFieldsSchema {\n");
        ...
        {
            return this.Equals(input as JobAttributesFieldsSchema);
        }

        /// <summary>
        /// Returns true if JobAttributesFieldsSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of JobAttributesFieldsSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobAttributesFieldsSchema input)
        {
            if (input == null)
                return false;
