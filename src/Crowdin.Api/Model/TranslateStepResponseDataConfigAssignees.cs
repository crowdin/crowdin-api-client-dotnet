...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslateStepResponse_data_config_assignees")]
    public partial class TranslateStepResponseDataConfigAssignees : IEquatable<TranslateStepResponseDataConfigAssignees>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateStepResponseDataConfigAssignees" /> class.
        /// </summary>
        /// <param name="de">de.</param>
        /// <param name="it">it.</param>
        public TranslateStepResponseDataConfigAssignees(List<int> de = default(List<int>), List<int> it = default(List<int>))
        {
            this.De = de;
            this.It = it;
        }
        ...
        public List<int> De { get; set; }

        /// <summary>
        /// Gets or Sets It
        /// </summary>
        [DataMember(Name = "it", EmitDefaultValue = false)]
        public List<int> It { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslateStepResponseDataConfigAssignees {\n");
        ...
        {
            return this.Equals(input as TranslateStepResponseDataConfigAssignees);
        }

        /// <summary>
        /// Returns true if TranslateStepResponseDataConfigAssignees instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslateStepResponseDataConfigAssignees to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslateStepResponseDataConfigAssignees input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.De != null &&
                    input.De != null &&
                    this.De.SequenceEqual(input.De)
                ) && 
                (
                    this.It == input.It ||
                    this.It != null &&
                    input.It != null &&
                    this.It.SequenceEqual(input.It)
                );
        }
