...
{
    /// <summary>
    /// CostEstimationFuzzyStepsProofreadIndividualRateModes
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.steps.proofread.individual-rate-modes")]
    public partial class CostEstimationFuzzyStepsProofreadIndividualRateModes : IEquatable<CostEstimationFuzzyStepsProofreadIndividualRateModes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyStepsProofreadIndividualRateModes" /> class.
        /// </summary>
        /// <param name="mode">approval.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationFuzzyStepsProofreadIndividualRateModes(string mode = default(string), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyStepsProofreadIndividualRateModes {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyStepsProofreadIndividualRateModes);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyStepsProofreadIndividualRateModes instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyStepsProofreadIndividualRateModes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyStepsProofreadIndividualRateModes input)
        {
            if (input == null)
                return false;
