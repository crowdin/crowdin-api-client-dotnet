...
namespace Crowdin.Api.Model
{
    ...
    /// Conflict
    /// </summary>
    [DataContract(Name = "ConflictExceptionResource")]
    public partial class ConflictExceptionResource : IEquatable<ConflictExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConflictExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public ConflictExceptionResource(ConflictExceptionResourceError error = default(ConflictExceptionResourceError))
        {
            this.Error = error;
        }
        ...
        public ConflictExceptionResourceError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConflictExceptionResource {\n");
        ...
        {
            return this.Equals(input as ConflictExceptionResource);
        }

        /// <summary>
        /// Returns true if ConflictExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ConflictExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConflictExceptionResource input)
        {
            if (input == null)
                return false;
