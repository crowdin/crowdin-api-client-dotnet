...
{
    /// <summary>
    /// XmlFileImportOptionsResponseModel
    /// </summary>
    [DataContract(Name = "XmlFileImportOptionsResponseModel")]
    public partial class XmlFileImportOptionsResponseModel : IEquatable<XmlFileImportOptionsResponseModel>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or Sets TranslatableElements
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlFileImportOptionsResponseModel" /> class.
        /// </summary>
        /// <param name="translateContent">translateContent.</param>
        /// <param name="translateAttributes">translateAttributes.</param>
        /// <param name="contentSegmentation">contentSegmentation.</param>
        /// <param name="translatableElements">translatableElements.</param>
        /// <param name="customSegmentation">customSegmentation.</param>
        public XmlFileImportOptionsResponseModel(bool translateContent = default(bool), bool translateAttributes = default(bool), bool contentSegmentation = default(bool), List<TranslatableElementsEnum> translatableElements = default(List<TranslatableElementsEnum>), bool customSegmentation = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XmlFileImportOptionsResponseModel {\n");
            ...
            sb.Append("  CustomSegmentation: ").Append(CustomSegmentation).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as XmlFileImportOptionsResponseModel);
        }

        /// <summary>
        /// Returns true if XmlFileImportOptionsResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of XmlFileImportOptionsResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XmlFileImportOptionsResponseModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CustomSegmentation == input.CustomSegmentation ||
                    this.CustomSegmentation.Equals(input.CustomSegmentation)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.CustomSegmentation.GetHashCode();
                return hashCode;
            }
        }
