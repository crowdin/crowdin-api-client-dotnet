...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FileOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(FileOperationReplace), "FileOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(FileOperationTest), "FileOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(FileOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(FileOperationTest), "test")]
    public partial class FileOperation : IEquatable<FileOperation>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum BranchId for value: /branchId
            /// </summary>
            [EnumMember(Value = "/branchId")]
            BranchId = 1,

            /// <summary>
            /// Enum DirectoryId for value: /directoryId
            /// </summary>
            [EnumMember(Value = "/directoryId")]
            DirectoryId = 2,
            ...
            /// <summary>
            /// Enum ImportOptionsSrxStorageId for value: /importOptions/srxStorageId
            /// </summary>
            [EnumMember(Value = "/importOptions/srxStorageId")]
            ImportOptionsSrxStorageId = 6,

            /// <summary>
            /// Enum ImportOptionsCustomSegmentation for value: /importOptions/customSegmentation
            /// </summary>
            [EnumMember(Value = "/importOptions/customSegmentation")]
            ImportOptionsCustomSegmentation = 7,

            /// <summary>
            /// Enum ExportOptionsExportPattern for value: /exportOptions/exportPattern
            /// </summary>
            [EnumMember(Value = "/exportOptions/exportPattern")]
            ExportOptionsExportPattern = 8,

            /// <summary>
            /// Enum ExportOptionsEscapeQuotes for value: /exportOptions/escapeQuotes
            /// </summary>
            [EnumMember(Value = "/exportOptions/escapeQuotes")]
            ExportOptionsEscapeQuotes = 9,

            /// <summary>
            /// Enum ExcludedTargetLanguages for value: /excludedTargetLanguages
            /// </summary>
            [EnumMember(Value = "/excludedTargetLanguages")]
            ExcludedTargetLanguages = 10,

            /// <summary>
            /// Enum AttachLabelIds for value: /attachLabelIds
            /// </summary>
            [EnumMember(Value = "/attachLabelIds")]
            AttachLabelIds = 11,

            /// <summary>
            /// Enum DetachLabelIds for value: /detachLabelIds
            /// </summary>
            [EnumMember(Value = "/detachLabelIds")]
            DetachLabelIds = 12
        ...
        public FileOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as FileOperation);
        }

        /// <summary>
        /// Returns true if FileOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of FileOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileOperation input)
        {
            if (input == null)
                return false;
