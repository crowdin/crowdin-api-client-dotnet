...
namespace Crowdin.Api.Model
{
    ...
    /// ProgressPhrases
    /// </summary>
    [DataContract(Name = "Progress_phrases")]
    public partial class ProgressPhrases : IEquatable<ProgressPhrases>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProgressPhrases" /> class.
        /// </summary>
        /// <param name="total">total.</param>
        /// <param name="translated">translated.</param>
        /// <param name="approved">approved.</param>
        public ProgressPhrases(int total = default(int), int translated = default(int), int approved = default(int))
        {
            this.Total = total;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProgressPhrases {\n");
        ...
        {
            return this.Equals(input as ProgressPhrases);
        }

        /// <summary>
        /// Returns true if ProgressPhrases instances are equal
        /// </summary>
        /// <param name="input">Instance of ProgressPhrases to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgressPhrases input)
        {
            if (input == null)
                return false;
