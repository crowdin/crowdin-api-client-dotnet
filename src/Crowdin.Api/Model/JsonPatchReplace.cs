...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "JsonPatchReplace")]
    ...
    public partial class JsonPatchReplace : JsonPatchOperation, IEquatable<JsonPatchReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JsonPatchReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;JsonPatchReplace&quot;).</param>
        ...
        public JsonPatchReplace(Any value = default(Any), OpEnum op = "JsonPatchReplace", string path = default(string)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for JsonPatchReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as JsonPatchReplace);
        }

        /// <summary>
        /// Returns true if JsonPatchReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonPatchReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonPatchReplace input)
        {
            if (input == null)
                return false;
