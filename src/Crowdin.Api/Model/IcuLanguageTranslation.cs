...
{
    /// <summary>
    /// IcuLanguageTranslation
    /// </summary>
    [DataContract(Name = "IcuLanguageTranslation")]
    public partial class IcuLanguageTranslation : IEquatable<IcuLanguageTranslation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IcuLanguageTranslation" /> class.
        /// </summary>
        ...
        public IcuLanguageTranslation(int stringId = default(int), string contentType = default(string), int translationId = default(int), string text = default(string), IcuLanguageTranslationUser user = default(IcuLanguageTranslationUser), DateTime createdAt = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IcuLanguageTranslation {\n");
        ...
        {
            return this.Equals(input as IcuLanguageTranslation);
        }

        /// <summary>
        /// Returns true if IcuLanguageTranslation instances are equal
        /// </summary>
        /// <param name="input">Instance of IcuLanguageTranslation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IcuLanguageTranslation input)
        {
            if (input == null)
                return false;
