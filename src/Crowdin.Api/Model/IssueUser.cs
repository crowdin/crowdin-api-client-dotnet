...
namespace Crowdin.Api.Model
{
    ...
    /// IssueUser
    /// </summary>
    [DataContract(Name = "Issue_user")]
    public partial class IssueUser : IEquatable<IssueUser>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueUser" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="username">username.</param>
        /// <param name="fullName">fullName.</param>
        /// <param name="avatarUrl">avatarUrl.</param>
        public IssueUser(int id = default(int), string username = default(string), string fullName = default(string), string avatarUrl = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as IssueUser);
        }

        /// <summary>
        /// Returns true if IssueUser instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueUser input)
        {
            if (input == null)
                return false;
