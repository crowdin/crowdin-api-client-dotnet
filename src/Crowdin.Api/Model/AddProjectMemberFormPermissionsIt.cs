...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddProjectMemberForm_permissions_it")]
    public partial class AddProjectMemberFormPermissionsIt : IEquatable<AddProjectMemberFormPermissionsIt>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectMemberFormPermissionsIt" /> class.
        /// </summary>
        /// <param name="workflowStepIds">Workflow Step Identifier. Get via [List Workflow Steps](#operation/api.projects.workflow-steps.getMany).</param>
        public AddProjectMemberFormPermissionsIt(List<int> workflowStepIds = default(List<int>))
        {
            this.WorkflowStepIds = workflowStepIds;
        }

        /// <summary>
        /// Workflow Step Identifier. Get via [List Workflow Steps](#operation/api.projects.workflow-steps.getMany)
        /// </summary>
        /// <value>Workflow Step Identifier. Get via [List Workflow Steps](#operation/api.projects.workflow-steps.getMany)</value>
        [DataMember(Name = "workflowStepIds", EmitDefaultValue = false)]
        public List<int> WorkflowStepIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProjectMemberFormPermissionsIt {\n");
            sb.Append("  WorkflowStepIds: ").Append(WorkflowStepIds).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AddProjectMemberFormPermissionsIt);
        }

        /// <summary>
        /// Returns true if AddProjectMemberFormPermissionsIt instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProjectMemberFormPermissionsIt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProjectMemberFormPermissionsIt input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.WorkflowStepIds == input.WorkflowStepIds ||
                    this.WorkflowStepIds != null &&
                    input.WorkflowStepIds != null &&
                    this.WorkflowStepIds.SequenceEqual(input.WorkflowStepIds)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.WorkflowStepIds != null)
                    hashCode = hashCode * 59 + this.WorkflowStepIds.GetHashCode();
                return hashCode;
            }
        }
