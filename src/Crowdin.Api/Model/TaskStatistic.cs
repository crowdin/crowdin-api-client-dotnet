...
{
    /// <summary>
    /// Task Statistic Response Model
    /// </summary>
    [DataContract(Name = "TaskStatistic")]
    public partial class TaskStatistic : IEquatable<TaskStatistic>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskStatistic" /> class.
        /// </summary>
        /// <param name="total">total.</param>
        /// <param name="languageId">languageId.</param>
        public TaskStatistic(int total = default(int), string languageId = default(string))
        {
            this.Total = total;
        ...
        {
            return this.Equals(input as TaskStatistic);
        }

        /// <summary>
        /// Returns true if TaskStatistic instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskStatistic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskStatistic input)
        {
            if (input == null)
                return false;
