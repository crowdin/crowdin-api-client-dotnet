...
{
    /// <summary>
    /// Defines fallback languages mapping. The passed value should be an associative array containing both language id and array of fallback language ids:   *     &#x60;{languageId}&#x60; – Crowdin id for the specified language. Get via [List Supported Languages](#operation/api.languages.getMany)  *     &#x60;Array of strings&#x60; – an array containing fallback language ids. Get via [List Supported Languages](#operation/api.languages.getMany)  __Note:__ Available only for TM Pre-Translation
    /// </summary>
    [DataContract(Name = "EnterpriseFallbackLanguagesScheme")]
    public partial class EnterpriseFallbackLanguagesScheme : IEquatable<EnterpriseFallbackLanguagesScheme>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseFallbackLanguagesScheme" /> class.
        /// </summary>
        /// <param name="languageId">languageId.</param>
        public EnterpriseFallbackLanguagesScheme(List<string> languageId = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseFallbackLanguagesScheme {\n");
        ...
        {
            return this.Equals(input as EnterpriseFallbackLanguagesScheme);
        }

        /// <summary>
        /// Returns true if EnterpriseFallbackLanguagesScheme instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseFallbackLanguagesScheme to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseFallbackLanguagesScheme input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.LanguageId.SequenceEqual(input.LanguageId)
                );
        }
