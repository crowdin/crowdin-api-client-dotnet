...
namespace Crowdin.Api.Model
{
    ...
    /// ProjectTeamMember
    /// </summary>
    [DataContract(Name = "ProjectTeamMember")]
    public partial class ProjectTeamMember : IEquatable<ProjectTeamMember>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTeamMember" /> class.
        /// </summary>
        ...
        /// <param name="managerOfGroup">managerOfGroup.</param>
        /// <param name="accessToAllWorkflowSteps">accessToAllWorkflowSteps.</param>
        /// <param name="permissions">permissions.</param>
        /// <param name="givenAccessAt">givenAccessAt.</param>
        public ProjectTeamMember(int id = default(int), string username = default(string), string firstName = default(string), string lastName = default(string), bool isManager = default(bool), ProjectTeamMemberManagerOfGroup managerOfGroup = default(ProjectTeamMemberManagerOfGroup), bool accessToAllWorkflowSteps = default(bool), ProjectTeamMemberPermissions permissions = default(ProjectTeamMemberPermissions), DateTime? givenAccessAt = default(DateTime?))
        {
            this.Id = id;
            ...
            this.ManagerOfGroup = managerOfGroup;
            this.AccessToAllWorkflowSteps = accessToAllWorkflowSteps;
            this.Permissions = permissions;
            this.GivenAccessAt = givenAccessAt;
        }
        ...
        /// <summary>
        /// Gets or Sets ManagerOfGroup
        /// </summary>
        [DataMember(Name = "managerOfGroup", EmitDefaultValue = true)]
        public ProjectTeamMemberManagerOfGroup ManagerOfGroup { get; set; }

        /// <summary>
        /// Gets or Sets AccessToAllWorkflowSteps
        /// </summary>
        ...
        public ProjectTeamMemberPermissions Permissions { get; set; }

        /// <summary>
        /// Gets or Sets GivenAccessAt
        /// </summary>
        [DataMember(Name = "givenAccessAt", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ManagerOfGroup: ").Append(ManagerOfGroup).Append("\n");
            sb.Append("  AccessToAllWorkflowSteps: ").Append(AccessToAllWorkflowSteps).Append("\n");
            sb.Append("  Permissions: ").Append(Permissions).Append("\n");
            sb.Append("  GivenAccessAt: ").Append(GivenAccessAt).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ProjectTeamMember);
        }

        /// <summary>
        /// Returns true if ProjectTeamMember instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTeamMember to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTeamMember input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ManagerOfGroup == input.ManagerOfGroup ||
                    (this.ManagerOfGroup != null &&
                    this.ManagerOfGroup.Equals(input.ManagerOfGroup))
                ) && 
                (
                ...
                (
                    this.GivenAccessAt == input.GivenAccessAt ||
                    (this.GivenAccessAt != null &&
                    this.GivenAccessAt.Equals(input.GivenAccessAt))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ManagerOfGroup != null)
                    hashCode = hashCode * 59 + this.ManagerOfGroup.GetHashCode();
                hashCode = hashCode * 59 + this.AccessToAllWorkflowSteps.GetHashCode();
                if (this.Permissions != null)
                    hashCode = hashCode * 59 + this.Permissions.GetHashCode();
                if (this.GivenAccessAt != null)
                    hashCode = hashCode * 59 + this.GivenAccessAt.GetHashCode();
                return hashCode;
            }
        }
