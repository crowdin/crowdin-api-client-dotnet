...
namespace Crowdin.Api.Model
{
    ...
    /// TagReplaceForm
    /// </summary>
    [DataContract(Name = "TagReplaceForm")]
    public partial class TagReplaceForm : IEquatable<TagReplaceForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TagReplaceForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TagReplaceForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TagReplaceForm" /> class.
        /// </summary>
        /// <param name="autoTag">Automatically tags screenshot and replaces old tags with new ones (required).</param>
        public TagReplaceForm(bool autoTag = default(bool))
        {
        ...
        /// </summary>
        /// <value>Automatically tags screenshot and replaces old tags with new ones</value>
        [DataMember(Name = "autoTag", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TagReplaceForm {\n");
        ...
        {
            return this.Equals(input as TagReplaceForm);
        }

        /// <summary>
        /// Returns true if TagReplaceForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TagReplaceForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TagReplaceForm input)
        {
            if (input == null)
                return false;
