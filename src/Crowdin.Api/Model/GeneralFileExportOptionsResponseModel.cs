...
{
    /// <summary>
    /// GeneralFileExportOptionsResponseModel
    /// </summary>
    [DataContract(Name = "GeneralFileExportOptionsResponseModel")]
    public partial class GeneralFileExportOptionsResponseModel : IEquatable<GeneralFileExportOptionsResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralFileExportOptionsResponseModel" /> class.
        /// </summary>
        /// <param name="exportPattern">exportPattern.</param>
        public GeneralFileExportOptionsResponseModel(string exportPattern = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GeneralFileExportOptionsResponseModel {\n");
        ...
        {
            return this.Equals(input as GeneralFileExportOptionsResponseModel);
        }

        /// <summary>
        /// Returns true if GeneralFileExportOptionsResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneralFileExportOptionsResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneralFileExportOptionsResponseModel input)
        {
            if (input == null)
                return false;
