...
namespace Crowdin.Api.Model
{
    ...
    /// Forbidden
    /// </summary>
    [DataContract(Name = "ForbiddenExceptionResource")]
    public partial class ForbiddenExceptionResource : IEquatable<ForbiddenExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForbiddenExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public ForbiddenExceptionResource(ForbiddenExceptionResourceError error = default(ForbiddenExceptionResourceError))
        {
            this.Error = error;
        }
        ...
        public ForbiddenExceptionResourceError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForbiddenExceptionResource {\n");
        ...
        {
            return this.Equals(input as ForbiddenExceptionResource);
        }

        /// <summary>
        /// Returns true if ForbiddenExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ForbiddenExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForbiddenExceptionResource input)
        {
            if (input == null)
                return false;
