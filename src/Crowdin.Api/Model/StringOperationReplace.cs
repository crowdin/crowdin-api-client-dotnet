...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(StringOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(StringOperationTest), "test")]
    public partial class StringOperationReplace : StringOperation, IEquatable<StringOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StringOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StringOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;StringOperationReplace&quot;).</param>
        ...
        public StringOperationReplace(OneOfstringintegerboolean value = default(OneOfstringintegerboolean), OpEnum op = "StringOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for StringOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public OneOfstringintegerboolean Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringOperationReplace {\n");
        ...
        {
            return this.Equals(input as StringOperationReplace);
        }

        /// <summary>
        /// Returns true if StringOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of StringOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringOperationReplace input)
        {
            if (input == null)
                return false;
