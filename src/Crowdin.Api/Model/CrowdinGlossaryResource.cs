...
namespace Crowdin.Api.Model
{
    ...
    /// Glossary Resource
    /// </summary>
    [DataContract(Name = "CrowdinGlossaryResource")]
    public partial class CrowdinGlossaryResource : IEquatable<CrowdinGlossaryResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinGlossaryResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CrowdinGlossaryResource(Glossary data = default(Glossary))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinGlossaryResource {\n");
        ...
        {
            return this.Equals(input as CrowdinGlossaryResource);
        }

        /// <summary>
        /// Returns true if CrowdinGlossaryResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinGlossaryResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinGlossaryResource input)
        {
            if (input == null)
                return false;
