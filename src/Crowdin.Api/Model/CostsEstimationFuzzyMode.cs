...
{
    /// <summary>
    /// Calculate the approximate translation costs to help plan your budget
    /// </summary>
    [DataContract(Name = "CostsEstimationFuzzyMode")]
    public partial class CostsEstimationFuzzyMode : IEquatable<CostsEstimationFuzzyMode>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostsEstimationFuzzyMode" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CostsEstimationFuzzyMode() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CostsEstimationFuzzyMode" /> class.
        /// </summary>
        /// <param name="name">costs-estimation (required).</param>
        /// <param name="schema">Cost Estimation Report schema (required).</param>
        public CostsEstimationFuzzyMode(string name = default(string), List<OneOfcostEstimationReportFuzzyGeneralcostEstimationReportFuzzyByTask> schema = default(List<OneOfcostEstimationReportFuzzyGeneralcostEstimationReportFuzzyByTask>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CostsEstimationFuzzyMode and cannot be null");
            }
            this.Name = name;
            // to ensure "schema" is required (not null)
            if (schema == null) {
                throw new ArgumentNullException("schema is a required property for CostsEstimationFuzzyMode and cannot be null");
            }
            this.Schema = schema;
        }
        ...
        /// costs-estimation
        /// </summary>
        /// <value>costs-estimation</value>
        [DataMember(Name = "name", IsRequired = true, EmitDefaultValue = false)]
        public string Name { get; set; }

        /// <summary>
        /// Cost Estimation Report schema
        /// </summary>
        /// <value>Cost Estimation Report schema</value>
        [DataMember(Name = "schema", IsRequired = true, EmitDefaultValue = false)]
        public List<OneOfcostEstimationReportFuzzyGeneralcostEstimationReportFuzzyByTask> Schema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostsEstimationFuzzyMode {\n");
        ...
        {
            return this.Equals(input as CostsEstimationFuzzyMode);
        }

        /// <summary>
        /// Returns true if CostsEstimationFuzzyMode instances are equal
        /// </summary>
        /// <param name="input">Instance of CostsEstimationFuzzyMode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostsEstimationFuzzyMode input)
        {
            if (input == null)
                return false;
