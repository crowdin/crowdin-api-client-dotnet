...
namespace Crowdin.Api.Model
{
    ...
    /// GlossaryImport
    /// </summary>
    [DataContract(Name = "GlossaryImport")]
    public partial class GlossaryImport : IEquatable<GlossaryImport>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryImport" /> class.
        /// </summary>
        ...
        public GlossaryImport(string identifier = default(string), string status = default(string), int progress = default(int), GlossaryImportAttributes attributes = default(GlossaryImportAttributes), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), DateTime startedAt = default(DateTime), DateTime finishedAt = default(DateTime), string eta = default(string))
        {
        ...
        public GlossaryImportAttributes Attributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryImport {\n");
        ...
        {
            return this.Equals(input as GlossaryImport);
        }

        /// <summary>
        /// Returns true if GlossaryImport instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryImport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryImport input)
        {
            if (input == null)
                return false;
