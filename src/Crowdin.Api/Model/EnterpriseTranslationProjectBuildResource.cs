...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnterpriseTranslationProjectBuildResource")]
    public partial class EnterpriseTranslationProjectBuildResource : IEquatable<EnterpriseTranslationProjectBuildResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseTranslationProjectBuildResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public EnterpriseTranslationProjectBuildResource(EnterpriseProjectBuildResponse data = default(EnterpriseProjectBuildResponse))
        {
            this.Data = data;
        }
        ...
        public EnterpriseProjectBuildResponse Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseTranslationProjectBuildResource {\n");
        ...
        {
            return this.Equals(input as EnterpriseTranslationProjectBuildResource);
        }

        /// <summary>
        /// Returns true if EnterpriseTranslationProjectBuildResource instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseTranslationProjectBuildResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseTranslationProjectBuildResource input)
        {
            if (input == null)
                return false;
