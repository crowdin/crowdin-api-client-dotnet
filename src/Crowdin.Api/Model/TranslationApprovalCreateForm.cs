...
{
    /// <summary>
    /// TranslationApprovalCreateForm
    /// </summary>
    [DataContract(Name = "TranslationApprovalCreateForm")]
    public partial class TranslationApprovalCreateForm : IEquatable<TranslationApprovalCreateForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationApprovalCreateForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TranslationApprovalCreateForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationApprovalCreateForm" /> class.
        /// </summary>
        ...
        public TranslationApprovalCreateForm(int translationId = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationApprovalCreateForm {\n");
        ...
        {
            return this.Equals(input as TranslationApprovalCreateForm);
        }

        /// <summary>
        /// Returns true if TranslationApprovalCreateForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationApprovalCreateForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationApprovalCreateForm input)
        {
            if (input == null)
                return false;
