...
{
    /// <summary>
    /// CrowdinProjectBuildResponseAllOf
    /// </summary>
    [DataContract(Name = "CrowdinProjectBuildResponse_allOf")]
    public partial class CrowdinProjectBuildResponseAllOf : IEquatable<CrowdinProjectBuildResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinProjectBuildResponseAllOf" /> class.
        /// </summary>
        /// <param name="attributes">attributes.</param>
        public CrowdinProjectBuildResponseAllOf(List<OneOfCrowdinBuildAttributesResponseModelCrowdinPseudoBuildAttributesResponseModel> attributes = default(List<OneOfCrowdinBuildAttributesResponseModelCrowdinPseudoBuildAttributesResponseModel>))
        {
        ...
        public List<OneOfCrowdinBuildAttributesResponseModelCrowdinPseudoBuildAttributesResponseModel> Attributes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinProjectBuildResponseAllOf {\n");
        ...
        {
            return this.Equals(input as CrowdinProjectBuildResponseAllOf);
        }

        /// <summary>
        /// Returns true if CrowdinProjectBuildResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinProjectBuildResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinProjectBuildResponseAllOf input)
        {
            if (input == null)
                return false;
