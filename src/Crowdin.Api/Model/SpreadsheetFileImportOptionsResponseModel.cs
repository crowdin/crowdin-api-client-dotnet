...
{
    /// <summary>
    /// SpreadsheetFileImportOptionsResponseModel
    /// </summary>
    [DataContract(Name = "SpreadsheetFileImportOptionsResponseModel")]
    public partial class SpreadsheetFileImportOptionsResponseModel : IEquatable<SpreadsheetFileImportOptionsResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpreadsheetFileImportOptionsResponseModel" /> class.
        /// </summary>
        /// <param name="firstLineContainsHeader">firstLineContainsHeader.</param>
        /// <param name="importTranslations">importTranslations.</param>
        /// <param name="scheme">scheme.</param>
        public SpreadsheetFileImportOptionsResponseModel(bool firstLineContainsHeader = default(bool), bool importTranslations = default(bool), Dictionary<string, SpreadsheetLanguageCodeColumnNumber> scheme = default(Dictionary<string, SpreadsheetLanguageCodeColumnNumber>))
        {
        ...
        public Dictionary<string, SpreadsheetLanguageCodeColumnNumber> Scheme { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SpreadsheetFileImportOptionsResponseModel {\n");
        ...
        {
            return this.Equals(input as SpreadsheetFileImportOptionsResponseModel);
        }

        /// <summary>
        /// Returns true if SpreadsheetFileImportOptionsResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of SpreadsheetFileImportOptionsResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpreadsheetFileImportOptionsResponseModel input)
        {
            if (input == null)
                return false;
