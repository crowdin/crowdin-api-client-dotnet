...
namespace Crowdin.Api.Model
{
    ...
    /// StringTranslation
    /// </summary>
    [DataContract(Name = "StringTranslation")]
    public partial class StringTranslation : IEquatable<StringTranslation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringTranslation" /> class.
        /// </summary>
        /// <param name="id">Translation Identifier.</param>
        /// <param name="text">translation text.</param>
        /// <param name="pluralCategoryName">plural category name.</param>
        /// <param name="user">user.</param>
        /// <param name="rating">Translation Rating (Votes).</param>
        /// <param name="createdAt">createdAt.</param>
        public StringTranslation(int id = default(int), string text = default(string), string pluralCategoryName = default(string), IcuLanguageTranslationUser user = default(IcuLanguageTranslationUser), int rating = default(int), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.Text = text;
        ...
        /// </summary>
        /// <value>plural category name</value>
        ...
        /// <summary>
        /// Translation Rating (Votes)
        /// </summary>
        /// <value>Translation Rating (Votes)</value>
        ...
        {
            return this.Equals(input as StringTranslation);
        }

        /// <summary>
        /// Returns true if StringTranslation instances are equal
        /// </summary>
        /// <param name="input">Instance of StringTranslation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringTranslation input)
        {
            if (input == null)
                return false;
