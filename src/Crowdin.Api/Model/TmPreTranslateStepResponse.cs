...
{
    /// <summary>
    /// TmPreTranslateStepResponse
    /// </summary>
    [DataContract(Name = "TmPreTranslateStepResponse")]
    public partial class TmPreTranslateStepResponse : IEquatable<TmPreTranslateStepResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmPreTranslateStepResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TmPreTranslateStepResponse(TmPreTranslateStepResponseData data = default(TmPreTranslateStepResponseData))
        {
            this.Data = data;
        }
        ...
        public TmPreTranslateStepResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmPreTranslateStepResponse {\n");
        ...
        {
            return this.Equals(input as TmPreTranslateStepResponse);
        }

        /// <summary>
        /// Returns true if TmPreTranslateStepResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TmPreTranslateStepResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmPreTranslateStepResponse input)
        {
            if (input == null)
                return false;
