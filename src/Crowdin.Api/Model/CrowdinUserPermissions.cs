...
{
    /// <summary>
    /// CrowdinUserPermissions
    /// </summary>
    [DataContract(Name = "CrowdinUser_permissions")]
    public partial class CrowdinUserPermissions : IEquatable<CrowdinUserPermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinUserPermissions" /> class.
        /// </summary>
        /// <param name="uk">uk.</param>
        /// <param name="it">it.</param>
        /// <param name="en">en.</param>
        public CrowdinUserPermissions(string uk = default(string), string it = default(string), string en = default(string))
        {
            this.Uk = uk;
            this.It = it;
            this.En = en;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinUserPermissions {\n");
        ...
        {
            return this.Equals(input as CrowdinUserPermissions);
        }

        /// <summary>
        /// Returns true if CrowdinUserPermissions instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinUserPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinUserPermissions input)
        {
            if (input == null)
                return false;
