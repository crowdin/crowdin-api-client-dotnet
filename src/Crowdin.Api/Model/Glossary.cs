...
namespace Crowdin.Api.Model
{
    ...
    public partial class Glossary : IEquatable<Glossary>, IValidatableObject
    {
        /// <summary>
        ...
        public Glossary(int id = default(int), string name = default(string), int userId = default(int), int terms = default(int), List<string> languageIds = default(List<string>), List<int> projectIds = default(List<int>), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.Name = name;
            this.UserId = userId;
        ...
        {
            return this.Equals(input as Glossary);
        }

        /// <summary>
        /// Returns true if Glossary instances are equal
        /// </summary>
        /// <param name="input">Instance of Glossary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Glossary input)
        {
            if (input == null)
                return false;
