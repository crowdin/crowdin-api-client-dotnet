...
namespace Crowdin.Api.Model
{
    ...
    public partial class Webhook : IEquatable<Webhook>, IValidatableObject
    {
        ...
        /// <param name="batchingEnabled">batchingEnabled.</param>
        /// <param name="requestType">requestType.</param>
        /// <param name="contentType">contentType.</param>
        /// <param name="createdAt">createdAt.</param>
        /// <param name="updatedAt">updatedAt.</param>
        public Webhook(int id = default(int), int projectId = default(int), string name = default(string), string url = default(string), List<string> events = default(List<string>), List<string> headers = default(List<string>), List<string> payload = default(List<string>), bool isActive = default(bool), bool batchingEnabled = default(bool), string requestType = default(string), string contentType = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
