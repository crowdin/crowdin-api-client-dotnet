...
namespace Crowdin.Api.Model
{
    ...
    /// AddProjectTeamForm
    /// </summary>
    [DataContract(Name = "AddProjectTeamForm")]
    public partial class AddProjectTeamForm : IEquatable<AddProjectTeamForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectTeamForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddProjectTeamForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectTeamForm" /> class.
        /// </summary>
        /// <param name="teamId">Team Identifier. Get via [List Teams](#operation/api.teams.getMany) (required).</param>
        ...
        public AddProjectTeamForm(Object teamId = default(Object), bool accessToAllWorkflowSteps = true, bool managerAccess = false, AddProjectTeamFormPermissions permissions = default(AddProjectTeamFormPermissions))
        {
            // to ensure "teamId" is required (not null)
            if (teamId == null) {
                throw new ArgumentNullException("teamId is a required property for AddProjectTeamForm and cannot be null");
            }
            this.TeamId = teamId;
        ...
        /// <summary>
        /// Team Identifier. Get via [List Teams](#operation/api.teams.getMany)
        /// </summary>
        /// <value>Team Identifier. Get via [List Teams](#operation/api.teams.getMany)</value>
        ...
        public AddProjectTeamFormPermissions Permissions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProjectTeamForm {\n");
        ...
        {
            return this.Equals(input as AddProjectTeamForm);
        }

        /// <summary>
        /// Returns true if AddProjectTeamForm instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProjectTeamForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProjectTeamForm input)
        {
            if (input == null)
                return false;
