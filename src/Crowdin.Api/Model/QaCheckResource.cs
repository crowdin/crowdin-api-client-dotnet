...
namespace Crowdin.Api.Model
{
    ...
    /// QaCheck Resource
    /// </summary>
    [DataContract(Name = "QaCheckResource")]
    public partial class QaCheckResource : IEquatable<QaCheckResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QaCheckResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public QaCheckResource(QaCheck data = default(QaCheck))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QaCheckResource {\n");
        ...
        {
            return this.Equals(input as QaCheckResource);
        }

        /// <summary>
        /// Returns true if QaCheckResource instances are equal
        /// </summary>
        /// <param name="input">Instance of QaCheckResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QaCheckResource input)
        {
            if (input == null)
                return false;
