...
{
    /// <summary>
    /// TranslateByVendorStepResponse
    /// </summary>
    [DataContract(Name = "TranslateByVendorStepResponse")]
    public partial class TranslateByVendorStepResponse : IEquatable<TranslateByVendorStepResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateByVendorStepResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public TranslateByVendorStepResponse(TranslateByVendorStepResponseData data = default(TranslateByVendorStepResponseData))
        {
            this.Data = data;
        }
        ...
        public TranslateByVendorStepResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslateByVendorStepResponse {\n");
        ...
        {
            return this.Equals(input as TranslateByVendorStepResponse);
        }

        /// <summary>
        /// Returns true if TranslateByVendorStepResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslateByVendorStepResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslateByVendorStepResponse input)
        {
            if (input == null)
                return false;
