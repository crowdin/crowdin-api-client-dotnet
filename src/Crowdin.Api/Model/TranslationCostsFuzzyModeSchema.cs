...
{
    /// <summary>
    /// Translation Cost Report schema
    /// </summary>
    [DataContract(Name = "TranslationCostsFuzzyMode_schema")]
    public partial class TranslationCostsFuzzyModeSchema : IEquatable<TranslationCostsFuzzyModeSchema>, IValidatableObject
    {
        /// <summary>
        /// Defines report unit
        /// </summary>
        ...
        /// <summary>
        /// Defines grouping parameter
        /// </summary>
        /// <value>Defines grouping parameter</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCostsFuzzyModeSchema" /> class.
        /// </summary>
        ...
        /// <param name="groupBy">Defines grouping parameter (default to GroupByEnum.User).</param>
        ...
        public TranslationCostsFuzzyModeSchema(UnitEnum? unit = UnitEnum.Words, CurrencyEnum? currency = CurrencyEnum.USD, string mode = default(string), FormatEnum? format = FormatEnum.Xlsx, GroupByEnum? groupBy = GroupByEnum.User, List<CostEstimationFuzzyRegularRates> regularRates = default(List<CostEstimationFuzzyRegularRates>), List<CostEstimationFuzzyIndividualRates> individualRates = default(List<CostEstimationFuzzyIndividualRates>), DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime))
        {
            this.Unit = unit;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCostsFuzzyModeSchema {\n");
        ...
        {
            return this.Equals(input as TranslationCostsFuzzyModeSchema);
        }

        /// <summary>
        /// Returns true if TranslationCostsFuzzyModeSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCostsFuzzyModeSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCostsFuzzyModeSchema input)
        {
            if (input == null)
                return false;
