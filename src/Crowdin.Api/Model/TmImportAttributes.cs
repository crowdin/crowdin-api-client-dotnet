...
namespace Crowdin.Api.Model
{
    ...
    /// TmImportAttributes
    /// </summary>
    [DataContract(Name = "TmImport_attributes")]
    public partial class TmImportAttributes : IEquatable<TmImportAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmImportAttributes" /> class.
        /// </summary>
        /// <param name="tmId">tmId.</param>
        /// <param name="storageId">storageId.</param>
        /// <param name="firstLineContainsHeader">firstLineContainsHeader.</param>
        /// <param name="scheme">scheme.</param>
        public TmImportAttributes(int tmId = default(int), int storageId = default(int), int firstLineContainsHeader = default(int), TmImportAttributesScheme scheme = default(TmImportAttributesScheme))
        {
            this.TmId = tmId;
        ...
        /// Gets or Sets TmId
        /// </summary>
        [DataMember(Name = "tmId", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "firstLineContainsHeader", EmitDefaultValue = false)]
        ...
        public TmImportAttributesScheme Scheme { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TmImportAttributes {\n");
            sb.Append("  TmId: ").Append(TmId).Append("\n");
        ...
        {
            return this.Equals(input as TmImportAttributes);
        }

        /// <summary>
        /// Returns true if TmImportAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of TmImportAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmImportAttributes input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.TmId == input.TmId ||
                    this.TmId.Equals(input.TmId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                hashCode = hashCode * 59 + this.TmId.GetHashCode();
