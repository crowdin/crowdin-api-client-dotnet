...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MtOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(MtOperationReplace), "MtOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(MtOperationTest), "MtOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(MtOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(MtOperationTest), "test")]
    public partial class MtOperation : IEquatable<MtOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MtOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MtOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MtOperation" /> class.
        /// </summary>
        ...
        public MtOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as MtOperation);
        }

        /// <summary>
        /// Returns true if MtOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of MtOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtOperation input)
        {
            if (input == null)
                return false;
