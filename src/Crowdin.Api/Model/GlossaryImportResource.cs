...
{
    /// <summary>
    /// Glossary Import Resource
    /// </summary>
    [DataContract(Name = "GlossaryImportResource")]
    public partial class GlossaryImportResource : IEquatable<GlossaryImportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryImportResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public GlossaryImportResource(GlossaryImport data = default(GlossaryImport))
        {
            this.Data = data;
        }
        ...
        public GlossaryImport Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryImportResource {\n");
        ...
        {
            return this.Equals(input as GlossaryImportResource);
        }

        /// <summary>
        /// Returns true if GlossaryImportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryImportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryImportResource input)
        {
            if (input == null)
                return false;
