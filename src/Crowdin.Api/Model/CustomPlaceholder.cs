...
namespace Crowdin.Api.Model
{
    ...
    /// CustomPlaceholder
    /// </summary>
    [DataContract(Name = "CustomPlaceholder")]
    public partial class CustomPlaceholder : IEquatable<CustomPlaceholder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholder" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="definition">definition.</param>
        /// <param name="description">description.</param>
        /// <param name="argumentDelimiter">argumentDelimiter.</param>
        public CustomPlaceholder(int id = default(int), string definition = default(string), string description = default(string), string argumentDelimiter = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomPlaceholder {\n");
        ...
        {
            return this.Equals(input as CustomPlaceholder);
        }

        /// <summary>
        /// Returns true if CustomPlaceholder instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomPlaceholder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomPlaceholder input)
        {
            if (input == null)
                return false;
