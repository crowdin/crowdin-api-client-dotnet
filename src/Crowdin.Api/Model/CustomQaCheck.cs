...
namespace Crowdin.Api.Model
{
    ...
    /// CustomQaCheck
    /// </summary>
    [DataContract(Name = "CustomQaCheck")]
    public partial class CustomQaCheck : IEquatable<CustomQaCheck>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomQaCheck" /> class.
        /// </summary>
        ...
        public CustomQaCheck(int id = default(int), string title = default(string), string description = default(string), string snippet = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.Title = title;
        ...
        {
            return this.Equals(input as CustomQaCheck);
        }

        /// <summary>
        /// Returns true if CustomQaCheck instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomQaCheck to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomQaCheck input)
        {
            if (input == null)
                return false;
