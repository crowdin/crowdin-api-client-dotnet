...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TermOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(TermOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(TermOperationTest), "test")]
    public partial class TermOperationReplace : TermOperation, IEquatable<TermOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;TermOperationReplace&quot;).</param>
        ...
        public TermOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "TermOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for TermOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TermOperationReplace {\n");
        ...
        {
            return this.Equals(input as TermOperationReplace);
        }

        /// <summary>
        /// Returns true if TermOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of TermOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermOperationReplace input)
        {
            if (input == null)
                return false;
