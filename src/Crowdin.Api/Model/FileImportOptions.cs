...
namespace Crowdin.Api.Model
{
    ...
    /// FileImportOptions
    /// </summary>
    [JsonConverter(typeof(FileImportOptionsJsonConverter))]
    [DataContract(Name = "FileImportOptions")]
    public partial class FileImportOptions : AbstractOpenAPISchema, IEquatable<FileImportOptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileImportOptions" /> class
        /// with the <see cref="OtherFilesImportOptions" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of OtherFilesImportOptions.</param>
        public FileImportOptions(OtherFilesImportOptions actualInstance)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileImportOptions" /> class
        /// with the <see cref="SpreadsheetFileImportOptions" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of SpreadsheetFileImportOptions.</param>
        public FileImportOptions(SpreadsheetFileImportOptions actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FileImportOptions" /> class
        /// with the <see cref="XmlFileImportOptions" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of XmlFileImportOptions.</param>
        public FileImportOptions(XmlFileImportOptions actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(OtherFilesImportOptions))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(SpreadsheetFileImportOptions))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(XmlFileImportOptions))
                {
                    this._actualInstance = value;
                }
                else
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: OtherFilesImportOptions, SpreadsheetFileImportOptions, XmlFileImportOptions");
                }
            }
        }

        /// <summary>
        /// Get the actual instance of `OtherFilesImportOptions`. If the actual instance is not `OtherFilesImportOptions`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of OtherFilesImportOptions</returns>
        public OtherFilesImportOptions GetOtherFilesImportOptions()
        {
            return (OtherFilesImportOptions)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `SpreadsheetFileImportOptions`. If the actual instance is not `SpreadsheetFileImportOptions`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of SpreadsheetFileImportOptions</returns>
        public SpreadsheetFileImportOptions GetSpreadsheetFileImportOptions()
        {
            return (SpreadsheetFileImportOptions)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `XmlFileImportOptions`. If the actual instance is not `XmlFileImportOptions`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of XmlFileImportOptions</returns>
        public XmlFileImportOptions GetXmlFileImportOptions()
        {
            return (XmlFileImportOptions)this.ActualInstance;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileImportOptions {\n");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, FileImportOptions.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of FileImportOptions
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of FileImportOptions</returns>
        public static FileImportOptions FromJson(string jsonString)
        {
            FileImportOptions newFileImportOptions = null;

            if (string.IsNullOrEmpty(jsonString))
            {
                return newFileImportOptions;
            }
            int match = 0;
            ...
            try
            {
                ...
                if (typeof(OtherFilesImportOptions).GetProperty("AdditionalProperties") == null)
                {
                    newFileImportOptions = new FileImportOptions(JsonConvert.DeserializeObject<OtherFilesImportOptions>(jsonString, FileImportOptions.SerializerSettings));
                }
                else
                {
                    newFileImportOptions = new FileImportOptions(JsonConvert.DeserializeObject<OtherFilesImportOptions>(jsonString, FileImportOptions.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("OtherFilesImportOptions");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into OtherFilesImportOptions: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(SpreadsheetFileImportOptions).GetProperty("AdditionalProperties") == null)
                {
                    newFileImportOptions = new FileImportOptions(JsonConvert.DeserializeObject<SpreadsheetFileImportOptions>(jsonString, FileImportOptions.SerializerSettings));
                }
                else
                {
                    newFileImportOptions = new FileImportOptions(JsonConvert.DeserializeObject<SpreadsheetFileImportOptions>(jsonString, FileImportOptions.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("SpreadsheetFileImportOptions");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into SpreadsheetFileImportOptions: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(XmlFileImportOptions).GetProperty("AdditionalProperties") == null)
                {
                    newFileImportOptions = new FileImportOptions(JsonConvert.DeserializeObject<XmlFileImportOptions>(jsonString, FileImportOptions.SerializerSettings));
                }
                else
                {
                    newFileImportOptions = new FileImportOptions(JsonConvert.DeserializeObject<XmlFileImportOptions>(jsonString, FileImportOptions.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("XmlFileImportOptions");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into XmlFileImportOptions: {1}", jsonString, exception.ToString()));
            }
        ...
        {
            return this.Equals(input as FileImportOptions);
        }

        /// <summary>
        /// Returns true if FileImportOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of FileImportOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileImportOptions input)
        {
            if (input == null)
                return false;
    ...
    /// <summary>
    /// Custom JSON converter for FileImportOptions
    /// </summary>
    public class FileImportOptionsJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(FileImportOptions).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            {
                return FileImportOptions.FromJson(JObject.Load(reader).ToString(Formatting.None));
            }
            return null;
        }
