...
{
    /// <summary>
    /// MtCredentialsGoogleAutoml
    /// </summary>
    [DataContract(Name = "mt.credentials.google_automl")]
    public partial class MtCredentialsGoogleAutoml : IEquatable<MtCredentialsGoogleAutoml>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentialsGoogleAutoml" /> class.
        /// </summary>
        /// <param name="credentials">Your Google Translate credentials as a JSON (base64 encoded) file..</param>
        public MtCredentialsGoogleAutoml(string credentials = default(string))
        {
            this.Credentials = credentials;
        }

        /// <summary>
        /// Your Google Translate credentials as a JSON (base64 encoded) file.
        /// </summary>
        /// <value>Your Google Translate credentials as a JSON (base64 encoded) file.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentialsGoogleAutoml {\n");
        ...
        {
            return this.Equals(input as MtCredentialsGoogleAutoml);
        }

        /// <summary>
        /// Returns true if MtCredentialsGoogleAutoml instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentialsGoogleAutoml to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentialsGoogleAutoml input)
        {
            if (input == null)
                return false;
