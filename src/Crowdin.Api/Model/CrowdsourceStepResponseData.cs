...
{
    /// <summary>
    /// CrowdsourceStepResponseData
    /// </summary>
    [DataContract(Name = "CrowdsourceStepResponse_data")]
    public partial class CrowdsourceStepResponseData : IEquatable<CrowdsourceStepResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdsourceStepResponseData" /> class.
        /// </summary>
        ...
        public CrowdsourceStepResponseData(int id = default(int), string title = default(string), string type = default(string), List<string> languages = default(List<string>), Object config = default(Object))
        {
            this.Id = id;
            this.Title = title;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdsourceStepResponseData {\n");
        ...
        {
            return this.Equals(input as CrowdsourceStepResponseData);
        }

        /// <summary>
        /// Returns true if CrowdsourceStepResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdsourceStepResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdsourceStepResponseData input)
        {
            if (input == null)
                return false;
