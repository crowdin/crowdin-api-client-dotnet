...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringCommentResource")]
    public partial class StringCommentResource : IEquatable<StringCommentResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCommentResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public StringCommentResource(StringComment data = default(StringComment))
        {
            this.Data = data;
        }
        ...
        public StringComment Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringCommentResource {\n");
        ...
        {
            return this.Equals(input as StringCommentResource);
        }

        /// <summary>
        /// Returns true if StringCommentResource instances are equal
        /// </summary>
        /// <param name="input">Instance of StringCommentResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringCommentResource input)
        {
            if (input == null)
                return false;
