...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LanguageCollectionResource")]
    public partial class LanguageCollectionResource : IEquatable<LanguageCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public LanguageCollectionResource(List<LanguageResource> data = default(List<LanguageResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<LanguageResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LanguageCollectionResource {\n");
        ...
        {
            return this.Equals(input as LanguageCollectionResource);
        }

        /// <summary>
        /// Returns true if LanguageCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageCollectionResource input)
        {
            if (input == null)
                return false;
