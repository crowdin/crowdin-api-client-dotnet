...
{
    /// <summary>
    /// CostEstimationReportFuzzyGeneral
    /// </summary>
    [DataContract(Name = "cost-estimation.report.fuzzy.general")]
    public partial class CostEstimationReportFuzzyGeneral : IEquatable<CostEstimationReportFuzzyGeneral>, IValidatableObject
    {
        /// <summary>
        /// Defines report unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationReportFuzzyGeneral" /> class.
        /// </summary>
        ...
        /// <param name="mode">fuzzy.</param>
        /// <param name="calculateInternalFuzzyMatches">false.</param>
        /// <param name="languageId">Language Identifier for which the report should be generated. Get via [List Supported Languages](#operation/api.languages.getMany)  __Note:__ Can&#39;t be used with &#x60;individualRates&#x60; in the same request.</param>
        ...
        /// <param name="regularRates">Class ReportCreateForm.</param>
        /// <param name="individualRates"> __Note:__ Can&#39;t be used with &#x60;languageId&#x60; in the same request.</param>
        ...
        public CostEstimationReportFuzzyGeneral(UnitEnum? unit = UnitEnum.Words, CurrencyEnum? currency = CurrencyEnum.USD, FormatEnum? format = FormatEnum.Xlsx, string mode = default(string), bool calculateInternalFuzzyMatches = default(bool), string languageId = default(string), List<int> fileIds = default(List<int>), List<int> directoryIds = default(List<int>), List<int> branchIds = default(List<int>), List<CostEstimationFuzzyRegularRates> regularRates = default(List<CostEstimationFuzzyRegularRates>), List<CostEstimationFuzzyIndividualRates> individualRates = default(List<CostEstimationFuzzyIndividualRates>), DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime), List<int> labelIds = default(List<int>), LabelIncludeTypeEnum? labelIncludeType = LabelIncludeTypeEnum.WithLabel)
        {
            this.Unit = unit;
            this.Currency = currency;
            this.Format = format;
            this.Mode = mode;
            this.CalculateInternalFuzzyMatches = calculateInternalFuzzyMatches;
        ...
        /// </summary>
        /// <value>false</value>
        [DataMember(Name = "calculateInternalFuzzyMatches", EmitDefaultValue = true)]
        public bool CalculateInternalFuzzyMatches { get; set; }

        /// <summary>
        /// Language Identifier for which the report should be generated. Get via [List Supported Languages](#operation/api.languages.getMany)  __Note:__ Can&#39;t be used with &#x60;individualRates&#x60; in the same request
        /// </summary>
        /// <value>Language Identifier for which the report should be generated. Get via [List Supported Languages](#operation/api.languages.getMany)  __Note:__ Can&#39;t be used with &#x60;individualRates&#x60; in the same request</value>
        ...
        /// </summary>
        /// <value>Class ReportCreateForm</value>
        [DataMember(Name = "regularRates", EmitDefaultValue = false)]
        public List<CostEstimationFuzzyRegularRates> RegularRates { get; set; }

        /// <summary>
        ///  __Note:__ Can&#39;t be used with &#x60;languageId&#x60; in the same request
        /// </summary>
        /// <value> __Note:__ Can&#39;t be used with &#x60;languageId&#x60; in the same request</value>
        [DataMember(Name = "individualRates", EmitDefaultValue = false)]
        public List<CostEstimationFuzzyIndividualRates> IndividualRates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationReportFuzzyGeneral {\n");
            sb.Append("  Unit: ").Append(Unit).Append("\n");
            sb.Append("  Currency: ").Append(Currency).Append("\n");
            sb.Append("  Format: ").Append(Format).Append("\n");
            sb.Append("  Mode: ").Append(Mode).Append("\n");
            sb.Append("  CalculateInternalFuzzyMatches: ").Append(CalculateInternalFuzzyMatches).Append("\n");
            sb.Append("  LanguageId: ").Append(LanguageId).Append("\n");
            sb.Append("  FileIds: ").Append(FileIds).Append("\n");
            sb.Append("  DirectoryIds: ").Append(DirectoryIds).Append("\n");
            sb.Append("  BranchIds: ").Append(BranchIds).Append("\n");
            sb.Append("  RegularRates: ").Append(RegularRates).Append("\n");
            sb.Append("  IndividualRates: ").Append(IndividualRates).Append("\n");
        ...
        {
            return this.Equals(input as CostEstimationReportFuzzyGeneral);
        }

        /// <summary>
        /// Returns true if CostEstimationReportFuzzyGeneral instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationReportFuzzyGeneral to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationReportFuzzyGeneral input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CalculateInternalFuzzyMatches == input.CalculateInternalFuzzyMatches ||
                    this.CalculateInternalFuzzyMatches.Equals(input.CalculateInternalFuzzyMatches)
                ) && 
                (
                ...
                (
                    this.RegularRates == input.RegularRates ||
                    this.RegularRates != null &&
                    input.RegularRates != null &&
                    this.RegularRates.SequenceEqual(input.RegularRates)
                ) && 
                (
                    this.IndividualRates == input.IndividualRates ||
                    this.IndividualRates != null &&
                    input.IndividualRates != null &&
                    this.IndividualRates.SequenceEqual(input.IndividualRates)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.CalculateInternalFuzzyMatches.GetHashCode();
                ...
                if (this.RegularRates != null)
                    hashCode = hashCode * 59 + this.RegularRates.GetHashCode();
                if (this.IndividualRates != null)
                    hashCode = hashCode * 59 + this.IndividualRates.GetHashCode();
