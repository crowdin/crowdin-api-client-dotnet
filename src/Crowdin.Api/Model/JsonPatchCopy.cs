...
{
    /// <summary>
    /// A JSON Patch &#x60;Copy&#x60; operation as defined by [RFC 6902](https://tools.ietf.org/html/rfc6902#section-4.5)
    /// </summary>
    [DataContract(Name = "JsonPatchCopy")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchAdd), "add")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchCopy), "copy")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchMove), "move")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchRemove), "remove")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(JsonPatchTest), "test")]
    public partial class JsonPatchCopy : JsonPatchOperation, IEquatable<JsonPatchCopy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchCopy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JsonPatchCopy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JsonPatchCopy" /> class.
        /// </summary>
        /// <param name="from">A JSON Pointer as defined by &lt;a href&#x3D;\&quot;https://tools.ietf.org/html/rfc6901\&quot; target&#x3D;\&quot;_blank\&quot;&gt;RFC 6901&lt;/a&gt; (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;JsonPatchCopy&quot;).</param>
        ...
        public JsonPatchCopy(string from = default(string), OpEnum op = "JsonPatchCopy", string path = default(string)) : base(op, path)
        {
            // to ensure "from" is required (not null)
            if (from == null) {
                throw new ArgumentNullException("from is a required property for JsonPatchCopy and cannot be null");
            }
            this.From = from;
        }
        ...
        {
            return this.Equals(input as JsonPatchCopy);
        }

        /// <summary>
        /// Returns true if JsonPatchCopy instances are equal
        /// </summary>
        /// <param name="input">Instance of JsonPatchCopy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JsonPatchCopy input)
        {
            if (input == null)
                return false;
