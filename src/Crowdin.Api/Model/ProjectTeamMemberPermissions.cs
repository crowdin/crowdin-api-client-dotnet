...
{
    /// <summary>
    /// ProjectTeamMemberPermissions
    /// </summary>
    [DataContract(Name = "ProjectTeamMember_permissions")]
    public partial class ProjectTeamMemberPermissions : IEquatable<ProjectTeamMemberPermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTeamMemberPermissions" /> class.
        /// </summary>
        /// <param name="it">it.</param>
        public ProjectTeamMemberPermissions(AddProjectMemberFormPermissionsIt it = default(AddProjectMemberFormPermissionsIt))
        {
            this.It = it;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectTeamMemberPermissions {\n");
        ...
        {
            return this.Equals(input as ProjectTeamMemberPermissions);
        }

        /// <summary>
        /// Returns true if ProjectTeamMemberPermissions instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTeamMemberPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTeamMemberPermissions input)
        {
            if (input == null)
                return false;
