...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WorkflowTemplateCollectionResource")]
    public partial class WorkflowTemplateCollectionResource : IEquatable<WorkflowTemplateCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WorkflowTemplateCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public WorkflowTemplateCollectionResource(List<WorkflowTemplateResource> data = default(List<WorkflowTemplateResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<WorkflowTemplateResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkflowTemplateCollectionResource {\n");
        ...
        {
            return this.Equals(input as WorkflowTemplateCollectionResource);
        }

        /// <summary>
        /// Returns true if WorkflowTemplateCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkflowTemplateCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkflowTemplateCollectionResource input)
        {
            if (input == null)
                return false;
