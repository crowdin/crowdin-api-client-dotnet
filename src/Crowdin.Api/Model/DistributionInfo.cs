...
namespace Crowdin.Api.Model
{
    ...
    /// Distribution Info
    /// </summary>
    [DataContract(Name = "DistributionInfo")]
    public partial class DistributionInfo : IEquatable<DistributionInfo>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="wsUrl">wsUrl.</param>
        public DistributionInfo(int project = default(int), int user = default(int), string wsUrl = default(string))
        {
        ...
        /// Gets or Sets WsUrl
        /// </summary>
        [DataMember(Name = "wsUrl", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as DistributionInfo);
        }

        /// <summary>
        /// Returns true if DistributionInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionInfo input)
        {
            if (input == null)
                return false;
