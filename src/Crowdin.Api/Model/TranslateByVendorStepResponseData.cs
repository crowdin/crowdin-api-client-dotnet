...
{
    /// <summary>
    /// TranslateByVendorStepResponseData
    /// </summary>
    [DataContract(Name = "TranslateByVendorStepResponse_data")]
    public partial class TranslateByVendorStepResponseData : IEquatable<TranslateByVendorStepResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslateByVendorStepResponseData" /> class.
        /// </summary>
        ...
        public TranslateByVendorStepResponseData(int id = default(int), string title = default(string), string type = default(string), List<string> languages = default(List<string>), TranslateByVendorStepResponseDataConfig config = default(TranslateByVendorStepResponseDataConfig))
        {
            this.Id = id;
            this.Title = title;
            this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslateByVendorStepResponseData {\n");
        ...
        {
            return this.Equals(input as TranslateByVendorStepResponseData);
        }

        /// <summary>
        /// Returns true if TranslateByVendorStepResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslateByVendorStepResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslateByVendorStepResponseData input)
        {
            if (input == null)
                return false;
