...
{
    /// <summary>
    /// CostEstimationStepsTranslateIndividualRates
    /// </summary>
    [DataContract(Name = "cost-estimation.steps.translate.individual-rates")]
    public partial class CostEstimationStepsTranslateIndividualRates : IEquatable<CostEstimationStepsTranslateIndividualRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationStepsTranslateIndividualRates" /> class.
        /// </summary>
        /// <param name="languageIdsTo">Array of language ids.</param>
        /// <param name="rates">rates.</param>
        public CostEstimationStepsTranslateIndividualRates(List<string> languageIdsTo = default(List<string>), List<CostEstimationStepsTranslateIndividualRateModes> rates = default(List<CostEstimationStepsTranslateIndividualRateModes>))
        {
        ...
        public List<CostEstimationStepsTranslateIndividualRateModes> Rates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationStepsTranslateIndividualRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationStepsTranslateIndividualRates);
        }

        /// <summary>
        /// Returns true if CostEstimationStepsTranslateIndividualRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationStepsTranslateIndividualRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationStepsTranslateIndividualRates input)
        {
            if (input == null)
                return false;
