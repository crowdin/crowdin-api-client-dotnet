...
namespace Crowdin.Api.Model
{
    ...
    /// TmUploadForm
    /// </summary>
    [DataContract(Name = "TmUploadForm")]
    public partial class TmUploadForm : IEquatable<TmUploadForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TmUploadForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TmUploadForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TmUploadForm" /> class.
        /// </summary>
        /// <param name="storageId">Storage Identifier. Get via [List Storages](#operation/api.storages.getMany)  Supported file formats: TMX, CSV, XLS/XLSX  See TMX 1.4b Specification (required).</param>
        ...
        /// <param name="scheme">Defines data columns mapping. The passed value should be an associative array containing both language id and column number:   *     &#x60;{languageId}&#x60; – Crowdin id for the specified language. Get via [List Supported Languages](#operation/api.languages.getMany)  *     &#x60;{columnNumber}&#x60; – a column number. Please note, that column numbering starts at 0  __Note:__ Required for CSV or XLS/XLSX files.</param>
        public TmUploadForm(int storageId = default(int), bool firstLineContainsHeader = false, Dictionary<string, TmLanguageCodeColumnCode> scheme = default(Dictionary<string, TmLanguageCodeColumnCode>))
        {
        ...
        /// <summary>
        /// Storage Identifier. Get via [List Storages](#operation/api.storages.getMany)  Supported file formats: TMX, CSV, XLS/XLSX  See TMX 1.4b Specification
        /// </summary>
        /// <value>Storage Identifier. Get via [List Storages](#operation/api.storages.getMany)  Supported file formats: TMX, CSV, XLS/XLSX  See TMX 1.4b Specification</value>
        ...
        /// <summary>
        /// Defines data columns mapping. The passed value should be an associative array containing both language id and column number:   *     &#x60;{languageId}&#x60; – Crowdin id for the specified language. Get via [List Supported Languages](#operation/api.languages.getMany)  *     &#x60;{columnNumber}&#x60; – a column number. Please note, that column numbering starts at 0  __Note:__ Required for CSV or XLS/XLSX files
        /// </summary>
        /// <value>Defines data columns mapping. The passed value should be an associative array containing both language id and column number:   *     &#x60;{languageId}&#x60; – Crowdin id for the specified language. Get via [List Supported Languages](#operation/api.languages.getMany)  *     &#x60;{columnNumber}&#x60; – a column number. Please note, that column numbering starts at 0  __Note:__ Required for CSV or XLS/XLSX files</value>
        [DataMember(Name = "scheme", EmitDefaultValue = false)]
        public Dictionary<string, TmLanguageCodeColumnCode> Scheme { get; set; }
        ...
        {
            return this.Equals(input as TmUploadForm);
        }

        /// <summary>
        /// Returns true if TmUploadForm instances are equal
        /// </summary>
        /// <param name="input">Instance of TmUploadForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TmUploadForm input)
        {
            if (input == null)
                return false;
