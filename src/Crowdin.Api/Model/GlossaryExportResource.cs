...
{
    /// <summary>
    /// Glossary Export Resource
    /// </summary>
    [DataContract(Name = "GlossaryExportResource")]
    public partial class GlossaryExportResource : IEquatable<GlossaryExportResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GlossaryExportResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public GlossaryExportResource(GlossaryExport data = default(GlossaryExport))
        {
            this.Data = data;
        }
        ...
        public GlossaryExport Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GlossaryExportResource {\n");
        ...
        {
            return this.Equals(input as GlossaryExportResource);
        }

        /// <summary>
        /// Returns true if GlossaryExportResource instances are equal
        /// </summary>
        /// <param name="input">Instance of GlossaryExportResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GlossaryExportResource input)
        {
            if (input == null)
                return false;
