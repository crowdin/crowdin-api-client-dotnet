...
{
    /// <summary>
    /// Generate a list of translators based on a specific period of time to see who contributed the most to your project’s translation.
    /// </summary>
    [DataContract(Name = "GroupTopMembers")]
    public partial class GroupTopMembers : IEquatable<GroupTopMembers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupTopMembers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupTopMembers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupTopMembers" /> class.
        /// </summary>
        /// <param name="name">group-top-members (required).</param>
        /// <param name="schema">schema (required).</param>
        public GroupTopMembers(string name = default(string), GroupTopMembersSchema schema = default(GroupTopMembersSchema))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for GroupTopMembers and cannot be null");
            }
            this.Name = name;
            // to ensure "schema" is required (not null)
            if (schema == null) {
                throw new ArgumentNullException("schema is a required property for GroupTopMembers and cannot be null");
            }
            this.Schema = schema;
        }
        ...
        public GroupTopMembersSchema Schema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupTopMembers {\n");
        ...
        {
            return this.Equals(input as GroupTopMembers);
        }

        /// <summary>
        /// Returns true if GroupTopMembers instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupTopMembers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupTopMembers input)
        {
            if (input == null)
                return false;
