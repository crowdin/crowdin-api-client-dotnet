...
{
    /// <summary>
    /// File Revision Collection Resource
    /// </summary>
    [DataContract(Name = "RevisionCollectionResource")]
    public partial class RevisionCollectionResource : IEquatable<RevisionCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RevisionCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public RevisionCollectionResource(List<RevisionResource> data = default(List<RevisionResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<RevisionResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RevisionCollectionResource {\n");
        ...
        {
            return this.Equals(input as RevisionCollectionResource);
        }

        /// <summary>
        /// Returns true if RevisionCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of RevisionCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RevisionCollectionResource input)
        {
            if (input == null)
                return false;
