...
{
    /// <summary>
    /// A JSON Patch &#x60;Remove&#x60; operation as defined by [RFC 6902](https://tools.ietf.org/html/rfc6902#section-4.3)
    /// </summary>
    [DataContract(Name = "ProjectSettingOperationRemove")]
    ...
    public partial class ProjectSettingOperationRemove : ProjectSettingOperation, IEquatable<ProjectSettingOperationRemove>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingOperationRemove" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectSettingOperationRemove() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingOperationRemove" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectSettingOperationRemove&quot;).</param>
        ...
        public ProjectSettingOperationRemove(OneOfstringintegerbooleanobject value = default(OneOfstringintegerbooleanobject), OpEnum op = "ProjectSettingOperationRemove", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectSettingOperationRemove and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectSettingOperationRemove {\n");
        ...
        {
            return this.Equals(input as ProjectSettingOperationRemove);
        }

        /// <summary>
        /// Returns true if ProjectSettingOperationRemove instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectSettingOperationRemove to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectSettingOperationRemove input)
        {
            if (input == null)
                return false;
