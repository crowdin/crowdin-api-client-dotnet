...
namespace Crowdin.Api.Model
{
    ...
    public partial class TeamMember : IEquatable<TeamMember>, IValidatableObject
    {
        ...
        /// <param name="addedAt">in UTC.</param>
        public TeamMember(int id = default(int), string username = default(string), string firstName = default(string), string lastName = default(string), string avatarUrl = default(string), DateTime addedAt = default(DateTime))
        {
            this.Id = id;
