...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CostsEstimation")]
    public partial class CostsEstimation : IEquatable<CostsEstimation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostsEstimation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CostsEstimation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CostsEstimation" /> class.
        /// </summary>
        /// <param name="name">costs-estimation (required).</param>
        /// <param name="schema">Cost Estimation Report schema (required).</param>
        public CostsEstimation(string name = default(string), List<OneOfcostEstimationReportGeneralcostEstimationReportByTask> schema = default(List<OneOfcostEstimationReportGeneralcostEstimationReportByTask>))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for CostsEstimation and cannot be null");
            }
            this.Name = name;
            // to ensure "schema" is required (not null)
            if (schema == null) {
                throw new ArgumentNullException("schema is a required property for CostsEstimation and cannot be null");
            }
            this.Schema = schema;
        }
        ...
        public List<OneOfcostEstimationReportGeneralcostEstimationReportByTask> Schema { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostsEstimation {\n");
        ...
        {
            return this.Equals(input as CostsEstimation);
        }

        /// <summary>
        /// Returns true if CostsEstimation instances are equal
        /// </summary>
        /// <param name="input">Instance of CostsEstimation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostsEstimation input)
        {
            if (input == null)
                return false;
