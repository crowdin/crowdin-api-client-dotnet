...
{
    /// <summary>
    /// CostEstimationFuzzyStepsTranslate
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.steps.translate")]
    public partial class CostEstimationFuzzyStepsTranslate : IEquatable<CostEstimationFuzzyStepsTranslate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyStepsTranslate" /> class.
        /// </summary>
        /// <param name="type">Translate.</param>
        /// <param name="mode">fuzzy.</param>
        /// <param name="calculateInternalFuzzyMatches">false.</param>
        /// <param name="regularRates">regularRates.</param>
        /// <param name="individualRates"> __Note:__ Can&#39;t be used with &#x60;languageId&#x60; (at &#x60;scheme&#x60;) in the same request.</param>
        public CostEstimationFuzzyStepsTranslate(string type = default(string), string mode = default(string), bool calculateInternalFuzzyMatches = default(bool), List<CostEstimationFuzzyStepsTranslateRegularRates> regularRates = default(List<CostEstimationFuzzyStepsTranslateRegularRates>), List<CostEstimationFuzzyStepsTranslateIndividualRates> individualRates = default(List<CostEstimationFuzzyStepsTranslateIndividualRates>))
        {
            this.Type = type;
            this.Mode = mode;
        ...
        /// <summary>
        /// Gets or Sets RegularRates
        /// </summary>
        [DataMember(Name = "regularRates", EmitDefaultValue = false)]
        public List<CostEstimationFuzzyStepsTranslateRegularRates> RegularRates { get; set; }

        /// <summary>
        ///  __Note:__ Can&#39;t be used with &#x60;languageId&#x60; (at &#x60;scheme&#x60;) in the same request
        /// </summary>
        /// <value> __Note:__ Can&#39;t be used with &#x60;languageId&#x60; (at &#x60;scheme&#x60;) in the same request</value>
        [DataMember(Name = "individualRates", EmitDefaultValue = false)]
        public List<CostEstimationFuzzyStepsTranslateIndividualRates> IndividualRates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyStepsTranslate {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyStepsTranslate);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyStepsTranslate instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyStepsTranslate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyStepsTranslate input)
        {
            if (input == null)
                return false;
