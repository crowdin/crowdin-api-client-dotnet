...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WebhookCollectionResource")]
    public partial class WebhookCollectionResource : IEquatable<WebhookCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public WebhookCollectionResource(List<WebhookResource> data = default(List<WebhookResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<WebhookResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookCollectionResource {\n");
        ...
        {
            return this.Equals(input as WebhookCollectionResource);
        }

        /// <summary>
        /// Returns true if WebhookCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookCollectionResource input)
        {
            if (input == null)
                return false;
