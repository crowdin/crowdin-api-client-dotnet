...
{
    /// <summary>
    /// A JSON Patch &#x60;Add&#x60; operation as defined by [RFC 6902](https://tools.ietf.org/html/rfc6902#section-4.3)
    /// </summary>
    [DataContract(Name = "ProjectSettingOperationAdd")]
    ...
    public partial class ProjectSettingOperationAdd : ProjectSettingOperation, IEquatable<ProjectSettingOperationAdd>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingOperationAdd" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProjectSettingOperationAdd() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingOperationAdd" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;ProjectSettingOperationAdd&quot;).</param>
        ...
        public ProjectSettingOperationAdd(OneOfstringintegerbooleanobject value = default(OneOfstringintegerbooleanobject), OpEnum op = "ProjectSettingOperationAdd", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for ProjectSettingOperationAdd and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectSettingOperationAdd {\n");
        ...
        {
            return this.Equals(input as ProjectSettingOperationAdd);
        }

        /// <summary>
        /// Returns true if ProjectSettingOperationAdd instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectSettingOperationAdd to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectSettingOperationAdd input)
        {
            if (input == null)
                return false;
