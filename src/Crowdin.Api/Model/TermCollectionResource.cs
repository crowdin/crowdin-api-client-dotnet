...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TermCollectionResource")]
    public partial class TermCollectionResource : IEquatable<TermCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public TermCollectionResource(List<TermResource> data = default(List<TermResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<TermResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TermCollectionResource {\n");
        ...
        {
            return this.Equals(input as TermCollectionResource);
        }

        /// <summary>
        /// Returns true if TermCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TermCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermCollectionResource input)
        {
            if (input == null)
                return false;
