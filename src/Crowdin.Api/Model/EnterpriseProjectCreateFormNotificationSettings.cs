...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EnterpriseProjectCreateForm_notificationSettings")]
    public partial class EnterpriseProjectCreateFormNotificationSettings : IEquatable<EnterpriseProjectCreateFormNotificationSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EnterpriseProjectCreateFormNotificationSettings" /> class.
        /// </summary>
        ...
        public EnterpriseProjectCreateFormNotificationSettings(bool translatorNewStrings = false, bool managerNewStrings = false, bool managerLanguageCompleted = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EnterpriseProjectCreateFormNotificationSettings {\n");
        ...
        {
            return this.Equals(input as EnterpriseProjectCreateFormNotificationSettings);
        }

        /// <summary>
        /// Returns true if EnterpriseProjectCreateFormNotificationSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of EnterpriseProjectCreateFormNotificationSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EnterpriseProjectCreateFormNotificationSettings input)
        {
            if (input == null)
                return false;
