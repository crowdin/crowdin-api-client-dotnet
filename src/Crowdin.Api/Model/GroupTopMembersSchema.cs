...
{
    /// <summary>
    /// Group Top Members Report schema
    /// </summary>
    [DataContract(Name = "GroupTopMembers_schema")]
    public partial class GroupTopMembersSchema : IEquatable<GroupTopMembersSchema>, IValidatableObject
    {
        /// <summary>
        /// Defines report unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupTopMembersSchema" /> class.
        /// </summary>
        ...
        public GroupTopMembersSchema(List<int> projectIds = default(List<int>), UnitEnum? unit = UnitEnum.Words, string languageId = default(string), FormatEnum? format = FormatEnum.Xlsx, DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupTopMembersSchema {\n");
        ...
        {
            return this.Equals(input as GroupTopMembersSchema);
        }

        /// <summary>
        /// Returns true if GroupTopMembersSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupTopMembersSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupTopMembersSchema input)
        {
            if (input == null)
                return false;
