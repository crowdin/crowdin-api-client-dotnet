...
namespace Crowdin.Api.Model
{
    ...
    public partial class Screenshot : IEquatable<Screenshot>, IValidatableObject
    {
        ...
        /// <param name="tagsCount">tagsCount.</param>
        /// <param name="tags">tags.</param>
        /// <param name="createdAt">createdAt.</param>
        /// <param name="updatedAt">updatedAt.</param>
        public Screenshot(int id = default(int), int userId = default(int), string url = default(string), string name = default(string), ScreenshotSize size = default(ScreenshotSize), int tagsCount = default(int), List<ScreenshotTag> tags = default(List<ScreenshotTag>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
            this.UserId = userId;
            this.Url = url;
        ...
        /// <summary>
        /// Gets or Sets TagsCount
        /// </summary>
        [DataMember(Name = "tagsCount", EmitDefaultValue = false)]
        ...
        public List<ScreenshotTag> Tags { get; set; }
        ...
        public bool Equals(Screenshot input)
        {
            ...
            return 
                ...
                (
                    this.TagsCount == input.TagsCount ||
                    this.TagsCount.Equals(input.TagsCount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.TagsCount.GetHashCode();
                if (this.Tags != null)
