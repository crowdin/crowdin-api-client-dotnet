...
{
    /// <summary>
    /// MtCredentialsModernmt
    /// </summary>
    [DataContract(Name = "mt.credentials.modernmt")]
    public partial class MtCredentialsModernmt : IEquatable<MtCredentialsModernmt>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentialsModernmt" /> class.
        /// </summary>
        /// <param name="apiKey">Api key.</param>
        public MtCredentialsModernmt(string apiKey = default(string))
        {
            this.ApiKey = apiKey;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentialsModernmt {\n");
        ...
        {
            return this.Equals(input as MtCredentialsModernmt);
        }

        /// <summary>
        /// Returns true if MtCredentialsModernmt instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentialsModernmt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentialsModernmt input)
        {
            if (input == null)
                return false;
