...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IssueOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(IssueOperationReplace), "IssueOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(IssueOperationTest), "IssueOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(IssueOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(IssueOperationTest), "test")]
    public partial class IssueOperation : IEquatable<IssueOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IssueOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueOperation" /> class.
        /// </summary>
        ...
        public IssueOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IssueOperation {\n");
        ...
        {
            return this.Equals(input as IssueOperation);
        }

        /// <summary>
        /// Returns true if IssueOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueOperation input)
        {
            if (input == null)
                return false;
