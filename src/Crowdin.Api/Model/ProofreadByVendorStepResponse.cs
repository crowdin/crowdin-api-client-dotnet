...
{
    /// <summary>
    /// ProofreadByVendorStepResponse
    /// </summary>
    [DataContract(Name = "ProofreadByVendorStepResponse")]
    public partial class ProofreadByVendorStepResponse : IEquatable<ProofreadByVendorStepResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProofreadByVendorStepResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public ProofreadByVendorStepResponse(ProofreadByVendorStepResponseData data = default(ProofreadByVendorStepResponseData))
        {
            this.Data = data;
        }
        ...
        public ProofreadByVendorStepResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProofreadByVendorStepResponse {\n");
        ...
        {
            return this.Equals(input as ProofreadByVendorStepResponse);
        }

        /// <summary>
        /// Returns true if ProofreadByVendorStepResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ProofreadByVendorStepResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProofreadByVendorStepResponse input)
        {
            if (input == null)
                return false;
