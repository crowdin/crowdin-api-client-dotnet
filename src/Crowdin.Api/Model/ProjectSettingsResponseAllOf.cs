...
{
    /// <summary>
    /// ProjectSettingsResponseAllOf
    /// </summary>
    [DataContract(Name = "ProjectSettingsResponse_allOf")]
    public partial class ProjectSettingsResponseAllOf : IEquatable<ProjectSettingsResponseAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectSettingsResponseAllOf" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectSettingsResponseAllOf {\n");
        ...
        {
            return this.Equals(input as ProjectSettingsResponseAllOf);
        }

        /// <summary>
        /// Returns true if ProjectSettingsResponseAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectSettingsResponseAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectSettingsResponseAllOf input)
        {
            if (input == null)
                return false;
