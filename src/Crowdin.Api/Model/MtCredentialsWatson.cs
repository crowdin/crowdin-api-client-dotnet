...
namespace Crowdin.Api.Model
{
    ...
    /// MtCredentialsWatson
    /// </summary>
    [DataContract(Name = "mt.credentials.watson")]
    public partial class MtCredentialsWatson : IEquatable<MtCredentialsWatson>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCredentialsWatson" /> class.
        /// </summary>
        /// <param name="apiKey">Api key.</param>
        /// <param name="endpoint">Endpoint URL.</param>
        public MtCredentialsWatson(string apiKey = default(string), string endpoint = default(string))
        {
            this.ApiKey = apiKey;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCredentialsWatson {\n");
        ...
        {
            return this.Equals(input as MtCredentialsWatson);
        }

        /// <summary>
        /// Returns true if MtCredentialsWatson instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCredentialsWatson to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCredentialsWatson input)
        {
            if (input == null)
                return false;
