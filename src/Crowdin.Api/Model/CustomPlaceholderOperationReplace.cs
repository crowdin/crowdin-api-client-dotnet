...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomPlaceholderOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(CustomPlaceholderOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(CustomPlaceholderOperationTest), "test")]
    public partial class CustomPlaceholderOperationReplace : CustomPlaceholderOperation, IEquatable<CustomPlaceholderOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholderOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomPlaceholderOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPlaceholderOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;CustomPlaceholderOperationReplace&quot;).</param>
        ...
        public CustomPlaceholderOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "CustomPlaceholderOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for CustomPlaceholderOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomPlaceholderOperationReplace {\n");
        ...
        {
            return this.Equals(input as CustomPlaceholderOperationReplace);
        }

        /// <summary>
        /// Returns true if CustomPlaceholderOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomPlaceholderOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomPlaceholderOperationReplace input)
        {
            if (input == null)
                return false;
