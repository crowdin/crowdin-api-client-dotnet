...
namespace Crowdin.Api.Model
{
    ...
    /// Tm Resource
    /// </summary>
    [DataContract(Name = "CrowdinTmResource")]
    public partial class CrowdinTmResource : IEquatable<CrowdinTmResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTmResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CrowdinTmResource(Tm data = default(Tm))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTmResource {\n");
        ...
        {
            return this.Equals(input as CrowdinTmResource);
        }

        /// <summary>
        /// Returns true if CrowdinTmResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTmResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTmResource input)
        {
            if (input == null)
                return false;
