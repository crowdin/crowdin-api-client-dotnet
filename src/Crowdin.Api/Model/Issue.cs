...
namespace Crowdin.Api.Model
{
    ...
    public partial class Issue : IEquatable<Issue>, IValidatableObject
    {
        ...
        public Issue(int id = default(int), string text = default(string), int userId = default(int), int stringId = default(int), IssueUser user = default(IssueUser), IssueString _string = default(IssueString), string languageId = default(string), string type = default(string), string status = default(string), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.Text = text;
            this.UserId = userId;
