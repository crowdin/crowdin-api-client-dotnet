...
{
    /// <summary>
    /// CostEstimationStepsProofreadIndividualRateModes
    /// </summary>
    [DataContract(Name = "cost-estimation.steps.proofread.individual-rate-modes")]
    public partial class CostEstimationStepsProofreadIndividualRateModes : IEquatable<CostEstimationStepsProofreadIndividualRateModes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationStepsProofreadIndividualRateModes" /> class.
        /// </summary>
        /// <param name="mode">proofread.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationStepsProofreadIndividualRateModes(string mode = default(string), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationStepsProofreadIndividualRateModes {\n");
        ...
        {
            return this.Equals(input as CostEstimationStepsProofreadIndividualRateModes);
        }

        /// <summary>
        /// Returns true if CostEstimationStepsProofreadIndividualRateModes instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationStepsProofreadIndividualRateModes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationStepsProofreadIndividualRateModes input)
        {
            if (input == null)
                return false;
