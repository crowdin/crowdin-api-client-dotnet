...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DownloadLinkResource")]
    public partial class DownloadLinkResource : IEquatable<DownloadLinkResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DownloadLinkResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public DownloadLinkResource(DownloadLink data = default(DownloadLink))
        {
            this.Data = data;
        }
        ...
        public DownloadLink Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DownloadLinkResource {\n");
        ...
        {
            return this.Equals(input as DownloadLinkResource);
        }

        /// <summary>
        /// Returns true if DownloadLinkResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DownloadLinkResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DownloadLinkResource input)
        {
            if (input == null)
                return false;
