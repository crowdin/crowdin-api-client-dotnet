...
{
    /// <summary>
    /// MT Collection Resource
    /// </summary>
    [DataContract(Name = "MtCollectionResource")]
    public partial class MtCollectionResource : IEquatable<MtCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MtCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public MtCollectionResource(List<MtResource> data = default(List<MtResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<MtResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MtCollectionResource {\n");
        ...
        {
            return this.Equals(input as MtCollectionResource);
        }

        /// <summary>
        /// Returns true if MtCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of MtCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MtCollectionResource input)
        {
            if (input == null)
                return false;
