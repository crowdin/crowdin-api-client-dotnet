...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomLanguageOperationReplace")]
    ...
    public partial class CustomLanguageOperationReplace : CustomLanguageOperation, IEquatable<CustomLanguageOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomLanguageOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomLanguageOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomLanguageOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;CustomLanguageOperationReplace&quot;).</param>
        ...
        public CustomLanguageOperationReplace(OneOfstringarray value = default(OneOfstringarray), OpEnum op = "CustomLanguageOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for CustomLanguageOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public OneOfstringarray Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomLanguageOperationReplace {\n");
        ...
        {
            return this.Equals(input as CustomLanguageOperationReplace);
        }

        /// <summary>
        /// Returns true if CustomLanguageOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomLanguageOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomLanguageOperationReplace input)
        {
            if (input == null)
                return false;
