...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BranchOperationTest")]
    ...
    public partial class BranchOperationTest : BranchOperation, IEquatable<BranchOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BranchOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BranchOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;BranchOperationTest&quot;).</param>
        ...
        public BranchOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "BranchOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for BranchOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BranchOperationTest {\n");
        ...
        {
            return this.Equals(input as BranchOperationTest);
        }

        /// <summary>
        /// Returns true if BranchOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchOperationTest input)
        {
            if (input == null)
                return false;
