...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IssueOperationTest")]
    ...
    public partial class IssueOperationTest : IssueOperation, IEquatable<IssueOperationTest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueOperationTest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IssueOperationTest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueOperationTest" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;IssueOperationTest&quot;).</param>
        ...
        public IssueOperationTest(OneOfstring value = default(OneOfstring), OpEnum op = "IssueOperationTest", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for IssueOperationTest and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IssueOperationTest {\n");
        ...
        {
            return this.Equals(input as IssueOperationTest);
        }

        /// <summary>
        /// Returns true if IssueOperationTest instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueOperationTest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueOperationTest input)
        {
            if (input == null)
                return false;
