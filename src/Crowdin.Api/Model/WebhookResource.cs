...
namespace Crowdin.Api.Model
{
    ...
    /// Webhook Resource
    /// </summary>
    [DataContract(Name = "WebhookResource")]
    public partial class WebhookResource : IEquatable<WebhookResource>, IValidatableObject
    {
        ...
        public WebhookResource(Webhook data = default(Webhook))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as WebhookResource);
        }

        /// <summary>
        /// Returns true if WebhookResource instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookResource input)
        {
            if (input == null)
                return false;
