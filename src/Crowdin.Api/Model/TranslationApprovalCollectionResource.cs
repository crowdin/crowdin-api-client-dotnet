...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslationApprovalCollectionResource")]
    public partial class TranslationApprovalCollectionResource : IEquatable<TranslationApprovalCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationApprovalCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public TranslationApprovalCollectionResource(List<TranslationApprovalResource> data = default(List<TranslationApprovalResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<TranslationApprovalResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationApprovalCollectionResource {\n");
        ...
        {
            return this.Equals(input as TranslationApprovalCollectionResource);
        }

        /// <summary>
        /// Returns true if TranslationApprovalCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationApprovalCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationApprovalCollectionResource input)
        {
            if (input == null)
                return false;
