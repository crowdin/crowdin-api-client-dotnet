...
{
    /// <summary>
    /// ICU Language Translation Resource
    /// </summary>
    [DataContract(Name = "IcuLanguageTranslationResource")]
    public partial class IcuLanguageTranslationResource : IEquatable<IcuLanguageTranslationResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IcuLanguageTranslationResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public IcuLanguageTranslationResource(IcuLanguageTranslation data = default(IcuLanguageTranslation))
        {
            this.Data = data;
        }
        ...
        public IcuLanguageTranslation Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IcuLanguageTranslationResource {\n");
        ...
        {
            return this.Equals(input as IcuLanguageTranslationResource);
        }

        /// <summary>
        /// Returns true if IcuLanguageTranslationResource instances are equal
        /// </summary>
        /// <param name="input">Instance of IcuLanguageTranslationResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IcuLanguageTranslationResource input)
        {
            if (input == null)
                return false;
