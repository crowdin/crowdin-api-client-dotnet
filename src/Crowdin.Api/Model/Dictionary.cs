...
namespace Crowdin.Api.Model
{
    ...
    public partial class Dictionary : IEquatable<Dictionary>, IValidatableObject
    {
        /// <summary>
        ...
        public Dictionary(string languageId = default(string), List<string> words = default(List<string>))
        {
        ...
        {
            return this.Equals(input as Dictionary);
        }

        /// <summary>
        /// Returns true if Dictionary instances are equal
        /// </summary>
        /// <param name="input">Instance of Dictionary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Dictionary input)
        {
            if (input == null)
                return false;
