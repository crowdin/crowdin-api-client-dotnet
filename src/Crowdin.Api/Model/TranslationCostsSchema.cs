...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TranslationCosts_schema")]
    public partial class TranslationCostsSchema : IEquatable<TranslationCostsSchema>, IValidatableObject
    {
        /// <summary>
        /// Defines report unit
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TranslationCostsSchema" /> class.
        /// </summary>
        ...
        public TranslationCostsSchema(UnitEnum? unit = UnitEnum.Words, CurrencyEnum? currency = CurrencyEnum.USD, string mode = default(string), FormatEnum? format = FormatEnum.Xlsx, GroupByEnum? groupBy = GroupByEnum.User, List<CostEstimationRegularRates> regularRates = default(List<CostEstimationRegularRates>), List<CostEstimationIndividualRates> individualRates = default(List<CostEstimationIndividualRates>), DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime))
        {
            this.Unit = unit;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TranslationCostsSchema {\n");
        ...
        {
            return this.Equals(input as TranslationCostsSchema);
        }

        /// <summary>
        /// Returns true if TranslationCostsSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of TranslationCostsSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TranslationCostsSchema input)
        {
            if (input == null)
                return false;
