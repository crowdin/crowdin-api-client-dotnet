...
{
    /// <summary>
    /// CostEstimationRegularRates
    /// </summary>
    [DataContract(Name = "cost-estimation.regular-rates")]
    public partial class CostEstimationRegularRates : IEquatable<CostEstimationRegularRates>, IValidatableObject
    {
        /// <summary>
        /// tm_match
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationRegularRates" /> class.
        /// </summary>
        /// <param name="mode">tm_match.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationRegularRates(ModeEnum? mode = default(ModeEnum?), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationRegularRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationRegularRates);
        }

        /// <summary>
        /// Returns true if CostEstimationRegularRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationRegularRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationRegularRates input)
        {
            if (input == null)
                return false;
