...
{
    /// <summary>
    /// ConflictExceptionResourceError
    /// </summary>
    [DataContract(Name = "ConflictExceptionResource_error")]
    public partial class ConflictExceptionResourceError : IEquatable<ConflictExceptionResourceError>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConflictExceptionResourceError" /> class.
        /// </summary>
        /// <param name="message">message.</param>
        /// <param name="code">code.</param>
        public ConflictExceptionResourceError(string message = default(string), int code = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConflictExceptionResourceError {\n");
        ...
        {
            return this.Equals(input as ConflictExceptionResourceError);
        }

        /// <summary>
        /// Returns true if ConflictExceptionResourceError instances are equal
        /// </summary>
        /// <param name="input">Instance of ConflictExceptionResourceError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConflictExceptionResourceError input)
        {
            if (input == null)
                return false;
