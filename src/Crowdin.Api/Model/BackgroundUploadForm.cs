...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BackgroundUploadForm")]
    public partial class BackgroundUploadForm : IEquatable<BackgroundUploadForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BackgroundUploadForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BackgroundUploadForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BackgroundUploadForm" /> class.
        /// </summary>
        /// <param name="storageId">A unique identifier for the storage. Storage is where you add files, before they can be added to your organization. [More about Storage](#tag/Storage). (required).</param>
        public BackgroundUploadForm(int storageId = default(int))
        {
            this.StorageId = storageId;
        }

        /// <summary>
        /// A unique identifier for the storage. Storage is where you add files, before they can be added to your organization. [More about Storage](#tag/Storage).
        /// </summary>
        /// <value>A unique identifier for the storage. Storage is where you add files, before they can be added to your organization. [More about Storage](#tag/Storage).</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BackgroundUploadForm {\n");
        ...
        {
            return this.Equals(input as BackgroundUploadForm);
        }

        /// <summary>
        /// Returns true if BackgroundUploadForm instances are equal
        /// </summary>
        /// <param name="input">Instance of BackgroundUploadForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BackgroundUploadForm input)
        {
            if (input == null)
                return false;
