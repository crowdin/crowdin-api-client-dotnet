...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "StringCollectionResource")]
    public partial class StringCollectionResource : IEquatable<StringCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public StringCollectionResource(List<StringResource> data = default(List<StringResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<StringResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StringCollectionResource {\n");
        ...
        {
            return this.Equals(input as StringCollectionResource);
        }

        /// <summary>
        /// Returns true if StringCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of StringCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringCollectionResource input)
        {
            if (input == null)
                return false;
