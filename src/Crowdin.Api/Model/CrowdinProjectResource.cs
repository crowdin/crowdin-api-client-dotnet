...
namespace Crowdin.Api.Model
{
    ...
    /// Project Resource
    /// </summary>
    [DataContract(Name = "CrowdinProjectResource")]
    public partial class CrowdinProjectResource : IEquatable<CrowdinProjectResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinProjectResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CrowdinProjectResource(ProjectResponse data = default(ProjectResponse))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinProjectResource {\n");
        ...
        {
            return this.Equals(input as CrowdinProjectResource);
        }

        /// <summary>
        /// Returns true if CrowdinProjectResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinProjectResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinProjectResource input)
        {
            if (input == null)
                return false;
