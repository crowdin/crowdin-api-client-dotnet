...
{
    /// <summary>
    /// File Collection Resource
    /// </summary>
    [DataContract(Name = "FileCollectionResource")]
    public partial class FileCollectionResource : IEquatable<FileCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FileCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public FileCollectionResource(List<FileResource> data = default(List<FileResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<FileResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FileCollectionResource {\n");
        ...
        {
            return this.Equals(input as FileCollectionResource);
        }

        /// <summary>
        /// Returns true if FileCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of FileCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileCollectionResource input)
        {
            if (input == null)
                return false;
