...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddProjectMemberForm_permissions_de")]
    public partial class AddProjectMemberFormPermissionsDe : IEquatable<AddProjectMemberFormPermissionsDe>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectMemberFormPermissionsDe" /> class.
        /// </summary>
        /// <param name="workflowStepIds">You cat set &#x60;all&#x60; value to grant permissions for all workflow steps for current language.</param>
        public AddProjectMemberFormPermissionsDe(string workflowStepIds = default(string))
        {
            this.WorkflowStepIds = workflowStepIds;
        }

        /// <summary>
        /// You cat set &#x60;all&#x60; value to grant permissions for all workflow steps for current language
        /// </summary>
        /// <value>You cat set &#x60;all&#x60; value to grant permissions for all workflow steps for current language</value>
        [DataMember(Name = "workflowStepIds", EmitDefaultValue = false)]
        public string WorkflowStepIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProjectMemberFormPermissionsDe {\n");
        ...
        {
            return this.Equals(input as AddProjectMemberFormPermissionsDe);
        }

        /// <summary>
        /// Returns true if AddProjectMemberFormPermissionsDe instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProjectMemberFormPermissionsDe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProjectMemberFormPermissionsDe input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.WorkflowStepIds.Equals(input.WorkflowStepIds))
                );
        }
