...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DistributionCollectionResource")]
    public partial class DistributionCollectionResource : IEquatable<DistributionCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DistributionCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public DistributionCollectionResource(List<DistributionResource> data = default(List<DistributionResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<DistributionResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DistributionCollectionResource {\n");
        ...
        {
            return this.Equals(input as DistributionCollectionResource);
        }

        /// <summary>
        /// Returns true if DistributionCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DistributionCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DistributionCollectionResource input)
        {
            if (input == null)
                return false;
