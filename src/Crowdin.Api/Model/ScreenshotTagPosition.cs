...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScreenshotTagPosition")]
    public partial class ScreenshotTagPosition : IEquatable<ScreenshotTagPosition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotTagPosition" /> class.
        /// </summary>
        /// <param name="x">x.</param>
        /// <param name="y">y.</param>
        /// <param name="width">width.</param>
        /// <param name="height">height.</param>
        public ScreenshotTagPosition(int x = default(int), int y = default(int), int width = default(int), int height = default(int))
        {
            this.X = x;
            this.Y = y;
            this.Width = width;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScreenshotTagPosition {\n");
        ...
        {
            return this.Equals(input as ScreenshotTagPosition);
        }

        /// <summary>
        /// Returns true if ScreenshotTagPosition instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotTagPosition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotTagPosition input)
        {
            if (input == null)
                return false;
