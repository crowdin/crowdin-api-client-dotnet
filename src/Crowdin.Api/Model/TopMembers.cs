...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TopMembers")]
    public partial class TopMembers : IEquatable<TopMembers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TopMembers" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TopMembers() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TopMembers" /> class.
        /// </summary>
        /// <param name="name">top-members (required).</param>
        /// <param name="schema">schema (required).</param>
        public TopMembers(string name = default(string), TopMembersSchema schema = default(TopMembersSchema))
        {
            // to ensure "name" is required (not null)
            if (name == null) {
                throw new ArgumentNullException("name is a required property for TopMembers and cannot be null");
            }
            this.Name = name;
            // to ensure "schema" is required (not null)
            if (schema == null) {
                throw new ArgumentNullException("schema is a required property for TopMembers and cannot be null");
            }
            this.Schema = schema;
        }
        ...
        public TopMembersSchema Schema { get; set; }
        ...
        {
            return this.Equals(input as TopMembers);
        }

        /// <summary>
        /// Returns true if TopMembers instances are equal
        /// </summary>
        /// <param name="input">Instance of TopMembers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TopMembers input)
        {
            if (input == null)
                return false;
