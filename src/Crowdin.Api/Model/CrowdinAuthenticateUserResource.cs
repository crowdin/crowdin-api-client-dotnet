...
namespace Crowdin.Api.Model
{
    ...
    /// User Resource
    /// </summary>
    [DataContract(Name = "CrowdinAuthenticateUserResource")]
    public partial class CrowdinAuthenticateUserResource : IEquatable<CrowdinAuthenticateUserResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinAuthenticateUserResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CrowdinAuthenticateUserResource(CrowdinAuthenticateUser data = default(CrowdinAuthenticateUser))
        {
            this.Data = data;
        }
        ...
        public CrowdinAuthenticateUser Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinAuthenticateUserResource {\n");
        ...
        {
            return this.Equals(input as CrowdinAuthenticateUserResource);
        }

        /// <summary>
        /// Returns true if CrowdinAuthenticateUserResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinAuthenticateUserResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinAuthenticateUserResource input)
        {
            if (input == null)
                return false;
