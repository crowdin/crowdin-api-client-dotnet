...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ScreenshotOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(ScreenshotOperationReplace), "ScreenshotOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(ScreenshotOperationTest), "ScreenshotOperationTest")]
    ...
    public partial class ScreenshotOperation : IEquatable<ScreenshotOperation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotOperation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ScreenshotOperation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ScreenshotOperation" /> class.
        /// </summary>
        ...
        public ScreenshotOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScreenshotOperation {\n");
        ...
        {
            return this.Equals(input as ScreenshotOperation);
        }

        /// <summary>
        /// Returns true if ScreenshotOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of ScreenshotOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScreenshotOperation input)
        {
            if (input == null)
                return false;
