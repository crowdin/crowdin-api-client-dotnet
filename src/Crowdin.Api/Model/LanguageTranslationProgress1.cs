...
{
    /// <summary>
    /// Files Translation Language Progress Response Model
    /// </summary>
    [DataContract(Name = "Language_Translation_Progress_1")]
    public partial class LanguageTranslationProgress1 : IEquatable<LanguageTranslationProgress1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LanguageTranslationProgress1" /> class.
        /// </summary>
        /// <param name="fileId">fileId.</param>
        /// <param name="eTag">eTag.</param>
        public LanguageTranslationProgress1(int fileId = default(int), string eTag = default(string))
        {
            this.FileId = fileId;
            this.ETag = eTag;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LanguageTranslationProgress1 {\n");
        ...
        {
            return this.Equals(input as LanguageTranslationProgress1);
        }

        /// <summary>
        /// Returns true if LanguageTranslationProgress1 instances are equal
        /// </summary>
        /// <param name="input">Instance of LanguageTranslationProgress1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LanguageTranslationProgress1 input)
        {
            if (input == null)
                return false;
