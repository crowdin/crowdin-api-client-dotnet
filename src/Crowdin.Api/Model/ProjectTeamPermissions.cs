...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ProjectTeam_permissions")]
    public partial class ProjectTeamPermissions : IEquatable<ProjectTeamPermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectTeamPermissions" /> class.
        /// </summary>
        /// <param name="it">it.</param>
        public ProjectTeamPermissions(AddProjectTeamFormPermissionsIt it = default(AddProjectTeamFormPermissionsIt))
        {
            this.It = it;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectTeamPermissions {\n");
        ...
        {
            return this.Equals(input as ProjectTeamPermissions);
        }

        /// <summary>
        /// Returns true if ProjectTeamPermissions instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectTeamPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectTeamPermissions input)
        {
            if (input == null)
                return false;
