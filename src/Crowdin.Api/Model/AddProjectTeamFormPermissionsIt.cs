...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddProjectTeamForm_permissions_it")]
    public partial class AddProjectTeamFormPermissionsIt : IEquatable<AddProjectTeamFormPermissionsIt>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectTeamFormPermissionsIt" /> class.
        /// </summary>
        ...
        public AddProjectTeamFormPermissionsIt(List<int> workflowStepIds = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProjectTeamFormPermissionsIt {\n");
        ...
        {
            return this.Equals(input as AddProjectTeamFormPermissionsIt);
        }

        /// <summary>
        /// Returns true if AddProjectTeamFormPermissionsIt instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProjectTeamFormPermissionsIt to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProjectTeamFormPermissionsIt input)
        {
            if (input == null)
                return false;
