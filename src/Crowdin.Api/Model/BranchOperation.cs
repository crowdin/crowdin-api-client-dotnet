...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BranchOperation")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(BranchOperationReplace), "BranchOperationReplace")]
    [JsonSubtypes.KnownSubType(typeof(BranchOperationTest), "BranchOperationTest")]
    [JsonSubtypes.KnownSubType(typeof(BranchOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(BranchOperationTest), "test")]
    public partial class BranchOperation : IEquatable<BranchOperation>, IValidatableObject
    {
        /// <summary>
        ...
        public BranchOperation(OpEnum op = default(OpEnum), PathEnum path = default(PathEnum))
        {
            this.Op = op;
            this.Path = path;
        }
        ...
        {
            return this.Equals(input as BranchOperation);
        }

        /// <summary>
        /// Returns true if BranchOperation instances are equal
        /// </summary>
        /// <param name="input">Instance of BranchOperation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BranchOperation input)
        {
            if (input == null)
                return false;
