...
namespace Crowdin.Api.Model
{
    ...
    /// TaskAssignedTeam
    /// </summary>
    [DataContract(Name = "TaskAssignedTeam")]
    public partial class TaskAssignedTeam : IEquatable<TaskAssignedTeam>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskAssignedTeam" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="wordsCount">wordsCount.</param>
        public TaskAssignedTeam(int id = default(int), int wordsCount = default(int))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TaskAssignedTeam {\n");
        ...
        {
            return this.Equals(input as TaskAssignedTeam);
        }

        /// <summary>
        /// Returns true if TaskAssignedTeam instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskAssignedTeam to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskAssignedTeam input)
        {
            if (input == null)
                return false;
