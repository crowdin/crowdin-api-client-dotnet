...
namespace Crowdin.Api.Model
{
    ...
    /// Issue Resource
    /// </summary>
    [DataContract(Name = "IssueResource")]
    public partial class IssueResource : IEquatable<IssueResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public IssueResource(Issue data = default(Issue))
        {
            this.Data = data;
        }
        ...
        {
            return this.Equals(input as IssueResource);
        }

        /// <summary>
        /// Returns true if IssueResource instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueResource input)
        {
            if (input == null)
                return false;
