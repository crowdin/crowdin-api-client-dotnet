...
namespace Crowdin.Api.Model
{
    ...
    /// Not Found
    /// </summary>
    [DataContract(Name = "InternalServerErrorExceptionResource")]
    public partial class InternalServerErrorExceptionResource : IEquatable<InternalServerErrorExceptionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalServerErrorExceptionResource" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public InternalServerErrorExceptionResource(InternalServerErrorExceptionResourceError error = default(InternalServerErrorExceptionResourceError))
        {
            this.Error = error;
        }
        ...
        public InternalServerErrorExceptionResourceError Error { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InternalServerErrorExceptionResource {\n");
        ...
        {
            return this.Equals(input as InternalServerErrorExceptionResource);
        }

        /// <summary>
        /// Returns true if InternalServerErrorExceptionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalServerErrorExceptionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalServerErrorExceptionResource input)
        {
            if (input == null)
                return false;
