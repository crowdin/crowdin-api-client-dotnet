...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IssueOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(IssueOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(IssueOperationTest), "test")]
    public partial class IssueOperationReplace : IssueOperation, IEquatable<IssueOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IssueOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IssueOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;IssueOperationReplace&quot;).</param>
        ...
        public IssueOperationReplace(OneOfstring value = default(OneOfstring), OpEnum op = "IssueOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for IssueOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IssueOperationReplace {\n");
        ...
        {
            return this.Equals(input as IssueOperationReplace);
        }

        /// <summary>
        /// Returns true if IssueOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of IssueOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueOperationReplace input)
        {
            if (input == null)
                return false;
