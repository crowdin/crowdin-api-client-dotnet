...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AddProjectMemberForm")]
    public partial class AddProjectMemberForm : IEquatable<AddProjectMemberForm>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectMemberForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddProjectMemberForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddProjectMemberForm" /> class.
        /// </summary>
        /// <param name="userIds">User Identifier. Get via [List Users](#operation/api.users.getMany) (required).</param>
        /// <param name="accessToAllWorkflowSteps">Grant access to all project languages, translation, and proofreading workflow steps (current and future) (default to true).</param>
        /// <param name="managerAccess">Grant manager access to a project (default to false).</param>
        /// <param name="permissions">permissions.</param>
        public AddProjectMemberForm(List<int> userIds = default(List<int>), bool accessToAllWorkflowSteps = true, bool managerAccess = false, AddProjectMemberFormPermissions permissions = default(AddProjectMemberFormPermissions))
        {
            // to ensure "userIds" is required (not null)
            if (userIds == null) {
                throw new ArgumentNullException("userIds is a required property for AddProjectMemberForm and cannot be null");
            }
        ...
        /// <summary>
        /// User Identifier. Get via [List Users](#operation/api.users.getMany)
        /// </summary>
        /// <value>User Identifier. Get via [List Users](#operation/api.users.getMany)</value>
        [DataMember(Name = "userIds", IsRequired = true, EmitDefaultValue = false)]
        public List<int> UserIds { get; set; }

        /// <summary>
        /// Grant access to all project languages, translation, and proofreading workflow steps (current and future)
        /// </summary>
        /// <value>Grant access to all project languages, translation, and proofreading workflow steps (current and future)</value>
        [DataMember(Name = "accessToAllWorkflowSteps", EmitDefaultValue = true)]
        public bool AccessToAllWorkflowSteps { get; set; }

        /// <summary>
        /// Grant manager access to a project
        /// </summary>
        /// <value>Grant manager access to a project</value>
        [DataMember(Name = "managerAccess", EmitDefaultValue = true)]
        ...
        public AddProjectMemberFormPermissions Permissions { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddProjectMemberForm {\n");
            sb.Append("  UserIds: ").Append(UserIds).Append("\n");
            sb.Append("  AccessToAllWorkflowSteps: ").Append(AccessToAllWorkflowSteps).Append("\n");
            sb.Append("  ManagerAccess: ").Append(ManagerAccess).Append("\n");
        ...
        {
            return this.Equals(input as AddProjectMemberForm);
        }

        /// <summary>
        /// Returns true if AddProjectMemberForm instances are equal
        /// </summary>
        /// <param name="input">Instance of AddProjectMemberForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddProjectMemberForm input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AccessToAllWorkflowSteps == input.AccessToAllWorkflowSteps ||
                    this.AccessToAllWorkflowSteps.Equals(input.AccessToAllWorkflowSteps)
                ) && 
                (
                    this.ManagerAccess == input.ManagerAccess ||
                    this.ManagerAccess.Equals(input.ManagerAccess)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.AccessToAllWorkflowSteps.GetHashCode();
                hashCode = hashCode * 59 + this.ManagerAccess.GetHashCode();
