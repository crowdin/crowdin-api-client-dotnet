...
{
    /// <summary>
    /// Directory Collection Resource
    /// </summary>
    [DataContract(Name = "DirectoryCollectionResource")]
    public partial class DirectoryCollectionResource : IEquatable<DirectoryCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectoryCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public DirectoryCollectionResource(List<DirectoryResource> data = default(List<DirectoryResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<DirectoryResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DirectoryCollectionResource {\n");
        ...
        {
            return this.Equals(input as DirectoryCollectionResource);
        }

        /// <summary>
        /// Returns true if DirectoryCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DirectoryCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DirectoryCollectionResource input)
        {
            if (input == null)
                return false;
