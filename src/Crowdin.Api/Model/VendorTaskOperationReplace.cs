...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VendorTaskOperationReplace")]
    [JsonConverter(typeof(JsonSubtypes), "Op")]
    [JsonSubtypes.KnownSubType(typeof(VendorTaskOperationReplace), "replace")]
    [JsonSubtypes.KnownSubType(typeof(VendorTaskOperationTest), "test")]
    public partial class VendorTaskOperationReplace : VendorTaskOperation, IEquatable<VendorTaskOperationReplace>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VendorTaskOperationReplace" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected VendorTaskOperationReplace() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="VendorTaskOperationReplace" /> class.
        /// </summary>
        /// <param name="value">value (required).</param>
        /// <param name="op">Patch operation to perform (required) (default to &quot;VendorTaskOperationReplace&quot;).</param>
        ...
        public VendorTaskOperationReplace(OneOfstringbooleanarrayarray value = default(OneOfstringbooleanarrayarray), OpEnum op = "VendorTaskOperationReplace", PathEnum path = default(PathEnum)) : base(op, path)
        {
            // to ensure "value" is required (not null)
            if (value == null) {
                throw new ArgumentNullException("value is a required property for VendorTaskOperationReplace and cannot be null");
            }
            this.Value = value;
        }
        ...
        public OneOfstringbooleanarrayarray Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VendorTaskOperationReplace {\n");
        ...
        {
            return this.Equals(input as VendorTaskOperationReplace);
        }

        /// <summary>
        /// Returns true if VendorTaskOperationReplace instances are equal
        /// </summary>
        /// <param name="input">Instance of VendorTaskOperationReplace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VendorTaskOperationReplace input)
        {
            if (input == null)
                return false;
