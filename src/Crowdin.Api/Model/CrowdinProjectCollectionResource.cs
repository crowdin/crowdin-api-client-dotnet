...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinProjectCollectionResource")]
    public partial class CrowdinProjectCollectionResource : IEquatable<CrowdinProjectCollectionResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinProjectCollectionResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="pagination">pagination.</param>
        public CrowdinProjectCollectionResource(List<CrowdinProjectResource> data = default(List<CrowdinProjectResource>), Pagination pagination = default(Pagination))
        {
            this.Data = data;
        ...
        public List<CrowdinProjectResource> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinProjectCollectionResource {\n");
        ...
        {
            return this.Equals(input as CrowdinProjectCollectionResource);
        }

        /// <summary>
        /// Returns true if CrowdinProjectCollectionResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinProjectCollectionResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinProjectCollectionResource input)
        {
            if (input == null)
                return false;
