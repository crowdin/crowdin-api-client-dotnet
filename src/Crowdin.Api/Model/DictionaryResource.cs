...
namespace Crowdin.Api.Model
{
    ...
    /// Dictionary Resource
    /// </summary>
    [DataContract(Name = "DictionaryResource")]
    public partial class DictionaryResource : IEquatable<DictionaryResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DictionaryResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public DictionaryResource(Dictionary data = default(Dictionary))
        {
            this.Data = data;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DictionaryResource {\n");
        ...
        {
            return this.Equals(input as DictionaryResource);
        }

        /// <summary>
        /// Returns true if DictionaryResource instances are equal
        /// </summary>
        /// <param name="input">Instance of DictionaryResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DictionaryResource input)
        {
            if (input == null)
                return false;
