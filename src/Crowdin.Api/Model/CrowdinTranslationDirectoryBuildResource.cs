...
namespace Crowdin.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CrowdinTranslationDirectoryBuildResource")]
    public partial class CrowdinTranslationDirectoryBuildResource : IEquatable<CrowdinTranslationDirectoryBuildResource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrowdinTranslationDirectoryBuildResource" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public CrowdinTranslationDirectoryBuildResource(CrowdinDirectoryBuildResponse data = default(CrowdinDirectoryBuildResponse))
        {
            this.Data = data;
        }
        ...
        public CrowdinDirectoryBuildResponse Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrowdinTranslationDirectoryBuildResource {\n");
        ...
        {
            return this.Equals(input as CrowdinTranslationDirectoryBuildResource);
        }

        /// <summary>
        /// Returns true if CrowdinTranslationDirectoryBuildResource instances are equal
        /// </summary>
        /// <param name="input">Instance of CrowdinTranslationDirectoryBuildResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrowdinTranslationDirectoryBuildResource input)
        {
            if (input == null)
                return false;
