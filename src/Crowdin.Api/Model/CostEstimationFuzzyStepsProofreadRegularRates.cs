...
{
    /// <summary>
    /// CostEstimationFuzzyStepsProofreadRegularRates
    /// </summary>
    [DataContract(Name = "cost-estimation-fuzzy.steps.proofread.regular-rates")]
    public partial class CostEstimationFuzzyStepsProofreadRegularRates : IEquatable<CostEstimationFuzzyStepsProofreadRegularRates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostEstimationFuzzyStepsProofreadRegularRates" /> class.
        /// </summary>
        /// <param name="mode">approval.</param>
        /// <param name="value">0.1.</param>
        public CostEstimationFuzzyStepsProofreadRegularRates(string mode = default(string), float value = default(float))
        {
            this.Mode = mode;
            this.Value = value;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CostEstimationFuzzyStepsProofreadRegularRates {\n");
        ...
        {
            return this.Equals(input as CostEstimationFuzzyStepsProofreadRegularRates);
        }

        /// <summary>
        /// Returns true if CostEstimationFuzzyStepsProofreadRegularRates instances are equal
        /// </summary>
        /// <param name="input">Instance of CostEstimationFuzzyStepsProofreadRegularRates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostEstimationFuzzyStepsProofreadRegularRates input)
        {
            if (input == null)
                return false;
