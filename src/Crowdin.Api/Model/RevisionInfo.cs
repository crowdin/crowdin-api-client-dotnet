...
namespace Crowdin.Api.Model
{
    ...
    /// RevisionInfo
    /// </summary>
    [DataContract(Name = "Revision_info")]
    public partial class RevisionInfo : IEquatable<RevisionInfo>, IValidatableObject
    {
        /// <summary>
        ...
        public RevisionInfo(RevisionInfo added = default(RevisionInfo), RevisionInfo deleted = default(RevisionInfo), RevisionInfo updated = default(RevisionInfo))
        {
            this.Added = added;
        ...
        {
            return this.Equals(input as RevisionInfo);
        }

        /// <summary>
        /// Returns true if RevisionInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RevisionInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RevisionInfo input)
        {
            if (input == null)
                return false;
