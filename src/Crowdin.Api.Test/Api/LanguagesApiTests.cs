...
namespace Crowdin.Api.Test.Api
{
    ...
    /// </remarks>
    public class LanguagesApiTests : IDisposable
    {
        private LanguagesApi instance;

        public LanguagesApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' LanguagesApi
            //Assert.IsType<LanguagesApi>(instance);
        }

        /// <summary>
        /// Test ApiLanguagesDelete
        /// </summary>
        [Fact]
        public void ApiLanguagesDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string languageId = null;
            //instance.ApiLanguagesDelete(languageId);
        }

        /// <summary>
        /// Test ApiLanguagesGet
        /// </summary>
        [Fact]
        public void ApiLanguagesGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string languageId = null;
            //var response = instance.ApiLanguagesGet(languageId);
            //Assert.IsType<LanguageResource>(response);
        }

        /// <summary>
        /// Test ApiLanguagesGetMany
        /// </summary>
        [Fact]
        public void ApiLanguagesGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiLanguagesGetMany(limit, offset);
            //Assert.IsType<LanguageCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiLanguagesPatch
        /// </summary>
        [Fact]
        public void ApiLanguagesPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string languageId = null;
            //List<CustomLanguageOperation> customLanguageOperation = null;
            //var response = instance.ApiLanguagesPatch(languageId, customLanguageOperation);
            //Assert.IsType<LanguageResource>(response);
        }

        /// <summary>
        /// Test ApiLanguagesPost
        /// </summary>
        [Fact]
        public void ApiLanguagesPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //LanguageCreateForm languageCreateForm = null;
            //var response = instance.ApiLanguagesPost(languageCreateForm);
            //Assert.IsType<LanguageResource>(response);
        }
    }
}
