...
namespace Crowdin.Api.Test.Api
{
    ...
    public class StorageApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiStoragesDelete
        /// </summary>
        [Fact]
        public void ApiStoragesDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int storageId = null;
            //instance.ApiStoragesDelete(storageId);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiStoragesGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int storageId = null;
            //var response = instance.ApiStoragesGet(storageId);
            //Assert.IsType<StorageResource>(response);
        }

        /// <summary>
        /// Test ApiStoragesGetMany
        /// </summary>
        [Fact]
        public void ApiStoragesGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiStoragesGetMany(limit, offset);
            //Assert.IsType<StorageCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiStoragesPost
        /// </summary>
        [Fact]
        public void ApiStoragesPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string crowdinAPIFileName = null;
            //string body = null;
            //var response = instance.ApiStoragesPost(crowdinAPIFileName, body);
            //Assert.IsType<StorageResource>(response);
        }
    }
}
