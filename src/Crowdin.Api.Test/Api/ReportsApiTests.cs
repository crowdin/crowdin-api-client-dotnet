...
namespace Crowdin.Api.Test.Api
{
    ...
    public class ReportsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiProjectsReportsDownloadDownload
        /// </summary>
        [Fact]
        public void ApiProjectsReportsDownloadDownloadTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string reportId = null;
            //var response = instance.ApiProjectsReportsDownloadDownload(projectId, reportId);
            //Assert.IsType<DownloadLinkResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsReportsGet
        /// </summary>
        [Fact]
        public void ApiProjectsReportsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string reportId = null;
            //var response = instance.ApiProjectsReportsGet(projectId, reportId);
            //Assert.IsType<ReportGenerate>(response);
        }

        /// <summary>
        /// Test ApiProjectsReportsPost
        /// </summary>
        [Fact]
        public void ApiProjectsReportsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //UNKNOWN_BASE_TYPE UNKNOWN_BASE_TYPE = null;
            //var response = instance.ApiProjectsReportsPost(projectId, UNKNOWN_BASE_TYPE);
            //Assert.IsType<ReportGenerate>(response);
        }
    }
}
