...
{
    /// <summary>
    ///  Class for testing StringCommentsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class StringCommentsApiTests : IDisposable
    {
        private StringCommentsApi instance;

        public StringCommentsApiTests()
        {
            instance = new StringCommentsApi();
        }
        ...
        /// <summary>
        /// Test an instance of StringCommentsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' StringCommentsApi
            //Assert.IsType<StringCommentsApi>(instance);
        }

        /// <summary>
        /// Test ApiProjectsCommentsDelete
        /// </summary>
        [Fact]
        public void ApiProjectsCommentsDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int stringCommentId = null;
            //instance.ApiProjectsCommentsDelete(projectId, stringCommentId);
        }

        /// <summary>
        /// Test ApiProjectsCommentsGet
        /// </summary>
        [Fact]
        public void ApiProjectsCommentsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int stringCommentId = null;
            //var response = instance.ApiProjectsCommentsGet(projectId, stringCommentId);
            //Assert.IsType<StringCommentResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsCommentsGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsCommentsGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int? limit = null;
            ...
            //var response = instance.ApiProjectsCommentsGetMany(projectId, limit, offset, stringId, type, issueType, issueStatus);
            //Assert.IsType<StringCommentCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsCommentsPatch
        /// </summary>
        [Fact]
        public void ApiProjectsCommentsPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int stringCommentId = null;
            //List<StringCommentOperation> stringCommentOperation = null;
            //var response = instance.ApiProjectsCommentsPatch(projectId, stringCommentId, stringCommentOperation);
            //Assert.IsType<StringCommentResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsCommentsPost
        /// </summary>
        [Fact]
        public void ApiProjectsCommentsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //StringCommentCreateForm stringCommentCreateForm = null;
            //var response = instance.ApiProjectsCommentsPost(projectId, stringCommentCreateForm);
            //Assert.IsType<StringCommentResource>(response);
        }
    }
}
