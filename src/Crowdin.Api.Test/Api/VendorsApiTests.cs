...
namespace Crowdin.Api.Test.Api
{
    ...
    public class VendorsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiVendorsGetMany
        /// </summary>
        [Fact]
        public void ApiVendorsGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiVendorsGetMany(limit, offset);
            //Assert.IsType<VendorCollectionResource>(response);
        }
    }
}
