...
{
    /// <summary>
    ///  Class for testing DictionariesApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class DictionariesApiTests : IDisposable
    {
        private DictionariesApi instance;

        public DictionariesApiTests()
        {
            instance = new DictionariesApi();
        }
        ...
        /// <summary>
        /// Test an instance of DictionariesApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' DictionariesApi
            //Assert.IsType<DictionariesApi>(instance);
        }

        /// <summary>
        /// Test ApiProjectsDictionariesGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsDictionariesGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string languageIds = null;
            //var response = instance.ApiProjectsDictionariesGetMany(projectId, languageIds);
            //Assert.IsType<DictionaryCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsDictionariesPatch
        /// </summary>
        [Fact]
        public void ApiProjectsDictionariesPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string languageId = null;
            //List<DictionaryOperation> dictionaryOperation = null;
            //var response = instance.ApiProjectsDictionariesPatch(projectId, languageId, dictionaryOperation);
            //Assert.IsType<DictionaryResource>(response);
        }
    }
}
