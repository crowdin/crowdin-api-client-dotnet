...
{
    /// <summary>
    ///  Class for testing MachineTranslationEnginesApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class MachineTranslationEnginesApiTests : IDisposable
    {
        private MachineTranslationEnginesApi instance;

        public MachineTranslationEnginesApiTests()
        {
            instance = new MachineTranslationEnginesApi();
        }
        ...
        /// <summary>
        /// Test an instance of MachineTranslationEnginesApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' MachineTranslationEnginesApi
            //Assert.IsType<MachineTranslationEnginesApi>(instance);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiMtsDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int mtId = null;
            //instance.ApiMtsDelete(mtId);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiMtsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int mtId = null;
            //var response = instance.ApiMtsGet(mtId);
            //Assert.IsType<MtResource>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiMtsGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? groupId = null;
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiMtsGetMany(groupId, limit, offset);
            //Assert.IsType<MtCollectionResource>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiMtsPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int mtId = null;
            //List<MtOperation> mtOperation = null;
            //var response = instance.ApiMtsPatch(mtId, mtOperation);
            //Assert.IsType<MtResource>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiMtsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //EnterpriseMtCreateForm enterpriseMtCreateForm = null;
            //var response = instance.ApiMtsPost(enterpriseMtCreateForm);
            //Assert.IsType<MtResource>(response);
        }
    }
}
