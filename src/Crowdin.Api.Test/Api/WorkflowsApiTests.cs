...
namespace Crowdin.Api.Test.Api
{
    ...
    public class WorkflowsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiProjectsWorkflowStepsGet
        /// </summary>
        [Fact]
        public void ApiProjectsWorkflowStepsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int stepId = null;
            //var response = instance.ApiProjectsWorkflowStepsGet(projectId, stepId);
            //Assert.IsType<OneOfTranslateStepResponseProofreadStepResponseTranslateByVendorStepResponseProofreadByVendorStepResponseTmPreTranslateStepResponseMtPreTranslateStepResponseCrowdsourceStepResponse>(response);
        }

        /// <summary>
        /// Test ApiProjectsWorkflowStepsGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsWorkflowStepsGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiProjectsWorkflowStepsGetMany(projectId, limit, offset);
            //Assert.IsType<WorkflowStepCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiWorkflowTemplatesGet
        /// </summary>
        [Fact]
        public void ApiWorkflowTemplatesGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int templateId = null;
            //var response = instance.ApiWorkflowTemplatesGet(templateId);
            //Assert.IsType<WorkflowTemplateResource>(response);
        }

        /// <summary>
        /// Test ApiWorkflowTemplatesGetMany
        /// </summary>
        [Fact]
        public void ApiWorkflowTemplatesGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? groupId = null;
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiWorkflowTemplatesGetMany(groupId, limit, offset);
            //Assert.IsType<WorkflowTemplateCollectionResource>(response);
        }
    }
}
