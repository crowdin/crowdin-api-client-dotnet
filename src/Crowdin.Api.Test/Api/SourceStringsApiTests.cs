...
{
    /// <summary>
    ///  Class for testing SourceStringsApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class SourceStringsApiTests : IDisposable
    {
        private SourceStringsApi instance;

        public SourceStringsApiTests()
        {
            instance = new SourceStringsApi();
        }
        ...
        /// <summary>
        /// Test an instance of SourceStringsApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' SourceStringsApi
            //Assert.IsType<SourceStringsApi>(instance);
        }

        /// <summary>
        /// Test ApiProjectsStringsDelete
        /// </summary>
        [Fact]
        public void ApiProjectsStringsDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int stringId = null;
            //instance.ApiProjectsStringsDelete(projectId, stringId);
        }

        /// <summary>
        /// Test ApiProjectsStringsGet
        /// </summary>
        [Fact]
        public void ApiProjectsStringsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int stringId = null;
            //int? denormalizePlaceholders = null;
            //var response = instance.ApiProjectsStringsGet(projectId, stringId, denormalizePlaceholders);
            //Assert.IsType<StringResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsStringsGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsStringsGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int? denormalizePlaceholders = null;
            ...
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiProjectsStringsGetMany(projectId, denormalizePlaceholders, labelIds, fileId, branchId, directoryId, croql, filter, scope, limit, offset);
            //Assert.IsType<StringCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsStringsPatch
        /// </summary>
        [Fact]
        public void ApiProjectsStringsPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int stringId = null;
            //List<StringOperation> stringOperation = null;
            //var response = instance.ApiProjectsStringsPatch(projectId, stringId, stringOperation);
            //Assert.IsType<StringResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsStringsPost
        /// </summary>
        [Fact]
        public void ApiProjectsStringsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //StringCreateForm stringCreateForm = null;
            //var response = instance.ApiProjectsStringsPost(projectId, stringCreateForm);
            //Assert.IsType<StringResource>(response);
        }
    }
}
