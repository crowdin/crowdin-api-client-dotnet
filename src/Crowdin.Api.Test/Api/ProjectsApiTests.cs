...
namespace Crowdin.Api.Test.Api
{
    ...
    public class ProjectsApiTests : IDisposable
    {
        ...
        public void ApiProjectsGetManyTest()
        {
            ...
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiProjectsGetMany(userId, hasManagerAccess, limit, offset);
            //Assert.IsType<CrowdinProjectCollectionResource>(response);
        }
        ...
        public void ApiProjectsPostTest()
        {
            ...
            //var response = instance.ApiProjectsPost(UNKNOWN_BASE_TYPE);
            //Assert.IsType<OneOfProjectResponseProjectSettingsResponse>(response);
        }
    }
}
