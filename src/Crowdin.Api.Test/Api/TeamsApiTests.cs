...
namespace Crowdin.Api.Test.Api
{
    ...
    public class TeamsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiProjectsTeamsPost
        /// </summary>
        [Fact]
        public void ApiProjectsTeamsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //AddProjectTeamForm addProjectTeamForm = null;
            //var response = instance.ApiProjectsTeamsPost(projectId, addProjectTeamForm);
            //Assert.IsType<OneOfProjectTeamResourceSkippedProjectTeamResourceAdded>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiTeamsDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int teamId = null;
            //instance.ApiTeamsDelete(teamId);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiTeamsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int teamId = null;
            //var response = instance.ApiTeamsGet(teamId);
            //Assert.IsType<TeamResource>(response);
        }

        /// <summary>
        /// Test ApiTeamsGetMany
        /// </summary>
        [Fact]
        public void ApiTeamsGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiTeamsGetMany(limit, offset);
            //Assert.IsType<TeamCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiTeamsMembersDelete
        /// </summary>
        [Fact]
        public void ApiTeamsMembersDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int teamId = null;
            //int memberId = null;
            //instance.ApiTeamsMembersDelete(teamId, memberId);
        }

        /// <summary>
        /// Test ApiTeamsMembersDeleteMany
        /// </summary>
        [Fact]
        public void ApiTeamsMembersDeleteManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int teamId = null;
            //instance.ApiTeamsMembersDeleteMany(teamId);
        }

        /// <summary>
        /// Test ApiTeamsMembersGetMany
        /// </summary>
        [Fact]
        public void ApiTeamsMembersGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int teamId = null;
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiTeamsMembersGetMany(teamId, limit, offset);
            //Assert.IsType<TeamMemberCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiTeamsMembersPost
        /// </summary>
        [Fact]
        public void ApiTeamsMembersPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int teamId = null;
            //TeamMemberForm teamMemberForm = null;
            //var response = instance.ApiTeamsMembersPost(teamId, teamMemberForm);
            //Assert.IsType<TeamMemberAddCollectionResource>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiTeamsPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int teamId = null;
            //List<TeamOperation> teamOperation = null;
            //var response = instance.ApiTeamsPatch(teamId, teamOperation);
            //Assert.IsType<TeamResource>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void ApiTeamsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //TeamCreateForm teamCreateForm = null;
            //var response = instance.ApiTeamsPost(teamCreateForm);
            //Assert.IsType<TeamResource>(response);
        }
    }
}
