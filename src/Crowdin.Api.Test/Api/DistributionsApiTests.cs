...
namespace Crowdin.Api.Test.Api
{
    ...
    public class DistributionsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiProjectsDistributionsDelete
        /// </summary>
        [Fact]
        public void ApiProjectsDistributionsDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string hash = null;
            //instance.ApiProjectsDistributionsDelete(projectId, hash);
        }

        /// <summary>
        /// Test ApiProjectsDistributionsGet
        /// </summary>
        [Fact]
        public void ApiProjectsDistributionsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string hash = null;
            //var response = instance.ApiProjectsDistributionsGet(projectId, hash);
            //Assert.IsType<DistributionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsDistributionsGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsDistributionsGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiProjectsDistributionsGetMany(projectId, limit, offset);
            //Assert.IsType<DistributionCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsDistributionsPatch
        /// </summary>
        [Fact]
        public void ApiProjectsDistributionsPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string hash = null;
            //List<DistributionOperation> distributionOperation = null;
            //var response = instance.ApiProjectsDistributionsPatch(projectId, hash, distributionOperation);
            //Assert.IsType<DistributionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsDistributionsPost
        /// </summary>
        [Fact]
        public void ApiProjectsDistributionsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //DistributionCreateForm distributionCreateForm = null;
            //var response = instance.ApiProjectsDistributionsPost(projectId, distributionCreateForm);
            //Assert.IsType<DistributionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsDistributionsReleaseGet
        /// </summary>
        [Fact]
        public void ApiProjectsDistributionsReleaseGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string hash = null;
            //var response = instance.ApiProjectsDistributionsReleaseGet(projectId, hash);
            //Assert.IsType<DistributionReleaseResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsDistributionsReleasePost
        /// </summary>
        [Fact]
        public void ApiProjectsDistributionsReleasePostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string hash = null;
            //var response = instance.ApiProjectsDistributionsReleasePost(projectId, hash);
            //Assert.IsType<DistributionReleaseResource>(response);
        }
    }
}
