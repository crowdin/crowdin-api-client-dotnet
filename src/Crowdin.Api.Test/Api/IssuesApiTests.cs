...
namespace Crowdin.Api.Test.Api
{
    ...
    public class IssuesApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiProjectsIssuesGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsIssuesGetManyTest()
        {
            ...
            //string type = null;
            //string status = null;
            //var response = instance.ApiProjectsIssuesGetMany(projectId, limit, offset, type, status);
            //Assert.IsType<IssueCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsIssuesPatch
        /// </summary>
        [Fact]
        public void ApiProjectsIssuesPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int issueId = null;
            //List<IssueOperation> issueOperation = null;
            //var response = instance.ApiProjectsIssuesPatch(projectId, issueId, issueOperation);
            //Assert.IsType<IssueResource>(response);
        }
    }
}
