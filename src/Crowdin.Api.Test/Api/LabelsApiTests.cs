...
namespace Crowdin.Api.Test.Api
{
    ...
    public class LabelsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiProjectsLabelsDelete
        /// </summary>
        [Fact]
        public void ApiProjectsLabelsDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int labelId = null;
            //instance.ApiProjectsLabelsDelete(projectId, labelId);
        }

        /// <summary>
        /// Test ApiProjectsLabelsGet
        /// </summary>
        [Fact]
        public void ApiProjectsLabelsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int labelId = null;
            //var response = instance.ApiProjectsLabelsGet(projectId, labelId);
            //Assert.IsType<LabelResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsLabelsGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsLabelsGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiProjectsLabelsGetMany(projectId, limit, offset);
            //Assert.IsType<LabelCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsLabelsPatch
        /// </summary>
        [Fact]
        public void ApiProjectsLabelsPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int labelId = null;
            //List<LabelOperation> labelOperation = null;
            //var response = instance.ApiProjectsLabelsPatch(projectId, labelId, labelOperation);
            //Assert.IsType<LabelResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsLabelsPost
        /// </summary>
        [Fact]
        public void ApiProjectsLabelsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //LabelCreateForm labelCreateForm = null;
            //var response = instance.ApiProjectsLabelsPost(projectId, labelCreateForm);
            //Assert.IsType<LabelResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsLabelsStringsDeleteMany
        /// </summary>
        [Fact]
        public void ApiProjectsLabelsStringsDeleteManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int labelId = null;
            //string stringIds = null;
            //var response = instance.ApiProjectsLabelsStringsDeleteMany(projectId, labelId, stringIds);
            //Assert.IsType<StringCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsLabelsStringsPost
        /// </summary>
        [Fact]
        public void ApiProjectsLabelsStringsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int labelId = null;
            //LabelStringAssignForm labelStringAssignForm = null;
            //var response = instance.ApiProjectsLabelsStringsPost(projectId, labelId, labelStringAssignForm);
            //Assert.IsType<StringCollectionResource>(response);
        }
    }
}
