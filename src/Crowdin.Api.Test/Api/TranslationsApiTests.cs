...
namespace Crowdin.Api.Test.Api
{
    ...
    /// </remarks>
    public class TranslationsApiTests : IDisposable
    {
        private TranslationsApi instance;

        public TranslationsApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsType' TranslationsApi
            //Assert.IsType<TranslationsApi>(instance);
        }

        /// <summary>
        /// Test ApiProjectsPreTranslationsPost
        /// </summary>
        [Fact]
        public void ApiProjectsPreTranslationsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //PreTranslationForm preTranslationForm = null;
            //var response = instance.ApiProjectsPreTranslationsPost(projectId, preTranslationForm);
            //Assert.IsType<PreTranslationResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTranslationsBuildsDelete
        /// </summary>
        [Fact]
        public void ApiProjectsTranslationsBuildsDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int buildId = null;
            //instance.ApiProjectsTranslationsBuildsDelete(projectId, buildId);
        }

        /// <summary>
        /// Test ApiProjectsTranslationsBuildsDirectoriesPost
        /// </summary>
        [Fact]
        public void ApiProjectsTranslationsBuildsDirectoriesPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int directoryId = null;
            //CrowdinTranslationCreateDirectoryBuildForm crowdinTranslationCreateDirectoryBuildForm = null;
            //var response = instance.ApiProjectsTranslationsBuildsDirectoriesPost(projectId, directoryId, crowdinTranslationCreateDirectoryBuildForm);
            //Assert.IsType<CrowdinTranslationDirectoryBuildResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTranslationsBuildsDownloadDownload
        /// </summary>
        [Fact]
        public void ApiProjectsTranslationsBuildsDownloadDownloadTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int buildId = null;
            //var response = instance.ApiProjectsTranslationsBuildsDownloadDownload(projectId, buildId);
            //Assert.IsType<DownloadLinkResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTranslationsBuildsFilesPost
        /// </summary>
        [Fact]
        public void ApiProjectsTranslationsBuildsFilesPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int fileId = null;
            //string ifNoneMatch = null;
            //CrowdinFileBuildForm crowdinFileBuildForm = null;
            //var response = instance.ApiProjectsTranslationsBuildsFilesPost(projectId, fileId, ifNoneMatch, crowdinFileBuildForm);
            //Assert.IsType<FileDownloadLinkResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTranslationsBuildsGet
        /// </summary>
        [Fact]
        public void ApiProjectsTranslationsBuildsGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int buildId = null;
            //var response = instance.ApiProjectsTranslationsBuildsGet(projectId, buildId);
            //Assert.IsType<CrowdinTranslationProjectBuildResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTranslationsBuildsGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsTranslationsBuildsGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int? branchId = null;
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiProjectsTranslationsBuildsGetMany(projectId, branchId, limit, offset);
            //Assert.IsType<CrowdinTranslationProjectBuildCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTranslationsBuildsPost
        /// </summary>
        [Fact]
        public void ApiProjectsTranslationsBuildsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //UNKNOWN_BASE_TYPE UNKNOWN_BASE_TYPE = null;
            //var response = instance.ApiProjectsTranslationsBuildsPost(projectId, UNKNOWN_BASE_TYPE);
            //Assert.IsType<CrowdinTranslationProjectBuildResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTranslationsExportsPost
        /// </summary>
        [Fact]
        public void ApiProjectsTranslationsExportsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //CrowdinTranslationExportForm crowdinTranslationExportForm = null;
            //var response = instance.ApiProjectsTranslationsExportsPost(projectId, crowdinTranslationExportForm);
            //Assert.IsType<DownloadLinkResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTranslationsPostOnLanguage
        /// </summary>
        [Fact]
        public void ApiProjectsTranslationsPostOnLanguageTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string languageId = null;
            //TranslationUploadForm translationUploadForm = null;
            //var response = instance.ApiProjectsTranslationsPostOnLanguage(projectId, languageId, translationUploadForm);
            //Assert.IsType<FileImportResource>(response);
        }

        /// <summary>
        /// Test ProjectsProjectIdPreTranslationsPreTranslationIdGet
        /// </summary>
        [Fact]
        public void ProjectsProjectIdPreTranslationsPreTranslationIdGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string preTranslationId = null;
            //var response = instance.ProjectsProjectIdPreTranslationsPreTranslationIdGet(projectId, preTranslationId);
            //Assert.IsType<PreTranslationResource>(response);
        }
    }
}
