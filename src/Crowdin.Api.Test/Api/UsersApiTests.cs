...
namespace Crowdin.Api.Test.Api
{
    ...
    public class UsersApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiProjectsMembersGet
        /// </summary>
        [Fact]
        public void ApiProjectsMembersGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int memberId = null;
            //var response = instance.ApiProjectsMembersGet(projectId, memberId);
            //Assert.IsType<CrowdinUserResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsMembersGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsMembersGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //string search = null;
            ...
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiProjectsMembersGetMany(projectId, search, role, languageId, limit, offset);
            //Assert.IsType<UserCollectionResource>(response);
        }
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.ApiUserGet();
            //Assert.IsType<CrowdinAuthenticateUserResource>(response);
        }
    }
}
