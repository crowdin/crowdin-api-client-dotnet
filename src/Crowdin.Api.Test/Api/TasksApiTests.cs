...
namespace Crowdin.Api.Test.Api
{
    ...
    public class TasksApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiProjectsTasksDelete
        /// </summary>
        [Fact]
        public void ApiProjectsTasksDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int taskId = null;
            //instance.ApiProjectsTasksDelete(projectId, taskId);
        }

        /// <summary>
        /// Test ApiProjectsTasksExportsPost
        /// </summary>
        [Fact]
        public void ApiProjectsTasksExportsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int taskId = null;
            //var response = instance.ApiProjectsTasksExportsPost(projectId, taskId);
            //Assert.IsType<DownloadLinkResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTasksGet
        /// </summary>
        [Fact]
        public void ApiProjectsTasksGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int taskId = null;
            //var response = instance.ApiProjectsTasksGet(projectId, taskId);
            //Assert.IsType<TaskResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTasksGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsTasksGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int? limit = null;
            ...
            //string status = null;
            //int? assigneeId = null;
            //var response = instance.ApiProjectsTasksGetMany(projectId, limit, offset, status, assigneeId);
            //Assert.IsType<TaskCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTasksPatch
        /// </summary>
        [Fact]
        public void ApiProjectsTasksPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int taskId = null;
            //List<OneOfTaskOperationVendorTaskOperation> oneOfTaskOperationVendorTaskOperation = null;
            //var response = instance.ApiProjectsTasksPatch(projectId, taskId, oneOfTaskOperationVendorTaskOperation);
            //Assert.IsType<TaskResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsTasksPost
        /// </summary>
        [Fact]
        public void ApiProjectsTasksPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //UNKNOWN_BASE_TYPE UNKNOWN_BASE_TYPE = null;
            //var response = instance.ApiProjectsTasksPost(projectId, UNKNOWN_BASE_TYPE);
            //Assert.IsType<TaskResource>(response);
        }

        /// <summary>
        /// Test ApiUserTasksGetMany
        /// </summary>
        [Fact]
        public void ApiUserTasksGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? limit = null;
            //int? offset = null;
            ...
            //var response = instance.ApiUserTasksGetMany(limit, offset, status, isArchived);
            //Assert.IsType<UserTaskCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiUserTasksPatch
        /// </summary>
        [Fact]
        public void ApiUserTasksPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int taskId = null;
            //List<UserTaskOperation> userTaskOperation = null;
            //var response = instance.ApiUserTasksPatch(projectId, taskId, userTaskOperation);
            //Assert.IsType<UserTaskResource>(response);
        }
    }
}
