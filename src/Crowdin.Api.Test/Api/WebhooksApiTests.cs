...
namespace Crowdin.Api.Test.Api
{
    ...
    public class WebhooksApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test ApiProjectsWebhooksDelete
        /// </summary>
        [Fact]
        public void ApiProjectsWebhooksDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int webhookId = null;
            //instance.ApiProjectsWebhooksDelete(projectId, webhookId);
        }

        /// <summary>
        /// Test ApiProjectsWebhooksGet
        /// </summary>
        [Fact]
        public void ApiProjectsWebhooksGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int webhookId = null;
            //var response = instance.ApiProjectsWebhooksGet(projectId, webhookId);
            //Assert.IsType<WebhookResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsWebhooksGetMany
        /// </summary>
        [Fact]
        public void ApiProjectsWebhooksGetManyTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int? limit = null;
            //int? offset = null;
            //var response = instance.ApiProjectsWebhooksGetMany(projectId, limit, offset);
            //Assert.IsType<WebhookCollectionResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsWebhooksPatch
        /// </summary>
        [Fact]
        public void ApiProjectsWebhooksPatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //int webhookId = null;
            //List<WebhookOperation> webhookOperation = null;
            //var response = instance.ApiProjectsWebhooksPatch(projectId, webhookId, webhookOperation);
            //Assert.IsType<WebhookResource>(response);
        }

        /// <summary>
        /// Test ApiProjectsWebhooksPost
        /// </summary>
        [Fact]
        public void ApiProjectsWebhooksPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int projectId = null;
            //WebhookCreateForm webhookCreateForm = null;
            //var response = instance.ApiProjectsWebhooksPost(projectId, webhookCreateForm);
            //Assert.IsType<WebhookResource>(response);
        }
    }
}
