...
{
    /// <summary>
    ///  Class for testing GlossaryOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class GlossaryOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for GlossaryOperation
        //private GlossaryOperation instance;

        public GlossaryOperationTests()
        {
            // TODO uncomment below to create an instance of GlossaryOperation
            //instance = new GlossaryOperation();
        }
        ...
        /// <summary>
        /// Test an instance of GlossaryOperation
        /// </summary>
        [Fact]
        public void GlossaryOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" GlossaryOperation
            //Assert.IsType<GlossaryOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a GlossaryOperationTest from type GlossaryOperation
        /// </summary>
        [Fact]
        public void GlossaryOperationTestDeserializeFromGlossaryOperationTest()
        {
            // TODO uncomment below to test deserialize a GlossaryOperationTest from type GlossaryOperation
            //Assert.IsType<GlossaryOperation>(JsonConvert.DeserializeObject<GlossaryOperation>(new GlossaryOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a GlossaryOperationReplace from type GlossaryOperation
        /// </summary>
        [Fact]
        public void GlossaryOperationReplaceDeserializeFromGlossaryOperationTest()
        {
            // TODO uncomment below to test deserialize a GlossaryOperationReplace from type GlossaryOperation
            //Assert.IsType<GlossaryOperation>(JsonConvert.DeserializeObject<GlossaryOperation>(new GlossaryOperationReplace().ToJson()));
        }
