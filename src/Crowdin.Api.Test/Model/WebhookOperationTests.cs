...
{
    /// <summary>
    ///  Class for testing WebhookOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class WebhookOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for WebhookOperation
        //private WebhookOperation instance;

        public WebhookOperationTests()
        {
            // TODO uncomment below to create an instance of WebhookOperation
            //instance = new WebhookOperation();
        }
        ...
        /// <summary>
        /// Test an instance of WebhookOperation
        /// </summary>
        [Fact]
        public void WebhookOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" WebhookOperation
            //Assert.IsType<WebhookOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a WebhookOperationReplace from type WebhookOperation
        /// </summary>
        [Fact]
        public void WebhookOperationReplaceDeserializeFromWebhookOperationTest()
        {
            // TODO uncomment below to test deserialize a WebhookOperationReplace from type WebhookOperation
            //Assert.IsType<WebhookOperation>(JsonConvert.DeserializeObject<WebhookOperation>(new WebhookOperationReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a WebhookOperationTest from type WebhookOperation
        /// </summary>
        [Fact]
        public void WebhookOperationTestDeserializeFromWebhookOperationTest()
        {
            // TODO uncomment below to test deserialize a WebhookOperationTest from type WebhookOperation
            //Assert.IsType<WebhookOperation>(JsonConvert.DeserializeObject<WebhookOperation>(new WebhookOperationTest().ToJson()));
        }
