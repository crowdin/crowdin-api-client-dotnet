...
{
    /// <summary>
    ///  Class for testing TaskOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class TaskOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for TaskOperation
        //private TaskOperation instance;

        public TaskOperationTests()
        {
            // TODO uncomment below to create an instance of TaskOperation
            //instance = new TaskOperation();
        }
        ...
        /// <summary>
        /// Test an instance of TaskOperation
        /// </summary>
        [Fact]
        public void TaskOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" TaskOperation
            //Assert.IsType<TaskOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a TaskOperationReplace from type TaskOperation
        /// </summary>
        [Fact]
        public void TaskOperationReplaceDeserializeFromTaskOperationTest()
        {
            // TODO uncomment below to test deserialize a TaskOperationReplace from type TaskOperation
            //Assert.IsType<TaskOperation>(JsonConvert.DeserializeObject<TaskOperation>(new TaskOperationReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a TaskOperationTest from type TaskOperation
        /// </summary>
        [Fact]
        public void TaskOperationTestDeserializeFromTaskOperationTest()
        {
            // TODO uncomment below to test deserialize a TaskOperationTest from type TaskOperation
            //Assert.IsType<TaskOperation>(JsonConvert.DeserializeObject<TaskOperation>(new TaskOperationTest().ToJson()));
        }
