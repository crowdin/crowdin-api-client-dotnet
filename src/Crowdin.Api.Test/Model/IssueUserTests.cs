...
namespace Crowdin.Api.Test.Model
{
    ...
    {
        // TODO uncomment below to declare an instance variable for IssueUser
        //private IssueUser instance;

        public IssueUserTests()
        {
            // TODO uncomment below to create an instance of IssueUser
            //instance = new IssueUser();
        }
        ...
        /// <summary>
        /// Test an instance of IssueUser
        /// </summary>
        [Fact]
        public void IssueUserInstanceTest()
        {
            // TODO uncomment below to test "IsType" IssueUser
            //Assert.IsType<IssueUser>(instance);
        }
