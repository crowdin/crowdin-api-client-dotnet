...
{
    /// <summary>
    ///  Class for testing FileOperation
    /// </summary>
    /// <remarks>
    ...
    {
        // TODO uncomment below to declare an instance variable for FileOperation
        //private FileOperation instance;

        public FileOperationTests()
        {
            // TODO uncomment below to create an instance of FileOperation
        ...
        /// <summary>
        /// Test an instance of FileOperation
        /// </summary>
        [Fact]
        public void FileOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" FileOperation
            //Assert.IsType<FileOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a FileOperationReplace from type FileOperation
        /// </summary>
        [Fact]
        public void FileOperationReplaceDeserializeFromFileOperationTest()
        {
            // TODO uncomment below to test deserialize a FileOperationReplace from type FileOperation
            //Assert.IsType<FileOperation>(JsonConvert.DeserializeObject<FileOperation>(new FileOperationReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a FileOperationTest from type FileOperation
        /// </summary>
        [Fact]
        public void FileOperationTestDeserializeFromFileOperationTest()
        {
            // TODO uncomment below to test deserialize a FileOperationTest from type FileOperation
            //Assert.IsType<FileOperation>(JsonConvert.DeserializeObject<FileOperation>(new FileOperationTest().ToJson()));
        }
