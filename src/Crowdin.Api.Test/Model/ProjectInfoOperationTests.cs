...
{
    /// <summary>
    ///  Class for testing ProjectInfoOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class ProjectInfoOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for ProjectInfoOperation
        //private ProjectInfoOperation instance;

        public ProjectInfoOperationTests()
        {
            // TODO uncomment below to create an instance of ProjectInfoOperation
            //instance = new ProjectInfoOperation();
        }
        ...
        /// <summary>
        /// Test an instance of ProjectInfoOperation
        /// </summary>
        [Fact]
        public void ProjectInfoOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" ProjectInfoOperation
            //Assert.IsType<ProjectInfoOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a ProjectInfoOperationTest from type ProjectInfoOperation
        /// </summary>
        [Fact]
        public void ProjectInfoOperationTestDeserializeFromProjectInfoOperationTest()
        {
            // TODO uncomment below to test deserialize a ProjectInfoOperationTest from type ProjectInfoOperation
            //Assert.IsType<ProjectInfoOperation>(JsonConvert.DeserializeObject<ProjectInfoOperation>(new ProjectInfoOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a ProjectInfoOperationReplace from type ProjectInfoOperation
        /// </summary>
        [Fact]
        public void ProjectInfoOperationReplaceDeserializeFromProjectInfoOperationTest()
        {
            // TODO uncomment below to test deserialize a ProjectInfoOperationReplace from type ProjectInfoOperation
            //Assert.IsType<ProjectInfoOperation>(JsonConvert.DeserializeObject<ProjectInfoOperation>(new ProjectInfoOperationReplace().ToJson()));
        }
