...
namespace Crowdin.Api.Test.Model
{
    ...
    public class GroupResourceTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" GroupResource
            //Assert.IsType<GroupResource>(instance);
        }
