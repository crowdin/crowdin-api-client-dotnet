...
namespace Crowdin.Api.Test.Model
{
    ...
    public class VendorResourceTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" VendorResource
            //Assert.IsType<VendorResource>(instance);
        }
