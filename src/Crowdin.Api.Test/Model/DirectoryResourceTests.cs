...
namespace Crowdin.Api.Test.Model
{
    ...
    public class DirectoryResourceTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" DirectoryResource
            //Assert.IsType<DirectoryResource>(instance);
        }
