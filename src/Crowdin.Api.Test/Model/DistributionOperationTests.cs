...
{
    /// <summary>
    ///  Class for testing DistributionOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class DistributionOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for DistributionOperation
        //private DistributionOperation instance;

        public DistributionOperationTests()
        {
            // TODO uncomment below to create an instance of DistributionOperation
            //instance = new DistributionOperation();
        }
        ...
        /// <summary>
        /// Test an instance of DistributionOperation
        /// </summary>
        [Fact]
        public void DistributionOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" DistributionOperation
            //Assert.IsType<DistributionOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a DistributionOperationReplace from type DistributionOperation
        /// </summary>
        [Fact]
        public void DistributionOperationReplaceDeserializeFromDistributionOperationTest()
        {
            // TODO uncomment below to test deserialize a DistributionOperationReplace from type DistributionOperation
            //Assert.IsType<DistributionOperation>(JsonConvert.DeserializeObject<DistributionOperation>(new DistributionOperationReplace().ToJson()));
        }
