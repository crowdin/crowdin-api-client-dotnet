...
{
    /// <summary>
    ///  Class for testing BranchOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class BranchOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for BranchOperation
        //private BranchOperation instance;

        public BranchOperationTests()
        {
            // TODO uncomment below to create an instance of BranchOperation
            //instance = new BranchOperation();
        }
        ...
        /// <summary>
        /// Test an instance of BranchOperation
        /// </summary>
        [Fact]
        public void BranchOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" BranchOperation
            //Assert.IsType<BranchOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a BranchOperationTest from type BranchOperation
        /// </summary>
        [Fact]
        public void BranchOperationTestDeserializeFromBranchOperationTest()
        {
            // TODO uncomment below to test deserialize a BranchOperationTest from type BranchOperation
            //Assert.IsType<BranchOperation>(JsonConvert.DeserializeObject<BranchOperation>(new BranchOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a BranchOperationReplace from type BranchOperation
        /// </summary>
        [Fact]
        public void BranchOperationReplaceDeserializeFromBranchOperationTest()
        {
            // TODO uncomment below to test deserialize a BranchOperationReplace from type BranchOperation
            //Assert.IsType<BranchOperation>(JsonConvert.DeserializeObject<BranchOperation>(new BranchOperationReplace().ToJson()));
        }
