...
{
    /// <summary>
    ///  Class for testing CustomLanguageOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class CustomLanguageOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for CustomLanguageOperation
        //private CustomLanguageOperation instance;

        public CustomLanguageOperationTests()
        {
            // TODO uncomment below to create an instance of CustomLanguageOperation
            //instance = new CustomLanguageOperation();
        }
        ...
        /// <summary>
        /// Test an instance of CustomLanguageOperation
        /// </summary>
        [Fact]
        public void CustomLanguageOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" CustomLanguageOperation
            //Assert.IsType<CustomLanguageOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a CustomLanguageOperationReplace from type CustomLanguageOperation
        /// </summary>
        [Fact]
        public void CustomLanguageOperationReplaceDeserializeFromCustomLanguageOperationTest()
        {
            // TODO uncomment below to test deserialize a CustomLanguageOperationReplace from type CustomLanguageOperation
            //Assert.IsType<CustomLanguageOperation>(JsonConvert.DeserializeObject<CustomLanguageOperation>(new CustomLanguageOperationReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a CustomLanguageOperationTest from type CustomLanguageOperation
        /// </summary>
        [Fact]
        public void CustomLanguageOperationTestDeserializeFromCustomLanguageOperationTest()
        {
            // TODO uncomment below to test deserialize a CustomLanguageOperationTest from type CustomLanguageOperation
            //Assert.IsType<CustomLanguageOperation>(JsonConvert.DeserializeObject<CustomLanguageOperation>(new CustomLanguageOperationTest().ToJson()));
        }
