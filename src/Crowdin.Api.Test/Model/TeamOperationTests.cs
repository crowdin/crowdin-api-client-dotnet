...
{
    /// <summary>
    ///  Class for testing TeamOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class TeamOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for TeamOperation
        //private TeamOperation instance;

        public TeamOperationTests()
        {
            // TODO uncomment below to create an instance of TeamOperation
            //instance = new TeamOperation();
        }
        ...
        /// <summary>
        /// Test an instance of TeamOperation
        /// </summary>
        [Fact]
        public void TeamOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" TeamOperation
            //Assert.IsType<TeamOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a TeamOperationReplace from type TeamOperation
        /// </summary>
        [Fact]
        public void TeamOperationReplaceDeserializeFromTeamOperationTest()
        {
            // TODO uncomment below to test deserialize a TeamOperationReplace from type TeamOperation
            //Assert.IsType<TeamOperation>(JsonConvert.DeserializeObject<TeamOperation>(new TeamOperationReplace().ToJson()));
        }
