...
{
    /// <summary>
    ///  Class for testing StringCommentOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class StringCommentOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for StringCommentOperation
        //private StringCommentOperation instance;

        public StringCommentOperationTests()
        {
            // TODO uncomment below to create an instance of StringCommentOperation
            //instance = new StringCommentOperation();
        }
        ...
        /// <summary>
        /// Test an instance of StringCommentOperation
        /// </summary>
        [Fact]
        public void StringCommentOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" StringCommentOperation
            //Assert.IsType<StringCommentOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a StringCommentOperationTest from type StringCommentOperation
        /// </summary>
        [Fact]
        public void StringCommentOperationTestDeserializeFromStringCommentOperationTest()
        {
            // TODO uncomment below to test deserialize a StringCommentOperationTest from type StringCommentOperation
            //Assert.IsType<StringCommentOperation>(JsonConvert.DeserializeObject<StringCommentOperation>(new StringCommentOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a StringCommentOperationReplace from type StringCommentOperation
        /// </summary>
        [Fact]
        public void StringCommentOperationReplaceDeserializeFromStringCommentOperationTest()
        {
            // TODO uncomment below to test deserialize a StringCommentOperationReplace from type StringCommentOperation
            //Assert.IsType<StringCommentOperation>(JsonConvert.DeserializeObject<StringCommentOperation>(new StringCommentOperationReplace().ToJson()));
        }
