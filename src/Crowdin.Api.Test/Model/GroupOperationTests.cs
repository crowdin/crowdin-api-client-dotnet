...
{
    /// <summary>
    ///  Class for testing GroupOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class GroupOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for GroupOperation
        //private GroupOperation instance;

        public GroupOperationTests()
        {
            // TODO uncomment below to create an instance of GroupOperation
            //instance = new GroupOperation();
        }
        ...
        /// <summary>
        /// Test an instance of GroupOperation
        /// </summary>
        [Fact]
        public void GroupOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" GroupOperation
            //Assert.IsType<GroupOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a GroupOperationReplace from type GroupOperation
        /// </summary>
        [Fact]
        public void GroupOperationReplaceDeserializeFromGroupOperationTest()
        {
            // TODO uncomment below to test deserialize a GroupOperationReplace from type GroupOperation
            //Assert.IsType<GroupOperation>(JsonConvert.DeserializeObject<GroupOperation>(new GroupOperationReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a GroupOperationTest from type GroupOperation
        /// </summary>
        [Fact]
        public void GroupOperationTestDeserializeFromGroupOperationTest()
        {
            // TODO uncomment below to test deserialize a GroupOperationTest from type GroupOperation
            //Assert.IsType<GroupOperation>(JsonConvert.DeserializeObject<GroupOperation>(new GroupOperationTest().ToJson()));
        }
