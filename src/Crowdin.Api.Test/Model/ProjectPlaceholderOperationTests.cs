...
{
    /// <summary>
    ///  Class for testing ProjectPlaceholderOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class ProjectPlaceholderOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for ProjectPlaceholderOperation
        //private ProjectPlaceholderOperation instance;

        public ProjectPlaceholderOperationTests()
        {
            // TODO uncomment below to create an instance of ProjectPlaceholderOperation
            //instance = new ProjectPlaceholderOperation();
        }
        ...
        /// <summary>
        /// Test an instance of ProjectPlaceholderOperation
        /// </summary>
        [Fact]
        public void ProjectPlaceholderOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" ProjectPlaceholderOperation
            //Assert.IsType<ProjectPlaceholderOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a ProjectPlaceholderOperationReplace from type ProjectPlaceholderOperation
        /// </summary>
        [Fact]
        public void ProjectPlaceholderOperationReplaceDeserializeFromProjectPlaceholderOperationTest()
        {
            // TODO uncomment below to test deserialize a ProjectPlaceholderOperationReplace from type ProjectPlaceholderOperation
            //Assert.IsType<ProjectPlaceholderOperation>(JsonConvert.DeserializeObject<ProjectPlaceholderOperation>(new ProjectPlaceholderOperationReplace().ToJson()));
        }
