...
namespace Crowdin.Api.Test.Model
{
    ...
    public class ErrorResourceTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" ErrorResource
            //Assert.IsType<ErrorResource>(instance);
        }
