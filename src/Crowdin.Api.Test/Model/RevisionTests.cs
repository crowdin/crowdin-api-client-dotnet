...
namespace Crowdin.Api.Test.Model
{
    ...
    public class RevisionTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" Revision
            //Assert.IsType<Revision>(instance);
        }
        ...
        /// <summary>
        /// Test the property 'RestoreToRevision'
        /// </summary>
        [Fact]
        public void RestoreToRevisionTest()
        {
            // TODO unit test for the property 'RestoreToRevision'
        }
        /// <summary>
