...
{
    /// <summary>
    ///  Class for testing TagOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class TagOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for TagOperation
        //private TagOperation instance;

        public TagOperationTests()
        {
            // TODO uncomment below to create an instance of TagOperation
            //instance = new TagOperation();
        }
        ...
        /// <summary>
        /// Test an instance of TagOperation
        /// </summary>
        [Fact]
        public void TagOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" TagOperation
            //Assert.IsType<TagOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a TagOperationTest from type TagOperation
        /// </summary>
        [Fact]
        public void TagOperationTestDeserializeFromTagOperationTest()
        {
            // TODO uncomment below to test deserialize a TagOperationTest from type TagOperation
            //Assert.IsType<TagOperation>(JsonConvert.DeserializeObject<TagOperation>(new TagOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a TagOperationReplace from type TagOperation
        /// </summary>
        [Fact]
        public void TagOperationReplaceDeserializeFromTagOperationTest()
        {
            // TODO uncomment below to test deserialize a TagOperationReplace from type TagOperation
            //Assert.IsType<TagOperation>(JsonConvert.DeserializeObject<TagOperation>(new TagOperationReplace().ToJson()));
        }
