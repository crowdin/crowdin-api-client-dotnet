...
{
    /// <summary>
    ///  Class for testing TmOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class TmOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for TmOperation
        //private TmOperation instance;

        public TmOperationTests()
        {
            // TODO uncomment below to create an instance of TmOperation
            //instance = new TmOperation();
        }
        ...
        /// <summary>
        /// Test an instance of TmOperation
        /// </summary>
        [Fact]
        public void TmOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" TmOperation
            //Assert.IsType<TmOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a TmOperationTest from type TmOperation
        /// </summary>
        [Fact]
        public void TmOperationTestDeserializeFromTmOperationTest()
        {
            // TODO uncomment below to test deserialize a TmOperationTest from type TmOperation
            //Assert.IsType<TmOperation>(JsonConvert.DeserializeObject<TmOperation>(new TmOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a TmOperationReplace from type TmOperation
        /// </summary>
        [Fact]
        public void TmOperationReplaceDeserializeFromTmOperationTest()
        {
            // TODO uncomment below to test deserialize a TmOperationReplace from type TmOperation
            //Assert.IsType<TmOperation>(JsonConvert.DeserializeObject<TmOperation>(new TmOperationReplace().ToJson()));
        }
