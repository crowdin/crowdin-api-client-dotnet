...
{
    /// <summary>
    ///  Class for testing LabelOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class LabelOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for LabelOperation
        //private LabelOperation instance;

        public LabelOperationTests()
        {
            // TODO uncomment below to create an instance of LabelOperation
            //instance = new LabelOperation();
        }
        ...
        /// <summary>
        /// Test an instance of LabelOperation
        /// </summary>
        [Fact]
        public void LabelOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" LabelOperation
            //Assert.IsType<LabelOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a LabelOperationTest from type LabelOperation
        /// </summary>
        [Fact]
        public void LabelOperationTestDeserializeFromLabelOperationTest()
        {
            // TODO uncomment below to test deserialize a LabelOperationTest from type LabelOperation
            //Assert.IsType<LabelOperation>(JsonConvert.DeserializeObject<LabelOperation>(new LabelOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a LabelOperationReplace from type LabelOperation
        /// </summary>
        [Fact]
        public void LabelOperationReplaceDeserializeFromLabelOperationTest()
        {
            // TODO uncomment below to test deserialize a LabelOperationReplace from type LabelOperation
            //Assert.IsType<LabelOperation>(JsonConvert.DeserializeObject<LabelOperation>(new LabelOperationReplace().ToJson()));
        }
