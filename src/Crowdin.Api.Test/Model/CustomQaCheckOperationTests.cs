...
{
    /// <summary>
    ///  Class for testing CustomQaCheckOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class CustomQaCheckOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for CustomQaCheckOperation
        //private CustomQaCheckOperation instance;

        public CustomQaCheckOperationTests()
        {
            // TODO uncomment below to create an instance of CustomQaCheckOperation
            //instance = new CustomQaCheckOperation();
        }
        ...
        /// <summary>
        /// Test an instance of CustomQaCheckOperation
        /// </summary>
        [Fact]
        public void CustomQaCheckOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" CustomQaCheckOperation
            //Assert.IsType<CustomQaCheckOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a CustomQaCheckOperationTest from type CustomQaCheckOperation
        /// </summary>
        [Fact]
        public void CustomQaCheckOperationTestDeserializeFromCustomQaCheckOperationTest()
        {
            // TODO uncomment below to test deserialize a CustomQaCheckOperationTest from type CustomQaCheckOperation
            //Assert.IsType<CustomQaCheckOperation>(JsonConvert.DeserializeObject<CustomQaCheckOperation>(new CustomQaCheckOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a CustomQaCheckOperationReplace from type CustomQaCheckOperation
        /// </summary>
        [Fact]
        public void CustomQaCheckOperationReplaceDeserializeFromCustomQaCheckOperationTest()
        {
            // TODO uncomment below to test deserialize a CustomQaCheckOperationReplace from type CustomQaCheckOperation
            //Assert.IsType<CustomQaCheckOperation>(JsonConvert.DeserializeObject<CustomQaCheckOperation>(new CustomQaCheckOperationReplace().ToJson()));
        }
