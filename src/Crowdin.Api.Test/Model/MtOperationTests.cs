...
{
    /// <summary>
    ///  Class for testing MtOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class MtOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for MtOperation
        //private MtOperation instance;

        public MtOperationTests()
        {
            // TODO uncomment below to create an instance of MtOperation
            //instance = new MtOperation();
        }
        ...
        /// <summary>
        /// Test an instance of MtOperation
        /// </summary>
        [Fact]
        public void MtOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" MtOperation
            //Assert.IsType<MtOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a MtOperationTest from type MtOperation
        /// </summary>
        [Fact]
        public void MtOperationTestDeserializeFromMtOperationTest()
        {
            // TODO uncomment below to test deserialize a MtOperationTest from type MtOperation
            //Assert.IsType<MtOperation>(JsonConvert.DeserializeObject<MtOperation>(new MtOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a MtOperationReplace from type MtOperation
        /// </summary>
        [Fact]
        public void MtOperationReplaceDeserializeFromMtOperationTest()
        {
            // TODO uncomment below to test deserialize a MtOperationReplace from type MtOperation
            //Assert.IsType<MtOperation>(JsonConvert.DeserializeObject<MtOperation>(new MtOperationReplace().ToJson()));
        }
