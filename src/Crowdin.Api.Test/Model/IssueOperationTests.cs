...
{
    /// <summary>
    ///  Class for testing IssueOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class IssueOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for IssueOperation
        //private IssueOperation instance;

        public IssueOperationTests()
        {
            // TODO uncomment below to create an instance of IssueOperation
            //instance = new IssueOperation();
        }
        ...
        /// <summary>
        /// Test an instance of IssueOperation
        /// </summary>
        [Fact]
        public void IssueOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" IssueOperation
            //Assert.IsType<IssueOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a IssueOperationReplace from type IssueOperation
        /// </summary>
        [Fact]
        public void IssueOperationReplaceDeserializeFromIssueOperationTest()
        {
            // TODO uncomment below to test deserialize a IssueOperationReplace from type IssueOperation
            //Assert.IsType<IssueOperation>(JsonConvert.DeserializeObject<IssueOperation>(new IssueOperationReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a IssueOperationTest from type IssueOperation
        /// </summary>
        [Fact]
        public void IssueOperationTestDeserializeFromIssueOperationTest()
        {
            // TODO uncomment below to test deserialize a IssueOperationTest from type IssueOperation
            //Assert.IsType<IssueOperation>(JsonConvert.DeserializeObject<IssueOperation>(new IssueOperationTest().ToJson()));
        }
