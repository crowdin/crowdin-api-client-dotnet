...
{
    /// <summary>
    ///  Class for testing VendorTaskOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class VendorTaskOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for VendorTaskOperation
        //private VendorTaskOperation instance;

        public VendorTaskOperationTests()
        {
            // TODO uncomment below to create an instance of VendorTaskOperation
            //instance = new VendorTaskOperation();
        }
        ...
        /// <summary>
        /// Test an instance of VendorTaskOperation
        /// </summary>
        [Fact]
        public void VendorTaskOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" VendorTaskOperation
            //Assert.IsType<VendorTaskOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a VendorTaskOperationTest from type VendorTaskOperation
        /// </summary>
        [Fact]
        public void VendorTaskOperationTestDeserializeFromVendorTaskOperationTest()
        {
            // TODO uncomment below to test deserialize a VendorTaskOperationTest from type VendorTaskOperation
            //Assert.IsType<VendorTaskOperation>(JsonConvert.DeserializeObject<VendorTaskOperation>(new VendorTaskOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a VendorTaskOperationReplace from type VendorTaskOperation
        /// </summary>
        [Fact]
        public void VendorTaskOperationReplaceDeserializeFromVendorTaskOperationTest()
        {
            // TODO uncomment below to test deserialize a VendorTaskOperationReplace from type VendorTaskOperation
            //Assert.IsType<VendorTaskOperation>(JsonConvert.DeserializeObject<VendorTaskOperation>(new VendorTaskOperationReplace().ToJson()));
        }
