...
{
    /// <summary>
    ///  Class for testing TermOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class TermOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for TermOperation
        //private TermOperation instance;

        public TermOperationTests()
        {
            // TODO uncomment below to create an instance of TermOperation
            //instance = new TermOperation();
        }
        ...
        /// <summary>
        /// Test an instance of TermOperation
        /// </summary>
        [Fact]
        public void TermOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" TermOperation
            //Assert.IsType<TermOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a TermOperationReplace from type TermOperation
        /// </summary>
        [Fact]
        public void TermOperationReplaceDeserializeFromTermOperationTest()
        {
            // TODO uncomment below to test deserialize a TermOperationReplace from type TermOperation
            //Assert.IsType<TermOperation>(JsonConvert.DeserializeObject<TermOperation>(new TermOperationReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a TermOperationTest from type TermOperation
        /// </summary>
        [Fact]
        public void TermOperationTestDeserializeFromTermOperationTest()
        {
            // TODO uncomment below to test deserialize a TermOperationTest from type TermOperation
            //Assert.IsType<TermOperation>(JsonConvert.DeserializeObject<TermOperation>(new TermOperationTest().ToJson()));
        }
