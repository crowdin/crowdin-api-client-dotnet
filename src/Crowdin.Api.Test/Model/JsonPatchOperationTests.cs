...
namespace Crowdin.Api.Test.Model
{
    ...
    public class JsonPatchOperationTests : IDisposable
    {
        ...
        /// <summary>
        /// Test deserialize a JsonPatchReplace from type JsonPatchOperation
        /// </summary>
        [Fact]
        public void JsonPatchReplaceDeserializeFromJsonPatchOperationTest()
        {
            // TODO uncomment below to test deserialize a JsonPatchReplace from type JsonPatchOperation
            //Assert.IsType<JsonPatchOperation>(JsonConvert.DeserializeObject<JsonPatchOperation>(new JsonPatchReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a JsonPatchCopy from type JsonPatchOperation
        /// </summary>
        [Fact]
        public void JsonPatchCopyDeserializeFromJsonPatchOperationTest()
        {
            // TODO uncomment below to test deserialize a JsonPatchCopy from type JsonPatchOperation
            //Assert.IsType<JsonPatchOperation>(JsonConvert.DeserializeObject<JsonPatchOperation>(new JsonPatchCopy().ToJson()));
        }
        /// <summary>
        /// Test deserialize a JsonPatchRemove from type JsonPatchOperation
        /// </summary>
        [Fact]
        public void JsonPatchRemoveDeserializeFromJsonPatchOperationTest()
        {
            // TODO uncomment below to test deserialize a JsonPatchRemove from type JsonPatchOperation
            //Assert.IsType<JsonPatchOperation>(JsonConvert.DeserializeObject<JsonPatchOperation>(new JsonPatchRemove().ToJson()));
        }
        /// <summary>
        /// Test deserialize a JsonPatchMove from type JsonPatchOperation
        /// </summary>
        [Fact]
        public void JsonPatchMoveDeserializeFromJsonPatchOperationTest()
        {
            // TODO uncomment below to test deserialize a JsonPatchMove from type JsonPatchOperation
            //Assert.IsType<JsonPatchOperation>(JsonConvert.DeserializeObject<JsonPatchOperation>(new JsonPatchMove().ToJson()));
        }
        /// <summary>
        /// Test deserialize a JsonPatchAdd from type JsonPatchOperation
        /// </summary>
        [Fact]
        public void JsonPatchAddDeserializeFromJsonPatchOperationTest()
        {
            // TODO uncomment below to test deserialize a JsonPatchAdd from type JsonPatchOperation
            //Assert.IsType<JsonPatchOperation>(JsonConvert.DeserializeObject<JsonPatchOperation>(new JsonPatchAdd().ToJson()));
        }
        /// <summary>
        /// Test deserialize a JsonPatchTest from type JsonPatchOperation
        /// </summary>
        [Fact]
        public void JsonPatchTestDeserializeFromJsonPatchOperationTest()
        {
            // TODO uncomment below to test deserialize a JsonPatchTest from type JsonPatchOperation
            //Assert.IsType<JsonPatchOperation>(JsonConvert.DeserializeObject<JsonPatchOperation>(new JsonPatchTest().ToJson()));
        }
