...
{
    /// <summary>
    ///  Class for testing ScreenshotOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class ScreenshotOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for ScreenshotOperation
        //private ScreenshotOperation instance;

        public ScreenshotOperationTests()
        {
            // TODO uncomment below to create an instance of ScreenshotOperation
            //instance = new ScreenshotOperation();
        }
        ...
        /// <summary>
        /// Test an instance of ScreenshotOperation
        /// </summary>
        [Fact]
        public void ScreenshotOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" ScreenshotOperation
            //Assert.IsType<ScreenshotOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a ScreenshotOperationReplace from type ScreenshotOperation
        /// </summary>
        [Fact]
        public void ScreenshotOperationReplaceDeserializeFromScreenshotOperationTest()
        {
            // TODO uncomment below to test deserialize a ScreenshotOperationReplace from type ScreenshotOperation
            //Assert.IsType<ScreenshotOperation>(JsonConvert.DeserializeObject<ScreenshotOperation>(new ScreenshotOperationReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a ScreenshotOperationTest from type ScreenshotOperation
        /// </summary>
        [Fact]
        public void ScreenshotOperationTestDeserializeFromScreenshotOperationTest()
        {
            // TODO uncomment below to test deserialize a ScreenshotOperationTest from type ScreenshotOperation
            //Assert.IsType<ScreenshotOperation>(JsonConvert.DeserializeObject<ScreenshotOperation>(new ScreenshotOperationTest().ToJson()));
        }
