...
{
    /// <summary>
    ///  Class for testing ProjectSettingOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class ProjectSettingOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for ProjectSettingOperation
        //private ProjectSettingOperation instance;

        public ProjectSettingOperationTests()
        {
            // TODO uncomment below to create an instance of ProjectSettingOperation
            //instance = new ProjectSettingOperation();
        }
        ...
        /// <summary>
        /// Test an instance of ProjectSettingOperation
        /// </summary>
        [Fact]
        public void ProjectSettingOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" ProjectSettingOperation
            //Assert.IsType<ProjectSettingOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a ProjectSettingOperationRemove from type ProjectSettingOperation
        /// </summary>
        [Fact]
        public void ProjectSettingOperationRemoveDeserializeFromProjectSettingOperationTest()
        {
            // TODO uncomment below to test deserialize a ProjectSettingOperationRemove from type ProjectSettingOperation
            //Assert.IsType<ProjectSettingOperation>(JsonConvert.DeserializeObject<ProjectSettingOperation>(new ProjectSettingOperationRemove().ToJson()));
        }
        /// <summary>
        /// Test deserialize a ProjectSettingOperationAdd from type ProjectSettingOperation
        /// </summary>
        [Fact]
        public void ProjectSettingOperationAddDeserializeFromProjectSettingOperationTest()
        {
            // TODO uncomment below to test deserialize a ProjectSettingOperationAdd from type ProjectSettingOperation
            //Assert.IsType<ProjectSettingOperation>(JsonConvert.DeserializeObject<ProjectSettingOperation>(new ProjectSettingOperationAdd().ToJson()));
        }
        /// <summary>
        /// Test deserialize a ProjectSettingOperationTest from type ProjectSettingOperation
        /// </summary>
        [Fact]
        public void ProjectSettingOperationTestDeserializeFromProjectSettingOperationTest()
        {
            // TODO uncomment below to test deserialize a ProjectSettingOperationTest from type ProjectSettingOperation
            //Assert.IsType<ProjectSettingOperation>(JsonConvert.DeserializeObject<ProjectSettingOperation>(new ProjectSettingOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a ProjectSettingOperationReplace from type ProjectSettingOperation
        /// </summary>
        [Fact]
        public void ProjectSettingOperationReplaceDeserializeFromProjectSettingOperationTest()
        {
            // TODO uncomment below to test deserialize a ProjectSettingOperationReplace from type ProjectSettingOperation
            //Assert.IsType<ProjectSettingOperation>(JsonConvert.DeserializeObject<ProjectSettingOperation>(new ProjectSettingOperationReplace().ToJson()));
        }
