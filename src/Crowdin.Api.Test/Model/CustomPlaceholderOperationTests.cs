...
{
    /// <summary>
    ///  Class for testing CustomPlaceholderOperation
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the model.
    /// </remarks>
    public class CustomPlaceholderOperationTests : IDisposable
    {
        // TODO uncomment below to declare an instance variable for CustomPlaceholderOperation
        //private CustomPlaceholderOperation instance;

        public CustomPlaceholderOperationTests()
        {
            // TODO uncomment below to create an instance of CustomPlaceholderOperation
            //instance = new CustomPlaceholderOperation();
        }
        ...
        /// <summary>
        /// Test an instance of CustomPlaceholderOperation
        /// </summary>
        [Fact]
        public void CustomPlaceholderOperationInstanceTest()
        {
            // TODO uncomment below to test "IsType" CustomPlaceholderOperation
            //Assert.IsType<CustomPlaceholderOperation>(instance);
        }

        /// <summary>
        /// Test deserialize a CustomPlaceholderOperationReplace from type CustomPlaceholderOperation
        /// </summary>
        [Fact]
        public void CustomPlaceholderOperationReplaceDeserializeFromCustomPlaceholderOperationTest()
        {
            // TODO uncomment below to test deserialize a CustomPlaceholderOperationReplace from type CustomPlaceholderOperation
            //Assert.IsType<CustomPlaceholderOperation>(JsonConvert.DeserializeObject<CustomPlaceholderOperation>(new CustomPlaceholderOperationReplace().ToJson()));
        }
        /// <summary>
        /// Test deserialize a CustomPlaceholderOperationTest from type CustomPlaceholderOperation
        /// </summary>
        [Fact]
        public void CustomPlaceholderOperationTestDeserializeFromCustomPlaceholderOperationTest()
        {
            // TODO uncomment below to test deserialize a CustomPlaceholderOperationTest from type CustomPlaceholderOperation
            //Assert.IsType<CustomPlaceholderOperation>(JsonConvert.DeserializeObject<CustomPlaceholderOperation>(new CustomPlaceholderOperationTest().ToJson()));
        }
        /// <summary>
        /// Test deserialize a ProjectPlaceholderOperationTest from type CustomPlaceholderOperation
        /// </summary>
        [Fact]
        public void ProjectPlaceholderOperationTestDeserializeFromCustomPlaceholderOperationTest()
        {
            // TODO uncomment below to test deserialize a ProjectPlaceholderOperationTest from type CustomPlaceholderOperation
            //Assert.IsType<CustomPlaceholderOperation>(JsonConvert.DeserializeObject<CustomPlaceholderOperation>(new ProjectPlaceholderOperationTest().ToJson()));
        }
