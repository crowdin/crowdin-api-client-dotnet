...
```
// Package Manager
Install-Package Crowdin.Api -Version 2.3.2

// .Net CLI
dotnet add package Crowdin.Api --version 2.3.2

// Package Reference
<PackageReference Include="Crowdin.Api" Version="2.3.2" />

// Paket CLI
paket add Crowdin.Api --version 2.3.2
```
