...
```
// Package Manager
Install-Package Crowdin.Api -Version 2.40.1

// .Net CLI
dotnet add package Crowdin.Api --version 2.40.1

// Package Reference
<PackageReference Include="Crowdin.Api" Version="2.40.1" />

// Paket CLI
paket add Crowdin.Api --version 2.40.1
```
