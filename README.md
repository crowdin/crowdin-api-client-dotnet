...
```
// Package Manager
Install-Package Crowdin.Api -Version 2.13.1

// .Net CLI
dotnet add package Crowdin.Api --version 2.13.1

// Package Reference
<PackageReference Include="Crowdin.Api" Version="2.13.1" />

// Paket CLI
paket add Crowdin.Api --version 2.13.1
```
