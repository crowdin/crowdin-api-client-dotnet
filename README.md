...
```
// Package Manager
Install-Package Crowdin.Api -Version 2.36.0

// .Net CLI
dotnet add package Crowdin.Api --version 2.36.0

// Package Reference
<PackageReference Include="Crowdin.Api" Version="2.36.0" />

// Paket CLI
paket add Crowdin.Api --version 2.36.0
```
