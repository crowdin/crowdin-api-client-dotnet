...
namespace Crowdin.Api.UnitTesting.Tests.Languages
{
    public class LanguagesApiTests
    {
        ...
        public async Task ListSupportedLanguages()
        {
            ...
            mockClient
                ...
                .ReturnsAsync(new CrowdinApiResult
                {
                    ...
                    JsonObject = JObject.Parse(Resources.Languages.ListSupportedLanguages_Response)
                });
        ...
        public async Task AddCustomLanguage()
        {
            ...
            string expectedRequestJson = TestUtils.CompactJson(Resources.Languages.AddCustomLanguage_Request);
            ...
            mockClient
                ...
                .ReturnsAsync(new CrowdinApiResult
                {
                    ...
                    JsonObject = JObject.Parse(Resources.Languages.AddCustomLanguage_Response)
                });
