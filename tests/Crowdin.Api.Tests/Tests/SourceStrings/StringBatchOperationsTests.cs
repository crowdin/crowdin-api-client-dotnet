...
namespace Crowdin.Api.UnitTesting.Tests.SourceStrings
{
    public class StringBatchOperationsTests
    {
        ...
        public async Task StringBatchOperations()
        {
            ...
            string expectedRequestJson = TestUtils.CompactJson(Resources.SourceStrings.StringBatchOperations_Request);
        ...
        public async Task StringBatchOperations_NoPagination()
        {
            ...
            mockClient
                ...
                {
                    StatusCode = HttpStatusCode.OK,
                    JsonObject = JObject.Parse(Resources.SourceStrings.StringBatchOperations_Response_NoPagination)
                });
