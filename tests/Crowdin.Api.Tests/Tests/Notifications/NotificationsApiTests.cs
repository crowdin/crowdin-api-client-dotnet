...
namespace Crowdin.Api.UnitTesting.Tests.Notifications
{
    public class NotificationsApiTests
    {
        ...
        public async Task SendNotificationToAuthenticatedUser()
        {
            ...
            string expectedRequestJson = TestUtils.CompactJson(Resources.Notifications.SendNotificationToAuthenticatedUser_Request);
        ...
        public async Task SendNotificationToProjectMembers_ByUserIds()
        {
            ...
            string actualRequestJson = JsonConvert.SerializeObject(request, JsonSettings);
            string expectedRequestJson = TestUtils.CompactJson(Resources.Notifications.SendNotificationToProjectMembers_Request_ByUserIds);
            Assert.Equal(expectedRequestJson, actualRequestJson);
        ...
        public async Task SendNotificationToProjectMembers_ByRole()
        {
            ...
            string actualRequestJson = JsonConvert.SerializeObject(request, JsonSettings);
            string expectedRequestJson = TestUtils.CompactJson(Resources.Notifications.SendNotificationToProjectMembers_Request_ByRole);
            Assert.Equal(expectedRequestJson, actualRequestJson);
        ...
        public async Task SendNotificationToOrganizationMembers_ByRole()
        {
            ...
            string actualRequestJson = JsonConvert.SerializeObject(request, JsonSettings);
            string expectedRequestJson = TestUtils.CompactJson(Resources.Notifications.SendNotificationToOrganizationMembers_Request_ByRole);
            Assert.Equal(expectedRequestJson, actualRequestJson);
        ...
        public async Task SendNotificationToOrganizationMembers_ByUserIds()
        {
            ...
            string actualRequestJson = JsonConvert.SerializeObject(request, JsonSettings);
            string expectedRequestJson = TestUtils.CompactJson(Resources.Notifications.SendNotificationToOrganizationMembers_Request_ByUserIds);
            Assert.Equal(expectedRequestJson, actualRequestJson);
