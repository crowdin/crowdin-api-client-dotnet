...
{
    public class GroupReportsApiTests
    {
        private const int groupId = 1;
        private const int reportId = 2;
        ...
        [Fact]
        public async Task GenerateGroupReport_GroupTranslationCost()
        {
            ...
            var response = await executor.GenerateGroupReport(groupId, request);
        ...
        [Fact]
        public async Task GenerateGroupReport_GroupTopMembers()
        {
        ...
        [Fact]
        public async Task CheckGroupReportGenerationStatus()
        {
            Mock<ICrowdinApiClient> mockClient = TestUtils.CreateMockClientWithDefaultParser();
            ...
            var executor = new ReportsApiExecutor(mockClient.Object);
            var response = await executor.CheckGroupReportGenerationStatus(groupId, reportId);
        ...
        [Fact]
        public async Task DownloadGroupReport()
        {
            ...
            var executor = new ReportsApiExecutor(mockClient.Object);
            var response = await executor.DownloadGroupReport(groupId, reportId);
