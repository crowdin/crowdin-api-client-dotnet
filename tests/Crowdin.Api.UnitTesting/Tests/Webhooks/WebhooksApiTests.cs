...
namespace Crowdin.Api.UnitTesting.Tests.Webhooks
{
    public class WebhooksApiTests
    {
        ...
        public async Task AddWebhook()
        {
            ...
            string expectedRequestJson = TestUtils.CompactJson(Resources.Webhooks.AddWebhook_Request);
            ...
            mockClient
                ...
                .ReturnsAsync(new CrowdinApiResult
                {
                    ...
                    JsonObject = JObject.Parse(Resources.Webhooks.AddWebhook_Response)
                });
        ...
        public async Task EditWebhook()
        {
            ...
            string expectedRequestJson = TestUtils.CompactJson(Resources.Webhooks.EditWebhook_Request);
            Assert.Equal(expectedRequestJson, actualRequestJson);
            ...
            mockClient
                ...
                .ReturnsAsync(new CrowdinApiResult
                {
                    ...
                    JsonObject = JObject.Parse(Resources.Webhooks.EditWebhook_Response)
                });
        ...
        public async Task GetWebhook()
        {
            ...
            mockClient
                ...
                {
                    StatusCode = HttpStatusCode.OK,
                    JsonObject = JObject.Parse(Resources.Webhooks.GetWebhook_Response)
                });
