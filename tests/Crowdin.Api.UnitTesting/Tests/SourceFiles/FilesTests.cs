...
namespace Crowdin.Api.UnitTesting.Tests.SourceFiles
{
    public class FilesTests
    {
        ...
        {
            var mockResponseObject = JObject.Parse(Resources.SourceFiles.AddFile_Response);
        ...
        public async Task EditFile()
        {
            ...
            string rightRequestJson = Resources.SourceFiles.EditFile_Request;
            ...
            mockClient
                ...
                {
                    StatusCode = HttpStatusCode.OK,
                    JsonObject = JObject.Parse(Resources.SourceFiles.EditFile_Response)
                });
        ...
        public async Task EditFile_JavaScriptExportOptions()
        {
            ...
            string expectedRequestJson = Resources.SourceFiles.EditFile_JavaScriptRequest;
            ...
            mockClient
                ...
                {
                    StatusCode = HttpStatusCode.OK,
                    JsonObject = JObject.Parse(Resources.SourceFiles.EditFile_JavaScript_Response)
                });
        ...
        public async Task DownloadFilePreview()
        {
            ...
            mockClient
                ...
                {
                    StatusCode = HttpStatusCode.OK,
                    JsonObject = JObject.Parse(Resources.SourceFiles.DownloadFilePreview_Response)
                });
